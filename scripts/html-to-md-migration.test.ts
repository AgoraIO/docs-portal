...
<html>
  ...
  await writeFixture(
    ...
    '<!doctype html><html><body><main><article><article id="toc_channel"><h1>频道相关</h1><div class="body"><section id="join"><h2>JoinChannel</h2><p>Joins a channel.</p></section></div></article></article></main></body></html>',
  );
  await writeFixture(
...
<html>
  <body>
    <div class="contents">
      ...
      <a href="empty-reference.html">Empty reference</a>
    </div>
  </body>
</html>`,
  );
...
<html>
  ...
  await writeFixture(
    path.join(sourceDir, 'empty-reference.html'),
    '<!doctype html><html><body><div class="header"><div class="title">Empty Reference</div></div><div class="contents"></div><hr class="footer"><address class="footer">制作者 <a href="https://www.doxygen.org/">Doxygen</a> 1.9.1</address></body></html>',
  );
  await writeFixture(
...
async function writeIosFixture(sourceDir: string, rootTitle = 'Jazzy API') {
  await writeFixture(
    path.join(sourceDir, 'index.html'),
    `<!doctype html>
<html>
  <body>
    <main role="main">
      <h1 class="title">${rootTitle}</h1>
      <div class="section section-overview"><p>Generated by jazzy.</p></div>
      <div class="index-container">
        <div class="index-column"><h2 class="index-title">Programming Guides</h2><ul><li><a href="docs/headers/AgoraRtcEngineKit-Overview.html">Overview guide</a></li></ul></div>
        <div class="index-column"><h2 class="index-title">Class References</h2><ul><li><a href="Classes/AgoraRtcEngineKit.html">AgoraRtcEngineKit</a></li></ul></div>
      </div>
      <div class="footer-copyright"><p>Copyright 2026 Agora.</p><p>Generated by appledoc.</p></div>
    </main>
  </body>
</html>`,
  );
  await writeFixture(
    ...
    '<!doctype html><html><body><main><h1>Hierarchy</h1><div>iOS hierarchy.</div><div class="footer-copyright"><p>Copyright 2026 Agora.</p></div></main></body></html>',
  );
  await writeFixture(
...
async function writeDartdocFixture(sourceDir: string) {
  await writeFixture(
    ...
    JSON.stringify([
      {
        name: 'agora_rtc',
        qualifiedName: 'agora_rtc',
        href: 'agora_rtc/agora_rtc-library.html',
        type: 'library',
        packageName: 'agora_rtc',
      },
      {
        name: 'RtcEngine',
        qualifiedName: 'agora_rtc.RtcEngine',
        href: 'agora_rtc/RtcEngine-class.html',
        type: 'class',
        packageName: 'agora_rtc',
        enclosedBy: { name: 'agora_rtc', type: 'library' },
      },
      {
        name: 'ChannelProfile',
        qualifiedName: 'agora_rtc.ChannelProfile',
        href: 'agora_rtc/ChannelProfile.html',
        type: 'enum',
        packageName: 'agora_rtc',
        enclosedBy: { name: 'agora_rtc', type: 'library' },
      },
      {
        name: 'connect',
        qualifiedName: 'agora_rtc.RtcEngine.connect',
        href: 'agora_rtc/RtcEngine/connect.html',
        type: 'method',
        packageName: 'agora_rtc',
        enclosedBy: { name: 'RtcEngine', type: 'class' },
      },
    ]),
  );
  await writeFixture(path.join(sourceDir, 'categories.json'), '[]');
  await writeFixture(
    path.join(sourceDir, 'index.html'),
    `<!doctype html>
<html>
  <body>
    <main>
      ...
      <a href="agora_rtc/agora_rtc-library.html">agora_rtc</a>
      <a href="agora_rtc/RtcEngine-class.html#instance-methods">RtcEngine</a>
    </main>
  </body>
</html>`,
  );
...
<html>
  ...
  await writeFixture(
    path.join(sourceDir, '__404error.html'),
    '<!doctype html><html><body><main><h1>404</h1></main></body></html>',
  );
  await writeFixture(
    path.join(sourceDir, 'flutter_main_page.html'),
    '<!doctype html><html><body><main><h1>Flutter helper page</h1></main></body></html>',
  );
  await writeFixture(
    path.join(sourceDir, 'agora_rtc', 'agora_rtc-library.html'),
    `<!doctype html>
<html>
  <head><meta name="description" content="agora_rtc library API docs, for the Dart programming language."></head>
  <body>
    <main>
      <div id="dartdoc-main-content">
        <h1>agora_rtc library <a href="https://dart.dev/null-safety">Null safety</a></h1>
        <section class="summary" id="classes">
          <h2>Classes</h2>
          <dl>
            <dt id="RtcEngine"><span class="name"><a href="RtcEngine-class.html">RtcEngine</a></span></dt>
            <dd><p>Primary Dart RTC engine.</p><ol><li>Initialize the engine.</li></ol></dd>
          </dl>
        </section>
        <section class="summary" id="enums">
          <h2>Enums</h2>
          <dl>
            <dt id="ChannelProfile"><span class="name"><a href="ChannelProfile.html">ChannelProfile</a></span></dt>
  ...
  await writeFixture(
    path.join(sourceDir, 'agora_rtc', 'RtcEngine-class.html'),
    `<!doctype html>
<html>
  <head><meta name="description" content="API docs for the RtcEngine class from the agora_rtc library, for the Dart programming language."></head>
  <body>
    <main>
      <div id="dartdoc-main-content">
        <h1>RtcEngine class <a href="https://dart.dev/null-safety">Null safety</a></h1>
        ...
        <section>
          <dl class="dl-horizontal">
            <dt>Inheritance</dt>
            <dd><ul><li>Object</li><li>RtcEngine</li></ul></dd>
          </dl>
        </section>
        <section class="summary" id="instance-properties">
          <h2>Properties</h2>
          <dl>
            <dt id="hashCode" class="property inherited"><span class="name">hashCode</span> <span class="signature">→ int</span></dt>
            <dd><p>The hash code for this object.</p><div class="features">read-only, inherited</div></dd>
          </dl>
        </section>
        <section class="summary" id="instance-methods">
          <h2>Methods</h2>
          <dl>
            <dt id="connect" class="callable"><span class="name"><a href="RtcEngine/connect.html">connect</a></span>(<span class="parameter">String channel</span>) <span class="returntype">→ Future&lt;void&gt;</span></dt>
            <dd><p>Connects to a channel. See <a href="ChannelProfile.html">ChannelProfile</a>.</p></dd>
          </dl>
        </section>
      </div>
    </main>
  ...
  await writeFixture(
    path.join(sourceDir, 'agora_rtc', 'RtcEngine', 'connect.html'),
    `<!doctype html>
<html>
  <head><meta name="description" content="API docs for the connect method from the RtcEngine class, for the Dart programming language."></head>
  <body>
    <main>
      <div id="dartdoc-main-content">
        <h1>connect method <a href="https://dart.dev/null-safety">Null safety</a></h1>
        <section class="multi-line-signature">
          <span class="returntype">Future&lt;void&gt;</span>
          <span class="name">connect</span>(<ol class="parameter-list"><li><span class="parameter"><span class="type-annotation">String</span> <span class="parameter-name">channel</span></span></li></ol>)
        </section>
        <section class="desc markdown">
          <p>Connects to the target channel.</p>
          <p>Param <code>channel</code> Channel name. Param <a href="../ChannelProfile.html">profile</a> Profile override. <strong>Return</strong> Future result.</p>
          <p>See <a href="../ChannelProfile.html">ChannelProfile</a>.</p>
        </section>
        <section class="summary source-code" id="source">
          <h2><span>Implementation</span></h2>
          <pre class="language-dart"><code class="language-dart">Future&lt;void&gt; connect(String channel) {
  ...
  await writeFixture(
    path.join(sourceDir, 'agora_rtc', 'ChannelProfile.html'),
    `<!doctype html>
<html>
  <head><meta name="description" content="API docs for the ChannelProfile enum from the agora_rtc library, for the Dart programming language."></head>
  <body>
    <main>
      <div id="dartdoc-main-content">
        <h1>ChannelProfile enum <a href="https://dart.dev/null-safety">Null safety</a></h1>
        <section class="desc markdown">
          <p>Channel profile options.</p>
        </section>
        <section class="summary" id="values">
          <h2>Values</h2>
          <dl>
            <dt id="communication"><span class="name">communication</span> <span class="signature">→ const ChannelProfile</span></dt>
            <dd><p>Communication profile.</p></dd>
          </dl>
        </section>
      </div>
    </main>
...
describe('html-to-md-migration', () => {
  ...
  it('preserves the functional navigation from a DITA root map', async () => {
    ...
    await expect(
      ...
      '## API navigation\n\n- [初始化相关](/api-reference/rtc/android/initialize)',
    );
    await expect(
      fs.readFile(path.join(outputDir, 'index.mdx'), 'utf8'),
    ...
    await expect(
      fs.readFile(path.join(outputDir, 'channel.mdx'), 'utf8'),
    ).resolves.not.toMatch(/<a id="(?:toc_channel|join)"><\/a>\n\n#{1,6}\s/);
  }, 15_000);
  ...
  it('does not use a nested DITA member short description as page metadata', async () => {
    ...
    const page = await fs.readFile(path.join(outputDir, 'channel.mdx'), 'utf8');
...
<html>
  ...
  it('migrates Doxygen/Javadoc output with dry-run planning and rewritten links', async () => {
    ...
    await expectLaneDryRunAndMigration({
      ...
      expectedPageContents: {
        ...
        'empty-reference.mdx': ['title: "Empty Reference"'],
      },
      outputDir,
      platform: 'cpp',
      product: 'rtc',
  ...
  it('migrates iOS doc-generator output with dry-run planning and rewritten links', async () => {
    ...
    await expectLaneDryRunAndMigration({
      ...
      expectedPageContents: {
        'index.mdx': [
          '## 编程指南',
          '- [Overview guide](/api-reference/rtc/ios/docs/headers/agora-rtc-engine-kit-overview)',
          '## 类参考',
        ],
        'classes/index.mdx': [
          'title: "Classes"',
      ...
      sourceDir,
      unexpectedPageContents: {
        'index.mdx': ['Generated by appledoc', 'Copyright 2026 Agora'],
        'hierarchy.mdx': ['description: "Copyright 2026 Agora."'],
      },
    });
  ...
  it('localizes a generic Whiteboard iOS appledoc index', async () => {
    ...
    expect(index).toContain('title: "互动白板 iOS API 参考"');
  ...
  it('migrates Dartdoc output with dry-run planning, semantic pages, and filtered navigation', async () => {
    ...
    await expectLaneDryRunAndMigration({
      ...
      expectedMetaPages: ['index', 'agora-rtc'],
      expectedPageContents: {
    ...
    expect(rootMeta.pages).not.toContain('__404error');
    expect(rootMeta.pages).not.toContain('flutter-main-page');
    expect(rootMeta.pages).not.toContain('library-index');

    const libraryMeta = await readJson(
      path.join(outputDir, 'agora-rtc', 'meta.json'),
    );
    expect(libraryMeta.pages).toEqual([
      'index',
      'rtc-engine',
      'channel-profile',
    ]);

    const classMeta = await readJson(
      path.join(outputDir, 'agora-rtc', 'rtc-engine', 'meta.json'),
    );
    expect(classMeta.pages).toEqual(['index']);
    await expect(
      pathExists(
        path.join(outputDir, 'agora-rtc', 'rtc-engine', 'connect.mdx'),
      ),
    ).resolves.toBe(true);
  });

  it('creates a localized scoped Agora Chat Flutter Dartdoc landing page', async () => {
    const rootDir = await makeTempDir();
    const sourceDir = path.join(rootDir, 'dartdoc-source');
    const outputDir = path.join(rootDir, 'output');
    await writeDartdocFixture(sourceDir);
    ...
    const index = await fs.readFile(path.join(outputDir, 'index.mdx'), 'utf8');
    expect(index).toContain('title: "即时通讯 Flutter API 参考"');
    expect(index).toContain('本节包含迁移后的 Flutter API 参考。');
    expect(index).not.toContain('Generated by dartdoc');
    await expect(
      readJson(path.join(outputDir, 'meta.json')),
    ).resolves.toMatchObject({
