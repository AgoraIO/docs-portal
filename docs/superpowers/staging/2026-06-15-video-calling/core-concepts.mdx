...
<PlatformStructured platform="sd-rtn">
### Agora SDRTN® {#agora-sd-rtn}
...
<PlatformStructured platform="channel">
### Channel
...
<PlatformStructured platform="channel-profile">
### Channel profile
...
<PlatformStructured platform="stream">
### Stream
...
<PlatformStructured platform="user-role">
### User role
...
<PlatformStructured platform="publish">
### Publish
...
<PlatformStructured platform="subscribe">
### Subscribe
...
<PlatformStructured platform="user-id">
### User ID
...
<PlatformStructured platform="connection">
### RTC connection
...
<PlatformStructured platform="app-id">
### App ID
...
<PlatformStructured platform="app-certificate">
### App Certificate
...
<PlatformStructured platform="token">
### Tokens
...
For information on setting up a token server for generating and managing tokens, refer to [Deploy a token server](/en/realtime-media/video/build/deploy-token-server).
</PlatformStructured>

<PlatformStructured platform="agora-console">
### Agora Console
...
<PlatformStructured platform="audio-video-concepts">
