...
* [What can I do if I get a pop-up warning saying 'the framework cannot be opened' when compiling an Xcode project?](/en/help/integration-issues/framework_cannot_be_opened)
