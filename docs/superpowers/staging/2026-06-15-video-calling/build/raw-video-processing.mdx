...
<Accordions>
  <Accordion title="Process raw video">
...
- [`registerVideoFrameObserver`]({{global.API_REF_ANDROID_ROOT}}/class_irtcengine.html#api_imediaengine_registervideoframeobserver)
- [`registerVideoEncodedFrameObserver`]({{global.API_REF_ANDROID_ROOT}}/class_irtcengine.html#api_imediaengine_registervideoencodedframeobserver)
...
- [`getVideoFrameProcessMode`]({{global.API_REF_ANDROID_ROOT}}/class_ivideoframeobserver.html#callback_ivideoframeobserver_getvideoframeprocessmode)
- [`onEncodedVideoFrameReceived`]({{global.API_REF_ANDROID_ROOT}}/class_ivideoencodedframeobserver.html#callback_ivideoencodedframeobserver_onencodedvideoframereceived)
</PlatformStructured>
<PlatformStructured platform="electron">
...
- [`setVideoFrameDelegate(_:)`]({{global.API_REF_IOS_ROOT_RTC_KIT}}/agorartcenginekit/setvideoframedelegate(_:))
- [`onRenderVideoFrame(_:uid:channelId:)`]({{global.API_REF_IOS_ROOT_RTC_KIT}}/agoravideoframedelegate/onrendervideoframe(_:uid:channelid:))
- [`onCapture(_:sourceType:)`]({{global.API_REF_IOS_ROOT_RTC_KIT}}/agoravideoframedelegate/oncapture(_:sourcetype:))
</PlatformStructured>
<PlatformStructured platform="macos">
### Sample project
...
- [`setVideoFrameDelegate(_:)`]({{global.API_REF_MACOS_ROOT_RTC_KIT}}/agorartcenginekit/setvideoframedelegate(_:))
- [`onRenderVideoFrame(_:uid:channelId:)`]({{global.API_REF_MACOS_ROOT_RTC_KIT}}/agoravideoframedelegate/onrendervideoframe(_:uid:channelid:))
- [`onCapture(_:sourceType:)`]({{global.API_REF_MACOS_ROOT_RTC_KIT}}/agoravideoframedelegate/oncapture(_:sourcetype:))
</PlatformStructured>
<PlatformStructured platform="react-js">
...
- [`RegisterVideoFrameObserver`]({{global.API_REF_UNITY_ROOT}}/class_irtcengine.html#api_imediaengine_registervideoframeobserver)
- [`RegisterVideoEncodedFrameObserver`]({{global.API_REF_UNITY_ROOT}}/class_irtcengine.html#api_imediaengine_registervideoencodedframeobserver)
- [`OnCaptureVideoFrame`]({{global.API_REF_UNITY_ROOT}}/class_ivideoframeobserver.html#callback_ivideoframeobserver_oncapturevideoframe)
- [`OnRenderVideoFrame`]({{global.API_REF_UNITY_ROOT}}/class_ivideoframeobserver.html#callback_ivideoframeobserver_onrendervideoframe)
</PlatformStructured>
<PlatformStructured platform="unreal">
### Sample project
...
- [`registerVideoFrameObserver`]({{global.API_REF_UE_ROOT}}/class_imediaplayer.html#api_imediaplayer_registervideoframeobserver)
- [`registerVideoEncodedFrameObserver`]({{global.API_REF_UE_ROOT}}/class_imediaengine.html#api_imediaengine_registervideoencodedframeobserver)
- [`onCaptureVideoFrame`]({{global.API_REF_UE_ROOT}}/class_ivideoframeobserver.html#callback_ivideoframeobserver_oncapturevideoframe)
- [`onRenderVideoFrame`]({{global.API_REF_UE_ROOT}}/class_ivideoframeobserver.html#callback_ivideoframeobserver_onrendervideoframe)
- [`getVideoFrameProcessMode`]({{global.API_REF_UE_ROOT}}/class_ivideoframeobserver.html#callback_ivideoframeobserver_getvideoframeprocessmode)
- [`onEncodedVideoFrameReceived`]({{global.API_REF_UE_ROOT}}/class_ivideoencodedframeobserver.html#callback_ivideoencodedframeobserver_onencodedvideoframereceived)
</PlatformStructured>
<PlatformStructured platform="web">
### API reference
...
- [`registerVideoFrameObserver`]({{global.API_REF_WINDOWS_ROOT_CPP}}/class_irtcengine.html#api_imediaengine_registervideoframeobserver)
- [`registerVideoEncodedFrameObserver`]({{global.API_REF_WINDOWS_ROOT_CPP}}/class_irtcengine.html#api_imediaengine_registervideoencodedframeobserver)
- [`onCaptureVideoFrame`]({{global.API_REF_WINDOWS_ROOT_CPP}}/class_ivideoframeobserver.html#callback_ivideoframeobserver_oncapturevideoframe)
- [`onRenderVideoFrame`]({{global.API_REF_WINDOWS_ROOT_CPP}}/class_ivideoframeobserver.html#callback_ivideoframeobserver_onrendervideoframe)
- [`getVideoFrameProcessMode`]({{global.API_REF_WINDOWS_ROOT_CPP}}/class_ivideoframeobserver.html#callback_ivideoframeobserver_getvideoframeprocessmode)
- [`onEncodedVideoFrameReceived`]({{global.API_REF_WINDOWS_ROOT_CPP}}/class_ivideoencodedframeobserver.html#callback_ivideoencodedframeobserver_onencodedvideoframereceived)
</PlatformStructured>
