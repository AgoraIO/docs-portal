...
<Accordions>
  <Accordion title="Screenshot upload">
...
<CodeBlockTabsList>
  <CodeBlockTabsTrigger value="tab1">AWS</CodeBlockTabsTrigger>
  <CodeBlockTabsTrigger value="tab2">Alibaba Cloud</CodeBlockTabsTrigger>
</CodeBlockTabsList>
...
3. **Integrate Video SDK**
   ...
   Integrate the Video SDK (including the local screenshot upload dynamic library) into your project, join a channel, and publish a video stream. See [SDK quickstart](../../video-calling/get-started/get-started-sdk) for details.
...
| `object`        | String      | Name of the screenshot file. The naming convention for this file is: `<OSS prefix>/<year month day>/<sid>_<cname>__uid_s_<uid>__uid_e_<type>_utc.jpg`. The meanings of the fields in the filename are as follows: - `<sid>`: Screenshot ID, a unique identifier for a screenshot.
...
- [`enableContentInspect`]({{global.API_REF_ANDROID_ROOT}}/class_irtcengine.html#api_irtcengine_enablecontentinspect)
</PlatformStructured>
<PlatformStructured platform="electron">
### API reference

- [`enableContentInspect`]({{Global.API_REF_ELECTRON_ROOT}}/class_irtcengine.html#api_irtcengine_enablecontentinspect)
</PlatformStructured>
<PlatformStructured platform="flutter">
...
- [`enableContentInspect(_:config:)`]({{Global.API_REF_IOS_ROOT_RTC_KIT}}/agorartcenginekit/enablecontentinspect(_:config:))
</PlatformStructured>
<PlatformStructured platform="macos">
### API reference

- [`enableContentInspect(_:config:)`]({{Global.API_REF_MACOS_ROOT_RTC_KIT}}/agorartcenginekit/enablecontentinspect(_:config:))
</PlatformStructured>
<PlatformStructured platform="react-js">
...
- [`enableContentInspect`]({{Global.API_REF_RN_ROOT}}/class_irtcengine.html#api_irtcengine_enablecontentinspect)
</PlatformStructured>
<PlatformStructured platform="unity">
### API reference

- [`EnableContentInspect`]({{Global.API_REF_UNITY_ROOT}}/class_irtcengine.html#api_irtcengine_enablecontentinspect)
</PlatformStructured>
<PlatformStructured platform="unreal">
...
- [`enableContentInspect`]({{global.API_REF_WINDOWS_ROOT_CPP}}/class_irtcengine.html#api_irtcengine_enablecontentinspect)
</PlatformStructured>

### local screenshot upload dynamic library

You can find details about the name of the local screenshot upload dynamic library and the increase in app size after integration in [App size optimization](/en/realtime-media/video/build/app-size-optimization).
