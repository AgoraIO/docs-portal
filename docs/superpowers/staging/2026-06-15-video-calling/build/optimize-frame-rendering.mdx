...
Complete the steps in the [SDK Quickstart](/en/realtime-media/video/index) to build a basic Video Calling app.
...
<Tabs defaultValue="tab1">
<TabsList>
  <TabsTrigger value="1">Preload and initialize early</TabsTrigger>
  <TabsTrigger value="2">Join early, subscribe on demand</TabsTrigger>
</TabsList>
...
<Accordions>
  <Accordion title="Sequence diagram for implementation">
