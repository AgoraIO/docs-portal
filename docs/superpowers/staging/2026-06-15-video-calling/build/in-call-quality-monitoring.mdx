...
<Accordions>
  <Accordion title="Audio transmission process">
...
| 1001 | `FRAMERATE_INPUT_TOO_LOW`
 Video capture frame rate is too low | 3001 | `FRAMERATE_INPUT_TOO_LOW_RECOVER`
 Video capture frame rate returns to normal|
| 1002 | `FRAMERATE_SENT_TOO_LOW`
 Video sending bitrate is too low  | 3002 | `FRAMERATE_SENT_TOO_LOW_RECOVER`
 Video sending frame rate returns to normal |
| 1003 | `SEND_VIDEO_BITRATE_TOO_LOW`
 Video sending bitrate is too low | 3003 | `SEND_VIDEO_BITRATE_TOO_LOW_RECOVER`
 Video sending bitrate returns to normal |
| 1005 | `RECV_VIDEO_DECODE_FAILED`
 Receiving video decoding failed | 3005 | `RECV_VIDEO_DECODE_FAILED_RECOVER`
 Receiving video decoding returns to normal |
| 2001 | `AUDIO_INPUT_LEVEL_TOO_LOW`
 Send volume too low | 4001 | `AUDIO_INPUT_LEVEL_TOO_LOW_RECOVER`
 Send volume back to normal |
| 2002 | `AUDIO_OUTPUT_LEVEL_TOO_LOW`
 Receive volume too low | 4002 | `AUDIO_OUTPUT_LEVEL_TOO_LOW_RECOVER`
 Receiving volume returns to normal |
| 2003 | `SEND_AUDIO_BITRATE_TOO_LOW`
 Audio sending bitrate is too low | 4003 | `SEND_AUDIO_BITRATE_TOO_LOW_RECOVER`
 Audio sending bitrate returns to normal |
| 2005 | `RECV_AUDIO_DECODE_FAILED`
 Failed to decode received audio | 4005 | `RECV_AUDIO_DECODE_FAILED_RECOVER`
...
- [`onNetworkQuality`]({{global.API_REF_ANDROID_ROOT}}/class_irtcengineeventhandler.html#callback_irtcengineeventhandler_onnetworkquality)

- [`onRemoteAudioStateChanged`]({{global.API_REF_ANDROID_ROOT}}/class_irtcengineeventhandler.html#callback_irtcengineeventhandler_onremoteaudiostatechanged)

- [`onRemoteVideoStateChanged`]({{global.API_REF_ANDROID_ROOT}}/class_irtcengineeventhandler.html#callback_irtcengineeventhandler_onremotevideostatechanged)

- [`onLocalAudioStateChanged`]({{global.API_REF_ANDROID_ROOT}}/class_irtcengineeventhandler.html#callback_irtcengineeventhandler_onlocalaudiostatechanged)

- [`onLocalVideoStateChanged`]({{global.API_REF_ANDROID_ROOT}}/class_irtcengineeventhandler.html#callback_irtcengineeventhandler_onlocalvideostatechanged)

- [`onRemoteAudioStats`]({{global.API_REF_ANDROID_ROOT}}/class_irtcengineeventhandler.html#callback_irtcengineeventhandler_onremoteaudiostats)

- [`onRemoteVideoStats`]({{global.API_REF_ANDROID_ROOT}}/class_irtcengineeventhandler.html#callback_irtcengineeventhandler_onremotevideostats)

- [`onLocalAudioStats`]({{global.API_REF_ANDROID_ROOT}}/class_irtcengineeventhandler.html#callback_irtcengineeventhandler_onlocalaudiostats)

- [`onLocalVideoStats`]({{global.API_REF_ANDROID_ROOT}}/class_irtcengineeventhandler.html#callback_irtcengineeventhandler_onlocalvideostats)

- [`onRtcStats`]({{global.API_REF_ANDROID_ROOT}}/class_irtcengineeventhandler.html#callback_irtcengineeventhandler_onrtcstats)
</PlatformStructured>
<PlatformStructured platform="electron">
### Network quality score
...
- [`onNetworkQuality`]({{global.API_REF_ELECTRON_ROOT}}/class_irtcengineeventhandler.html#callback_irtcengineeventhandler_onnetworkquality)

- [`onRemoteAudioStateChanged`]({{global.API_REF_ELECTRON_ROOT}}/class_irtcengineeventhandler.html#callback_irtcengineeventhandler_onremoteaudiostatechanged)

- [`onRemoteVideoStateChanged`]({{global.API_REF_ELECTRON_ROOT}}/class_irtcengineeventhandler.html#callback_irtcengineeventhandler_onremotevideostatechanged)

- [`onLocalAudioStateChanged`]({{global.API_REF_ELECTRON_ROOT}}/class_irtcengineeventhandler.html#callback_irtcengineeventhandler_onlocalaudiostatechanged)

- [`onLocalVideoStateChanged`]({{global.API_REF_ELECTRON_ROOT}}/class_irtcengineeventhandler.html#callback_irtcengineeventhandler_onlocalvideostatechanged)

- [`onRemoteAudioStats`]({{global.API_REF_ELECTRON_ROOT}}/class_irtcengineeventhandler.html#callback_irtcengineeventhandler_onremoteaudiostats)

- [`onRemoteVideoStats`]({{global.API_REF_ELECTRON_ROOT}}/class_irtcengineeventhandler.html#callback_irtcengineeventhandler_onremotevideostats)

- [`onLocalAudioStats`]({{global.API_REF_ELECTRON_ROOT}}/class_irtcengineeventhandler.html#callback_irtcengineeventhandler_onlocalaudiostats)

- [`onLocalVideoStats`]({{global.API_REF_ELECTRON_ROOT}}/class_irtcengineeventhandler.html#callback_irtcengineeventhandler_onlocalvideostats)

- [`onRtcStats`]({{global.API_REF_ELECTRON_ROOT}}/class_irtcengineeventhandler.html#callback_irtcengineeventhandler_onrtcstats)
</PlatformStructured>
<PlatformStructured platform="flutter">
### Network quality score
...
- [`onNetworkQuality`]({{global.API_REF_FLUTTER_ROOT}}/class_irtcengineeventhandler.html#callback_irtcengineeventhandler_onnetworkquality)

- [`onRemoteAudioStateChanged`]({{global.API_REF_FLUTTER_ROOT}}/class_irtcengineeventhandler.html#callback_irtcengineeventhandler_onremoteaudiostatechanged)

- [`onRemoteVideoStateChanged`]({{global.API_REF_FLUTTER_ROOT}}/class_irtcengineeventhandler.html#callback_irtcengineeventhandler_onremotevideostatechanged)

- [`onLocalAudioStateChanged`]({{global.API_REF_FLUTTER_ROOT}}/class_irtcengineeventhandler.html#callback_irtcengineeventhandler_onlocalaudiostatechanged)

- [`onLocalVideoStateChanged`]({{global.API_REF_FLUTTER_ROOT}}/class_irtcengineeventhandler.html#callback_irtcengineeventhandler_onlocalvideostatechanged)

- [`onRemoteAudioStats`]({{global.API_REF_FLUTTER_ROOT}}/class_irtcengineeventhandler.html#callback_irtcengineeventhandler_onremoteaudiostats)

- [`onRemoteVideoStats`]({{global.API_REF_FLUTTER_ROOT}}/class_irtcengineeventhandler.html#callback_irtcengineeventhandler_onremotevideostats)

- [`onLocalAudioStats`]({{global.API_REF_FLUTTER_ROOT}}/class_irtcengineeventhandler.html#callback_irtcengineeventhandler_onlocalaudiostats)

- [`onLocalVideoStats`]({{global.API_REF_FLUTTER_ROOT}}/class_irtcengineeventhandler.html#callback_irtcengineeventhandler_onlocalvideostats)

- [`onRtcStats`]({{global.API_REF_FLUTTER_ROOT}}/class_irtcengineeventhandler.html#callback_irtcengineeventhandler_onrtcstats)
</PlatformStructured>
<PlatformStructured platform="ios">
### Network quality score
...
- [`rtcEngine(_:networkQuality:txQuality:rxQuality:)`]({{Global.API_REF_IOS_ROOT_RTC_KIT}}/agorartcenginedelegate/rtcengine(_:networkquality:txquality:rxquality:))
- [`rtcEngine(_:reportRtcStats:)`]({{Global.API_REF_IOS_ROOT_RTC_KIT}}/agorartcenginedelegate/rtcengine(_:reportrtcstats:))
- [`rtcEngine(_:localAudioStats:)`]({{Global.API_REF_IOS_ROOT_RTC_KIT}}/agorartcenginedelegate/rtcengine(_:localaudiostats:))
- [`rtcEngine(_:localAudioStateChanged:reason:)`]({{Global.API_REF_IOS_ROOT_RTC_KIT}}/agorartcenginedelegate/rtcengine(_:localaudiostatechanged:error:))
- [`rtcEngine(_:remoteAudioStats:)`]({{Global.API_REF_IOS_ROOT_RTC_KIT}}/agorartcenginedelegate/rtcengine(_:remoteaudiostats:))
- [`rtcEngine(_:remoteAudioStateChangedOfUid:state:reason:elapsed:)`]({{Global.API_REF_IOS_ROOT_RTC_KIT}}/agorartcenginedelegate/rtcengine(_:remoteaudiostatechangedofuid:state:reason:elapsed:))
- [`rtcEngine(_:localVideoStats:sourceType:)`]({{Global.API_REF_IOS_ROOT_RTC_KIT}}/agorartcenginedelegate/rtcengine(_:localvideostats:sourcetype:))
- [`rtcEngine(_:localVideoStateChangedOf:reason:sourceType:)`]({{Global.API_REF_IOS_ROOT_RTC_KIT}}/agorartcenginedelegate/rtcengine(_:localvideostatechangedof:reason:sourcetype:))
- [`rtcEngine(_:remoteVideoStats:)`]({{Global.API_REF_IOS_ROOT_RTC_KIT}}/agorartcenginedelegate/rtcengine(_:remotevideostats:))
- [`rtcEngine(_:remoteVideoStateChangedOfUid:state:reason:elapsed:)`]({{Global.API_REF_IOS_ROOT_RTC_KIT}}/agorartcenginedelegate/rtcengine(_:remotevideostatechangedofuid:state:reason:elapsed:))
</PlatformStructured>
<PlatformStructured platform="macos">
### Network quality score
...
- [`rtcEngine(_:networkQuality:txQuality:rxQuality:)`]({{Global.API_REF_MACOS_ROOT_RTC_KIT}}/agorartcenginedelegate/rtcengine(_:networkquality:txquality:rxquality:))
- [`rtcEngine(_:reportRtcStats:)`]({{Global.API_REF_MACOS_ROOT_RTC_KIT}}/agorartcenginedelegate/rtcengine(_:reportrtcstats:))
- [`rtcEngine(_:localAudioStats:)`]({{Global.API_REF_MACOS_ROOT_RTC_KIT}}/agorartcenginedelegate/rtcengine(_:localaudiostats:))
- [`rtcEngine(_:localAudioStateChanged:reason:)`]({{Global.API_REF_MACOS_ROOT_RTC_KIT}}/agorartcenginedelegate/rtcengine(_:localaudiostatechanged:error:))
- [`rtcEngine(_:remoteAudioStats:)`]({{Global.API_REF_MACOS_ROOT_RTC_KIT}}/agorartcenginedelegate/rtcengine(_:remoteaudiostats:))
- [`rtcEngine(_:remoteAudioStateChangedOfUid:state:reason:elapsed:)`]({{Global.API_REF_MACOS_ROOT_RTC_KIT}}/agorartcenginedelegate/rtcengine(_:remoteaudiostatechangedofuid:state:reason:elapsed:))
- [`rtcEngine(_:localVideoStats:sourceType:)`]({{Global.API_REF_MACOS_ROOT_RTC_KIT}}/agorartcenginedelegate/rtcengine(_:localvideostats:sourcetype:))
- [`rtcEngine(_:localVideoStateChangedOf:reason:sourceType:)`]({{Global.API_REF_MACOS_ROOT_RTC_KIT}}/agorartcenginedelegate/rtcengine(_:localvideostatechangedof:error:sourcetype:))
- [`rtcEngine(_:remoteVideoStats:)`]({{Global.API_REF_MACOS_ROOT_RTC_KIT}}/agorartcenginedelegate/rtcengine(_:remotevideostats:))
- [`rtcEngine(_:remoteVideoStateChangedOfUid:state:reason:elapsed:)`]({{Global.API_REF_MACOS_ROOT_RTC_KIT}}/agorartcenginedelegate/rtcengine(_:remotevideostatechangedofuid:state:reason:elapsed:))
</PlatformStructured>
<PlatformStructured platform="react-js">
### API reference

- [useNetworkQuality]({{global.API_REF_RNJS_ROOT}}/functions/useNetworkQuality.html)

- [getLocalAudioStats]({{global.API_REF_RNJS_ROOT}}/interfaces/IAgoraRTCClient.html#getLocalAudioStats)

- [getLocalVideoStats]({{global.API_REF_RNJS_ROOT}}/interfaces/IAgoraRTCClient.html#getLocalVideoStats)

- [getRTCStats]({{global.API_REF_RNJS_ROOT}}/interfaces/IAgoraRTCClient.html#getRTCStats)

- [getRemoteAudioStats]({{global.API_REF_RNJS_ROOT}}/interfaces/IAgoraRTCClient.html#getRemoteAudioStats)

- [getRemoteVideoStats]({{global.API_REF_RNJS_ROOT}}/interfaces/IAgoraRTCClient.html#getRemoteVideoStats)
</PlatformStructured>
<PlatformStructured platform="react-native">
### Network quality score
...
- [`onNetworkQuality`]({{global.API_REF_RN_ROOT}}/class_irtcengineeventhandler.html#callback_irtcengineeventhandler_onnetworkquality)

- [`onRemoteAudioStateChanged`]({{global.API_REF_RN_ROOT}}/class_irtcengineeventhandler.html#callback_irtcengineeventhandler_onremoteaudiostatechanged)

- [`onRemoteVideoStateChanged`]({{global.API_REF_RN_ROOT}}/class_irtcengineeventhandler.html#callback_irtcengineeventhandler_onremotevideostatechanged)

- [`onLocalAudioStateChanged`]({{global.API_REF_RN_ROOT}}/class_irtcengineeventhandler.html#callback_irtcengineeventhandler_onlocalaudiostatechanged)

- [`onLocalVideoStateChanged`]({{global.API_REF_RN_ROOT}}/class_irtcengineeventhandler.html#callback_irtcengineeventhandler_onlocalvideostatechanged)

- [`onRemoteAudioStats`]({{global.API_REF_RN_ROOT}}/class_irtcengineeventhandler.html#callback_irtcengineeventhandler_onremoteaudiostats)

- [`onRemoteVideoStats`]({{global.API_REF_RN_ROOT}}/class_irtcengineeventhandler.html#callback_irtcengineeventhandler_onremotevideostats)

- [`onLocalAudioStats`]({{global.API_REF_RN_ROOT}}/class_irtcengineeventhandler.html#callback_irtcengineeventhandler_onlocalaudiostats)

- [`onLocalVideoStats`]({{global.API_REF_RN_ROOT}}/class_irtcengineeventhandler.html#callback_irtcengineeventhandler_onlocalvideostats)

- [`onRtcStats`]({{global.API_REF_RN_ROOT}}/class_irtcengineeventhandler.html#callback_irtcengineeventhandler_onrtcstats)
</PlatformStructured>
<PlatformStructured platform="unity">
### Network quality score
...
- [`onNetworkQuality`]({{global.API_REF_UNITY_ROOT}}/class_irtcengineeventhandler.html#callback_irtcengineeventhandler_onnetworkquality)

- [`onRemoteAudioStateChanged`]({{global.API_REF_UNITY_ROOT}}/class_irtcengineeventhandler.html#callback_irtcengineeventhandler_onremoteaudiostatechanged)

- [`onRemoteVideoStateChanged`]({{global.API_REF_UNITY_ROOT}}/class_irtcengineeventhandler.html#callback_irtcengineeventhandler_onremotevideostatechanged)

- [`onLocalAudioStateChanged`]({{global.API_REF_UNITY_ROOT}}/class_irtcengineeventhandler.html#callback_irtcengineeventhandler_onlocalaudiostatechanged)

- [`onLocalVideoStateChanged`]({{global.API_REF_UNITY_ROOT}}/class_irtcengineeventhandler.html#callback_irtcengineeventhandler_onlocalvideostatechanged)

- [`onRemoteAudioStats`]({{global.API_REF_UNITY_ROOT}}/class_irtcengineeventhandler.html#callback_irtcengineeventhandler_onremoteaudiostats)

- [`onRemoteVideoStats`]({{global.API_REF_UNITY_ROOT}}/class_irtcengineeventhandler.html#callback_irtcengineeventhandler_onremotevideostats)

- [`onLocalAudioStats`]({{global.API_REF_UNITY_ROOT}}/class_irtcengineeventhandler.html#callback_irtcengineeventhandler_onlocalaudiostats)

- [`onLocalVideoStats`]({{global.API_REF_UNITY_ROOT}}/class_irtcengineeventhandler.html#callback_irtcengineeventhandler_onlocalvideostats)

- [`onRtcStats`]({{global.API_REF_UNITY_ROOT}}/class_irtcengineeventhandler.html#callback_irtcengineeventhandler_onrtcstats)
</PlatformStructured>
<PlatformStructured platform="unreal">
### Network quality score
...
- [`onNetworkQuality`]({{global.API_REF_UE_ROOT}}/class_irtcengineeventhandler.html#callback_irtcengineeventhandler_onnetworkquality)

- [`onRemoteAudioStateChanged`]({{global.API_REF_UE_ROOT}}/class_irtcengineeventhandler.html#callback_irtcengineeventhandler_onremoteaudiostatechanged)

- [`onRemoteVideoStateChanged`]({{global.API_REF_UE_ROOT}}/class_irtcengineeventhandler.html#callback_irtcengineeventhandler_onremotevideostatechanged)

- [`onLocalAudioStateChanged`]({{global.API_REF_UE_ROOT}}/class_irtcengineeventhandler.html#callback_irtcengineeventhandler_onlocalaudiostatechanged)

- [`onLocalVideoStateChanged`]({{global.API_REF_UE_ROOT}}/class_irtcengineeventhandler.html#callback_irtcengineeventhandler_onlocalvideostatechanged)

- [`onRemoteAudioStats`]({{global.API_REF_UE_ROOT}}/class_irtcengineeventhandler.html#callback_irtcengineeventhandler_onremoteaudiostats)

- [`onRemoteVideoStats`]({{global.API_REF_UE_ROOT}}/class_irtcengineeventhandler.html#callback_irtcengineeventhandler_onremotevideostats)

- [`onLocalAudioStats`]({{global.API_REF_UE_ROOT}}/class_irtcengineeventhandler.html#callback_irtcengineeventhandler_onlocalaudiostats)

- [`onLocalVideoStats`]({{global.API_REF_UE_ROOT}}/class_irtcengineeventhandler.html#callback_irtcengineeventhandler_onlocalvideostats)

- [`onRtcStats`]({{global.API_REF_UE_ROOT}}/class_irtcengineeventhandler.html#callback_irtcengineeventhandler_onrtcstats)
</PlatformStructured>
<PlatformStructured platform="web">
### Network quality score
...
- [`onNetworkQuality`]({{global.API_REF_WINDOWS_ROOT_CPP}}/class_irtcengineeventhandler.html#callback_irtcengineeventhandler_onnetworkquality)

- [`onRemoteAudioStateChanged`]({{global.API_REF_WINDOWS_ROOT_CPP}}/class_irtcengineeventhandler.html#callback_irtcengineeventhandler_onremoteaudiostatechanged)

- [`onRemoteVideoStateChanged`]({{global.API_REF_WINDOWS_ROOT_CPP}}/class_irtcengineeventhandler.html#callback_irtcengineeventhandler_onremotevideostatechanged)

- [`onLocalAudioStateChanged`]({{global.API_REF_WINDOWS_ROOT_CPP}}/class_irtcengineeventhandler.html#callback_irtcengineeventhandler_onlocalaudiostatechanged)

- [`onLocalVideoStateChanged`]({{global.API_REF_WINDOWS_ROOT_CPP}}/class_irtcengineeventhandler.html#callback_irtcengineeventhandler_onlocalvideostatechanged)

- [`onRemoteAudioStats`]({{global.API_REF_WINDOWS_ROOT_CPP}}/class_irtcengineeventhandler.html#callback_irtcengineeventhandler_onremoteaudiostats)

- [`onRemoteVideoStats`]({{global.API_REF_WINDOWS_ROOT_CPP}}/class_irtcengineeventhandler.html#callback_irtcengineeventhandler_onremotevideostats)

- [`onLocalAudioStats`]({{global.API_REF_WINDOWS_ROOT_CPP}}/class_irtcengineeventhandler.html#callback_irtcengineeventhandler_onlocalaudiostats)

- [`onLocalVideoStats`]({{global.API_REF_WINDOWS_ROOT_CPP}}/class_irtcengineeventhandler.html#callback_irtcengineeventhandler_onlocalvideostats)

- [`onRtcStats`]({{global.API_REF_WINDOWS_ROOT_CPP}}/class_irtcengineeventhandler.html#callback_irtcengineeventhandler_onrtcstats)
</PlatformStructured>
