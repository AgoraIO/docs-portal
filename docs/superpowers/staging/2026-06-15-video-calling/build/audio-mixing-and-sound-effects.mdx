...
|----------|--------------|-----------------------------|
| Play or stop playing a specific audio file     | `preloadEffect`
 `unloadEffect`
 `playEffect`
 `stopEffect`
 `stopAllEffects`  | `startAudioMixing`
 `stopAudioMixing`       |
| Pause or resume playing an audio file          | `pauseEffect`
 `pauseAllEffects`
 `resumeEffect`
 `resumeAllEffects` | `pauseAudioMixing`
 `resumeAudioMixing`    |
| Get and adjust playback position and volume   | `setEffectPosition`
 `getEffectCurrentPosition`
 `getEffectsVolume`
 `setEffectsVolume`
 `setVolumeOfEffect` | `getAudioMixingCurrentPosition`
...
* [`preloadEffect`]({{Global.API_REF_ANDROID_ROOT}}class_iaudioeffectmanager.html#api_irtcengine_preloadeffect)

* [`playEffect`]({{Global.API_REF_ANDROID_ROOT}}/class_iaudioeffectmanager.html#api_irtcengine_playeffect3)

* [`onAudioEffectFinished`]({{Global.API_REF_ANDROID_ROOT}}/class_irtcengineeventhandler.html#callback_irtcengineeventhandler_onaudioeffectfinished)

* [`startAudioMixing`]({{Global.API_REF_ANDROID_ROOT}}/class_irtcengine.html#api_irtcengine_startaudiomixing)

* [`onAudioMixingStateChanged`]({{Global.API_REF_ANDROID_ROOT}}/class_irtcengineeventhandler.html#callback_irtcengineeventhandler_onaudiomixingstatechanged)

* [`pauseAudioMixing`]({{Global.API_REF_ANDROID_ROOT}}class_irtcengine.html#api_irtcengine_pauseaudiomixing)

* [`resumeAudioMixing`]({{Global.API_REF_ANDROID_ROOT}}class_irtcengine.html#api_irtcengine_resumeaudiomixing)

* [`stopAudioMixing`]({{Global.API_REF_ANDROID_ROOT}}class_irtcengine.html#api_irtcengine_stopaudiomixing)
...
* [`adjustAudioMixingPublishVolume`]({{Global.API_REF_ANDROID_ROOT}}class_irtcengine.html#api_irtcengine_adjustaudiomixingpublishvolume)
</PlatformStructured>
<PlatformStructured platform="electron">
### API reference

* [`playEffect`]({{Global.API_REF_ELECTRON_ROOT}}/class_irtcengine.html#api_irtcengine_playeffect3)

* [`onAudioEffectFinished`]({{Global.API_REF_ELECTRON_ROOT}}/class_irtcengineeventhandler.html#callback_irtcengineeventhandler_onaudioeffectfinished)

* [`startAudioMixing`]({{Global.API_REF_ELECTRON_ROOT}}/class_irtcengine.html#api_irtcengine_startaudiomixing2)

* [`onAudioMixingStateChanged`]({{Global.API_REF_ELECTRON_ROOT}}/class_irtcengineeventhandler.html#callback_irtcengineeventhandler_onaudiomixingstatechanged)
</PlatformStructured>
<PlatformStructured platform="flutter">
...
* [`preloadEffect`]({{Global.API_REF_IOS_ROOT}}/agorartckit/agorartcenginekit/preloadeffect(_:filepath:))

* [`playEffect`]({{Global.API_REF_IOS_ROOT}}/agorartckit/agorartcenginekit/playeffect(_:filepath:loopcount:pitch:pan:gain:publish:startpos:))

* [`rtcEngineDidAudioEffectFinish`]({{Global.API_REF_IOS_ROOT}}/agorartckit/agorartcenginedelegate/rtcenginedidaudioeffectfinish(_:soundid:))

* [`startAudioMixing`]({{Global.API_REF_IOS_ROOT}}/agorartckit/agorartcenginekit/startaudiomixing(_:loopback:cycle:))

* [`audioMixingStateChanged`]({{Global.API_REF_IOS_ROOT}}/agorartckit/agorartcenginedelegate/rtcengine(_:audiomixingstatechanged:reasoncode:))

* [`pauseAudioMixing`]({{Global.API_REF_IOS_ROOT}}/agorartckit/agorartcenginekit/pauseaudiomixing())

* [`resumeAudioMixing`]({{Global.API_REF_IOS_ROOT}}/agorartckit/agorartcenginekit/resumeaudiomixing())

* [`stopAudioMixing`]({{Global.API_REF_IOS_ROOT}}/agorartckit/agorartcenginekit/stopaudiomixing())

* [`adjustAudioMixingPlayoutVolume`]({{Global.API_REF_IOS_ROOT}}/agorartckit/agorartcenginekit/adjustaudiomixingplayoutvolume(_:))

* [`adjustAudioMixingPublishVolume`]({{Global.API_REF_IOS_ROOT}}/agorartckit/agorartcenginekit/adjustaudiomixingpublishvolume(_:))
</PlatformStructured>
<PlatformStructured platform="macos">
### Sample project
...
* [`preloadEffect`]({{Global.API_REF_MACOS_ROOT}}/agorartckit/agorartcenginekit/preloadeffect(_:filepath:))

* [`playEffect`]({{Global.API_REF_MACOS_ROOT}}/agorartckit/agorartcenginekit/playeffect(_:filepath:loopcount:pitch:pan:gain:publish:startpos:))

* [`rtcEngineDidAudioEffectFinish`]({{Global.API_REF_MACOS_ROOT}}/agorartckit/agorartcenginedelegate/rtcenginedidaudioeffectfinish(_:soundid:))

* [`startAudioMixing`]({{Global.API_REF_MACOS_ROOT}}/agorartckit/agorartcenginekit/startaudiomixing(_:loopback:cycle:))

* [`audioMixingStateChanged`]({{Global.API_REF_MACOS_ROOT}}/agorartckit/agorartcenginedelegate/rtcengine(_:audiomixingstatechanged:reasoncode:))

* [`pauseAudioMixing`]({{Global.API_REF_MACOS_ROOT}}/agorartckit/agorartcenginekit/pauseaudiomixing())

* [`resumeAudioMixing`]({{Global.API_REF_MACOS_ROOT}}/agorartckit/agorartcenginekit/resumeaudiomixing())

* [`stopAudioMixing`]({{Global.API_REF_MACOS_ROOT}}/agorartckit/agorartcenginekit/stopaudiomixing())

* [`adjustAudioMixingPlayoutVolume`]({{Global.API_REF_MACOS_ROOT}}/agorartckit/agorartcenginekit/adjustaudiomixingplayoutvolume(_:))

* [`adjustAudioMixingPublishVolume`]({{Global.API_REF_MACOS_ROOT}}/agorartckit/agorartcenginekit/adjustaudiomixingpublishvolume(_:))
</PlatformStructured>
<PlatformStructured platform="react-js">
...
* [`playEffect`]({{Global.API_REF_RN_ROOT}}/class_irtcengine.html#api_irtcengine_playeffect3)

* [`onAudioEffectFinished`]({{Global.API_REF_RN_ROOT}}/class_irtcengineeventhandler.html#callback_irtcengineeventhandler_onaudioeffectfinished)

* [`startAudioMixing`]({{Global.API_REF_RN_ROOT}}/class_irtcengine.html#api_irtcengine_startaudiomixing2)

* [`onAudioMixingStateChanged`]({{Global.API_REF_RN_ROOT}}/class_irtcengineeventhandler.html#callback_irtcengineeventhandler_onaudiomixingstatechanged)
</PlatformStructured>
<PlatformStructured platform="unity">
### Sample project
...
* [`PreloadEffect`]({{Global.API_REF_UNITY_ROOT}}/class_irtcengine.html#api_irtcengine_preloadeffect)

* [`PlayEffect`]({{Global.API_REF_UNITY_ROOT}}/class_irtcengine.html#api_irtcengine_playeffect3)

* [`OnAudioEffectFinished`]({{Global.API_REF_UNITY_ROOT}}/class_irtcengineeventhandler.html#callback_irtcengineeventhandler_onaudioeffectfinished)

* [`StartAudioMixing`]({{Global.API_REF_UNITY_ROOT}}/class_irtcengine.html#api_irtcengine_startaudiomixing)

* [`OnAudioMixingStateChanged`]({{Global.API_REF_UNITY_ROOT}}/class_irtcengineeventhandler.html#callback_irtcengineeventhandler_onaudiomixingstatechanged)

* [`PauseAudioMixing`]({{Global.API_REF_UNITY_ROOT}}/class_irtcengine.html#api_irtcengine_pauseaudiomixing)

* [`ResumeAudioMixing`]({{Global.API_REF_UNITY_ROOT}}/class_irtcengine.html#api_irtcengine_resumeaudiomixing)

* [`StopAudioMixing`]({{Global.API_REF_UNITY_ROOT}}/class_irtcengine.html#api_irtcengine_stopaudiomixing)
...
* [`AdjustAudioMixingPublishVolume`]({{Global.API_REF_UNITY_ROOT}}/class_irtcengine.html#api_irtcengine_adjustaudiomixingpublishvolume)
</PlatformStructured>
<PlatformStructured platform="unreal">
...
* [`preloadEffect`]({{Global.API_REF_WINDOWS_ROOT_CPP}}/class_irtcengine.html#api_irtcengine_preloadeffect)

* [`playEffect`]({{Global.API_REF_WINDOWS_ROOT_CPP}}/class_irtcengine.html#api_irtcengine_playeffect3)

* [`onAudioEffectFinished`]({{Global.API_REF_WINDOWS_ROOT_CPP}}/class_irtcengineeventhandler.html#callback_irtcengineeventhandler_onaudioeffectfinished)

* [`startAudioMixing`]({{Global.API_REF_WINDOWS_ROOT_CPP}}/class_irtcengine.html#api_irtcengine_startaudiomixing)

* [`onAudioMixingStateChanged`]({{Global.API_REF_WINDOWS_ROOT_CPP}}/class_irtcengineeventhandler.html#callback_irtcengineeventhandler_onaudiomixingstatechanged)

* [`pauseAudioMixing`]({{Global.API_REF_WINDOWS_ROOT_CPP}}/class_irtcengine.html#api_irtcengine_pauseaudiomixing)

* [`resumeAudioMixing`]({{Global.API_REF_WINDOWS_ROOT_CPP}}/class_irtcengine.html#api_irtcengine_resumeaudiomixing)

* [`stopAudioMixing`]({{Global.API_REF_WINDOWS_ROOT_CPP}}/class_irtcengine.html#api_irtcengine_stopaudiomixing)
...
* [`adjustAudioMixingPublishVolume`]({{Global.API_REF_WINDOWS_ROOT_CPP}}/class_irtcengine.html#api_irtcengine_adjustaudiomixingpublishvolume)
</PlatformStructured>
</PlatformStructured>
