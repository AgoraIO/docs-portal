...
<Accordions>
  <Accordion title="Screen sharing use-cases">
...
- On the Web platform, please ensure that the user has granted **screen capture** permission to the app.
</PlatformStructured>
...
<Accordions>
  <Accordion title="Screen sharing iOS tech">
...
<Accordions>
  <Accordion title="API calling sequence">
...
<Accordions>
  <Accordion title="Screen sharing sequence">
    ![Screen Sharing Blueprint Tech Android iOS](/images/video-sdk/screen-sharing-flutter-unity-rn-blueprint.svg)
  </Accordion>
</Accordions>

Refer to the [iOS Screen Sharing Guide](https://github.com/AgoraIO-Extensions/Agora-Unreal-RTC-SDK/blob/main/Agora-Unreal-SDK-CPP-Example/IOS%20ScreenShare%20Guide.md) to create an Extension for your Web project.
...
<CodeBlockTabsList>
  <CodeBlockTabsTrigger value="tab1">Automatic integration</CodeBlockTabsTrigger>
...
- Due to Web performance limitations, screen sharing does not support Web TV.
...
- On Web 9 and later, to avoid system termination when the app is backed up, it is recommended to add the foreground service permission: `android.permission.FOREGROUND_SERVICE` to the `/app/Manifests/AndroidManifest.xml` file.

- Screen capture is only available for Web API level 21 (Web 5) or later. On earlier versions the SDK reports error codes `ERR_SCREEN_CAPTURE_PERMISSION_DENIED(16)` and `ERR_ SCREEN_CAPTURE_SYSTEM_NOT_SUPPORTED(2)`.

- Capturing system audio is only available for Web API level 29 (Web 10) or later. On earlier versions, the SDK reports the error code `ERR_SCREEN_CAPTURE_SYSTEM_AUDIO_NOT_SUPPORTED(3)`.
</PlatformStructured>
<PlatformStructured platform="blueprint">
...
- The video unit price for a screen-shared stream is based on the **video resolution** you set in `FScreenCaptureParameters`. If you do not pass dimensions in `FScreenCaptureParameters`, Agora bills at the default resolution of 1920 x 1080 (2,073,600). See [Pricing](/en/realtime-media/video/reference/pricing) for details.
...
- The video unit price for a screen-shared stream is based on the **video resolution** you set in `ScreenCaptureParameters`. If you do not pass dimensions in `ScreenCaptureParameters`, Agora bills you for the default resolution of 1920 x 1080 (2,073,600). See [Pricing](/en/realtime-media/video/reference/pricing) for details.
</PlatformStructured>
<PlatformStructured platform="flutter">
...
- The video unit price for a screen sharing stream is based on the **video resolution** you set in `ScreenCaptureParameters`. If you do not pass dimensions in `ScreenCaptureParameters`, Agora bills you at the default resolution of 1920 x 1080 (2,073,600). See [Pricing](/en/realtime-media/video/reference/pricing) for details.
...
<Accordions>
  <Accordion title="Screen share process">
...
<Accordions>
  <Accordion title="Screen sharing React Native tech">
    ![Screen Sharing React Native Tech](/images/video-sdk/screen-sharing-flutter-unity-rn-blueprint.svg)
  </Accordion>
</Accordions>
...
<Accordions>
  <Accordion title="Screen sharing Unity tech">
    ![Screen Sharing Unity Tech](/images/video-sdk/screen-sharing-flutter-unity-rn-blueprint.svg)
  </Accordion>
</Accordions>
...
<Admonition title="Information" type="info">- Make sure your app and extension have the same **TARGETS/Deployment/iOS** version. The memory usage of **Broadcast Upload Extension** is limited to 50 MB.
- Make sure that the memory usage of **Screen Sharing Extension** does not exceed 50 MB.</Admonition>
...
:::info[Information]
On the Web platform, you can block up to 24 windows.
:::
...
Agora provides an open-source Web [sample project](https://github.com/AgoraIO/API-Examples/blob/main/Android/APIExample/app/src/main/java/io/agora/api/example/examples/advanced/ScreenSharing.java) on GitHub. Download and explore this project for a more detailed example.

### API reference

- [`startScreenCapture`]({{Global.API_REF_ANDROID_ROOT}}/class_irtcengine.html#api_irtcengine_startscreencapture)
- [`ScreenCaptureParameters`]({{Global.API_REF_ANDROID_ROOT}}/class_screencaptureparameters2.html)
- [`updateScreenCaptureParameters`]({{Global.API_REF_ANDROID_ROOT}}/class_irtcengine.html#api_irtcengine_updatescreencaptureparameters)
- [`stopScreenCapture`]({{Global.API_REF_ANDROID_ROOT}}/class_irtcengine.html#api_irtcengine_stopscreencapture)
- [`setScreenCaptureScenario `]({{Global.API_REF_ANDROID_ROOT}}/class_irtcengine.html#api_irtcengine_setscreencapturescenario)
</PlatformStructured>
<PlatformStructured platform="blueprint">
### Sample project

Agora provides an open source Web [sample project](https://github.com/AgoraIO-Extensions/Agora-Unreal-RTC-SDK/tree/main/Agora-Unreal-SDK-Blueprint-Example) on GitHub for your reference:
...
- Android, iOS
    - [`StartScreenCapture`]({{Global.API_REF_BLUEPRINT_ROOT}}/class_irtcengine.html#api_irtcengine_startscreencapture)
    - [`StopScreenCapture`]({{Global.API_REF_BLUEPRINT_ROOT}}/class_irtcengine.html#api_irtcengine_stopscreencapture)
    - [`UpdateScreenCapture`]({{Global.API_REF_BLUEPRINT_ROOT}}/class_irtcengine.html#api_irtcengine_updatescreencapture)

- macOS, Windows
    - [`GetScreenCaptureSources`]({{Global.API_REF_BLUEPRINT_ROOT}}/class_irtcengine.html#api_irtcengine_getscreencapturesources)
    - [`StartScreenCaptureByDisplayId`]({{Global.API_REF_BLUEPRINT_ROOT}}/class_irtcengine.html#api_irtcengine_startscreencapturebydisplayid)
    - [`StartScreenCaptureByWindowId`]({{Global.API_REF_BLUEPRINT_ROOT}}/class_irtcengine.html#api_irtcengine_startscreencapturebywindowid)
    - [`UpdateScreenCaptureParameters`]({{Global.API_REF_BLUEPRINT_ROOT}}/class_irtcengine.html#api_irtcengine_updatescreencaptureparameters)
    - [`UpdateScreenCaptureRegion`]({{Global.API_REF_BLUEPRINT_ROOT}}/class_irtcengine.html#api_irtcengine_updatescreencaptureregion)
    - [`SetScreenCaptureContentHint`]({{Global.API_REF_BLUEPRINT_ROOT}}/class_irtcengine.html#api_irtcengine_setscreencapturecontenthint)
    - [`SetScreenCaptureScenario`]({{Global.API_REF_BLUEPRINT_ROOT}}/class_irtcengine.html#api_irtcengine_setscreencapturescenario)
    - [`StopScreenCapture`]({{Global.API_REF_BLUEPRINT_ROOT}}/class_irtcengine.html#api_irtcengine_stopscreencapture)
</PlatformStructured>
<PlatformStructured platform="electron">
### Sample project

Agora provides an open source Web [sample project](https://github.com/AgoraIO-Extensions/Electron-SDK/blob/main/example/src/renderer/examples/advanced/ScreenShare/ScreenShare.tsx) on GitHub. Download and explore this project for a more detailed example.

### API reference

- [`getScreenCaptureSources`]({{Global.API_REF_ELECTRON_ROOT}}/class_irtcengine.html#api_irtcengine_getscreencapturesources)

- [`startScreenCaptureByDisplayId`]({{Global.API_REF_ELECTRON_ROOT}}/class_irtcengine.html#api_irtcengine_startscreencapturebydisplayid)

- [`startScreenCaptureByWindowId`]({{Global.API_REF_ELECTRON_ROOT}}/class_irtcengine.html#api_irtcengine_startscreencapturebywindowid)

- [`ScreenCaptureParameters`]({{Global.API_REF_ELECTRON_ROOT}}/class_screencaptureparameters.html)

- [`updateScreenCaptureParameters`]({{Global.API_REF_ELECTRON_ROOT}}/class_irtcengine.html#api_irtcengine_updatescreencaptureparameters)

- [`stopScreenCapture`]({{Global.API_REF_ELECTRON_ROOT}}/class_irtcengine.html#api_irtcengine_stopscreencapture)

- [`enableLoopbackRecording`]({{Global.API_REF_ELECTRON_ROOT}}/class_irtcengine.html#api_irtcengine_enableloopbackrecording)
</PlatformStructured>
<PlatformStructured platform="flutter">
### Sample project
...
- Android, iOS
    - [`startScreenCapture`]({{global.API_REF_FLUTTER_ROOT}}/class_irtcengine.html#api_irtcengine_startscreencapture)
    - [`stopScreenCapture`]({{global.API_REF_FLUTTER_ROOT}}/class_irtcengine.html#api_irtcengine_stopscreencapture)
    - [`updateScreenCapture`]({{global.API_REF_FLUTTER_ROOT}}/class_irtcengine.html#api_irtcengine_updatescreencapture)

- macOS, Windows
    - [`getScreenCaptureSources`]({{global.API_REF_FLUTTER_ROOT}}/class_irtcengine.html#api_irtcengine_getscreencapturesources)
    - [`startScreenCaptureByDisplayId`]({{global.API_REF_FLUTTER_ROOT}}/class_irtcengine.html#api_irtcengine_startscreencapturebydisplayid)
    - [`startScreenCaptureByWindowId`]({{global.API_REF_FLUTTER_ROOT}}/class_irtcengine.html#api_irtcengine_startscreencapturebywindowid)
    - [`updateScreenCaptureParameters`]({{global.API_REF_FLUTTER_ROOT}}/class_irtcengine.html#api_irtcengine_updatescreencaptureparameters)
    - [`updateScreenCaptureRegion`]({{global.API_REF_FLUTTER_ROOT}}/class_irtcengine.html#api_irtcengine_updatescreencaptureregion)
    - [`setScreenCaptureContentHint`]({{global.API_REF_FLUTTER_ROOT}}/class_irtcengine.html#api_irtcengine_setscreencapturecontenthint)
    - [`setScreenCaptureScenario`]({{global.API_REF_FLUTTER_ROOT}}/class_irtcengine.html#api_irtcengine_setscreencapturescenario)
    - [`stopScreenCapture`]({{global.API_REF_FLUTTER_ROOT}}/class_irtcengine.html#api_irtcengine_stopscreencapture)
</PlatformStructured>
<PlatformStructured platform="ios">
### Sample project
...
- [`startScreenCapture`]({{Global.API_REF_IOS_ROOT}}/agorartckit/agorartcenginekit/startscreencapture(_:))
- [`updateScreenCapture`]({{Global.API_REF_IOS_ROOT}}/agorartckit/agorartcenginekit/updatescreencapture(_:))
- [`stopScreenCapture`]({{Global.API_REF_IOS_ROOT}}/agorartckit/agorartcenginekit/stopscreencapture())
</PlatformStructured>
<PlatformStructured platform="macos">
### Sample project

Agora provides an open source Web [sample project](https://github.com/AgoraIO/API-Examples/tree/main/macOS/APIExample/Examples/Advanced/ScreenShare) on GitHub. Download and explore this project for a more detailed example.

### API reference

- [`startScreenCaptureByDisplayId`]({{Global.API_REF_MACOS_ROOT}}/agorartckit/agorartcenginekit/startscreencapture(bydisplayid:regionrect:captureparams:))
- [`startScreenCaptureByWindowId`]({{Global.API_REF_MACOS_ROOT}}/agorartckit/agorartcenginekit/startscreencapture(bywindowid:regionrect:captureparams:))
- [`updateScreenCaptureRegion`]({{Global.API_REF_MACOS_ROOT}}/agorartckit/agorartcenginekit/updatescreencaptureregion(_:))
- [`updateScreenCaptureParameters`]({{Global.API_REF_MACOS_ROOT}}/agorartckit/agorartcenginekit/updatescreencaptureparameters(_:))
- [`stopScreenCapture`]({{Global.API_REF_MACOS_ROOT}}/agorartckit/agorartcenginekit/stopscreencapture())
</PlatformStructured>
<PlatformStructured platform="react-js">
...
- [`startScreenCapture`]({{Global.API_REF_RN_ROOT}}/class_irtcengine.html#api_irtcengine_startscreencapture)
- [`stopScreenCapture`]({{Global.API_REF_RN_ROOT}}/class_irtcengine.html#api_irtcengine_stopscreencapture)
- [`updateScreenCapture`]({{Global.API_REF_RN_ROOT}}/class_irtcengine.html#api_irtcengine_updatescreencapture)
</PlatformStructured>
<PlatformStructured platform="unity">
### Sample project

Agora provides an open-source Web [sample project](https://github.com/AgoraIO-Extensions/Agora-Unity-Quickstart/tree/main/API-Example-Unity/Assets/API-Example/Examples/Advanced/ScreenShare) on GitHub. Download and explore this project for a more detailed example.

### API reference

- Common
    - [`EnableAudio`]({{Global.API_REF_UNITY_ROOT}}/class_irtcengine.html#api_irtcengine_enableaudio)
    - [`EnableVideo`]({{Global.API_REF_UNITY_ROOT}}/class_irtcengine.html#api_irtcengine_enablevideo)
    - [`SetClientRole` [1/2]]({{Global.API_REF_UNITY_ROOT}}/class_irtcengine.html#api_irtcengine_setclientrole)
    - [`UpdateChannelMediaOptions`]({{Global.API_REF_UNITY_ROOT}}/class_irtcengine.html#api_irtcengine_updatechannelmediaoptions)
    - [`ChannelMediaOptions`]({{Global.API_REF_UNITY_ROOT}}/class_channelmediaoptions.html)
    - [`JoinChannel` [2/2]]({{Global.API_REF_UNITY_ROOT}}/class_irtcengine.html#api_irtcengine_joinchannel2)
    - [`JoinChannelEx`]({{Global.API_REF_UNITY_ROOT}}/class_irtcengineex.html#api_irtcengineex_joinchannelex)

- Android
    - [`StartScreenCapture` [1/2]]({{Global.API_REF_UNITY_ROOT}}/class_irtcengine.html#api_irtcengine_startscreencapture)
    - [`StopScreenCapture` [1/2]]({{Global.API_REF_UNITY_ROOT}}/class_irtcengine.html#api_irtcengine_stopscreencapture)
    - [`JoinChannel` [2/2]]({{Global.API_REF_UNITY_ROOT}}/class_irtcengine.html#api_irtcengine_joinchannel2)

- iOS
    - [`StartScreenCapture` [1/2]]({{Global.API_REF_UNITY_ROOT}}/class_irtcengine.html#api_irtcengine_startscreencapture)
    - [`StopScreenCapture` [1/2]]({{Global.API_REF_UNITY_ROOT}}/class_irtcengine.html#api_irtcengine_stopscreencapture)
    - [`UpdateScreenCaptureParameters`]({{Global.API_REF_UNITY_ROOT}}/class_irtcengine.html#api_irtcengine_updatescreencaptureparameters)

- macOS, Windows
    - [`GetScreenCaptureSources`]({{Global.API_REF_UNITY_ROOT}}/class_irtcengine.html#api_irtcengine_getscreencapturesources)
    - [`StartScreenCaptureByDisplayId`]({{Global.API_REF_UNITY_ROOT}}/class_irtcengine.html#api_irtcengine_startscreencapturebydisplayid)
    - [`StartScreenCaptureByWindowId`]({{Global.API_REF_UNITY_ROOT}}/class_irtcengine.html#api_irtcengine_startscreencapturebywindowid)
</PlatformStructured>
<PlatformStructured platform="unreal">
### Sample project

Agora provides an open source Web [sample project](https://github.com/AgoraIO/API-Examples/blob/main/windows/APIExample/APIExample/Advanced/ScreenShare/AgoraScreenCapture.cpp) on GitHub. Download and explore this project for a more detailed example.

### API reference

- [`getScreenCaptureSources`]({{Global.API_REF_UE_ROOT}}/class_irtcengine.html#api_irtcengine_getscreencapturesources)

- [`startScreenCaptureByDisplayId`]({{Global.API_REF_UE_ROOT}}/class_irtcengine.html#api_irtcengine_startscreencapturebydisplayid)

- [`startScreenCaptureByWindowId`]({{Global.API_REF_UE_ROOT}}/class_irtcengine.html#api_irtcengine_startscreencapturebywindowid)

- [`setScreenCaptureScenario`]({{Global.API_REF_UE_ROOT}}/class_irtcengine.html#api_irtcengine_setscreencapturescenario)

- [`updateScreenCaptureParameters`]({{Global.API_REF_UE_ROOT}}/class_irtcengine.html#api_irtcengine_updatescreencaptureparameters)

- [`updateScreenCaptureRegion`]({{Global.API_REF_UE_ROOT}}/class_irtcengine.html#api_irtcengine_updatescreencaptureregion)

- [`stopScreenCapture`[1/2]]({{Global.API_REF_UE_ROOT}}/class_irtcengine.html#api_irtcengine_stopscreencapture)
</PlatformStructured>
<PlatformStructured platform="web">
### Sample project
...
- [`getScreenCaptureSources`]({{Global.API_REF_WINDOWS_ROOT_CPP}}/class_irtcengine.html#api_irtcengine_getscreencapturesources)
- [`startScreenCaptureByDisplayId`]({{Global.API_REF_WINDOWS_ROOT_CPP}}/class_irtcengine.html#api_irtcengine_startscreencapturebydisplayid)
- [`startScreenCaptureByWindowId`]({{Global.API_REF_WINDOWS_ROOT_CPP}}/class_irtcengine.html#api_irtcengine_startscreencapturebywindowid)
- [`setScreenCaptureScenario`]({{Global.API_REF_WINDOWS_ROOT_CPP}}/class_irtcengine.html#api_irtcengine_setscreencapturescenario)
- [`updateScreenCaptureParameters`]({{Global.API_REF_WINDOWS_ROOT_CPP}}/class_irtcengine.html#api_irtcengine_updatescreencaptureparameters)
- [`updateScreenCaptureRegion`]({{Global.API_REF_WINDOWS_ROOT_CPP}}/class_irtcengine.html#api_irtcengine_updatescreencaptureregion)
- [`stopScreenCapture` [1/2]]({{Global.API_REF_WINDOWS_ROOT_CPP}}/class_irtcengine.html#api_irtcengine_stopscreencapture)
</PlatformStructured>
