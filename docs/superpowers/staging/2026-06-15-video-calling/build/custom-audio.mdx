...
<Accordions>
  <Accordion title="Custom audio capture process">
...
<Accordions>
  <Accordion title="Custom audio rendering workflow">
...
<Accordions>
  <Accordion title="Custom audio capture">
    ![Custom audio capture](/images/video-sdk/custom-audio-capture-with-custom-track.svg)
  </Accordion>
</Accordions>
...
* [`createCustomAudioTrack`]({{Global.API_REF_ANDROID_ROOT}}/class_imediaengine.html#api_imediaengine_createcustomaudiotrack)

* [`destroyCustomAudioTrack`]({{Global.API_REF_ANDROID_ROOT}}/class_imediaengine.html#api_imediaengine_destroycustomaudiotrack)

* [`pushExternalAudioFrame`]({{Global.API_REF_ANDROID_ROOT}}/class_irtcengine.html#api_irtcengine_pushaudioframe2)

* [`setExternalAudioSink`]({{Global.API_REF_ANDROID_ROOT}}/class_irtcengine.html#api_imediaengine_setexternalaudiosink)

* [`pullPlaybackAudioFrame` [1/2]]({{Global.API_REF_ANDROID_ROOT}}/class_irtcengine.html#api_imediaengine_pullaudioframe)

* [`pullPlaybackAudioFrame` [2/2]]({{Global.API_REF_ANDROID_ROOT}}/class_irtcengine.html#api_irtcengine_pullaudioframe2)
</PlatformStructured>
<PlatformStructured platform="electron">
...
- [`createCustomAudioTrack`]({{Global.API_REF_IOS_ROOT_RTC_KIT}}/agorartcenginekit/createcustomaudiotrack(_:config:))
- [`destroyCustomAudioTrack`]({{Global.API_REF_IOS_ROOT_RTC_KIT}}/agorartcenginekit/destroycustomaudiotrack(_:))
- [`pushExternalAudioFrameSampleBuffer`]({{Global.API_REF_IOS_ROOT_RTC_KIT}}/agorartcmediaplayerprotocol/play())
- [`pushExternalAudioFrameRawData`]({{Global.API_REF_IOS_ROOT_RTC_KIT}}/agorartcenginekit/pushexternalaudioframesamplebuffer(_:))
- [`enableExternalAudioSink`]({{Global.API_REF_IOS_ROOT_RTC_KIT}}/agorartcenginekit/enableexternalaudiosink(_:samplerate:channels:))
- [`pullPlaybackAudioFrameRawData`]({{Global.API_REF_IOS_ROOT_RTC_KIT}}/agorartcenginekit/pullplaybackaudioframerawdata(_:lengthinbyte:))
</PlatformStructured>
<PlatformStructured platform="macos">
### Sample projects
...
- [`createCustomAudioTrack`]({{Global.API_REF_MACOS_ROOT_RTC_KIT}}/agorartcenginekit/createcustomaudiotrack(_:config:))
- [`destroyCustomAudioTrack`]({{Global.API_REF_MACOS_ROOT_RTC_KIT}}/agorartcenginekit/destroycustomaudiotrack(_:))
- [`pushExternalAudioFrameSampleBuffer`]({{Global.API_REF_MACOS_ROOT_RTC_KIT}}/agorartcmediaplayerprotocol/play())
- [`pushExternalAudioFrameRawData`]({{Global.API_REF_MACOS_ROOT_RTC_KIT}}/agorartcenginekit/pushexternalaudioframesamplebuffer(_:))
- [`enableExternalAudioSink`]({{Global.API_REF_MACOS_ROOT_RTC_KIT}}/agorartcenginekit/enableexternalaudiosink(_:samplerate:channels:))
- [`pullPlaybackAudioFrameRawData`]({{Global.API_REF_MACOS_ROOT_RTC_KIT}}/agorartcenginekit/pullplaybackaudioframerawdata(_:lengthinbyte:))
</PlatformStructured>
<PlatformStructured platform="react-js">
...
* [`setExternalAudioSource`]({{Global.API_REF_UE_ROOT}}/class_irtcengine.html#api_imediaengine_setexternalaudiosource2)

* [`pushAudioFrame`]({{Global.API_REF_UE_ROOT}}/class_imediaengine.html#api_imediaengine_pushaudioframe0)

* [`setExternalAudioSink`]({{Global.API_REF_UE_ROOT}}/class_irtcengine.html#api_imediaengine_setexternalaudiosink)

* [`pullAudioFrame`]({{Global.API_REF_UE_ROOT}}/class_imediaengine.html#api_imediaengine_pullaudioframe)

* [`createCustomAudioTrack`]({{Global.API_REF_UE_ROOT}}/class_imediaengine.html#api_imediaengine_createcustomaudiotrack)

* [`destroyCustomAudioTrack`]({{Global.API_REF_UE_ROOT}}/class_imediaengine.html#api_imediaengine_destroycustomaudiotrack)
</PlatformStructured>
<PlatformStructured platform="web">
### API reference
...
* [`setExternalAudioSource`]({{Global.API_REF_WINDOWS_ROOT_CPP}}/class_irtcengine.html#api_imediaengine_setexternalaudiosource2)

* [`pushAudioFrame`]({{Global.API_REF_WINDOWS_ROOT_CPP}}/class_imediaengine.html#api_imediaengine_pushaudioframe0)

* [`setExternalAudioSink`]({{Global.API_REF_WINDOWS_ROOT_CPP}}/class_irtcengine.html#api_imediaengine_setexternalaudiosink)

* [`pullAudioFrame`]({{Global.API_REF_WINDOWS_ROOT_CPP}}/class_imediaengine.html#api_imediaengine_pullaudioframe)
</PlatformStructured>
