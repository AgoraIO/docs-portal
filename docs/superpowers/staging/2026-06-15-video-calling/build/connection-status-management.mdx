...
- `REJECTED_BY_SERVER` (10): The user is banned by the server. May also occurs under the following circumstances:<ul>The app calls `joinChannel` again after the local user has joined the channel.
- The app called `startEchoTest`, but did not call `stopEchoTest` to end the echo test.</li></ul> |
...
- `RejectedByServer` (10): The user is banned by the server. May also occurs under the following circumstances:<ul>The app calls `joinChannel` again after the local user has joined the channel.
- The app called `startEchoTest`, but did not call `stopEchoTest` to end the echo test.</li></ul> |
...
- `RejectedByServer` (10): The user is banned by the server. May also occurs under the following circumstances:<ul>The app calls `joinChannelByToken` again after the local user has joined the channel.
- The app called `startEchoTest`, but did not call `stopEchoTest` to end the echo test.</li></ul> |
