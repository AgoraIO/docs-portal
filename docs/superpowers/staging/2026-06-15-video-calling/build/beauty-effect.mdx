...
Ensure that you have implemented the [SDK quickstart](/en/realtime-media/video/index) in your project using the Web SDK version 4.12.0 or later.
...
<Accordions>
  <Accordion title="Complete sample code for beauty effect extension">
    ```js
    // Create a Client
    var client = AgoraRTC.createClient({mode: "rtc", codec: "vp8"});
