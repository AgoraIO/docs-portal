...
1. Call <code>{props.setAudioRouteAPI}(true)</code> in the app. Audio routing is changed to speakerphone.
...
- [`setDefaultAudioRoutetoSpeakerphone`]({{global.API_REF_ANDROID_ROOT}}/class_irtcengine.html#api_irtcengine_setdefaultaudioroutetospeakerphone)

- [`setEnableSpeakerphone`]({{global.API_REF_ANDROID_ROOT}}/class_irtcengine.html#api_irtcengine_setenablespeakerphone)

- [`onAudioRouteChanged`]({{global.API_REF_ANDROID_ROOT}}/class_irtcengineeventhandler.html#callback_irtcengineeventhandler_onaudioroutingchanged)
</PlatformStructured>
<PlatformStructured platform="electron">
...
- [`setDefaultAudioRouteToSpeakerphone`]({{Global.API_REF_IOS_ROOT_RTC_KIT}}/agorartcenginekit/setdefaultaudioroutetospeakerphone(_:))

- [`setEnableSpeakerphone`]({{Global.API_REF_IOS_ROOT_RTC_KIT}}/agorartcenginekit/setenablespeakerphone(_:))

- [`didAudioRouteChanged`]({{Global.API_REF_IOS_ROOT_RTC_KIT}}/agorartcenginedelegate/rtcengine(_:didaudioroutechanged:))
</PlatformStructured>
<PlatformStructured platform="macos">
...
- [`setDefaultAudioRouteToSpeakerphone`]({{global.API_REF_RN_ROOT}}/class_irtcengine.html#api_irtcengine_setdefaultaudioroutetospeakerphone)

- [`setEnableSpeakerphone`]({{global.API_REF_RN_ROOT}}/class_irtcengine.html#api_irtcengine_setenablespeakerphone)

- [`onAudioRoutingChanged`]({{global.API_REF_RN_ROOT}}/class_irtcengineeventhandler.html#callback_irtcengineeventhandler_onaudioroutingchanged)
</PlatformStructured>
<PlatformStructured platform="unity">
### Sample project
...
- [`SetDefaultAudioRouteToSpeakerphone`]({{global.API_REF_UNITY_ROOT}}/class_irtcengine.html#api_irtcengine_setdefaultaudioroutetospeakerphone)

- [`SetEnableSpeakerphone`]({{global.API_REF_UNITY_ROOT}}/class_irtcengine.html#api_irtcengine_setenablespeakerphone)

- [`OnAudioRoutingChanged`]({{global.API_REF_UNITY_ROOT}}/class_irtcengineeventhandler.html#callback_irtcengineeventhandler_onaudioroutingchanged)
</PlatformStructured>
<PlatformStructured platform="unreal">
