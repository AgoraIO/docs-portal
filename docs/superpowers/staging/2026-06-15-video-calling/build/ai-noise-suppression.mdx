...
Want to try out AI Noise Suppression? Use the [online demo](https://webdemo.agora.io/aiDenoiser/index.html).
...
<PlatformStructured platform="web">
:::info[Note]
The following implementation steps apply to the latest version of the AI Noise Suppression extension. Refer to the [extension release notes](/video-calling/overview/release-notes#ai-noise-suppression) for details.
:::
...
<PlatformStructured platform="unreal.blueprint">
