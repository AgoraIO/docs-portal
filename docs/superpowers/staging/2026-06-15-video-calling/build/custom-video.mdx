...
<Accordions>
  <Accordion title="Custom video capture">
...
1. Push video data to the SDK
    ...
    <PlatformStructured platform="ios">
The following code demonstrates how to push video data in the `CVPixelBufferRef` format. For other supported video frame formats, refer to the `format` field in [AgoraVideoFrame]({{Global.API_REF_IOS_ROOT}}/agorartckit/agoravideoframe).
</PlatformStructured>

    <PlatformStructured platform="macos">
The following code demonstrates how to push video data in the `CVPixelBufferRef` format. For other supported video frame formats, refer to the `format` field in [AgoraVideoFrame]({{Global.API_REF_MACOS_ROOT}}/agorartckit/agoravideoframe).
</PlatformStructured>
...
- [`createCustomVideoTrack`]({{Global.API_REF_ANDROID_ROOT}}/class_irtcengine.html#api_irtcengine_createcustomvideotrack)
- [`destroyCustomVideoTrack`]({{Global.API_REF_ANDROID_ROOT}}/class_irtcengine.html#api_irtcengine_destroycustomvideotrack)
- [`getCurrentMonotonicTimeInMs`]({{Global.API_REF_ANDROID_ROOT}}/class_irtcengine.html#api_irtcengine_getcurrentmonotonictimeinms)
- [`joinChannel`]({{Global.API_REF_ANDROID_ROOT}}/class_irtcengine.html#api_irtcengine_joinchannel)
- [`pushExternalVideoFrameById` [2/2]]({{Global.API_REF_ANDROID_ROOT}}/class_irtcengine.html#api_irtcengine_pushvideoframe3)
...
- [`onRenderVideoFrame`]({{Global.API_REF_ANDROID_ROOT}}/class_ivideoframeobserver.html#callback_ivideoframeobserver_onrendervideoframe)
</PlatformStructured>
<PlatformStructured platform="electron">
...
- [`createCustomVideoTrack`]({{Global.API_REF_IOS_ROOT}}/agorartckit/agorartcenginekit/createcustomvideotrack())
- [`destroyCustomVideoTrack`]({{Global.API_REF_IOS_ROOT}}/agorartckit/agorartcenginekit/destroycustomvideotrack(_:))
- [`setExternalVideoSource`]({{Global.API_REF_IOS_ROOT}}/agorartckit/agorartcenginekit/setexternalvideosource(_:usetexture:sourcetype:encodedvideotrackoption:))
- [`pushExternalVideoFrame` [2/2]]({{Global.API_REF_IOS_ROOT}}/agorartckit/agorartcenginekit/pushexternalvideoframe(_:videotrackid:))
- [`onRenderVideoFrame(_:uid:channelId:)`]({{Global.API_REF_IOS_ROOT}}/agorartckit/agoravideoframedelegate/onrendervideoframe(_:uid:channelid:))
- [`onCapture(_:sourceType:)`]({{Global.API_REF_IOS_ROOT}}/agorartckit/agoravideoframedelegate/oncapture(_:sourcetype:))
- [`getCurrentMonotonicTimeInMs`]({{Global.API_REF_IOS_ROOT}}/agorartckit/agorartcenginekit/getcurrentmonotonictimeinms())
- [`joinChannel`]({{Global.API_REF_IOS_ROOT}}/agorartckit/agorartcenginekit/joinchannel(bytoken:channelid:info:uid:joinsuccess:))
</PlatformStructured>
<PlatformStructured platform="macos">
### Sample projects
...
- [`createCustomVideoTrack`]({{Global.API_REF_MACOS_ROOT}}/agorartckit/agorartcenginekit/createcustomvideotrack())
- [`destroyCustomVideoTrack`]({{Global.API_REF_MACOS_ROOT}}/agorartckit/agorartcenginekit/destroycustomvideotrack(_:))
- [`setExternalVideoSource`]({{Global.API_REF_MACOS_ROOT}}/agorartckit/agorartcenginekit/setexternalvideosource(_:usetexture:sourcetype:encodedvideotrackoption:))
- [`pushExternalVideoFrame` [2/2]]({{Global.API_REF_MACOS_ROOT}}/agorartckit/agorartcenginekit/pushexternalvideoframe(_:videotrackid:))
- [`onRenderVideoFrame(_:uid:channelId:)`]({{Global.API_REF_MACOS_ROOT}}/agorartckit/agoravideoframedelegate/onrendervideoframe(_:uid:channelid:))
- [`onCapture(_:sourceType:)`]({{Global.API_REF_MACOS_ROOT}}/agorartckit/agoravideoframedelegate/oncapture(_:sourcetype:))
- [`getCurrentMonotonicTimeInMs`]({{Global.API_REF_MACOS_ROOT}}/agorartckit/agorartcenginekit/getcurrentmonotonictimeinms())
- [`joinChannel`]({{Global.API_REF_MACOS_ROOT}}/agorartckit/agorartcenginekit/joinchannel(bytoken:channelid:info:uid:joinsuccess:))
</PlatformStructured>
<PlatformStructured platform="react-js">
...
- [`setExternalVideoSource`]({{Global.API_REF_UE_ROOT}}/class_imediaengine.html#api_imediaengine_setexternalvideosource)
- [`pushVideoFrame`]({{Global.API_REF_UE_ROOT}}/class_imediaengine.html#api_imediaengine_pushvideoframe)
</PlatformStructured>
<PlatformStructured platform="web">
### API reference
...
- [`createCustomVideoTrack`]({{Global.API_REF_CPP_ROOT}}/class_irtcengine.html#api_irtcengine_createcustomvideotrack)
- [`destroyCustomVideoTrack`]({{Global.API_REF_CPP_ROOT}}/class_irtcengine.html#api_irtcengine_destroycustomvideotrack)
- [`getCurrentMonotonicTimeInMs`]({{Global.API_REF_CPP_ROOT}}/class_irtcengine.html#api_irtcengine_getcurrentmonotonictimeinms)
- [`joinChannel`]({{Global.API_REF_CPP_ROOT}}/class_irtcengine.html#api_irtcengine_joinchannel)
- [`pushVideoFrame`]({{Global.API_REF_CPP_ROOT}}/class_imediaengine.html#api_imediaengine_pushvideoframe)
...
- [`onRenderVideoFrame`]({{Global.API_REF_CPP_ROOT}}/class_ivideoframeobserver.html#callback_ivideoframeobserver_onrendervideoframe)
</PlatformStructured>
</PlatformStructured>
