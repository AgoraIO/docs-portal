...
- Implemented basic real-time audio and video functionality with SDK version 4.5 or above. See the [SDK quickstart](/en/realtime-media/video/index) guide.
...
- [`onTranscodedStreamLayoutInfo`]({{Global.API_REF_ANDROID_ROOT}}/class_irtcengineeventhandler.html#callback_irtcengineeventhandler_ontranscodedstreamlayoutinfo)
...
- [`rtcEngine(_:didTranscodedStreamLayoutInfoUpdatedWithUserId:videoLayoutInfo:)`]({{Global.API_REF_IOS_ROOT}}/agorartckit/agorartcenginedelegate/rtcengine(_:didtranscodedstreamlayoutinfoupdatedwithuserid:videolayoutinfo:))
- [`setupRemoteVideo(_:)`]({{Global.API_REF_IOS_ROOT}}/agorartckit/agorartcenginekit/setupremotevideo(_:))
- [`setupRemoteVideoEx(_:connection:)`]({{Global.API_REF_IOS_ROOT}}/agorartckit/agorartcenginekit/setupremotevideoex(_:connection:))
</PlatformStructured>
<PlatformStructured platform="flutter">
### API reference

- [`onTranscodedStreamLayoutInfo`]({{Global.API_REF_FLUTTER_ROOT}}/class_irtcengineeventhandler.html#callback_irtcengineeventhandler_ontranscodedstreamlayoutinfo)
- [`setupRemoteVideo`]({{Global.API_REF_FLUTTER_ROOT}}/class_irtcengine.html#api_irtcengine_setupremotevideo)
- [`setupRemoteVideoEx`]({{Global.API_REF_FLUTTER_ROOT}}/class_irtcengineex.html#api_irtcengineex_setupremotevideoex)
</PlatformStructured>
</PlatformStructured>
