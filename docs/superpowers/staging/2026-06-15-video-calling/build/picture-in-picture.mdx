...
- Video SDK for Flutter [v6.6.2](../overview/release-notes#v662) or later integrated into your project. See [SDK quickstart](/en/realtime-media/video/index).
</PlatformStructured>
...
<PlatformStructured platform="react-native">
- Video SDK for React Native [v4.6.2](../overview/release-notes#v462) or later integrated into your project. See [SDK quickstart](/en/realtime-media/video/index).
</PlatformStructured>
...
<PlatformStructured platform="flutter">
Starting from Video SDK [v6.6.2](../overview/release-notes#v662), Agora provides the [`AgoraPipController`]({{global.API_REF_FLUTTER_ROOT}}/class_agorapip.html) and related configuration options for enabling and managing PiP on Android and iOS. This section describes how to implement PiP in your Flutter project.
...
Call `pipSetup()` to configure PiP options. Use [`AgoraPipOptions`]({{global.API_REF_FLUTTER_ROOT}}/class_agorapipoptions.html) to set platform-specific options for Android and iOS.
...
Implement [`AgoraPipStateChangedObserver`]({{global.API_REF_FLUTTER_ROOT}}/class_agorapipstatechangedobserver.html) to listen for PiP state changes. Use the [`AgoraPipState`]({{global.API_REF_FLUTTER_ROOT}}/enum_agorapipstate.html) value to update the UI or handle errors:
```dart
await _pip.registerPipStateChangedObserver(
  AgoraPipStateChangedObserver(
...
- [`AgoraPipOptions.controlStyle`]({{global.API_REF_FLUTTER_ROOT}}/class_agorapipoptions.html) supports four control styles. Style `2` is recommended for video call scenarios. Style `3` hides all controls, including the close and restore buttons.
- Call `pipDispose()` or `dispose()` promptly when leaving a channel, destroying the page, or when PiP is no longer needed, to avoid resource leaks.
</TabsContent>
</Tabs></Tabs>
</PlatformStructured>
<PlatformStructured platform="react-native">
Starting from Video SDK [v4.6.2](../overview/release-notes#v462), Agora provides the [`AgoraPip`]({{global.API_REF_RN_ROOT}}/class_agorapip.html) controller and related configuration options for enabling and managing PiP on Android and iOS. This section describes how to implement Picture-in-Picture in your React Native project.
...
Call `pipSetup` to configure PiP options. Use [`AgoraPipOptions`]({{global.API_REF_RN_ROOT}}/class_agorapipoptions.html) to set platform-specific options for Android and iOS.
...
Implement [`AgoraPipStateChangedObserver`]({{global.API_REF_RN_ROOT}}/class_agorapipstatechangedobserver.html) to listen for PiP state changes. Use the [`AgoraPipState`]({{global.API_REF_RN_ROOT}}/enum_agorapipstate.html) value to update the UI or handle errors:
```typescript
...
- The PiP window is managed by the system and the SDK. Your app does not need to render a custom floating window.
- To display multiple video streams in PiP mode, configure the layout explicitly using `videoStreams` and `contentViewLayout`. When remote users join or leave, call `pipSetup` again with the updated `videoStreams`. You do not need to call `pipDispose` first.
- [`AgoraPipOptions.controlStyle`]({{global.API_REF_RN_ROOT}}/class_agorapipoptions.html) accepts values `0` to `3`. Use `2` for video call scenarios, which hides the play/pause button and progress bar. Style `3` hides all controls, including the close and restore buttons.
...
- [`AgoraPipController`]({{global.API_REF_FLUTTER_ROOT}}/class_agorapip.html)
- [`AgoraPipOptions`]({{global.API_REF_FLUTTER_ROOT}}/class_agorapipoptions.html)
- [`AgoraPipContentViewLayout`]({{global.API_REF_FLUTTER_ROOT}}/class_agorapipcontentviewlayout.html)
- [`AgoraPipVideoStream`]({{global.API_REF_FLUTTER_ROOT}}/class_agorapipvideostream.html)
- [`pipIsSupported`]({{global.API_REF_FLUTTER_ROOT}}/api_agorapip_pipissupported.html)
- [`pipIsAutoEnterSupported`]({{global.API_REF_FLUTTER_ROOT}}/api_agorapip_pipisautoentersupported.html)
- [`pipSetup`]({{global.API_REF_FLUTTER_ROOT}}/api_agorapip_pipsetup.html)
- [`pipStart`]({{global.API_REF_FLUTTER_ROOT}}/api_agorapip_pipstart.html)
- [`pipStop`]({{global.API_REF_FLUTTER_ROOT}}/api_agorapip_pipstop.html)
- [`pipDispose`]({{global.API_REF_FLUTTER_ROOT}}/api_agorapip_pipdispose.html)
- [`registerPipStateChangedObserver`]({{global.API_REF_FLUTTER_ROOT}}/api_agorapip_registerpipstatechangedobserver.html)
- [`AgoraPipStateChangedObserver`]({{global.API_REF_FLUTTER_ROOT}}/class_agorapipstatechangedobserver.html)
- [`AgoraPipState`]({{global.API_REF_FLUTTER_ROOT}}/enum_agorapipstate.html)
- [`onPipStateChanged`]({{global.API_REF_FLUTTER_ROOT}}/callback_agorapipstatechangedobserver_onpipstatechanged.html)
...
- [`AgoraPip`]({{global.API_REF_RN_ROOT}}/class_agorapip.html)
- [`AgoraPipOptions`]({{global.API_REF_RN_ROOT}}/class_agorapipoptions.html)
- [`AgoraPipContentViewLayout`]({{global.API_REF_RN_ROOT}}/class_agorapipcontentviewlayout.html)
- [`AgoraPipVideoStream`]({{global.API_REF_RN_ROOT}}/class_agorapipvideostream.html)
- [`pipIsSupported`]({{global.API_REF_RN_ROOT}}/api_agorapip_pipissupported.html)
- [`pipIsAutoEnterSupported`]({{global.API_REF_RN_ROOT}}/api_agorapip_pipisautoentersupported.html)
- [`pipSetup`]({{global.API_REF_RN_ROOT}}/api_agorapip_pipsetup.html)
- [`pipStart`]({{global.API_REF_RN_ROOT}}/api_agorapip_pipstart.html)
- [`pipStop`]({{global.API_REF_RN_ROOT}}/api_agorapip_pipstop.html)
- [`pipDispose`]({{global.API_REF_RN_ROOT}}/api_agorapip_pipdispose.html)
- [`registerPipStateChangedObserver`]({{global.API_REF_RN_ROOT}}/api_agorapip_registerpipstatechangedobserver.html)
- [`AgoraPipStateChangedObserver`]({{global.API_REF_RN_ROOT}}/class_agorapipstatechangedobserver.html)
- [`AgoraPipState`]({{global.API_REF_RN_ROOT}}/enum_agorapipstate.html)
- [`onPipStateChanged`]({{global.API_REF_RN_ROOT}}/callback_agorapipstatechangedobserver_onpipstatechanged.html)
...
This feature guide is not yet available for Web.
