...
---
<PlatformStructured platform="_cloud-proxy-migration-guide">
...
- If you use cloud proxy with [Restricted media zones](/en/realtime-media/video/build/geofencing), add only the IP addresses dedicated to your specified region.
