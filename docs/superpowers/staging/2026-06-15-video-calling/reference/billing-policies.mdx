...
2. Purchase a [pre-paid monthly package](/en/realtime-media/video/subscription-packages) or [top-up package](../overview/subscription-packages#top-up-package). This option is highly recommended.
...
<PlatformStructured platform="_account-settlement">
...
<PlatformStructured platform="_end-of-life">
## End-of-life policy
