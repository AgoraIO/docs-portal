...
---
<PlatformStructured platform="_pricing">
...
- If you are an existing Agora customer before August 29, 2025, your projects continue under the legacy billing model. For details, see [Legacy Pricing](/en/realtime-media/video/reference/pricing-legacy). You may also manually subscribe or upgrade in the Agora Console to switch to the new RTC pricing model.
