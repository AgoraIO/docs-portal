...
In short: `spec.md` governs rules, `ledger` governs progress, `map` governs addresses, `checklist` governs acceptance, and `decisions` governs judgment.
...
8. `docs/migration/verification-checklist.md`
...
5. Check `verification-checklist.md` for the required evidence.
...
4. Add human decisions to `decisions.md`.
5. Keep blockers explicit and actionable.
