...
Generated: 2026-07-15T06:01:35.244Z
Old source: `/Users/yangyixuan/Documents/GitHub/shengwang-doc-source/docs/rtc-server-sdk/landing-page.python.go.mdx`
...
Projection: product=`rtc-server-sdk`, platform=`python`
...
- Unsupported: 0
- Legacy residue: none
- Unresolved differences: 45

## Missing (5)

- `old:heading:2`  > 快速入门 @ 11 "快速入门"
- `old:list-item`  > 快速入门 @ 16 "实现发送和接收媒体流"
- `old:heading:2`  > 推荐阅读 @ 21 "推荐阅读"
- `old:list-item`  > 推荐阅读 @ 26 "最新版发布"
- `old:list-item`  > 推荐阅读 @ 31 "区域访问限制"
...
- `old:paragraph` (root) @ 8 "声网RTC服务端SDK部署在服务端，可与集成了声网RTC客户端SDK的App通过SD-RTN™ 进行实时通信，实现收发音视频流的功能。"
