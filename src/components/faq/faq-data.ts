...
export const faqItems: FaqItem[] = [
  ...
  },
  {
    ...
    platforms: ['All Platforms', 'RESTful API'],
  ...
  },
  {
    ...
    platforms: ['All Platforms', 'Unreal Engine'],
    products: [
      'All Products',
      'Video Calling',
      'Voice Calling',
    ...
    summary:
      'In order to implement real-time interactive features on different target platforms, you need to add camera, microphone, and other permissions to your Unreal Engine project. Depending on the target platform, you can refer to this article for',
    title:
  ...
  },
  {
    ...
    summary:
      "The startAudioMixing method is called to play a music file on an Android device. During the playback process, the system's built-in phone software is used to answer or make a call. After hanging up the phone, the music file does not automat",
    title:
  ...
  },
  {
    ...
    platforms: ['All Platforms', 'Android', 'iOS', 'Electron', 'Web'],
    products: ['All Products', 'Flexible Classroom'],
    summary:
  ...
  },
  {
    ...
    summary:
      'Co-host authentication enables you to authenticate whether a user has the privilege to publish streams in a live streaming channel. This feature helps ensure that only authorized users publish streams and prevents illegal users from exploit',
  ...
  },
  {
    ...
    summary:
      'When a primary/secondary certificate is enabled for your project, you use dynamic tokens to authenticate users. This page lists token-related error codes and event callbacks you may receive, provides triggering causes and solutions, and hel',
  ...
  },
  {
    ...
    summary:
      'The in-call volume refers to the volume of voice and video calls, while the media volume refers to the volume at which background music, videos, and audio effects are played. The in-call volume and the media volume are independent from each',
    title:
  ...
  },
  {
    ...
    platforms: ['All Platforms', 'Linux', 'RESTful API'],
    products: ['All Products', 'On-premise Recording', 'Cloud Recording'],
    summary:
      'If you want more flexibility in processing the recorded files, choose individual recording mode. For example, in an online classroom, if parents want to see the video of the teacher and their child only, you can use individual recording mod',
    title:
  ...
  },
  {
    ...
    summary:
      'In video applications, adjusting camera exposure and focus is essential for capturing subjects with accurate brightness and sharpness. The Agora RTC SDK offers camera management methods for mobile platforms, enabling users to switch between',
  ...
  },
  {
    ...
    platforms: ['All Platforms', 'Web', 'Electron'],
    products: ['All Products', 'Flexible Classroom'],
    summary:
  ...
  },
  {
    ...
    summary:
      "During a call, a user may join and leave a Video SDK channel for multiple times, and the user's call duration is the actual time when the user is in the channel. You can use the Agora Video SDK or Agora Analytics to get a user's call durati",
  ...
  },
  {
    ...
    products: ['All Products', 'Cloud Recording'],
    summary:
      'If an app integrated with cloud recording crashes, the recording session is not affected. You can continue to use the original resource ID and recording ID to control the recording instance, such as to query recording status or stop recordi',
  ...
  },
  {
    ...
    products: ['All Products', 'Flexible Classroom'],
    summary:
      'Check if your Chat permission has been activated. If not, activate it in the Console.',
  ...
  },
  {
    ...
    products: ['All Products', 'Flexible Classroom'],
    summary:
      'When configuring the recording file storage path in the Console through the fileNamePrefix field, you can use built-in variables to specify a dynamic path for storing recording files. When the recording starts, variables are replaced with r',
  ...
  },
  {
    ...
    products: ['All Products', 'Flexible Classroom'],
    summary:
      '"vendor": 2, "region": 1, //CN_Shanghai endpoint:https://agora-recording.oss-cn-shanghai.aliyuncs.com',
  ...
  },
  {
    ...
    summary:
      'When the request of an Agora Server RESTful API exceeds its call frequency limit, the API returns the HTTP status code 429, indicating that you have made too many requests in a specified amount of time. The following suggestions can help yo',
    title:
  ...
  },
  {
    ...
    products: ['All Products', 'On-premise Recording'],
    summary:
      'Reason: The system environment cannot find the librecording.so file. Solution: Check if the java demo is compiled and the library file is generated, and then, check and configure the path of the library file. For example, on Linux, if the p',
  ...
  },
  {
    ...
    summary:
      "On macOS 11.6 or later, when using Xcode to integrate the Agora Voice or Video SDKs with version 3.6.2 or later, you can encounter a pop-up warning when your project is compiled or running that says \"'library_name.framework' cannot be opene",
    title:
  ...
  },
  {
    ...
    summary:
      'During a video call or live streaming, users often want to improve their on-screen appearance, which can help improve their confidence. The Agora Video SDK provides APIs to help you easily implement basic image enhancement. Users can enable',
  ...
  },
  {
    ...
    summary:
      'To apply optimization algorithms for different real-time engagement scenarios, Agora provides a setChannelProfile method for the Video SDK channel. You can use this method to set the channel profile as either CHANNELPROFILECOMMUNICATION or',
    title:
  ...
  },
  {
    ...
    summary:
      'Static libraries and Dynamic Link Libraries (DLL) are both used for organizing and sharing code in programming. In earlier versions, the Video SDK utilized static libraries on certain platforms. However, there are several drawbacks associat',
    title:
  ...
  },
  {
    ...
    summary:
      'When using the Agora Video SDK for real-time Video Calling, Interactive Live Streaming, or Broadcast Streaming, some developers observe that the remote video takes too long to display after joining a channel. This delay can negatively impac',
    title:
  ...
  },
  {
    ...
    summary:
      'On devices running iOS 14 and above, Flutter apps installed in debug mode cannot be reopened using the home screen icon, deep linking, or other methods. Additionally, if an iOS app integrates a Flutter module in debug mode, reopening the ap',
    title:
  ...
  },
  {
    ...
    products: ['All Products', 'On-premise Recording'],
    summary:
      'If Error: 3, with statcode:16 is reported, the recording quits normally. You can determine why the recording quit by the leavepath code.',
  ...
  },
  {
    ...
    title:
      'Why is the audio and video capture invalid after some iOS versions of apps are locked or switched to the background?',
  },
  {
    category: 'quality-issues',
  ...
  },
  {
    ...
    platforms: ['All Platforms', 'RESTful API', 'Linux'],
    products: ['All Products', 'Cloud Recording', 'On-premise Recording'],
    summary:
  ...
  },
  {
    ...
    products: ['All Products', 'Signaling'],
    summary:
      'Agora Signaling SDK supports the Unicode Character Table, so it supports all emoji defined in the Unicode Character Table. You may as well define your own emoji character set, decode based on your specifications, and render the desired emoj',
  ...
  },
  {
    ...
    products: ['All Products', 'Signaling'],
    summary:
      'The Agora Signaling SDK does not impose a hard limit on the number of concurrent online users. However, your pricing plan may impose a Peak Concurrent User (PCU) limit. Exceeding this limit could result in additional charges or service rest',
    title:
      'Does the Agora Signaling SDK limit concurrent users or channel message frequency?',
  },
  {
    category: 'general-product-inquiry',
  ...
  },
  {
    ...
    platforms: ['All Platforms', 'Web', 'Android', 'iOS', 'RESTful API'],
  ...
  },
  {
    ...
    products: ['All Products', 'Cloud Recording'],
    summary:
      'A Web API needs to make a cross-origin request in accordance with Cross-Origin Resource Sharing (CORS) to call the Cloud Recording RESTful API. The browser must first send an OPTIONS request to the server to query if the server accepts cros',
    title:
  ...
  },
  {
    ...
    summary:
      "Most CDN + RTMP technologies for live streaming allow users to watch the live steaming in a web browser, which lowers the audience's threshold. Agora provides a solution for SD-RTN™, host, and audience to have the same real-time communicati",
    title:
  ...
  },
  {
    ...
    summary:
      'When you perform the following operations on Agora Console, Agora sends a verification email to you or your member:',
    title:
      'What should I do if I cannot receive the verification email from Agora?',
  },
  {
    category: 'account-and-billing',
  ...
  },
  {
    ...
    summary:
      'To ensure the privacy and security of end users, Apple requires that all apps listed on its App Store provide a privacy manifest file in accordance with its requirements. The privacy manifest is a property list that records the types of dat',
  ...
  },
  {
    ...
    summary:
      'When developing on macOS 15 Beta system, if the path of the App and the App name contain non-English characters (for example, Chinese, Japanese, Korean, or others), the compiled Metal shader library may not contain any methods, causing the',
    title:
