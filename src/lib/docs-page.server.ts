...
function resolveRealtimeMediaRedirect(
  ...
  const redirects: Record<string, string> = {
    ...
    'speech-to-text/develop/parse-data': `/${locale}/realtime-media/speech-to-text/build/parse-data`,
    'speech-to-text/develop/translation': `/${locale}/realtime-media/speech-to-text/build/translation`,
    'speech-to-text/develop/encrypt-captions': `/${locale}/realtime-media/speech-to-text/build/encrypt-captions`,
    'speech-to-text/develop/record-captions': `/${locale}/realtime-media/speech-to-text/build/record-captions`,
    'speech-to-text/develop/transcribe-individual-host': `/${locale}/realtime-media/speech-to-text/build/transcribe-individual-host`,
    'speech-to-text/develop/update-service': `/${locale}/realtime-media/speech-to-text/build/update-service`,
    'speech-to-text/develop/supported-languages': `/${locale}/realtime-media/speech-to-text/build/supported-languages`,
    'speech-to-text/develop/api-callback-service': `/${locale}/realtime-media/speech-to-text/build/api-callback-service`,
    'speech-to-text/get-started/manage-agora-account': `/${locale}/realtime-media/speech-to-text/build/manage-agora-account`,
    'speech-to-text/get-started/skills': `/${locale}/realtime-media/speech-to-text/build/skills`,
    'speech-to-text/get-started/mcp': `/${locale}/realtime-media/speech-to-text/build/mcp`,
    'speech-to-text/best-practice/enable-service': `/${locale}/realtime-media/speech-to-text/build/enable-service`,
    'speech-to-text/best-practice/optimize-quality': `/${locale}/realtime-media/speech-to-text/build/optimize-quality`,
    'speech-to-text/overview/core-concepts': `/${locale}/realtime-media/speech-to-text/reference/core-concepts`,
    'speech-to-text/overview/pricing': `/${locale}/realtime-media/speech-to-text/reference/pricing`,
    'speech-to-text/overview/release-notes': `/${locale}/realtime-media/speech-to-text/reference/release-notes`,
    'media-push/get-started/manage-agora-account': `/${locale}/realtime-media/media-push/build/manage-agora-account`,
    'media-push/get-started/skills': `/${locale}/realtime-media/media-push/build/skills`,
    'media-push/get-started/mcp': `/${locale}/realtime-media/media-push/build/mcp`,
    'media-push/develop/restful-api': `/${locale}/realtime-media/media-push/build/restful-api`,
    'media-push/develop/integration-best-practices': `/${locale}/realtime-media/media-push/build/integration-best-practices`,
    'media-push/develop/receive-notifications': `/${locale}/realtime-media/media-push/build/receive-notifications`,
    'media-push/overview/pricing': `/${locale}/realtime-media/media-push/reference/pricing`,
    'media-pull/get-started/manage-agora-account': `/${locale}/realtime-media/media-pull/build/manage-agora-account`,
    'media-pull/get-started/skills': `/${locale}/realtime-media/media-pull/build/skills`,
    'media-pull/get-started/mcp': `/${locale}/realtime-media/media-pull/build/mcp`,
    'media-pull/develop/integration-best-practices': `/${locale}/realtime-media/media-pull/build/integration-best-practices`,
    'media-pull/develop/receive-notifications': `/${locale}/realtime-media/media-pull/build/receive-notifications`,
    'media-pull/overview/pricing': `/${locale}/realtime-media/media-pull/reference/pricing`,
    'media-pull/overview/release-notes': `/${locale}/realtime-media/media-pull/reference/release-notes`,
  };
