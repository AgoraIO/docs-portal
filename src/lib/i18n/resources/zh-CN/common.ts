const zhCnCommon = {
  ...
  docs: {
    ...
    pagesLabel: '页面',
    toggleSectionPages: '展开或收起{{title}}子页面',
    tableOverflowLabel: '可横向滚动的表格',
    tableOverflowDescription: '表格内容超出当前宽度，可横向滚动查看更多列。',
    versionSelect: '选择文档版本',
    ...
    openMenu: '打开导航',
    dismissLegacyDocsBanner: '关闭旧版文档提示',
