...
const TARGET_PAGE_TAXONOMY: TaxonomyCase[] = [
  ...
  {
    contentId: 'realtime-media/rtc/get-started-sdk',
    journeyStage: 'get-started',
    navSection: 'get-started',
    navSectionTitle: 'Get started',
    pageType: 'task-guide',
  ...
  {
    contentId: 'realtime-media/rtc/reference/pricing-legacy',
  ...
  {
    contentId: 'realtime-media/rtc/reference/release-notes',
  ...
  {
    contentId: 'realtime-media/rtc/voice-quickstart',
    journeyStage: 'get-started',
    navSection: 'get-started',
    navSectionTitle: 'Get started',
    pageType: 'task-guide',
