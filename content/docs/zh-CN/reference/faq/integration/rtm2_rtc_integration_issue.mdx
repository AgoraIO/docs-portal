...
- 你可以前往 SDK 发版说明页查看各 SDK 中 `aosl` 库的版本信息：
  - [RTC 发版说明](/zh-CN/realtime-media/rtc/reference/release-notes)
  - [RTM 发版说明](/zh-CN/realtime-media/rtm/reference/release-notes)
...
:::info[信息]
你可以前往[RTM 发版说明](/zh-CN/realtime-media/rtm/reference/release-notes)和[RTC 发版说明](/zh-CN/realtime-media/rtc/reference/release-notes)查看各 SDK 中 `aosl` 库的版本信息。
:::
