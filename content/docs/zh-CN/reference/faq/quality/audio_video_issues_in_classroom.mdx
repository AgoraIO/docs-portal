...
Web 端可以通过改变 [`launch`](/zh-CN/api-reference/flexible-classroom/web/api-reference/classroom-sdk#launch) 方法中的 `launchOption.MediaOptions` 参数来调整课堂中的分辨率：
...
Web 端可以通过改变[设置录制状态 RESTful API](/zh-CN/api-reference/flexible-classroom/restful-api/api-recording#设置录制状态) 中的 `webRecordConfig` 参数来调整课堂录制视频的分辨率，参照以下示例代码：
