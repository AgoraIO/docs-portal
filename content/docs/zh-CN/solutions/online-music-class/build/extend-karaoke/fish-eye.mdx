---
title: "鱼眼镜头畸变矫正与分离显示"
description: "了解在线音乐课堂在不同平台上的鱼眼镜头畸变矫正与分离显示方式，包括接入流程、关键配置和平台差异。"
---
<PlatformStructured platform="android">

本文介绍如何使用声网提供的 API 对鱼眼镜头的画面进行畸变矫正和分离显示处理，以帮助教师在教学过程中更好地演示和纠正学生的弹奏动作。
...
你可以参考[在线音乐教学 API 参考](/zh-CN/solutions/online-music-class/reference/fish-eye)了解更多 API 使用信息。
