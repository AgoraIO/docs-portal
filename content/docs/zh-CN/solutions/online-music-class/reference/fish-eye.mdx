---
title: "在线音乐教学 API"
description: "查看在线音乐课堂的在线音乐教学 API，了解关键概念、参数说明、使用限制和接入注意事项。"
---
<PlatformStructured platform="android">

声网为在线音乐场景提供鱼眼镜头画面畸变矫正功能，本文提供相关的 API 参考。除了在线音乐教学相关的 API，你还需要使用 RTC API 来实现实时音视频互动功能。你可以参考 [RTC API](/zh-CN/api-reference/rtc/android/rtc-api-overview) 文档来了解详细的 RTC API 用法。
...
| 参数 | 说明 |
| --- | --- |
| `enabled` | <Slot name="fish-eye-android-html-0-1-1" /> |
| `config` | 畸变矫正参数。详见 [`FishCorrectionParams`](/zh-CN/solutions/online-music-class/reference/fish-eye#fishcorrectionparams)。 |

<Slot for="fish-eye-android-html-0-1-1">
...
| 参数 | 说明 |
| --- | --- |
| `enabled` | <Slot name="fish-eye-android-html-1-1-1" /> |

<Slot for="fish-eye-android-html-1-1-1">
...
| 参数 | 说明 |
| --- | --- |
| `local` | 视频渲染画布。详见 [`VideoCanvas`](/zh-CN/api-reference/rtc/android/class-videocanvas)。 |
| `mode` | 视频渲染模式。详见 [`VideoViewSetupMode`](/zh-CN/solutions/online-music-class/reference/fish-eye#videoviewsetupmode)。 |
...
| 参数 | 说明 |
| --- | --- |
| `remote` | 视频渲染画布。详见 [`VideoCanvas`](/zh-CN/api-reference/rtc/android/class-videocanvas)。 |
| `mode` | 视频渲染模式。详见 [`VideoViewSetupMode`](/zh-CN/solutions/online-music-class/reference/fish-eye#videoviewsetupmode)。 |
...
![截图方式](https://web-cdn.agora.io/docs-files/1645427490815)
...
| `params` | 畸变矫正参数。详见 [`AgoraFishCorrectionParams`](/zh-CN/solutions/online-music-class/reference/fish-eye#agorafishcorrectionparams)。 |
...
除了在线音乐教学相关的 API，你还需要使用 RTC API 来实现实时音视频互动功能。你可以参考 [RTC API](/zh-CN/api-reference/rtc/macos/rtc-api-overview) 文档来了解详细的 RTC API 用法。
...
| 参数 | 说明 |
| --- | --- |
| `local` | 视频渲染画布。详见 [`VideoCanvas`](/zh-CN/api-reference/rtc/macos/class-videocanvas)。 |
| `mode` | 视频渲染模式。详见 [`VideoViewSetupMode`](/zh-CN/solutions/online-music-class/reference/fish-eye#videoviewsetupmode)。 |
...
| 参数 | 说明 |
| --- | --- |
| `remote` | 视频渲染画布。详见 [`VideoCanvas`](/zh-CN/api-reference/rtc/macos/class-videocanvas)。 |
| `mode` | 视频渲染模式。详见 [`VideoViewSetupMode`](/zh-CN/solutions/online-music-class/reference/fish-eye#videoviewsetupmode)。 |
...
| `remote` | 视频渲染画布。详见 [`VideoCanvas`](/zh-CN/api-reference/rtc/macos/class-videocanvas)。 |
| `mode` | 视频渲染模式。详见 [`VideoViewSetupMode`](/zh-CN/solutions/online-music-class/reference/fish-eye#videoviewsetupmode)。 |
| `connection` | Connection 信息。详见 [`RtcConnection`](/zh-CN/api-reference/rtc/macos/class-rtcconnection)。 |
...
| `params` | 畸变矫正参数。详见 [`FishCorrectionParams`](/zh-CN/solutions/online-music-class/reference/fish-eye#fishcorrectionparams)。 |
