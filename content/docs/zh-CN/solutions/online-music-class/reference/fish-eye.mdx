...
声网为在线音乐场景提供鱼眼镜头画面畸变矫正功能，本文提供相关的 API 参考。除了在线音乐教学相关的 API，你还需要使用 RTC API 来实现实时音视频互动功能。你可以参考 [RTC API](/api-ref/rtc/android/API/rtc_api_overview) 文档来了解详细的 RTC API 用法。
...
| 参数 | 说明 |
| --- | --- |
| `local` | 视频渲染画布。详见 [`VideoCanvas`](/api-ref/rtc/android/API/class_videocanvas)。 |
...
| 参数 | 说明 |
| --- | --- |
| `remote` | 视频渲染画布。详见 [`VideoCanvas`](/api-ref/rtc/android/API/class_videocanvas)。 |
| `mode` | 视频渲染模式。详见 [`VideoViewSetupMode`](/zh-CN/solutions/online-music-class/reference/fish-eye#videoviewsetupmode)。 |
...
除了在线音乐教学相关的 API，你还需要使用 RTC API 来实现实时音视频互动功能。你可以参考 [RTC API](/api-ref/rtc/ios/API/rtc_api_overview) 文档来了解详细的 RTC API 用法。
...
| 参数 | 说明 |
| --- | --- |
| `local` | 视频渲染画布。详见 [`VideoCanvas`](/api-ref/rtc/ios/API/class_videocanvas)。 |
| `mode` | 视频渲染模式。详见 [`VideoViewSetupMode`](/zh-CN/solutions/online-music-class/reference/fish-eye#videoviewsetupmode)。 |
...
| 参数 | 说明 |
| --- | --- |
| `remote` | 视频渲染画布。详见 [`VideoCanvas`](/api-ref/rtc/ios/API/class_videocanvas)。 |
| `mode` | 视频渲染模式。详见 [`VideoViewSetupMode`](/zh-CN/solutions/online-music-class/reference/fish-eye#videoviewsetupmode)。 |
...
| `remote` | 视频渲染画布。详见 [`VideoCanvas`](/api-ref/rtc/ios/API/class_videocanvas)。 |
| `mode` | 视频渲染模式。详见 [`VideoViewSetupMode`](/zh-CN/solutions/online-music-class/reference/fish-eye#videoviewsetupmode)。 |
| `connection` | Connection 信息。详见 [`RtcConnection`](/api-ref/rtc/ios/API/class_rtcconnection)。 |
...
除了在线音乐教学相关的 API，你还需要使用 RTC API 来实现实时音视频互动功能。你可以参考 [RTC API](/api-ref/rtc/macos/API/rtc_api_overview) 文档来了解详细的 RTC API 用法。
...
| 参数 | 说明 |
| --- | --- |
| `local` | 视频渲染画布。详见 [`VideoCanvas`](/api-ref/rtc/macos/API/class_videocanvas)。 |
| `mode` | 视频渲染模式。详见 [`VideoViewSetupMode`](/zh-CN/solutions/online-music-class/reference/fish-eye#videoviewsetupmode)。 |
...
| 参数 | 说明 |
| --- | --- |
| `remote` | 视频渲染画布。详见 [`VideoCanvas`](/api-ref/rtc/macos/API/class_videocanvas)。 |
| `mode` | 视频渲染模式。详见 [`VideoViewSetupMode`](/zh-CN/solutions/online-music-class/reference/fish-eye#videoviewsetupmode)。 |
...
| `remote` | 视频渲染画布。详见 [`VideoCanvas`](/api-ref/rtc/macos/API/class_videocanvas)。 |
| `mode` | 视频渲染模式。详见 [`VideoViewSetupMode`](/zh-CN/solutions/online-music-class/reference/fish-eye#videoviewsetupmode)。 |
| `connection` | Connection 信息。详见 [`RtcConnection`](/api-ref/rtc/macos/API/class_rtcconnection)。 |
...
除了在线音乐教学相关的 API，你还需要使用 RTC API 来实现实时音视频互动功能。你可以参考 [RTC API](/api-ref/rtc/windows/API/rtc_api_overview) 文档来了解详细的 RTC API 用法。
...
| 参数 | 说明 |
| --- | --- |
| `canvas` | 视频渲染画布。详见 [`VideoCanvas`](/api-ref/rtc/windows/API/class_videocanvas)。 |
| `mode` | 视频渲染模式。详见 [`VideoViewSetupMode`](/zh-CN/solutions/online-music-class/reference/fish-eye#videoviewsetupmode)。 |
...
| 参数 | 说明 |
| --- | --- |
| `remote` | 视频渲染画布。详见 [`VideoCanvas`](/api-ref/rtc/windows/API/class_videocanvas)。 |
| `mode` | 视频渲染模式。详见 [`VideoViewSetupMode`](/zh-CN/solutions/online-music-class/reference/fish-eye#videoviewsetupmode)。 |
