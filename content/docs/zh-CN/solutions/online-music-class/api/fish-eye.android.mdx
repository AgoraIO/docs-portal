...
| `config` | 畸变矫正参数。详见 [`FishCorrectionParams`](/zh-CN/solutions/online-music-class/api/fish-eye.android#fishcorrectionparams)。 |
...
| `mode` | 视频渲染模式。详见 [`VideoViewSetupMode`](/zh-CN/solutions/online-music-class/api/fish-eye.android#videoviewsetupmode)。 |
