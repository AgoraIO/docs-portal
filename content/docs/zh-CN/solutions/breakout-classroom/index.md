...
超级小班课支持将一个万人直播大班课里的学生拆分成若干个小班。每个小班人数不定，推荐为 4 - 6 人，小班的数量无上限。大班中主讲老师进行直播授课，小班中学生进行实时分组讨论。此外，小班中还可配备助教老师。主讲老师专注提升教学内容，助教老师负责教学辅导，两者分工明确，相互配合。

## 方案选择

声网对在线教育场景提供 PaaS 和 aPaaS 两种实现方案，你可以根据场景和资源评估选择哪一种方式搭建。

![PaaS 方案](/img/edu-paas/breakout-classroom.png)

- **PaaS 方案**：集成不同功能的 SDK，实现定制化需求
  - 分别集成 RTC、RTM、白板和云端录制
  - 适用开发资源充足、定制化需求高的场景
  - 支持超过 20 个平台和框架
  - [方案介绍](/zh-CN/solutions/breakout-classroom/paas/architecture)
...
## 如何搭建 PaaS 方案？
    ...
    - [集成指引](/zh-CN/solutions/breakout-classroom/paas/integration-guide)

    - [集成注意事项](/zh-CN/solutions/breakout-classroom/paas/best-practices)

## PaaS 方案如何计费？

超级小班课场景方案基于 RTC SDK、RTM SDK、互动白板 SDK 和云端录制搭建，你可以参考如下文档了解各服务的计费详情：
