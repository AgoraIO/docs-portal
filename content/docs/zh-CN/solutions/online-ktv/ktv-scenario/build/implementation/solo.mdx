---
title: "独唱"
description: "了解 K 歌场景化方案在不同平台上的独唱方式，包括接入流程、关键配置和平台差异。"
---
...
![独唱时序图](https://web-cdn.agora.io/docs-portal/img/online-ktv/solo.android.svg)
...
- [合唱方案](/zh-CN/solutions/online-ktv/ktv-scenario/build/implementation/chorus)
