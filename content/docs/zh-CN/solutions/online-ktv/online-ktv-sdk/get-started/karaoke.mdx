...
3. 用户可以点歌，从[声网内容中心](/zh-CN/solutions/online-ktv/online-ktv-sdk/reference/music-content-center)获取歌单，并下载歌曲文件和歌词文件，成为主唱。
...
- [RESTful API](/zh-CN/solutions/online-ktv/online-ktv-sdk/reference/music-content-center)
- [歌词打分组件](/zh-CN/solutions/online-ktv/online-ktv-sdk/build/extend-karaoke/lyrics-scoring)
- [实时互动 API 参考](/zh-CN/solutions/online-ktv/online-ktv-sdk/reference/rtc-api)
