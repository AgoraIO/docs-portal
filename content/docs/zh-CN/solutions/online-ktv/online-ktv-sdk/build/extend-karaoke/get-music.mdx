...
- 已实现基本的在线 K 歌逻辑，详情请参考[快速实现](/zh-CN/solutions/online-ktv/online-ktv-sdk/get-started/karaoke)。
- 已联系[技术支持](https://ticket.shengwang.cn)开通版权音乐权限。
- 有效的声网项目，详情请参考[开通服务](/zh-CN/solutions/online-ktv/online-ktv-sdk/build/setup-and-access/enable-service)。
...
- [快速实现](/zh-CN/solutions/online-ktv/online-ktv-sdk/get-started/karaoke)
