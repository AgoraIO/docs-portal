---
title: "获取版权音乐"
description: "了解在线 K 歌 SDK 在不同平台上的获取版权音乐方式，包括接入流程、关键配置和平台差异。"
---
<PlatformStructured platform="android">

本文分别介绍如何使用实时互动 SDK API 及 RESTful API 获取并加载声网内容中心提供的版权音乐。

## 前提条件

- 已实现基本的在线 K 歌逻辑，详情请参考[快速集成在线 K 歌 SDK](/zh-CN/solutions/online-ktv/online-ktv-sdk/get-started/karaoke)。
- 已联系[技术支持](https://ticket.shengwang.cn)开通版权音乐权限。
- 有效的声网项目，详情请参考[开通在线 K 歌 SDK 服务](/zh-CN/solutions/online-ktv/online-ktv-sdk/build/setup-and-access/enable-service)。
...
2. 获取歌曲列表
   ...
   根据你的需求调用不同的 RESTful API 来获取歌曲列表、热门榜单等。调用说明及示例详见 [API 文档](/zh-CN/solutions/online-ktv/online-ktv-sdk/reference/music-content-center)。
...
1. 预加载音乐资源。
   ...
   调用 `preload` 方法来预加载需要播放的音乐资源。加载音乐资源之后，你可以调用 `isPreloaded` 方法来检测音乐资源是否已被预加载，该方法可同步调用且不包含耗时操作。
...
获取版权音乐后，你可以参考[实现文档](/zh-CN/solutions/online-ktv/online-ktv-sdk/get-started/karaoke)实现其他 K 歌功能。

## API 参考

本节介绍获取版权音乐使用的 API：

- [实时互动 SDK API](/zh-CN/solutions/online-ktv/online-ktv-sdk/reference/rtc-api)
...
- [快速集成在线 K 歌 SDK](/zh-CN/solutions/online-ktv/online-ktv-sdk/get-started/karaoke)
- [歌词打分组件](/zh-CN/solutions/online-ktv/online-ktv-sdk/reference/lyrics-api)
- [歌词强同步](/zh-CN/solutions/online-ktv/online-ktv-sdk/build/extend-karaoke/lyrics-syncing)
