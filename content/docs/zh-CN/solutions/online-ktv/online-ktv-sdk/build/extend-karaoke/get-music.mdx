...
- 你的项目的 RTM Token。如何部署请参考[部署 Token 服务器](/zh-CN/realtime-media/rtm/build/authentication-and-connection/token-generation)。
...
- [实时互动 SDK API](/zh-CN/api-reference/online-ktv)
