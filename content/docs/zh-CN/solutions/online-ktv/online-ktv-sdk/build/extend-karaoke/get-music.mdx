---
title: "获取版权音乐"
description: "了解 PaaS 方案在不同平台上的获取版权音乐方式，包括接入流程、关键配置和平台差异。"
---
...
- 已实现基本的在线 K 歌逻辑，详情请参考[快速集成 PaaS 方案](/zh-CN/solutions/online-ktv/online-ktv-sdk/get-started/karaoke)。
- 已联系[技术支持](https://ticket.shengwang.cn)开通版权音乐权限。
- 有效的声网项目，详情请参考[开通 PaaS 方案服务](/zh-CN/solutions/online-ktv/online-ktv-sdk/build/setup-and-access/enable-service)。
...
- [快速集成 PaaS 方案](/zh-CN/solutions/online-ktv/online-ktv-sdk/get-started/karaoke)
