...
客户端需要通过信令系统在设备端调节摄像头分辨率、设备音量等。你可以在客户端集成声网 [RTM SDK](https://docs.agora.io/cn/Real-time-Messaging/product_rtm) 实现设备控制。RTSA Lite SDK 具备云信令接口，可以直接与 RTM SDK 进行通信。
