...
- [下载](/zh-CN/solutions/multi-usecase/scenario-based/resources)
- [场景概览](/zh-CN/solutions/multi-usecase/scenario-based/overview/introduction)
...
当你使用声网在线 K 歌房解决方案时，声网收取实时音频费用和内容订阅费用，详见[计费说明](/zh-CN/solutions/multi-usecase/scenario-based/overview/billing)。
