...
- [独唱](/zh-CN/solutions/multi-usecase/scenario-based/solo)
- [合唱](/zh-CN/solutions/multi-usecase/scenario-based/chorus)
- [抢唱](./gaming)
- [接唱](./relay)
...
:::info[信息]
- 加载版权音乐时声网使用 RTM Token 进行鉴权，不会产生云信令服务费用。
- 你可以参考[开通服务](/doc/online-ktv/ios/overview/enable-service)获取临时 RTM Token 用于测试，但在正式生产环境中，你需要自己部署一个 RTM Token 服务器来生成、更新 Token，详见[部署 RTM Token](/zh-CN/realtime-media/rtm/user-guide/token/token-generation)。
:::
...
获取版权音乐后，你可以根据你实际的业务场景，进行[独唱](/zh-CN/solutions/multi-usecase/scenario-based/solo)、[合唱](/zh-CN/solutions/multi-usecase/scenario-based/chorus)、[抢唱](./gaming)、[接唱](./relay)。
