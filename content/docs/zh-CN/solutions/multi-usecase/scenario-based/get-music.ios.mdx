...
获取版权音乐后，你可以根据你实际的业务场景，进行[独唱](/zh-CN/solutions/multi-usecase/scenario-based/solo.ios)、[合唱](/zh-CN/solutions/multi-usecase/scenario-based/chorus.ios)、[抢唱](./gaming)、[接唱](./relay)。
...
- [独唱](/zh-CN/solutions/multi-usecase/scenario-based/solo.ios)
- [合唱](/zh-CN/solutions/multi-usecase/scenario-based/chorus.ios)
- [抢唱](./gaming)
- [接唱](./relay)
