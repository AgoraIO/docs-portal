---
title: "独唱"
description: "了解声网解决方案在不同平台上的独唱方式，包括接入流程、关键配置和平台差异。"
---
<PlatformStructured platform="android">

本文介绍如何实现独唱。在此之前，请确保你已参考[实现文档](/zh-CN/solutions/online-ktv/ktv-scenario/get-started/integrate-ktvapi)集成 KTV API。
...
![独唱](https://web-cdn.agora.io/docs-portal/img/online-ktv/solo.png)
...
![抢唱时序图](https://web-cdn.agora.io/docs-portal/img/online-ktv/solo.android.svg)
...
- [合唱方案](/zh-CN/solutions/multi-usecase/scenario-based/build/implement-core-features/chorus)
...
![抢唱时序图](https://web-cdn.agora.io/docs-portal/img/online-ktv/solo.ios.svg)
