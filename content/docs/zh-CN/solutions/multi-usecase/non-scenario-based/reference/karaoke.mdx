...
3. 用户可以点歌，从[声网内容中心](/zh-CN/solutions/online-ktv/ktv-scenario/reference/music-content-center)获取歌单，并下载歌曲文件和歌词文件，成为主唱。
...
根据下表提供的链接，下载对应平台的 SDK 并集成到你的项目中，并[开通内容中心服务](/zh-CN/solutions/online-ktv/ktv-scenario/reference/music-content-center#开通服务)。
...
- [声网内容中心](/zh-CN/solutions/online-ktv/ktv-scenario/reference/music-content-center)
