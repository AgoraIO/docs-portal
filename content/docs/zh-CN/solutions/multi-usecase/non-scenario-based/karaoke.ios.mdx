...
| 产品 | SDK 下载 | 集成文档 |
| --- | --- | --- |
| 声网实时互动 SDK v4.x | [声网实时互动 SDK v4.x](/zh-CN/realtime-media/rtc/resources.ios) | [实现纯语音互动](/zh-CN/realtime-media/rtc/basic-features/audio-quick-start.ios) |
...
调用 `setAudioEffectPreset` 方法，在不改变原声的性别特征的前提下，设置人声音效。设置音效后，频道内所有用户都能听到该效果。详见[设置人声效果](/zh-CN/realtime-media/rtc/advanced-features/voice-changer.ios.ios)。
