...
- 设备端兼容[产品概述](/zh-CN/solutions/iot-apaas/overview/product-overview#设备端)中描述的版本。
- [开通并配置声网灵隼物联网服务](/zh-CN/solutions/iot-apaas/get-started/enable-service)。
- 有效的设备 License。参考[申请和使用 License](/zh-CN/solutions/iot-apaas/get-started/license) 获取免费或商业 License。
...
1. 参考[定义属性](/zh-CN/solutions/iot-apaas/get-started/enable-service#6-定义属性)添加产品所需属性，并在设备端 App 中定义相同的 DP 值。
