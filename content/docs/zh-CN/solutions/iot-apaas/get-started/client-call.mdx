...
5. 在登录成功后的页面，可以点击 **+** 号添加新设备（设备产品码请参考[开通灵隼服务](/zh-CN/solutions/iot-apaas/get-started/enable-service)文档获取产品二维码章节），或者选择已经添加设备实时预览对应设备的画面（设备端示例项目请参考[实现设备端功能](/zh-CN/solutions/iot-apaas/get-started/device-call)文档）。
...
- `product_key`: 配置的产品 ID。获取方式详见[开通并配置灵隼物联网服务](/zh-CN/solutions/iot-apaas/get-started/enable-service)。
