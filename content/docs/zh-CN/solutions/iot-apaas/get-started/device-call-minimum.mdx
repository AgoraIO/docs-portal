...
2. 设备端示例项目源码中，你需要修改 `example/src/app_config.h` 中的以下参数。参考[开通并配置声网灵隼物联网服务](/zh-CN/solutions/iot-apaas/get-started/enable-service)从声网灵隼控制台的**应用配置&gt;&gt;开发者选项**页面获取所需参数。
