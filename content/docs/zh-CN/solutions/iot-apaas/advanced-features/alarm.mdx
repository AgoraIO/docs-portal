...
- 开通声网灵隼服务并创建一个产品。参考[开通声网灵隼服务](/zh-CN/solutions/iot-apaas/get-started/enable-service)。
- 如需实现推送和查看带视频和视频封面图片的告警消息，你需要先参考[云存储服务](/zh-CN/solutions/iot-apaas/advanced-features/cloud-storage)开通并使用云存储服务。
