---
title: "通过 OTA 升级设备固件"
description: "了解灵隼物联网云平台在不同平台上的通过 OTA 升级设备固件方式，包括接入流程、关键配置和平台差异。"
---
...
你需要开通声网灵隼服务并创建一个产品。参考[开通声网灵隼服务](/zh-CN/solutions/iot-apaas/build/setup-and-access/enable-service)。
