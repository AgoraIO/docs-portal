...
- 推送和查询告警消息、图片、视频。详见[告警服务](/zh-CN/solutions/iot-apaas/advanced-features/alarm.android.ios.device-c)。
- 通过云存储服务录制告警视频。详见[云存储服务](/zh-CN/solutions/iot-apaas/advanced-features/cloud-storage.android.ios.device-c)。

## 1.1.0 版

该版本于 2022 年 9 月 19 日发布，主要新增如下功能：

- [通过 OTA 升级设备端固件](/zh-CN/solutions/iot-apaas/advanced-features/upgrade-ota.android.ios.device-c)。
- [使用 RESTful API 对接第三方用户账号](/zh-CN/solutions/iot-apaas/restful#对接自研或第三方账户系统)。
