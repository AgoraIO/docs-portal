...
description: "查看灵隼物联网云平台的 RESTful API 参考，了解关键概念、参数说明、使用限制和接入注意事项。"
---
声网灵隼提供 RESTful API，帮助你实现云存储、对接第三方账户系统等功能。

你可以在自己的业务服务器中通过 RESTful API 与声网灵隼云平台进行云云对接。
...
| 参数                | 类型   | 描述                    |
| ------------------- | ------ | ----------------------- |
| `projectId`         | String | 必填。你的声网 Project ID。详见[配置开发参数](../build/setup-and-access/enable-service#8-配置开发参数)。 |
