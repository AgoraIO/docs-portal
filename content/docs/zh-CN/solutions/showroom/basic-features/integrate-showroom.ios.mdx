...
1. [创建项目](/zh-CN/realtime-media/rtc/get-started/quick-start.ios#创建项目)：新建一个 iOS 项目。
2. [集成 SDK](/zh-CN/realtime-media/rtc/get-started/quick-start.ios#集成-sdk)：将实时互动 RTC SDK 集成到项目中。
