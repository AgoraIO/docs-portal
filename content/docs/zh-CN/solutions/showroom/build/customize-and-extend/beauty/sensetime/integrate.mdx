---
title: "实现商汤美颜"
description: "了解秀场直播在不同平台上的商汤美颜方式，包括接入流程、关键配置和平台差异。"
---
<PlatformStructured platform="android">

## 示例项目

本文介绍如何通过声网美颜场景化 API (Beauty API) 集成商汤美颜到实时音视频互动中。声网在 GitHub 上提供开源 `BeautyAPI` 示例项目供你参考。
...
![](https://web-cdn.agora.io/docs-portal/img/showroom/st-1.0.1.1-and.svg)
...
5. 将商汤美颜 SDK 复制到你的项目中：请联系商汤技术支持获取美颜 SDK、美颜资源、证书等文件。下载并解压文件，然后添加到美颜项目对应的文件路径下：
...
8. 在终端内运行 `pod install` 命令安装声网 RTC SDK 和商汤美颜依赖。
...
:::warning[注意]
Beauty API 1.0.1.1 版中 `destory`方法的命名存在笔误，会在 1.0.2 版本修正成 `destroy`。
:::
...
![](https://web-cdn.agora.io/docs-portal/img/showroom/st-1.0.1.1-ios.svg)
