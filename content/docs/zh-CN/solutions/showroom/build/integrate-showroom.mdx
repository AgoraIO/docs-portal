...
- [开通秀场直播服务](/zh-CN/solutions/showroom/build/enable-service)并从声网控制台获取 App ID 和临时 Token。
...
如果你需要在秀场直播中实现美颜功能，可以参考[集成第三方美颜](/zh-CN/solutions/showroom/build/beauty/overview)。
