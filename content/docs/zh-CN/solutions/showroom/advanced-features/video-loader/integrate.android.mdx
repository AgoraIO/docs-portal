...
请确保已准备好符合要求的开发环境，详见[准备开发环境](/zh-CN/solutions/showroom/basic-features/integrate-showroom.android#准备开发环境)。
...
为加快用户加入频道的速度，你可以使用通配 Token，详见[使用通配 Token 最佳实践](/zh-CN/realtime-media/rtc/best-practice/wildcard-token.android.android)。
