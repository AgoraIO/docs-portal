...
完成[集成声网 Meta SDK](/zh-CN/solutions/meta-world/get-started/integrate-sdk.ios) 后，你可以参考本节实现元语聊。
...
调用 [`createScene`](/zh-CN/solutions/meta-world/api-ref/meta-api.ios#createscene) 创建 `AgoraMetaScene`，并在 `AgoraMetaSceneConfig` 中设置场景配置信息。通过 `AgoraMetaEventDelegate` 类的 [`onCreateSceneResult`](/zh-CN/solutions/meta-world/api-ref/meta-api.ios#oncreatesceneresult) 和 [`onConnectionStateChanged`](/zh-CN/solutions/meta-world/api-ref/meta-api.ios#onconnectionstatechanged) 回调监听创建场景和连接状态的事件。
...
1. 调用 [`setUserInfo`](/zh-CN/solutions/meta-world/api-ref/meta-api.ios#setuserinfo) 和 [`setModelInfo`](/zh-CN/solutions/meta-world/api-ref/meta-api.ios#getmodelinfo) 设置用户的基本信息和虚拟形象（Avatar）的模型信息。
2. 调用 [`enterScene`](/zh-CN/solutions/meta-world/api-ref/meta-api.ios#enterscene) 进入场景，并通过 `config` 设置配置信息。
3. 通过 `AgoraMetaSceneEventDelegate` 类的 [`onEnterSceneResult`](/zh-CN/solutions/meta-world/api-ref/meta-api.ios#onentersceneresult) 回调监听进入场景的结果。
...
1. 调用 [`leaveScene`](/zh-CN/solutions/meta-world/api-ref/meta-api.ios#leavescene) 离开场景。
2. 通过 `AgoraMetaSceneEventDelegate` 类的 [`onLeaveSceneResult`](/zh-CN/solutions/meta-world/api-ref/meta-api.ios#onleavesceneresult) 回调得知成功离开场景后，调用 [`destroy`](/zh-CN/solutions/meta-world/api-ref/meta-api.ios#destroy) 释放 `AgoraMetaScene`。
3. 通过 `AgoraMetaSceneEventDelegate` 类的 [`onReleasedScene`](/zh-CN/solutions/meta-world/api-ref/meta-api.ios#onreleasedscene) 回调监听 `AgoraMetaScene` 是否释放成功。
