...
完成[集成声网 Meta SDK](/zh-CN/solutions/meta-world/get-started/integrate-sdk.android) 后，你可以参考本节实现元语聊。
...
调用 [`create`](/api-ref/rtc/android/API/toc_initialize#api_irtcengine_initialize) 创建 `RtcEngine`。调用 `IMetaService` 类的 [`create`](/zh-CN/solutions/meta-world/api-ref/meta-api.android#create) 和 [`initialize`](/zh-CN/solutions/meta-world/api-ref/meta-api.android#initialize) 创建并初始化 `IMetaService`。
...
调用 `IMetaService` 类的 [`getSceneAssetsInfo`](/zh-CN/solutions/meta-world/api-ref/meta-api.android#getsceneassetsinfo) 获取场景资源，并通过 `IMetaServiceEventHandler` 类的 [`onGetSceneAssetsInfoResult`](/zh-CN/solutions/meta-world/api-ref/meta-api.android#ongetsceneassetsinforesult) 回调监听获取场景资源时的事件。
...
调用 [`createScene`](/zh-CN/solutions/meta-world/api-ref/meta-api.android#createscene) 创建 `IMetaScene`，并在 `sceneConfig` 中设置场景配置信息。通过 `IMetaServiceEventHandler` 类的 [`onCreateSceneResult`](/zh-CN/solutions/meta-world/api-ref/meta-api.android#oncreatesceneresult) 和 [`onConnectionStateChanged`](/zh-CN/solutions/meta-world/api-ref/meta-api.android#onconnectionstatechanged) 回调监听创建场景和连接状态的事件。
...
1. 调用 [`setUserInfo`](/zh-CN/solutions/meta-world/api-ref/meta-api.android#setuserinfo) 和 [`setModelInfo`](/zh-CN/solutions/meta-world/api-ref/meta-api.android#setmodelinfo) 设置用户的基本信息和虚拟形象（Avatar）的模型信息。
2. 调用 `IMetaScene` 类的 [`addEventHandler`](/zh-CN/solutions/meta-world/api-ref/meta-api.android#addeventhandler) 添加事件句柄，监听 `IMetaScene` 的事件回调。
3. 调用 [`enterScene`](/zh-CN/solutions/meta-world/api-ref/meta-api.android#enterscene) 进入场景，并通过 `config` 设置配置信息。
...
1. 调用 [`leaveScene`](/zh-CN/solutions/meta-world/api-ref/meta-api.android#leavescene) 离开场景。
2. 通过 `IMetaSceneEventHandler` 类的 [`onLeaveSceneResult`](/zh-CN/solutions/meta-world/api-ref/meta-api.android#onleavesceneresult) 回调得知成功离开场景后，调用 [`release`](/zh-CN/solutions/meta-world/api-ref/meta-api.android#release) 释放 `IMetaScene`。
3. 通过 `IMetaSceneEventHandler` 类的 [`onReleasedScene`](/zh-CN/solutions/meta-world/api-ref/meta-api.android#onreleasedscene) 回调监听 `IMetaScene` 是否释放成功。
