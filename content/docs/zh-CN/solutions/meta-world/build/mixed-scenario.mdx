...
- `mAppId`：在声网控制台获取的 App ID。详见[开通元语聊服务](/zh-CN/solutions/meta-world/build/enable-service)。
...
- 声网 Meta SDK 支持自定义装扮捏脸功能，详见[换装和捏脸](/zh-CN/solutions/meta-world/build/dress-face)。
:::
...
- `appId`：在声网控制台获取的 App ID。详见[开通元语聊服务](/zh-CN/solutions/meta-world/build/enable-service)。
