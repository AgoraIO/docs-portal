...
1. 调用 `RtcEngine` 类的 [`joinChannel`](/api-ref/rtc/android/API/toc_channel#api_irtcengine_joinchannel2) 使主播加入 RTC 频道。
...
1. 调用 `RtcEngine` 类的 [`leaveChannel`](/api-ref/rtc/android/API/toc_channel#api_irtcengine_leavechannel) 离开直播频道。
...
1. 调用 `AgoraRtcEngineKit` 类的 [`joinChannelByToken`](/api-ref/rtc/ios/API/toc_channel#api_irtcengine_joinchannel2) 使主播加入 RTC 频道。
...
1. 调用 `AgoraRtcEngineKit` 类的 [`leaveChannel`](/api-ref/rtc/ios/API/toc_channel#api_irtcengine_leavechannel) 离开直播频道。
