---
title: "换装和捏脸"
description: "了解声网解决方案在不同平台上的换装和捏脸方式，包括接入流程、关键配置和平台差异。"
---
...
![换装捏脸 API 时序图](https://web-cdn.agora.io/docs-portal/img/meta-world/dress-face.svg)
...
通过 [`sendSceneMessage`](/zh-CN/solutions/meta-world/reference/meta-api#sendscenemessage) 方法向虚拟场景中发送用户虚拟角色的换装和捏脸消息。
...
实现换装和捏脸前，请确保你已实现基础的元语聊或元直播功能，如创建 Meta 服务、获取并下载场景资源、创建场景、设置虚拟形象的信息并进入场景。详见[基础功能](/zh-CN/solutions/meta-world/build/implement-core-features/metachat)。
