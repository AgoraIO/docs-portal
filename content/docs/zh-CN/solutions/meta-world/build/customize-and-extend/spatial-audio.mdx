...
参考[媒体播放器](/zh-CN/realtime-media/rtc/build/media/media-player)功能指南创建一个 `IMediaPlayer` 对象，然后打开、播放媒体资源。
...
参考[媒体播放器](/zh-CN/realtime-media/rtc/build/media/media-player)功能指南创建一个 `AgoraMediaPlayerProtocol` 对象，然后打开、播放媒体资源。
