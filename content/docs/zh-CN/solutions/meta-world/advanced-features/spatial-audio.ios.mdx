...
实现该进阶功能前，请确保你已实现基础的元语聊或元直播功能，如创建 Meta 服务、获取并下载场景资源、创建场景、设置虚拟形象的信息并进入场景。详见[基础功能](/zh-CN/solutions/meta-world/basic-features/metachat.ios)。
...
参考[媒体播放器](/zh-CN/realtime-media/rtc/advanced-features/media-player.ios.ios)功能指南创建一个 `AgoraMediaPlayerProtocol` 对象，然后打开、播放媒体资源。
