...
调用 [`enableVideoDisplay`](/zh-CN/solutions/meta-world/api-ref/meta-api.ios#enablevideodisplay) 开启元宇宙中的视频显示屏，再通过 [`pushVideoFrameToDisplay`](/zh-CN/solutions/meta-world/api-ref/meta-api.ios#pushvideoframetodisplay) 将你从媒体播放器 [`didReceiveVideoFrame`](/api-ref/rtc/ios/API/toc_video_raw#callback_ivideoframeobserver_onframe) 回调得到的视频帧赋值给 `AgoraVideoFrame` 并推送其至该视频显示屏。
