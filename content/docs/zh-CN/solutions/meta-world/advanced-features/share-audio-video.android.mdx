...
调用 [`enableVideoDisplay`](/zh-CN/solutions/meta-world/api-ref/meta-api.android#enablevideodisplay) 开启元宇宙中的视频显示屏，再通过 [`pushVideoFrameToDisplay`](/zh-CN/solutions/meta-world/api-ref/meta-api.android#pushvideoframetodisplay) 将你从媒体播放器 [`onFrame`](/api-ref/rtc/android/API/toc_audio_basic#callback_iaudiopcmframesink_onframe) 回调得到的视频帧推送至该视频显示屏。
