...
- 参考[开通服务](/zh-CN/solutions/chatroom/sdk/build/setup-and-access/enable-service)创建声网开发者账号和声网项目，并获取项目的 App ID 和临时 Token，以及登录即时通讯系统所需的用户名 (ID) 和 Token。
...
1. 根据[开通服务](/zh-CN/solutions/chatroom/sdk/build/setup-and-access/enable-service)在声网控制台创建声网项目后，复制界面的 App ID。
...
- 有效的苹果开发者账号。
- 可以访问互联网的计算机。确保你的网络环境没有部署防火墙，否则无法正常使用声网服务。
- 参考[开通服务](/zh-CN/solutions/chatroom/sdk/build/setup-and-access/enable-service)创建声网开发者账号和声网项目，并获取项目的 App ID 和临时 Token。
