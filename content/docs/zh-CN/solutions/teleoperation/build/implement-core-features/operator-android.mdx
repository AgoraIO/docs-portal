---
title: "操控端实现 (Android)"
description: "了解如何在远程控制中操控端实现 (Android)，包括适用场景、配置步骤、实现要点和注意事项。"
---
...
接收 YUV 格式或已编码的视频数据，详细步骤请参考[实现音视频互动流程](/zh-CN/realtime-media/rtc/get-started/quick-start)。
...
- [实时音视频 API](/zh-CN/api-reference/rtc-server-sdk/java/overview)
