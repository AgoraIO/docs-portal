---
title: "操控端实现 (Linux)"
description: "了解如何在远程控制中操控端实现 (Linux)，包括适用场景、配置步骤、实现要点和注意事项。"
---
...
接收 YUV 格式的原始视频数据或编码后的 H.264 格式视频数据，详细步骤请参考[从设备端接收媒体流](/zh-CN/realtime-media/rtc-server-sdk/build/implement-core-features/send-receive#从客户端接收媒体流)。
