...
- 参考[创建项目](/zh-CN/realtime-media/rtc/get-started/quick-start.android#创建项目)为你的项目添加平行操控场景所需的网络及设备权限。

## 实现流程

### 接收音视频流

接收 YUV 格式或已编码的视频数据，详细步骤请参考[实现音视频互动流程](/zh-CN/realtime-media/rtc/get-started/quick-start.android#实现流程)。
