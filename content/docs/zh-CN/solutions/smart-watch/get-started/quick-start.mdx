...
你需要在 Android 设备端集成 [RTC SDK](/zh-CN/realtime-media/rtc/resources)，直接实现音视频采集、编码、传输、解码、渲染等功能。详见[实现音视频互动](/zh-CN/realtime-media/rtc/get-started/quick-start)。
...
你需要在客户端集成 [RTC SDK](/zh-CN/realtime-media/rtc/resources)，直接实现音视频采集、编码、传输、解码、渲染等功能。详见[实现音视频互动](/zh-CN/realtime-media/rtc/get-started/quick-start)。
