...
4. 调用 [`AgoraClassroomSDK.launch`](/api-ref/flexible-classroom/ios/classroom-sdk#launch) 方法启动教育场景的灵动课堂。示例代码如下：
...
6. 调用 [`AgoraClassroomSDK.exit`](/api-ref/flexible-classroom/ios/classroom-sdk#exit) 方法关闭教育场景的灵动课堂。示例代码如下：
...
4. 调用 [`AgoraProctorSDK.launch`](/api-ref/flexible-classroom/ios/proctor-sdk#launch) 方法启动监考场景的灵动课堂。示例代码如下：
