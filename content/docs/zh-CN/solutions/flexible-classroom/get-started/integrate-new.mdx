...
灵动课堂 FcrUIScene 包含了云课堂场景，本文详细介绍如何将灵动课堂云课堂场景集成到你自己的 Web 项目中。云课堂代码包含以下包：
...
3. 在项目的 JavaScript 代码中调用 [FcrUIScene.launch](/zh-CN/api-reference/flexible-classroom/web/api-reference/fcr-ui-scene#launch) 方法启动课堂。
...
2. 在项目的 JavaScript 代码中调用 [FcrUIScene.launch](/zh-CN/api-reference/flexible-classroom/web/api-reference/fcr-ui-scene#launch) 方法启动课堂。
...
示例代码中 `token` 的填写方式：你可以使用[临时 Token](/zh-CN/solutions/flexible-classroom/build/create-classroom/enable#生成临时-token)，也可以参考[使用 Token 鉴权](/zh-CN/solutions/flexible-classroom/build/create-classroom/generate-token) 从服务器生成 Token。
