...
灵动课堂中的白板模块是基于 [AgoraWidget](/zh-CN/solutions/flexible-classroom/build/customize-classroom-experience/widget) 实现的，你可以通过将 widget 状态设置为活跃（active）或非活跃（inactive）来开启或关闭白板模块。
