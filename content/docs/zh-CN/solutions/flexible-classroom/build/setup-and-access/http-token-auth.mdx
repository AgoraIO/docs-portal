...
认证时，你需要在 HTTP 请求的请求 Header 中，在 `Authorization: agora token=` 字段填入服务端生成的 EducationToken。关于如何生成 EducationToken，可参考[生成器代码](/zh-CN/solutions/flexible-classroom/build/setup-and-access/generate-token#accesstoken2-生成器代码)。
