...
:::warning[注意]
本文仅针对 2.7.0 或之后版本。如需了解如何在 2.4.x、2.5.x、2.6.x 版本上自定义插件，请参考[自定义插件（旧版）](/zh-CN/solutions/flexible-classroom/build/customize-classroom-experience/widget-previous)。
:::
...
详见 [插件的技术原理介绍](/zh-CN/solutions/flexible-classroom/build/customize-classroom-experience/widget-tech)。
...
通过 [`launch`](/zh-CN/api-reference/flexible-classroom/web/api-reference/classroom-sdk#launch) 中的 `widgets` 参数传入自定义 Widget：
...
通过 [`launch`](/zh-CN/api-reference/flexible-classroom/electron/api-reference/classroom-sdk#launch) 中的 `widgets` 参数传入自定义 Widget：
