...
如果你需要自定义课堂 UI，需要下载并修改灵动课堂源码。具体步骤参照[集成教育场景下灵动课堂并自定义](/zh-CN/solutions/flexible-classroom/get-started/integrate.ios#集成教育场景下灵动课堂并自定义)和[集成监考场景下灵动课堂并自定义](/zh-CN/solutions/flexible-classroom/get-started/integrate.ios#集成监考场景下灵动课堂并自定义)。
