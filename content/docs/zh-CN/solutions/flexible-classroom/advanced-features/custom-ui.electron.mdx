...
---
:::warning[注意]
云课堂场景包含在 FcrUIScene 内，若需自定义云课堂场景 UI，请参考[自定义云课堂 UI](/zh-CN/solutions/flexible-classroom/advanced-features/custom-ui-new.electron)。
:::
...
如需自定义组件，你需要先集成灵动课堂到你的项目中，参考[集成灵动课堂](/zh-CN/solutions/flexible-classroom/get-started/integrate.electron)。
