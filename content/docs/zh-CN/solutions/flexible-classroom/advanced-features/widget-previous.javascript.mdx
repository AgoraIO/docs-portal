...
:::warning[注意]
本文仅针对 2.4.x、2.5.x、2.6.x 版本。如需了解如何在 2.7.0 或之后版本上自定义插件，请参考[自定义插件](/zh-CN/solutions/flexible-classroom/advanced-features/widget.javascript.javascript)。
:::
...
1. 参考[集成灵动课堂](/zh-CN/solutions/flexible-classroom/get-started/integrate.javascript#使用自定义-ui-的方式集成-1)获取灵动课堂 GitHub 源码。
