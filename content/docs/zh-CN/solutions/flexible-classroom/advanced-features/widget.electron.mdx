...
:::warning[注意]
本文仅针对 2.7.0 或之后版本。如需了解如何在 2.4.x、2.5.x、2.6.x 版本上自定义插件，请参考[自定义插件（旧版）](/zh-CN/solutions/flexible-classroom/advanced-features/widget-previous.javascript.electron)。
:::
...
详见 [插件的技术原理介绍](/zh-CN/solutions/flexible-classroom/advanced-features/widget-tech.javascript.electron)。
