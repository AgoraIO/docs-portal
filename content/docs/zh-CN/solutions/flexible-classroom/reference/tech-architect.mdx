---
title: "技术架构"
description: "查看灵动课堂的技术架构，了解关键概念、参数说明、使用限制和接入注意事项。"
---
<PlatformStructured platform="android">

下图展示了灵动课堂的整体技术架构：

![灵动课堂技术架构](https://web-cdn.agora.io/docs-portal/img/flexible-classroom/tech-architecture.png)

## 灵动课堂教室 SDK

-   提供在线教育类的课堂场景化方案源码，目前支持一对一、小班课、大班课三个场景，同时支持客户自定义班型。
...
-   提供了多种教室类型的 UI 交互模板，目前支持 1 对 1、小班课、大班课三个场景，同时支持客户自定义班型。
