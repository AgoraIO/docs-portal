...
以[创建课堂 API](/zh-CN/solutions/flexible-classroom/reference/api-classroom#创建课堂) 为例，请求的 URL 示例如下：
...
以下是[创建课堂](/zh-CN/solutions/flexible-classroom/reference/api-classroom#创建课堂)的请求示例：
...
响应 Body 包含了服务器反馈的数据。例如，[查询课堂](/zh-CN/solutions/flexible-classroom/reference/api-classroom#查询课堂)的响应 Body 包括标识课堂房间的 UUID、课堂名称、创建时间、房间属性等信息。具体以每个 API 的响应为准。

以下是[查询课堂](/zh-CN/solutions/flexible-classroom/reference/api-classroom#查询课堂)的响应示例：
