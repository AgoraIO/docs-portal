...
:::info[信息]
如需了解 Edu Context API 2.0.0 的具体信息，查看 [API 文档](/zh-CN/api-reference/flexible-classroom/android/api-reference/edu-context/edu-context-api-overview)。
:::
...
:::info[信息]
如需了解 Agora Edu Context API 2.0.0 的具体信息，查看 [API 文档](/zh-CN/api-reference/flexible-classroom/ios/api-reference/edu-context/edu-context-api-overview)。
:::
