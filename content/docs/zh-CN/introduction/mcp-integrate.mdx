---
title: "Agora MCP"
description: "了解如何在声网开发者文档中 Agora MCP，包括适用场景、配置步骤、实现要点和注意事项。"
---
你可以借助 AI Coding Agent 更高效地集成声网产品。

通过配置 Shengwang Doc MCP Server，Coding Agent 可直接搜索和读取声网官方文档，在回答问题或生成代码前先获取最新官方文档内容，从而提供更准确、更高效的协助。
