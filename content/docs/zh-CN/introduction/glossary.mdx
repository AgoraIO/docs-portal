...
- [单流录制和合流录制（本地服务端录制）](/zh-CN/realtime-media/recording/local-server-recording/build/recording-modes/set-recording-mode)
...
:::info[相关链接]
[实现 HTTP 基本认证（RTC）](/zh-CN/realtime-media/rtc/build/security-and-auth/http-basic-auth)
:::
...
:::info[相关链接]
- [使用 Token 鉴权（RTC）](/zh-CN/realtime-media/rtc/build/security-and-auth/token-authentication)
