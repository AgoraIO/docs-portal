...
:::info[相关链接]
- [管理 App 证书](/zh-CN/introduction/user-guides/manage-authentication#启用主要证书)
:::
...
- [单流录制和合流录制（本地服务端录制）](/zh-CN/realtime-media/local-server-recording/build/recording-modes/recording-mode)
- [合流录制（云端录制）](/zh-CN/realtime-media/cloud-recording/build/recording-modes/mix-mode/set-composite)
:::
...
- 两个及以上频道内的主播进行连麦互动。声网 SDK 支持将某一频道中主播的媒体流转发至多个其他频道中，实现跨频道连麦。具体实现方式详见[跨频道媒体流转发](/zh-CN/realtime-media/rtc/build/advanced-channel/media-relay)。
...
- [下麦](#become-audience)
- [连麦](#cohosting)
- [主播](/zh-CN/realtime-media/rtc/reference/key-concept#音视频基本流程)
- [观众](/zh-CN/realtime-media/rtc/reference/key-concept#音视频基本流程)
:::
...
- [生成和使用 Token（互动白板）](/zh-CN/realtime-media/whiteboard/fastboard-sdk/build/setup-and-access/generate-token)
:::
