...
```java
rtmClient.login(token, new ResultCallback() {
    @Override
...
streamChannel.join(options, new ResultCallback() {
    @Override
    public void onSuccess(Void responseInfo) {
...
```java
rtmClient.logout(new ResultCallback() {
    @Override
    public void onSuccess(Void responseInfo) {
    }
...
```java
streamChannel.leave(new ResultCallback() {
    @Override
    public void onSuccess(Void responseInfo) {
