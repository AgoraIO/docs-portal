...
mStreamChannel.joinTopic("topic_name", options, new ResultCallback() {
    @Override
...
```java
mStreamChannel.leaveTopic("Motion", new ResultCallback() {
    @Override
    public void onSuccess(Void responseInfo) {
...
mStreamChannel.subscribeTopic("Motion", options, new ResultCallback() {
    @Override
...
mStreamChannel.unsubscribeTopic(topicName.toString(), options, new ResultCallback() {
    @Override
    public void onSuccess(Void responseInfo) {
