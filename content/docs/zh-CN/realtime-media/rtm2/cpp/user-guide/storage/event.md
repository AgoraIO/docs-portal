...
| 属性         |  类型  |   描述                                                                                                                         |
|---|----| ----
| `channelType`            | `RTM_CHANNEL_TYPE`    |  频道类型。详见 [`RTM_CHANNEL_TYPE`](https://doc.shengwang.cn/api-ref/rtm2/cpp/enumv#channeltype)。   |
| `storageType`            | `RTM_STORAGE_TYPE`    |  Storage 类型。详见 [`RTM_STORAGE_TYPE`](https://doc.shengwang.cn/api-ref/rtm2/cpp/enumv#storagetype)。  |
| `eventType`            | `RTM_STORAGE_EVENT_TYPE`    |  Storage 事件类型。详见 [`RTM_STORAGE_EVENT_TYPE`](https://doc.shengwang.cn/api-ref/rtm2/cpp/enumv#storageeventtype)。  |
