...
- 1 次订阅 (`subscribe`) Message Channel 计作 1 条消息。
- 1 次取消订阅 (`unsubscribe`) Message Channel 计作 1 条消息。
- 1 次加入 (`join`) Stream Channel 计作 1 条消息。
...
- 向 Stream Channel 中的 Topic 中发布 (`publishTextMessage`) 的任何 1 条消息计作 1 条消息。
