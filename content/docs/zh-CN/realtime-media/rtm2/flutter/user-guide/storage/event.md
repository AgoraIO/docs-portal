...
| 属性          | 类型                     | 描述                                                                                          |
| ------------ | --------- | ------- |
| `channelType` | `RtmChannelType`       | 频道类型。详见 [`RtmChannelType`](https://doc.shengwang.cn/api-ref/rtm2/flutter/enumv#channeltype)。                    |
| `storageType` | `RtmStorageType`       | Storage 类型。详见 [`RtmStorageType`](https://doc.shengwang.cn/api-ref/rtm2/flutter/enumv#storagetype)。                |
| `eventType`   | `RtmStorageEventType` | Storage 事件类型。详见 [`RtmStorageEventType`](https://doc.shengwang.cn/api-ref/rtm2/flutter/enumv#storageeventtype)。 |
