...
try {
  ...
  if (error instanceof RtmError) {
    console.error(`Operation: $`); // "publish" or "publishTopicMessage"
    console.error(`Error code: $`); // -11010
    console.error(`Reason: $`); // "Message length exceeds limit"
