...
description: 实时消息 SDK 合规使用说明，用于补充 RTM 的排障、生命周期或合规说明。
---
...
- Android: [实现收发消息-2. 初始化 RTM​](../android/get-started/quick-start.md#2-初始化-rtm)
- iOS: [实现收发消息-2. 初始化 RTM​](../ios/get-started/quick-start.md#2-初始化-rtm)
...
![image](/img/security/app-alert.png)
...
- Android:
  - [实现收发消息-4. 登录服务](../android/get-started/quick-start.md#4-登录服务)
  - [实现收发消息-6. 登出服务](../android/get-started/quick-start.md#6-登出服务)

- iOS:
  - [实现收发消息-4. 登录服务](../ios/get-started/quick-start.md#4-登录服务)
  - [实现收发消息-6. 登出服务](../ios/get-started/quick-start.md#6-登出服务)
