---
title: 开通服务
description: 开通服务，用于帮助开发者在对应平台上快速完成 RTM 接入与基础验证。
---
...
> **信息**
> 注册和登录过程中如果遇到疑问，可以查看[快速开始](/doc/console/general/quickstart)。
...
![image](/img/rtm2/create-project.png)

> **信息**
> 如果项目的鉴权机制为**安全模式**，则你需要在初始化 SDK 时填入 Token。详见[获取临时 Token](#5-获取临时-token) 和<a href=>初始配置</a >。
...
![image](/img/rtm2/get-temp-token.png)
