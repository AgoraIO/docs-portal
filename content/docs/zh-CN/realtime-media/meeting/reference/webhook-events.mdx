...
|`cmd`|Integer| [事件类型](/zh-CN/realtime-media/meeting/reference/webhook-events)|
...
|`data`|Object|事件的具体数据，不同事件会包含不同数据，详见[事件类型](/zh-CN/realtime-media/meeting/reference/webhook-events)。|
