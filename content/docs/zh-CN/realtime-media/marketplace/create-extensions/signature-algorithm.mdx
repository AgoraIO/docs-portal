...
以声网调用计量计费 RESTful API [查询用量](/zh-CN/realtime-media/marketplace/create-extensions/usage-billing)为例，请求 URL 为：
...
以声网调用服务开通 RESTful API [激活插件](/zh-CN/realtime-media/marketplace/create-extensions/provisioning)为例，请求包体为：
