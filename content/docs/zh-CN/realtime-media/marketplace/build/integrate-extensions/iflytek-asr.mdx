...
本文介绍如何在你的项目中集成和使用讯飞语音实时转写及翻译（多语种）插件（以下简称“讯飞转写及翻译插件”）。讯飞转写及翻译插件的工作流程如下：
...
讯飞转写及翻译插件需要与[声网音频 SDK v4.x](/zh-CN/realtime-media/rtc) 搭配使用。参考以下文档集成音频 SDK v4.x 并实现基础的语音通话：
...
- 声网 Web SDK 的插件相关方法：
  ...
  - [`IMicrophoneAudioTrack.pipe`](/zh-CN/api-reference/rtc/web/interfaces/imicrophoneaudiotrack#pipe)
...
- [声网 SDK 的插件相关方法和回调](/zh-CN/api-reference/rtc/cpp-all-platforms/extension#toc_extension)
- [插件的 key-value 说明](/zh-CN/realtime-media/marketplace/reference/iflytek-asr-api)
