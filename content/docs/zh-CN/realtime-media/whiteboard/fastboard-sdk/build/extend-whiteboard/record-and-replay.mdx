---
title: "录制与回放"
description: "了解 Fastboard SDK 在不同平台上的录制与回放方式，包括接入流程、关键配置和平台差异。"
---
...
2. 已获取有效的 App Identifier 和 Room Token。详见[获取互动白板项目的安全密钥](/zh-CN/realtime-media/whiteboard/fastboard-sdk/build/setup-and-access/enable-service#获取互动白板项目的安全密钥)。
3. 如需在业务服务器上创建房间，请参考[房间管理服务端 API](/zh-CN/api-reference/api-ref/whiteboard/restful/create-room)。

## 实现录制功能

### 开启录制

要开启白板录制功能，需要在创建房间时设置 `isRecord: true` 参数。通过服务端 API [POST 创建房间](/zh-CN/api-reference/api-ref/whiteboard/restful/create-room)创建支持录制的房间。
...
- [`Player.play`](/zh-CN/api-reference/whiteboard/whiteboard-sdk/android/classcom-1-1herewhite-1-1sdk-1-1-player#play) - 开始播放
- [`Player.pause`](/zh-CN/api-reference/whiteboard/whiteboard-sdk/android/classcom-1-1herewhite-1-1sdk-1-1-player#pause) - 暂停播放
- [`Player.seekToScheduleTime`](/zh-CN/api-reference/whiteboard/whiteboard-sdk/android/classcom-1-1herewhite-1-1sdk-1-1-player#seektoscheduletime) - 跳转播放位置
- [`Player.setPlaybackSpeed`](/zh-CN/api-reference/whiteboard/whiteboard-sdk/android/classcom-1-1herewhite-1-1sdk-1-1-player#setplaybackspeed) - 设置播放速度
- [`Player.setObserverMode`](/zh-CN/api-reference/whiteboard/whiteboard-sdk/android/classcom-1-1herewhite-1-1sdk-1-1-player#setobservermode) - 设置观看模式
- [POST 创建房间](/zh-CN/api-reference/api-ref/whiteboard/restful/create-room)
...
- [`WhiteSDK.createReplayerWithConfig`](/zh-CN/api-reference/whiteboard/whiteboard-sdk/ios/classes/white-sdk#createreplayerwithconfigcallbackscompletionhandler) - 创建回放播放器
- [`WhitePlayer.play`](/zh-CN/api-reference/whiteboard/whiteboard-sdk/ios/classes/white-player#play) - 开始播放
- [`WhitePlayer.pause`](/zh-CN/api-reference/whiteboard/whiteboard-sdk/ios/classes/white-player#pause) - 暂停播放
- [`WhitePlayer.seekToScheduleTime`](/zh-CN/api-reference/whiteboard/whiteboard-sdk/ios/classes/white-player#seektoscheduletime) - 跳转播放位置
- [`WhitePlayer.setObserverMode`](/zh-CN/api-reference/whiteboard/whiteboard-sdk/ios/classes/white-player#setobservermode) - 设置观看模式
- [POST 创建房间](/zh-CN/api-reference/api-ref/whiteboard/restful/create-room)
...
- [`replayFastboard`](/zh-CN/api-reference/whiteboard/fastboard/web#replayfastboard) - 创建回放播放器
- [`createReplayUI`](/zh-CN/api-reference/whiteboard/fastboard/web#createreplayui) - 创建回放 UI
- [POST 创建房间](/zh-CN/api-reference/api-ref/whiteboard/restful/create-room)
