...
- `images`：JSON Object。文档转图片结果的地址和图片参数，每页对应一张图片。该参数仅在调用[发起文档转换](/zh-CN/api-reference/api-ref/whiteboard/restful/start-file-conversion)时，请求 Body 中的 `type` 设为 `static` 时生效。
