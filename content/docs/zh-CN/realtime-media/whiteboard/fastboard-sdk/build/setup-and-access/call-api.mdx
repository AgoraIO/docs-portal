---
title: "调用 Fastboard RESTful API"
description: "了解如何在 Fastboard SDK 中调用 Fastboard RESTful API，包括适用场景、配置步骤、实现要点和注意事项。"
---
# 前提条件
...
以[生成 SDK Token](/doc/whiteboard/restful/fastboard-sdk/restful-wb/operations/post-v5-tokens-teams)的请求 URL 示例如下：
...
以下是[发起文档转换](/doc/whiteboard/restful/fastboard-sdk/restful-wb/operations/post-v5-projector-tasks)的请求示例：
...
以下是[查询转换任务进度](/doc/whiteboard/restful/fastboard-sdk/restful-wb/operations/get-v5-projector-tasks-uuid)的响应示例：
