...
- 在 App 服务端调用互动白板服务端 RESTful API，详见[使用 RESTful API 生成 Token](/doc/whiteboard/restful/fastboard-sdk/restful-wb/operations/post-v5-tokens-teams)。
...
- 如果房间已经存在，你可以调用[获取房间列表](/doc/whiteboard/restful/fastboard-sdk/restful-wb/operations/get-v5-rooms)查询已创建的房间列表。请求成功后，响应 Body 中包含查询房间的 UUID。
- 如果房间尚未创建，你可以调用[创建房间](/doc/whiteboard/restful/fastboard-sdk/restful-wb/operations/post-v5-rooms)。请求成功后，响应 Body 中包含新创建房间的 UUID。
...
要获取文档转换任务的 UUID， 你需要调用互动白板 RESTful API [发起文档转换](/doc/whiteboard/restful/fastboard-sdk/restful-wb/operations/post-v5-projector-tasks)。请求成功后，响应 Body 会包含转换任务的 UUID。
...
生成 SDK Token 时，你需要传入项目的 AK 和 SK、Token 的有效时长和角色，详见[生成 SDK Token](/doc/whiteboard/restful/fastboard-sdk/restful-wb/operations/post-v5-tokens-teams)。以 cURL 为例：
...
生成 Room Token 时，你需要传入房间 UUID、SDK Token、Token 的有效时长和角色，其中房间 UUID 需要调用[POST 创建房间](/doc/whiteboard/restful/fastboard-sdk/restful-wb/operations/post-v5-rooms)获取，详见[生成 Room Token](/doc/whiteboard/restful/fastboard-sdk/restful-wb/operations/post-v5-tokens-rooms-uuid)。以 cURL 为例：
...
生成 Task Token 时，你需要传入转换任务的 UUID、SDK Token、AK、Token 的有效时长和角色，其中转换任务的 UUID 需要调用[发起文档转换](/doc/whiteboard/restful/fastboard-sdk/restful-wb/operations/post-v5-projector-tasks)获取，详见[生成 Task Token](/doc/whiteboard/restful/fastboard-sdk/restful-wb/operations/post-v5-tokens-tasks-uuid)。以 cURL 为例：
...
- [生成 SDK Token](/doc/whiteboard/restful/fastboard-sdk/restful-wb/operations/post-v5-tokens-teams)
- [生成 Room Token](/doc/whiteboard/restful/fastboard-sdk/restful-wb/operations/post-v5-tokens-rooms-uuid)
- [生成 Task Token](/doc/whiteboard/restful/fastboard-sdk/restful-wb/operations/post-v5-tokens-tasks-uuid)
