...
在调用 RESTful API 之前，你需要参考[开启和配置互动白板服务](/zh-CN/realtime-media/whiteboard/fastboard-sdk/get-started/enable-service)完成以下准备工作：
...
- 如果 HTTP 状态码不为 200 或 201，可参考[响应状态码](/zh-CN/realtime-media/whiteboard/fastboard-sdk/response-code)排查问题。
...
当你遇到问题时，可以使用开发者工具查看请求和响应，结合[响应状态码](/zh-CN/realtime-media/whiteboard/fastboard-sdk/response-code)进行排查。如未能解决问题，可联系[技术支持](https://ticket.shengwang.cn)。
