...
1. 已在项目中集成声网 Fastboard SDK。详见[快速开始](/zh-CN/realtime-media/whiteboard/fastboard-sdk/get-started/join-room-fb.android)。
...
- [快速开始](/zh-CN/realtime-media/whiteboard/fastboard-sdk/get-started/join-room-fb.android)
