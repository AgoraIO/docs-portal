...
![房间连接状态切换关系图](/img/whiteboard/room-phase.png)
...
开始前，请确保你已在项目中集成声网 Whiteboard SDK 并加入房间，详见[加入白板房间](/zh-CN/realtime-media/whiteboard/whiteboard-sdk/get-started/join-room-wb.javascript)。
