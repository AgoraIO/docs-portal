...
白板 SDK 提供 [`setMemberState`](/api-ref/whiteboard/javascript/interfaces/room#setMemberState) 方法，用于设置当前白板房间内使用的工具。你可以通过修改当前 `Room` 对象的 [`MemberState`](/api-ref/whiteboard/javascript/globals#MemberState) 切换工具、选择图形、修改字体的大小、线条的颜色和粗细。
...
本节展示如何在[加入白板房间](/zh-CN/realtime-media/whiteboard/whiteboard-sdk/get-started/join-room-wb.javascript)示例代码的基础上，直接在程序中设置当前用户使用的工具。
...
本节展示如何在[加入白板房间](/zh-CN/realtime-media/whiteboard/whiteboard-sdk/get-started/join-room-wb.javascript)示例代码的基础上，实现一个简单的工具条。
