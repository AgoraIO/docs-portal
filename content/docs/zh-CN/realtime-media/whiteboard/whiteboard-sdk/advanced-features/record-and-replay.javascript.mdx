...
1. 已在项目中集成声网互动白板 SDK。详见[快速开始](/zh-CN/realtime-media/whiteboard/whiteboard-sdk/get-started/join-room-wb.javascript)。
2. 已获取有效的 SDK Token 和 Room Token。详见[获取互动白板项目的安全密钥](/zh-CN/realtime-media/whiteboard/whiteboard-sdk/get-started/enable-service#获取互动白板项目的安全密钥)。
...
- [互动白板 Token 概述](/zh-CN/realtime-media/whiteboard/whiteboard-sdk/overview/concepts#token) - Token 相关说明
- [创建自定义事件](/zh-CN/realtime-media/whiteboard/whiteboard-sdk/advanced-features/custom-event.javascript) - 自定义事件使用指南
