...
在[多窗口模式](/zh-CN/realtime-media/whiteboard/reference/concepts#多窗口模式)下，SDK 支持以新建窗口的方式插入 PPT 或白板插件等，它们统称为[小窗应用](/zh-CN/realtime-media/whiteboard/reference/concepts#小窗应用)。该版本起，`Room` 对象新增以下方法用于在多窗口模式下管理小窗应用：
...
在[多窗口模式](/zh-CN/realtime-media/whiteboard/reference/concepts#多窗口模式)下，SDK 支持以新建窗口的方式插入 PPT 或白板插件等，它们统称为[小窗应用](/zh-CN/realtime-media/whiteboard/reference/concepts#小窗应用)。该版本起，`WhiteRoom` 类新增以下方法用于在多窗口模式下管理小窗应用：
