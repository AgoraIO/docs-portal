---
title: "生成 Token"
description: "了解互动白板 SDK 在不同平台上的生成 Token 方式，包括接入流程、关键配置和平台差异。"
---
...
| 权限                         | admin（管理员） | writer（读写） | reader（只读） |
| :--------------------------- | :-------------- | :------------- | :------------- |
| 以[互动模式](/zh-CN/realtime-media/whiteboard/concepts#互动模式)加入特定房间       |  ✔               |  ✔             |✘               |
| 以[订阅模式](/zh-CN/realtime-media/whiteboard/concepts#订阅模式)加入特定房间       | ✘                | ✘              |  ✔              |
| 获取特定房间信息             |  ✔             |  ✔              | ✘               |
| 封禁特定房间                 |  ✔              | ✘               | ✘               |
| 对指定场景进行截图           |  ✔           |  ✔              | ✘               |
| 对场景组下的所有场景进行截图 | ✔              |  ✔              | ✘               |
