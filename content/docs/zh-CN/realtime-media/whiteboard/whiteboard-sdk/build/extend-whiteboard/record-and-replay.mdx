...
- [`WhiteWebSdk.replayRoom`](/zh-CN/api-reference/whiteboard/whiteboard-sdk/web/classes/whitewebsdk#replayroom) - 创建回放播放器
- [`WhiteWebSdk.isPlayable`](/zh-CN/api-reference/whiteboard/whiteboard-sdk/web/classes/whitewebsdk#isplayable) - 检查是否可回放
- [`Player.play`](/zh-CN/api-reference/whiteboard/whiteboard-sdk/web/interfaces/player#play) - 开始播放
- [`Player.pause`](/zh-CN/api-reference/whiteboard/whiteboard-sdk/web/interfaces/player#pause) - 暂停播放
- [`Player.seekToProgressTime`](/zh-CN/api-reference/whiteboard/whiteboard-sdk/web/interfaces/player#seektoprogresstime) - 跳转播放位置
- [`Player.setObserverMode`](/zh-CN/api-reference/whiteboard/whiteboard-sdk/web/interfaces/player#setobservermode) - 设置观看模式
- [`PlayerCallbacks`](/zh-CN/api-reference/whiteboard/whiteboard-sdk/web/globals#playercallbacks) - 播放器回调

### 相关文档

- [房间管理服务端 API](/zh-CN/api-reference/api-ref/whiteboard/restful/create-room) - 创建房间 API
