...
已经从声网控制台获取客户 ID 和客户密钥，详见[开通服务](/zh-CN/realtime-media/media-pull/get-started/enable-service)。
...
2. 参考 [接收 Webhook 事件](/zh-CN/realtime-media/media-pull/webhook/enable-event-notification) 开启消息通知服务，通过事件回调监听服务状态。
3. 参考 [集成最佳实践](/zh-CN/realtime-media/media-pull/best-practices/ensure-player-created) 检查你的集成步骤，保障服务可靠性。
