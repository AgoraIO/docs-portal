...
已经从声网控制台获取客户 ID 和客户密钥，详见[开通转码服务](/zh-CN/realtime-media/transcoding/build/enable-service)。
...
- [HTTP 基本认证](/zh-CN/realtime-media/transcoding/build/http-auth)。易用，但安全性较弱。
...
- 声网项目的 App ID，详见[获取 App ID](/zh-CN/realtime-media/transcoding/build/enable-service#获取-app-id)。
- 声网控制台 RESTful API 中提供的客户 ID 及客户密钥，详见[生成客户 ID 和密钥](/zh-CN/realtime-media/transcoding/build/enable-service#获取客户-id-和客户密钥)。
...
1. 参考[实现观众端多码率](/zh-CN/realtime-media/transcoding/build/enable-multiple-bitrate)了解实现流程。
