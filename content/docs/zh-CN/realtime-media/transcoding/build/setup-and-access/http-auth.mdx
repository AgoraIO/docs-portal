...
已经从声网控制台获取客户 ID 和客户密钥，详见[开通服务](/zh-CN/realtime-media/transcoding/build/setup-and-access/enable-service)。

### 实现方法

参考 [HTTP 基本认证](/zh-CN/realtime-media/rtc/build/security-and-auth/http-basic-auth#生成方法)实现。
