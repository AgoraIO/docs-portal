...
在 `main.go` 文件中，添加如下代码，定义或配置关键参数，取值可参考[前提条件](/zh-CN/realtime-media/transcoding/get-started/quick-start-go)。
...
云端转码支持设置的所有参数请参考 [API 文档](/zh-CN/api-reference/api-ref/cloud-transcoding/acquire)。
