...
- 参考[开通服务](/zh-CN/realtime-media/transcoding/get-started/enable-service)在声网控制台开通云端转码，并复制保存 App ID、临时 Token、客户 ID 和客户密钥。
...
如果遇到问题，可参考[响应状态码和错误码](/zh-CN/realtime-media/transcoding/response-code)排查。
