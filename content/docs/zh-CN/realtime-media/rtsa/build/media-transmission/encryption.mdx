...
2. 实现客户端逻辑：
   ...
   3. 调用 `agora_rtc_join_channel` 时在 `crypto_option_t` 中开启加密，设置加密模式为 `AES_128_GCM2` 或 `AES_256_GCM2`，并将密钥和盐传入 SDK。
...
[`agora_rtc_join_channel`](/zh-CN/api-reference/rtsa/c/agora-rtc-api-8h#a6c29ff27f04623526a164cf6e5dcd738)
