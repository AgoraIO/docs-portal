---
title: "发送关键帧"
description: "了解 RTSA 中发送关键帧相关内容的适用场景、配置步骤、实现要点和注意事项。"
---
关键帧是自带全部解码信息的独立视频帧，解码时仅需本帧数据，无需参考其他图像。

关键帧的设置会影响视频编解码效率和数据空间占用。本文介绍如何发送关键帧。
...
```c tab="C" tabGroup="zh-cn-realtime-media-rtsa-build-implement-core-features-key-frame-1"
...
```java tab="Java" tabGroup="zh-cn-realtime-media-rtsa-build-implement-core-features-key-frame-1"
int streamId = 0;
