---
title: "媒体流加密"
description: "了解如何在 RTSA 中媒体流加密，包括适用场景、配置步骤、实现要点和注意事项。"
---
在实时音视频互动过程中，你需要对媒体流加密，从而保障用户的数据安全。

声网 RTSA SDK 提供内置加密方案，可以对音视频数据包进行加密。
...
![RTSA 加密原理](https://web-cdn.agora.io/docs-portal/img/rtsa/encryption.png)
...
```c tab="C" tabGroup="zh-cn-realtime-media-rtsa-build-implement-core-features-encryption-1"
...
```java tab="Java" tabGroup="zh-cn-realtime-media-rtsa-build-implement-core-features-encryption-1"
