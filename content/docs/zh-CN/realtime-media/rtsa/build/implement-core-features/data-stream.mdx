---
title: "发送和接收数据流"
description: "了解 RTSA 中发送和接收数据流相关内容的适用场景、配置步骤、实现要点和注意事项。"
---
...
调用 [`agora_rtc_init`](/api-ref/rtsa/c/agora__rtc__api_8h#a6187076d897f0b56cb20942368c15aaa) 初始化 SDK。然后调用 [`agora_rtc_create_connection`](/api-ref/rtsa/c/agora__rtc__api_8h#adef869ae47e2f1c194af611b57d06394) 和 [`agora_rtc_join_channel`](/api-ref/rtsa/c/agora__rtc__api_8h#a6c29ff27f04623526a164cf6e5dcd738) 加入 RTC 频道。
...
加入 RTC 频道后，调用 [`agora_rtc_create_data_stream`](/api-ref/rtsa/c/agora__rtc__api_8h#aa6b288b479c7048b4cceb85d995771ed) 创建数据流。接口签名如下：
...
调用 [`agora_rtc_send_stream_message`](/api-ref/rtsa/c/agora__rtc__api_8h#aee89fa14447b4529d45275afe5b5a86f) 发送数据流。
...
接收到数据流后，SDK 会触发 [`on_stream_message`](/api-ref/rtsa/c/structagora__rtc__event__handler__t#a7c73b2bb0558e2b695d8838ee542c87a) 回调。你可以从该回调中获取具体的数据内容。
