...
- `warnCode`：Number 类型，警告码。与 `module` 有关：
  - 如果 `module` 为 `0`，警告发生在录制模块，请参考[警告码](/zh-CN/api-reference/local-server-recording/cpp/legacy/namespaceagora-1-1linuxsdk#a11cab69078db26c1f166c68e469dcfcf)的说明。
