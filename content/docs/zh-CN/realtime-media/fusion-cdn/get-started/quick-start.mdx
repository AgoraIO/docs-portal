...
| 配置方式 | 前往声网控制台。详见[添加域名配置](/zh-CN/realtime-media/fusion-cdn/get-started/quick-start)。 | <Slot name="quick-start-html-0-3-2" /> |

<Slot for="quick-start-html-0-3-2">

根据你的域名灵活性选择：

- 如果你的域名相对固定，可以在声网控制台上添加。详见[添加域名配置](/zh-CN/realtime-media/fusion-cdn/get-started/quick-start)。
