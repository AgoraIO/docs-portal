...
- 声网项目的 App ID，详见[获取 App ID](/zh-CN/realtime-media/fusion-cdn/build/enable-service#获取-app-id)。
- 声网控制台 RESTful API 中提供的客户 ID 及客户密钥，详见[生成客户 ID 和密钥](/zh-CN/realtime-media/fusion-cdn/build/enable-service#获取客户-id-和客户密钥)。
