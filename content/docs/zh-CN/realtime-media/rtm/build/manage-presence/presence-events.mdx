...
|     参数      | 描述                                                                                                                                        |
| ----------- | -------------- |
|   `presence.eventtype`     | Presence 事件类型。详见 [`enumv.presencetype`](/zh-CN/api-reference/rtm/unity/enumv#presencetype)。详见 [API 参考](/api-ref/rtm2/javascript/enumv#presence-事件类型)。 |
