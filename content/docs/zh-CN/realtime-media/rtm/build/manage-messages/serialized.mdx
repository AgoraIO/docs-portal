---
title: "消息负载序列化"
description: "了解如何在实时消息 RTM 中消息负载序列化，包括适用场景、配置步骤、实现要点和注意事项。"
---
当你为消息负载构建结构化的格式后，还需要将消息数据进行序列化转换成字符串类型或二进制类型，以满足 RTM 中发送消息的格式要求。

可以自己实现或使用第三方的插件，我们有以下两种推荐做法：
...
```csharp tab="C#" tabGroup="rtm-build-manage-messages-serialized-1"
...
```java tab="Java" tabGroup="rtm-build-manage-messages-serialized-1"
PollMessage message = new PollMessage();
// ...
// 序列化对象
...
```swift tab="Swift" tabGroup="rtm-build-manage-messages-serialized-1"
...
```objc tab="Objective-C" tabGroup="rtm-build-manage-messages-serialized-1"
...
```cpp tab="C++" tabGroup="rtm-build-manage-messages-serialized-1"
...
```cpp tab="C++" tabGroup="rtm-build-manage-messages-serialized-2"
// 异步回调
...
```dart tab="Dart" tabGroup="rtm-build-manage-messages-serialized-2"
...
```csharp tab="C#" tabGroup="rtm-build-manage-messages-serialized-3"
// 添加消息事件监听
...
```java tab="Java" tabGroup="rtm-build-manage-messages-serialized-3"
...
```swift tab="Swift" tabGroup="rtm-build-manage-messages-serialized-3"
...
```objc tab="Objective-C" tabGroup="rtm-build-manage-messages-serialized-3"
...
```cpp tab="C++" tabGroup="rtm-build-manage-messages-serialized-3"
...
```dart tab="Dart" tabGroup="rtm-build-manage-messages-serialized-3"
// TODO Flutter 请根据上面其他语言的示例代码，提供 Dart 的示例代码
...
```csharp tab="C#" tabGroup="rtm-build-manage-messages-serialized-4"
using Newtonsoft.Json;
...
```java tab="Java" tabGroup="rtm-build-manage-messages-serialized-4"
...
```swift tab="Swift" tabGroup="rtm-build-manage-messages-serialized-4"
...
```objc tab="Objective-C" tabGroup="rtm-build-manage-messages-serialized-4"
...
```cpp tab="C++" tabGroup="rtm-build-manage-messages-serialized-4"
PublishOptions options;
options.messageType = RTM_MESSAGE_TYPE_STRING;
...
```dart tab="Dart" tabGroup="rtm-build-manage-messages-serialized-4"
// TODO Flutter 请根据上面其他语言的示例代码，提供 Dart 的示例代码
...
```csharp tab="C#" tabGroup="rtm-build-manage-messages-serialized-5"
// 添加消息事件监听
rtmClient.OnMessageEvent += OnMessageEvent;
...
```java tab="Java" tabGroup="rtm-build-manage-messages-serialized-5"
eventListener = new RtmEventListener {
    @Override
    public void onMessageEvent(MessageEvent event) {
        log(INFO, "onMessageEvent");
...
```swift tab="Swift" tabGroup="rtm-build-manage-messages-serialized-5"
...
```objc tab="Objective-C" tabGroup="rtm-build-manage-messages-serialized-5"
@interface RtmHandler : NSObject <AgoraRtmClientDelegate>
@end
...
```cpp tab="C++" tabGroup="rtm-build-manage-messages-serialized-5"
class RtmHandler: public IRtmEventHandler {
    void onMessageEvent(const MessageEvent &event) override{
        printf("onMessageEvent");
        if (event.messageType == RTM_MESSAGE_TYPE_STRING) {
...
```dart tab="Dart" tabGroup="rtm-build-manage-messages-serialized-5"
// TODO Flutter 请根据上面其他语言的示例代码，提供 Dart 的示例代码
...
```java tab="Java" tabGroup="rtm-build-manage-messages-serialized-6"
...
```swift tab="Swift" tabGroup="rtm-build-manage-messages-serialized-6"
...
```objc tab="Objective-C" tabGroup="rtm-build-manage-messages-serialized-6"
...
```cpp tab="C++" tabGroup="rtm-build-manage-messages-serialized-6"
PublishOptions options;
...
```dart tab="Dart" tabGroup="rtm-build-manage-messages-serialized-6"
// TODO Flutter 请根据上面其他语言的示例代码，提供 Dart 的示例代码
...
```java tab="Java" tabGroup="rtm-build-manage-messages-serialized-7"
eventListener = new RtmEventListener {
    @Override
    public void onMessageEvent(MessageEvent event) {
        log(INFO, "onMessageEvent");
...
```swift tab="Swift" tabGroup="rtm-build-manage-messages-serialized-7"
class RtmHandler: NSObject, AgoraRtmClientDelegate {
    func rtmKit(_ rtmKit: AgoraRtmClientKit, didReceiveMessageEvent event: AgoraRtmMessageEvent) {
        let channel = event.channelName
        let channelType = event.channelType
...
```objc tab="Objective-C" tabGroup="rtm-build-manage-messages-serialized-7"
@interface RtmHandler : NSObject <AgoraRtmClientDelegate>
@end
...
```cpp tab="C++" tabGroup="rtm-build-manage-messages-serialized-7"
class RtmHandler: public IRtmEventHandler {
    void onMessageEvent(const MessageEvent &event) override{
        printf("onMessageEvent");
...
```dart tab="Dart" tabGroup="rtm-build-manage-messages-serialized-7"
// TODO Flutter 请根据上面其他语言的示例代码，提供 Dart 的示例代码
