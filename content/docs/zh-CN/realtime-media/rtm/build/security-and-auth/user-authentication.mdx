---
title: "客户端鉴权"
description: "了解实时消息 RTM 在不同平台上的客户端鉴权方式，包括接入流程、关键配置和平台差异。"
---
<PlatformStructured platform="android">

用户在使用声网服务，如加入音视频通话或登录信令系统时，声网使用 Token 对其鉴权。
...
本文展示如何搭建一个使用 RTM Token 鉴权的客户端。使用 RTC Token 请参考[使用 RTC Token 鉴权](/zh-CN/realtime-media/rtc/build/setup-and-access/token-authentication)。

## 鉴权流程

下图展示了 RTM Token 鉴权的基本流程：

![Token 流程](https://web-cdn.agora.io/docs-portal/img/rtm2/token-authentication.svg)
...
- 已开启 App 证书的声网项目以及项目的 App ID，可参考[开通 RTM 服务](/zh-CN/realtime-media/rtm/build/setup-and-access/enable-service)获取。
...
![Token 流程](https://web-cdn.agora.io/docs-portal/img/rtm2/token-authentication-javascript.svg)
