...
本文展示如何搭建一个使用 RTM Token 鉴权的客户端。使用 RTC Token 请参考[使用 RTC Token 鉴权](/zh-CN/realtime-media/rtc/build/security-and-auth/token-authentication)。
...
- 已开启 App 证书的声网项目以及项目的 App ID，可参考[开通服务](/zh-CN/realtime-media/rtm/build/setup-and-access/enable-service)获取。
