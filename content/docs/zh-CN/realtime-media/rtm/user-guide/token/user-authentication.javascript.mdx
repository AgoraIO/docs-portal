...
本文展示如何搭建一个使用 RTM Token 鉴权的客户端。使用 RTC Token 请参考[使用 RTC Token 鉴权](/zh-CN/realtime-media/rtc/basic-features/token-authentication.javascript)。
...
- 已在你的项目中集成实时消息 SDK 并实现基本的收发消息功能，详见[实现收发消息](/zh-CN/realtime-media/rtm/get-started/quick-start.javascript)。
