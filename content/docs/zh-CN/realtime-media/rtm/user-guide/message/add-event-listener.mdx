...
完成事件监听处理程序后，你可以通过订阅频道或 Topic 来接收指定的 Message Channel 或 Stream Channel 中的消息和事件通知了。详见[订阅 Message Channel](/zh-CN/realtime-media/rtm/user-guide/channel/message-channel#订阅频道) 和[订阅 Topic](/zh-CN/realtime-media/rtm/user-guide/topic/usage#订阅-topic)。
