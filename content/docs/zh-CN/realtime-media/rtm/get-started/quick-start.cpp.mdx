...
开始构建项目前，你需要完成[开通服务](/zh-CN/realtime-media/rtm/get-started/enable-service)，并检查你的开发环境是否满足[平台支持](/zh-CN/realtime-media/rtm/overview/platform-support.cpp)中的最低版本要求。
