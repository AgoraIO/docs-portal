...
开始构建项目前，你需要完成[开通服务](/zh-CN/realtime-media/rtm/get-started/enable-service)，并检查你的开发环境是否满足[平台支持](/zh-CN/realtime-media/rtm/overview/platform-support)中的最低版本要求。
...
开始构建项目前，你需要完成[开通服务](/zh-CN/realtime-media/rtm/get-started/enable-service)，并检查你的浏览器是否满足[平台支持](/zh-CN/realtime-media/rtm/overview/platform-support)中的最低版本要求。
...
开始构建项目前，你需要完成[开通服务](/zh-CN/realtime-media/rtm/get-started/enable-service)，并检查你的开发环境和运行环境是否满足如下要求：
...
你也可以使用 `JSON` 或 `Protobuf` 等方式来构建你的负载结构以便于简化业务逻辑，此部分内容可以参考[消息负载序列化](/zh-CN/realtime-media/rtm/user-guide/message/serialized)。但请记住在把消息负载转交给 RTM 发送前，需要对消息负载进行序列化。
...
你可以通过调用 `SubscribeTopicAsync` 方法订阅某个 Topic 中的一位或多位消息发布者以便于接收他们发送的消息。单个客户端在单个 Topic 中最多只能订阅 64 个消息发布者，详见 [API 使用限制](/zh-CN/realtime-media/rtm/user-guide/setup/api-limits)。
...
开始构建项目前，你需要完成[开通服务](/zh-CN/realtime-media/rtm/get-started/enable-service)，并检查你的开发环境和运行环境是否满足[平台支持](/zh-CN/realtime-media/rtm/overview/platform-support)中的最低版本要求。
