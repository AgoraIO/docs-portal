...
开始构建项目前，你需要完成[开通服务](/zh-CN/realtime-media/rtm/build/setup-and-access/enable-service)，并检查你的开发环境是否满足[平台支持](/zh-CN/realtime-media/rtm/reference/platform-support)中的最低版本要求。
...
开始构建项目前，你需要完成[开通服务](/zh-CN/realtime-media/rtm/build/setup-and-access/enable-service)，并检查你的浏览器是否满足[平台支持](/zh-CN/realtime-media/rtm/reference/platform-support)中的最低版本要求。
...
开始构建项目前，你需要完成[开通服务](/zh-CN/realtime-media/rtm/build/setup-and-access/enable-service)，并检查你的开发环境和运行环境是否满足如下要求：
...
开始构建项目前，你需要完成[开通服务](/zh-CN/realtime-media/rtm/build/setup-and-access/enable-service)，并检查你的开发环境和运行环境是否满足[平台支持](/zh-CN/realtime-media/rtm/reference/platform-support)中的最低版本要求。
