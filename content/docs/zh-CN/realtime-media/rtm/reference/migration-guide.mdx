...
如果你没有声网账号，点击[此处](https://sso.shengwang.cn/cn/v4/signup/with-sms)注册账号。关于如何开通服务和如何创建项目，详见[开通服务](/zh-CN/realtime-media/rtm/build/setup-and-access/enable-service)。
