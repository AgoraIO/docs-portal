...
- 参考[开始录制音视频](/zh-CN/realtime-media/local-server-recording/get-started/start-recording)在你的项目中集成录制 SDK 并实现基础的录制功能。
...
你也可以直接前往声网控制台获取临时 Token 来调试你的项目，详见[获取临时 Token](/zh-CN/realtime-media/local-server-recording/build/recording-preparation/enable-service#获取临时-token)。
