...
开始前请确保你已经完成[集成录制 SDK](/zh-CN/realtime-media/local-server-recording/build/implement-core-features/legacy/integrate-sdk)。
...
- 如果想了解如何通过命令行录制，可以参考[使用命令行录制](/zh-CN/realtime-media/local-server-recording/build/implement-core-features/legacy/record-by-cmd)。
...
开始前请确保你已经完成[集成录制 SDK](/zh-CN/realtime-media/local-server-recording/build/implement-core-features/legacy/integrate-sdk)，并将以下文件复制到你的项目：
