...
录制 SDK 提供了一个 [`setVideoMixingLayout`](/zh-CN/api-reference/local-server-recording/java/agoramediartcrecorder.java#setvideomixinglayout) 方法用来设置合流布局，通过对 `VideoMixingLayout` 对象的定义，来设置合流画布和参与合流的用户的视窗：
...
录制 SDK 提供了一个 [`setVideoMixingLayout`](/zh-CN/api-reference/local-server-recording/cpp/iagoramediartcrecorder.cpp#setvideomixinglayout) 方法用来设置合流布局，通过对 `VideoMixingLayout` 结构体的定义，来设置合流画布和参与合流的用户的视窗：
