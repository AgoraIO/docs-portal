---
title: "收集崩溃日志"
description: "了解如何在本地服务端录制中收集崩溃日志，包括适用场景、配置步骤、实现要点和注意事项。"
---
## 实现方法

声网建议你在集成本地服务端录制前，使用我们提供的 enable_coredump.sh 脚本开启系统 core dump 功能，以便在后续录制出现问题时，能够快速调查和定位问题，提高问题解决效率。
...
| `--privileged=true`                 | 允许录制进程生成 core dump 文件 |
