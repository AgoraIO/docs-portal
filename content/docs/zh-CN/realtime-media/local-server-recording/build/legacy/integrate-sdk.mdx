...
你可参考上述云主机配置和对应的录制性能，根据自己的录制需要选择和配置云主机，详见[使用云容器部署录制 SDK](/zh-CN/realtime-media/local-server-recording/build/legacy/docker)。
...
- [使用命令行录制](/zh-CN/realtime-media/local-server-recording/build/legacy/record-by-cmd)
- [调用 API 录制](/zh-CN/realtime-media/local-server-recording/build/legacy/record-by-api)
