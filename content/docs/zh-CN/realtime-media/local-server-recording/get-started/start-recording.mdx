...
调用 [`createMediaRtcRecorder`](/zh-CN/api-reference/local-server-recording/java/agoraservice.java#createmediartcrecorder) 创建录制实例，然后使用 [`AgoraMediaRtcRecorder.initialize`](/api-ref/recording/java/agoramediartcrecorder#initialize) 方法初始化录制实例。
