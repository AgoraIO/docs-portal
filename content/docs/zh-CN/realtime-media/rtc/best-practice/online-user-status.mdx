...
开始前，请确保你的声网项目已经开启了消息通知服务。详见[接收 Webhook 事件](/zh-CN/realtime-media/rtc/webhook/receive_webhook)。
...
1. 开通声网消息通知服务，根据频道场景，至少监听以下频道事件回调：
   ...
   - [`103`](/zh-CN/realtime-media/rtc/webhook/events#103-broadcaster-join-channel)
   - [`105`](/zh-CN/realtime-media/rtc/webhook/events#105-audience-join-channel)
   - [`106`](/zh-CN/realtime-media/rtc/webhook/events#106-audience-leave-channel)
   - [`111`](/zh-CN/realtime-media/rtc/webhook/events#111-client-role-change-to-broadcaster)
   - [`112`](/zh-CN/realtime-media/rtc/webhook/events#112-client-role-change-to-audience)
