...
- 本文档仅适用于 SDK 大于等于 v4.5.2.9 且小于 v4.6.0 的版本。
  - 如果你的 SDK 版本大于或等于 v4.6.0，你可以参考[高级美颜-4.6.x](/zh-CN/realtime-media/rtc/advanced-features/advanced-beauty-460.windows.android)了解如何使用适用于 v4.6.0 及以上版本的高级美颜 2.0 API。
  - 如果你的 SDK 版本小于 v4.5.2.9，你可以参考[高级美颜（Legacy）](/zh-CN/realtime-media/rtc/advanced-features/advanced-beauty-legacy.android)了解如何使用美颜 1.0 API。
:::
...
:::info[信息]
目前美颜 2.1 API 不支持对美型部位进行参数设置或参数获取，需要使用美颜 1.0 的 API 来设置或获取参数，详见[微调美型部位](/zh-CN/realtime-media/rtc/advanced-features/advanced-beauty-legacy.android#微调单个部位)。
:::
