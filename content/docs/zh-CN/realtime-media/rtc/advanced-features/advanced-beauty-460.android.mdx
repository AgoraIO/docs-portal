...
- 如果你的 SDK 版本小于 v4.6.0，你可以参考[高级美颜（Legacy）](/zh-CN/realtime-media/rtc/advanced-features/advanced-beauty-legacy.android)了解如何使用美颜 1.0 API。
:::
...
- 已在应用中实现基本的实时音视频功能。详见[实现音视频互动](/zh-CN/realtime-media/rtc/get-started/quick-start.android)。
...
:::info[信息]
目前美颜 2.0 API 不支持对美型进行参数设置或参数获取，需要使用美颜 1.0 的 API 来设置或获取参数，详见[微调美型部位](/zh-CN/realtime-media/rtc/advanced-features/advanced-beauty-legacy.android#微调单个部位)。
:::
