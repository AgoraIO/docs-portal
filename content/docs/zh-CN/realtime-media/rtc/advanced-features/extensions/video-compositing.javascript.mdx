...
- 屏幕共享视频轨道。
- 两张本地图片。
- 源视频轨道 1：通过摄像头采集的视频流创建，并且使用[虚拟背景插件](/zh-CN/realtime-media/rtc/advanced-features/extensions/virtual-background.javascript)移除该轨道的背景。
- 源视频轨道 2：通过本地视频文件创建。
...
1. 集成虚拟背景插件并了解注意事项。具体请参考[使用虚拟背景插件](/zh-CN/realtime-media/rtc/advanced-features/extensions/virtual-background.javascript)。
