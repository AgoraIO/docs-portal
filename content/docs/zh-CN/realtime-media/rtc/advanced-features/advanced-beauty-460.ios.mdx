...
- 如果你的 SDK 版本小于 v4.6.0，你可以参考[高级美颜（Legacy）](/zh-CN/realtime-media/rtc/advanced-features/advanced-beauty-legacy.ios.ios)了解如何使用美颜 1.0 API。
:::
...
:::info[信息]
目前美颜 2.0 API 不支持对美型进行参数设置或参数获取，需要使用美颜 1.0 的 API 来设置或获取参数，详见[微调美型部位](/zh-CN/realtime-media/rtc/advanced-features/advanced-beauty-legacy.ios.ios#微调单个部位)。
:::
