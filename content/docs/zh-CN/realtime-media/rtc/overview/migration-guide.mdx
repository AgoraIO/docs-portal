...
声网 SDK v4.x 是一个新的 SDK 版本，可帮助用户将实时音视频功能集成到 App 中。在大规模的实时互动场景下，你可以用它实现更好的实时互动效果，详见[产品概述](/zh-CN/realtime-media/rtc/overview/product-overview)。
...
参考[建立项目](/zh-CN/realtime-media/rtc/get-started/quick-start#建立项目)，将 v4.x SDK 集成到你的项目中。
...
- Web SDK 4.x 中，`subscribe` 是异步操作，会返回 Promise。传入的参数为 `remoteUser`，也就是远端用户对象，详见 [`AgoraRTCRemoteUser`](/api-ref/rtc/javascript/interfaces/iagorartcremoteuser.html)。
...
- `getScreenSources` 更名为 [`getElectronScreenSources`](/api-ref/rtc/javascript/interfaces/iagorartc.html#getelectronscreensources)，并且移除了回调参数，现在会返回一个 Promise。
- [`getDevices`](/api-ref/rtc/javascript/interfaces/iagorartc.html#getdevices) 现在会返回一个 Promise，同时新增 [`getCameras`](/api-ref/rtc/javascript/interfaces/iagorartc.html#getcameras) 和 [`getMicrophones`](/api-ref/rtc/javascript/interfaces/iagorartc.html#getmicrophones)。
- 移除 `Logger` 对象，增加 [`disableLogUpload`](/api-ref/rtc/javascript/interfaces/iagorartc.html#disablelogupload)、[`enableLogUpload`](/api-ref/rtc/javascript/interfaces/iagorartc.html#enablelogupload) 和 [`setLogLevel`](/api-ref/rtc/javascript/interfaces/iagorartc.html#setloglevel) 用于控制日志上报和打印行为。
- 移除 `createStream`，新增以下方法创建音视频对象：
  - [`createMicrophoneAudioTrack`](/api-ref/rtc/javascript/interfaces/iagorartc.html#createmicrophoneaudiotrack): 创建麦克风轨道
  - [`createCameraVideoTrack`](/api-ref/rtc/javascript/interfaces/iagorartc.html#createcameravideotrack): 创建摄像头轨道
  - [`createScreenVideoTrack`](/api-ref/rtc/javascript/interfaces/iagorartc.html#createscreenvideotrack): 创建屏幕共享轨道
  - [`createBufferSourceAudioTrack`](/api-ref/rtc/javascript/interfaces/iagorartc.html#createbuffersourceaudiotrack): 创建音频文件轨道（用于混音）
  - [`createCustomAudioTrack`](/api-ref/rtc/javascript/interfaces/iagorartc.html#createcustomaudiotrack) 和 [`createCustomVideoTrack`](/api-ref/rtc/javascript/interfaces/iagorartc.html#createcustomvideotrack): 创建自定义音视频轨道（用于自采集）

### Client

- 移除 `Client.init`
- 移除 `Client.getConnectionState`，新增 [`Client.connectionState`](/api-ref/rtc/javascript/interfaces/iagorartcclient.html#connectionstate) 字段表示当前和服务器的连接状态
- [`ConnectionState`](/api-ref/rtc/javascript/globals.html#connectionstate) 中新增状态 `RECONNECTING` 表示当前正在重连，原来的 `CONNECTING` 仅表示首次正在建立连接
- 新增 [`Client.uid`](/api-ref/rtc/javascript/interfaces/iagorartcclient.html#uid) 来表示当前本地用户的用户 ID
- 新增 [`Client.remoteUsers`](/api-ref/rtc/javascript/interfaces/iagorartcclient.html#remoteusers) 来表示当前远端用户的用户列表
...
- 移除 [`Client.enableDualStream`](/api-ref/rtc/javascript/interfaces/iagorartcclient.html#enabledualstream) 和 [`Client.disableDualStream`](/api-ref/rtc/javascript/interfaces/iagorartcclient.html#disabledualstream) 的回调参数，现在会返回 Promise
- 移除 `Client.getCameras`, `Client.getDevices`, `Client.getRecordingDevices`, 现在这些方法被移动到 `AgoraRTC` 下
- 移除 `Client.getPlayoutDevices`
- 移除 `Client.getLocalAudioStats`、`Client.getLocalVideoStats`、`Client.getRemoteAudioStats`、`Client.getRemoteVideoStats`，现在音视频媒体统计数据统一通过 [`LocalAudioTrack.getStats`](/api-ref/rtc/javascript/interfaces/ilocalaudiotrack.html#getstats)、[`LocalVideoTrack.getStats`](/api-ref/rtc/javascript/interfaces/ilocalvideotrack.html#getstats)、[`RemoteAudioTrack.getStats`](/api-ref/rtc/javascript/interfaces/iremoteaudiotrack.html#getstats)、[`RemoteVideoTrack.getStats`](/api-ref/rtc/javascript/interfaces/iremotevideotrack.html#getstats) 这些方法来获取，同时字段都做了改变，具体参阅 API 文档
- 移除 `Client.getSystemStats`
- 移除 `Client.getSessionStats` 和 `Client.getTransportStats`，现在使用一个方法统一获取这些状态 [`Client.getRTCStats`](/api-ref/rtc/javascript/interfaces/iagorartcclient.html#getrtcstats)
- [`Client.join`](/api-ref/rtc/javascript/interfaces/iagorartcclient.html#join) 现在会返回一个 Promise，移除回调参数，增加 `appid` 参数
- [`Client.leave`](/api-ref/rtc/javascript/interfaces/iagorartcclient.html#leave) 现在会返回一个 Promise，移除回调参数
- 增加 [`Client.once`](/api-ref/rtc/javascript/interfaces/iagorartcclient.html#once) 只监听目标事件一次
- 增加 [`Client.removeAllListeners`](/api-ref/rtc/javascript/interfaces/iagorartcclient.html#removealllisteners) 用于删除所有事件监听
- [`Client.publish`](/api-ref/rtc/javascript/interfaces/iagorartcclient.html#publish) 现在需要传入 [`LocalTrack`](/api-ref/rtc/javascript/interfaces/ilocaltrack.html) 的列表，现在会返回一个 Promise，同时移除 `Client.on("stream-published")` 回调。
- [`Client.unpublish`](/api-ref/rtc/javascript/interfaces/iagorartcclient.html#publish) 现在会返回一个 Promise
- [`Client.subscribe`](/api-ref/rtc/javascript/interfaces/iagorartcclient.html#subscribe) 现在使用 [`AgoraRTCRemoteUser`](/api-ref/rtc/javascript/interfaces/iagorartcremoteuser.html) 作为参数，返回一个 Promise，移除 `Client.on("stream-subscribed")`
- [`Client.unsubscribe`](/api-ref/rtc/javascript/interfaces/iagorartcclient.html#unsubscribe) 现在使用 [`AgoraRTCRemoteUser`](/api-ref/rtc/javascript/interfaces/iagorartcremoteuser.html) 作为参数，返回一个 Promise
- [`Client.renewToken`](/api-ref/rtc/javascript/interfaces/iagorartcclient.html#renewtoken) 现在会返回一个 Promise
- [`Client.setClientRole`](/api-ref/rtc/javascript/interfaces/iagorartcclient.html#setclientrole) 移除回调参数，现在会返回一个 Promise。**设置角色为 `audience` 后 SDK 不会自动 `unpublish`，调用 `publish` 时也不会自动把角色设置成 `host`**
- 移除 `Client.setEncryptionMode` 和 `Client.setEncryptionSecret`，现在通过一个方法 [`Client.setEncryptionConfig`](/api-ref/rtc/javascript/interfaces/iagorartcclient.html#setencryptionconfig) 来配置
- [`Client.setLiveTranscoding`](/api-ref/rtc/javascript/interfaces/iagorartcclient.html#setlivetranscoding)、[`Client.startLiveStreaming`](/api-ref/rtc/javascript/interfaces/iagorartcclient.html#startlivestreaming) 和 [`Client.stopLiveStreaming`](/api-ref/rtc/javascript/interfaces/iagorartcclient.html#stoplivestreaming) 现在都会返回 Promise，同时移除 `Client.on("liveTranscodingUpdated")`、`Client.on("liveStreamingStarted")`、`Client.on("liveStreamingFailed")` 和 `Client.on("liveStreamingStopped")` 事件
- [`Client.startChannelMediaRelay`](/api-ref/rtc/javascript/interfaces/iagorartcclient.html#startchannelmediarelay) 现在会返回一个 Promise
  - [`ChannelMediaRelayConfiguration`](/api-ref/rtc/javascript/interfaces/ichannelmediarelayconfiguration.html) 移除 `setDestChannelInfo`, 改为 [`addDestChannelInfo`](/api-ref/rtc/javascript/interfaces/ichannelmediarelayconfiguration.html#adddestchannelinfo) 并去除冗余参数，具体参考 API 文档
  - [`ChannelMediaRelayConfiguration`](/api-ref/rtc/javascript/interfaces/ichannelmediarelayconfiguration.html) 去除了 [`setSrcChannelInfo`](/api-ref/rtc/javascript/interfaces/ichannelmediarelayconfiguration.html#setsrcchannelinfo) 的冗余参数
- [`Client.stopChannelMediaRelay`](/api-ref/rtc/javascript/interfaces/iagorartcclient.html#stopchannelmediarelay) 现在会返回一个 Promise
- [`Client.updateChannelMediaRelay`](/api-ref/rtc/javascript/interfaces/iagorartcclient.html#updatechannelmediarelay) 移除回调参数，现在会返回一个 Promise
- 移除 `Client.on("first-video-frame-decode")` 和 `Client.on("first-audio-frame-decode")`，现在这两个事件通过 [`RemoteTrack.on("first-frame-decode")`](/api-ref/rtc/javascript/interfaces/iremotetrack.html#event_first_frame_decoded) 触发
- 移除 `Client.on("active-speaker")` 事件，相同的功能由 [`Client.on("volume-indicator")`](/api-ref/rtc/javascript/interfaces/iagorartcclient.html#event_volume_indicator) 提供
- `Client.on("onTokenPrivilegeWillExpire")` 和 `Client.on("onTokenPrivilegeDidExpire")` 更名为 [`Client.on("token-privilege-will-expire")`](/api-ref/rtc/javascript/interfaces/iagorartcclient.html#event_token_privilege_will_expire) 和 [`Client.on("token-privilege-did-expire")`](/api-ref/rtc/javascript/interfaces/iagorartcclient.html#event_token_privilege_did_expire)
- 移除 `Client.on("network-type-changed")` 事件， SDK 无法保证其可靠性
- 移除 `Client.on("connected")` 和 `Client.on("reconnect")` 事件，连接状态事件统一从 [`Client.on("connection-state-change")`](/api-ref/rtc/javascript/interfaces/iagorartcclient.html#event_connection_state_change) 获取
- [`Client.on("stream-fallback")`](/api-ref/rtc/javascript/interfaces/iagorartcclient.html#event_stream_fallback) 参数修改，增加 `isFallbackOrRecover` 参数，详见 API 文档
...
- 启用或禁用本地音视频：4.x 以 [`ILocalTrack.setEnabled`](/api-ref/rtc/javascript/interfaces/ilocalaudiotrack.html#setenabled) 取代 3.x 的 `Stream.muteAudio` 和 `Stream.muteVideo`，用于实现启用或禁用本地轨道。有以下行为变更：
...
- 设置媒体设备：
  - 4.x 以 [`IMicrophoneAudioTrack.setDevice`](/api-ref/rtc/javascript/interfaces/imicrophoneaudiotrack.html#setdevice) 和 [`ICameraVideoTrack.setDevice`](/api-ref/rtc/javascript/interfaces/icameravideotrack.html#setdevice) 取代 3.x 的 `Stream.switchDevice`，用于设置媒体输入设备。
  - 4.x 以 [`IRemoteAudioTrack.setPlaybackDevice`](/api-ref/rtc/javascript/interfaces/iremoteaudiotrack.html#setplaybackdevice) 取代 3.x 的 `Stream.setAudioOutput`，用于设置音频输出设备。

</PlatformStructured>

<PlatformStructured platform="windows">

声网 SDK v4.x 是一个新的 SDK 版本，可帮助用户将实时音视频功能集成到 App 中。在大规模的实时互动场景下，你可以用它实现更好的实时互动效果，详见[产品概述](/zh-CN/realtime-media/rtc)。
...
参考[创建项目](/zh-CN/realtime-media/rtc/get-started/quick-start#建立项目)，将 v4.x SDK 集成到你的项目中。
...
`agora_rtc_engine: ^6.0.0` 基于声网 RTC SDK v4.0.0，可帮助你将实时音视频功能集成到 App 中。在大规模的实时互动场景下，你可以用它实现更好的实时互动效果，详见[产品概述](/zh-CN/realtime-media/rtc)。
...
参考[建立项目](/zh-CN/realtime-media/rtc/get-started/quick-start#创建-flutter-项目)，将 agora_rtc_engine: ^6.0.0 SDK 集成到你的项目中。
...
- `joinChannel` 方法移除 `info` 参数，新增 `options` 参数，详见 [`joinChannel`](/api-ref/rtc/flutter/API/toc_channel#api_irtcengine_joinchannel2) 方法。
