...
参考[建立项目](/zh-CN/realtime-media/rtc/get-started/quick-start.rn)，将 v4.0.0 SDK 集成到你的项目中。
...
从 v4.0.0 Beta 升级至 v4.0.0 后，SDK 包名由 `react-native-agora` 变更为 `react-native-agora`，详见 [集成 SDK](/zh-CN/realtime-media/rtc/get-started/quick-start.rn#集成-sdk)。
