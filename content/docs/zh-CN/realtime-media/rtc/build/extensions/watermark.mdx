---
title: "水印插件（Beta 版）"
description: "了解如何在实时互动 RTC 中水印插件（Beta 版），包括适用场景、配置步骤、实现要点和注意事项。"
---
## 使用水印插件（Beta 版）

水印插件可以与 Web SDK (v4.24.0 或以上) 搭配使用，用于在视频流中添加图像水印。

该插件支持自定义水印的位置、大小、透明度等属性，可以应用于本地视频轨道和远端视频轨道。
...
- 已集成 v4.24.0 或以上版本的 Web SDK，实现基础的实时音视频互动功能，具体参考[快速开始](../../get-started/quick-start?platform=web)文档。
