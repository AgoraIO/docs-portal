---
title: "AI 画质插件（Beta 版）"
description: "了解如何在实时互动 RTC 中 AI 画质插件（Beta 版），包括适用场景、配置步骤、实现要点和注意事项。"
---
# 使用 AI 画质插件（Beta 版）

AI 画质插件封装了声网自研的 AI 画质增强算法，可以在不改变分辨率的条件下智能提升视频画质，优化接收端的观看体验。

AI 画质增强算法对移动端机型的覆盖率达到 95% 以上，并且在低端机上也能保证较大分辨率视频的渲染画质。
