...
- [`multipathStats`](/zh-CN/api-reference/rtc/ios/network#callback_irtcengineeventhandler_onmultipathstats)
...
- [`multipathStats`](/zh-CN/api-reference/rtc/macos/network#callback_irtcengineeventhandler_onmultipathstats)
