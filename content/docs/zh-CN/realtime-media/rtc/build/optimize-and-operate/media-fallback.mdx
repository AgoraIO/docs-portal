...
- [`AgoraRTCClient.enableDualStream`](/zh-CN/api-reference/rtc/web/interfaces/iagorartcclient#enabledualstream)
- [`AgoraRTCClient.setStreamFallbackOption`](/zh-CN/api-reference/rtc/web/interfaces/iagorartcclient#setstreamfallbackoption)
- [`AgoraRTCClient.setRemoteVideoStreamType`](/zh-CN/api-reference/rtc/web/interfaces/iagorartcclient#setremotevideostreamtype)
