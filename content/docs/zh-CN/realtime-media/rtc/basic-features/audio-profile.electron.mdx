...
在实现设置音频编码属性和应用场景前，请确保已在你的项目中实现基本的实时音视频功能。详见[实现音视频互动](/zh-CN/realtime-media/rtc/get-started/quick-start.electron)。
...
- [实现高音质](/zh-CN/realtime-media/rtc/best-practice/optimal-audio-quality.android.electron)
