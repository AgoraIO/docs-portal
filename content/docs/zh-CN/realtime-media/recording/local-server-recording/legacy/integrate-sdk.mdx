...
你可参考上述云主机配置和对应的录制性能，根据自己的录制需要选择和配置云主机，详见[使用云容器部署录制 SDK](/zh-CN/realtime-media/recording/local-server-recording/legacy/docker)。

## 下载 SDK

前往[资源中心](/zh-CN/realtime-media/recording/local-server-recording/resources)获取最新的声网本地服务端录制 SDK 软件包。软件包内容如下：
...
2. 安装编译器：gcc 4.4+。
3. 如果你的网络环境设置了防火墙限制外网访问，请使用[云代理服务](/zh-CN/realtime-media/recording/local-server-recording/user-guides/cloud-proxy)。
...
4. 如果你的网络环境设置了防火墙限制外网访问，请使用[云代理服务](/zh-CN/realtime-media/recording/local-server-recording/user-guides/cloud-proxy)。
...
- [使用命令行录制](/zh-CN/realtime-media/recording/local-server-recording/legacy/record-by-cmd)
- [调用 API 录制](/zh-CN/realtime-media/recording/local-server-recording/legacy/record-by-api.cpp)
