...
- 下载[录制 SDK](/zh-CN/realtime-media/recording/local-server-recording/resources)。
...
- 启动参数：录制的具体设置，可以参考[设置录制选项](/zh-CN/realtime-media/recording/local-server-recording/legacy/record-by-cmd#设置录制格式)。
