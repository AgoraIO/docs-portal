...
- [单流录制和合流录制](/zh-CN/realtime-media/recording/local-server-recording/user-guides/recording-mode)
- [自定义合流录制视频布局](/zh-CN/realtime-media/recording/local-server-recording/user-guides/set-layout)
- [配置水印](/zh-CN/realtime-media/recording/local-server-recording/user-guides/watermark)
...
4. 按照场景需要填写 `recorder.json`（合流录制的配置文件）或 `singleVideo.json`（单流录制的配置文件）。单流和合流的场景区别可以参考[单流录制和合流录制](/zh-CN/realtime-media/recording/local-server-recording/user-guides/recording-mode)。
...
1. 前往[下载](/zh-CN/realtime-media/recording/local-server-recording/resources)获取最新的声网本地服务端录制 SDK 软件包。
