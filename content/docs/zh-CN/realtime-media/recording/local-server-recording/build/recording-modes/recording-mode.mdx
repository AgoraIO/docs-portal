...
开始前，请确保你已参考[快速开始](/zh-CN/realtime-media/recording/local-server-recording/get-started/start-recording)集成了录制 SDK，并实现了极简的录制功能。
...
- [设置合流布局](/zh-CN/realtime-media/recording/local-server-recording/build/recording-modes/set-layout)
