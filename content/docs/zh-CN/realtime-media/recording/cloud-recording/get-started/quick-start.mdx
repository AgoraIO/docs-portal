...
参考[开通服务](/zh-CN/realtime-media/recording/cloud-recording/get-started/enable-service)在声网控制台开通云端录制，并复制保存如下参数，以供后续使用：
...
有关录制文件的详细信息，请参考[录制文件介绍](/zh-CN/realtime-media/recording/cloud-recording/user-guides/manage-file/introduce-recorded-files)。
