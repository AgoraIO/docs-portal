---
title: "在线播放"
description: "了解如何在云端录制中在线播放，包括适用场景、配置步骤、实现要点和注意事项。"
---
## 功能描述

使用声网云端录制服务完成录制后，录制的内容会以 TS 文件形式上传到你设定的第三方云存储中，同时生成一个 M3U8 文件用于索引所有的 TS 文件。

你可以在你的第三方云存储中获得该 M3U8 文件的链接，直接在线播放录制文件。
...
开始前，请参考[使用 RESTful API 开始云端录制](/zh-CN/realtime-media/recording/cloud-recording/get-started/quick-start)进行一次完整的录制流程体验，并且确保录制文件已上传到你设定的第三方云存储中。
