---
title: "实现 HTTP 基本认证"
description: "了解如何在弹幕玩法中 HTTP 基本认证，包括适用场景、配置步骤、实现要点和注意事项。"
---
本文介绍如何进行 HTTP 基本认证。

## 前提条件

已经从声网控制台获取客户 ID 和客户密钥，详见[开通弹幕服务](/zh-CN/realtime-media/danmaku/build/setup-and-access/enable-service)。
