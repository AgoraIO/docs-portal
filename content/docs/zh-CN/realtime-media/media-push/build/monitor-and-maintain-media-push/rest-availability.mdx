...
对于频道内观众较多或关键性业务场景，你需要根据业务重要性和自动迁移时效，评估是否采用更高等级的保障措施。例如，准备[多路推流任务保障](/zh-CN/realtime-media/media-push/build/monitor-and-maintain-media-push/rest-availability)以应对迁移期间的快速切换，或采用[退避重试策略](/zh-CN/realtime-media/media-push/build/monitor-and-maintain-media-push/rest-availability)主动迁移以减少迁移时间。
