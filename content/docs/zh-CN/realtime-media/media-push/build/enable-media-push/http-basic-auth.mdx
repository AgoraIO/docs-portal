---
title: "实现 HTTP 基本认证"
description: "了解如何在旁路推流中 HTTP 基本认证，包括适用场景、配置步骤、实现要点和注意事项。"
---
## 前提条件

本文介绍如何进行 HTTP 基本认证。

已经从声网控制台获取客户 ID 和客户密钥，详见[开通服务](/zh-CN/realtime-media/media-push/build/enable-media-push/enable-service)。
