...
参考[开通服务](/zh-CN/realtime-media/rtc-server-sdk/build/enable-service)获取声网 App ID 和 RTC 临时 Token。
...
- 一个有效的声网账号以及声网项目。请参考[开通服务](/zh-CN/realtime-media/rtc-server-sdk/build/enable-service)从声网控制台获得 App ID。
