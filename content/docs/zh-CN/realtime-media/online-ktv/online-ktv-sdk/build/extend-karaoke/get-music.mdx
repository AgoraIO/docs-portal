...
- 已实现基本的在线 K 歌逻辑，详情请参考[快速实现](/zh-CN/realtime-media/online-ktv/online-ktv-sdk/get-started/karaoke)。
- 已联系[技术支持](https://ticket.shengwang.cn)开通版权音乐权限。
- 有效的声网项目，详情请参考[开通服务](/zh-CN/realtime-media/online-ktv/online-ktv-sdk/build/setup-and-access/enable-service)。
...
2. 获取歌曲列表
   ...
   根据你的需求调用不同的 RESTful API 来获取歌曲列表、热门榜单等。调用说明及示例详见 [API 文档](/zh-CN/realtime-media/online-ktv/online-ktv-sdk/reference/music-content-center)。
...
获取版权音乐后，你可以参考[实现文档](/zh-CN/realtime-media/online-ktv/online-ktv-sdk/get-started/karaoke)实现其他 K 歌功能。

## API 参考

本节介绍获取版权音乐使用的 API：

- [实时互动 SDK API](/zh-CN/realtime-media/online-ktv/online-ktv-sdk/reference/rtc-api)
...
- [快速实现](/zh-CN/realtime-media/online-ktv/online-ktv-sdk/get-started/karaoke)
- [歌词打分组件](/zh-CN/realtime-media/online-ktv/online-ktv-sdk/reference/lyrics-api)
- [歌词强同步](/zh-CN/realtime-media/online-ktv/online-ktv-sdk/build/extend-karaoke/lyrics-syncing)
