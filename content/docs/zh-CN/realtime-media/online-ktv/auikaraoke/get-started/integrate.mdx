...
- [AUIKaraoke Kotlin API](/zh-CN/realtime-media/online-ktv/auikaraoke/api/auikaraoke-api)
...
- 你的声网项目的 App ID、App 证书，以及环信项目的 APPKEY、Client ID 以及 Client Secret，如何获取请参考[开通服务](/zh-CN/realtime-media/online-ktv/auikaraoke/get-started/enable-service)
...
- [AUIKaraoke Swift API](/zh-CN/realtime-media/online-ktv/auikaraoke/api/auikaraoke-api)
