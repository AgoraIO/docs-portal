...
title: "独唱"
---
本文介绍如何实现独唱。在此之前，请确保你已参考[实现文档](/zh-CN/realtime-media/online-ktv/ktv-scenario/get-started/integrate-ktvapi.ios)集成 KTV API。
...
- [抢唱方案](/zh-CN/realtime-media/online-ktv/ktv-scenario/implementation/gaming.ios)
- [接唱方案](/zh-CN/realtime-media/online-ktv/ktv-scenario/implementation/relay.ios)
