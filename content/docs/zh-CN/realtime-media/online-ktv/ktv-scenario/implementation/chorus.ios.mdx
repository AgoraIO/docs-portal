...
title: "合唱"
---
本文介绍如何实现合唱。在此之前，请确保你已参考[实现文档](/zh-CN/realtime-media/online-ktv/ktv-scenario/get-started/integrate-ktvapi.ios)集成 KTV API。
...
:::warning[注意]
如需加载声网提供的版权音乐，请参考[获取版权音乐](/zh-CN/realtime-media/online-ktv/ktv-scenario/advanced-features/get-music.ios)。
:::
...
- [歌词打分组件](/zh-CN/realtime-media/online-ktv/ktv-scenario/api/lyrics-api.ios)
