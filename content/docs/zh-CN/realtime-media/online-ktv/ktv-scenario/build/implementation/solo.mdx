...
本文介绍如何实现独唱。在此之前，请确保你已参考[实现文档](/zh-CN/realtime-media/online-ktv/ktv-scenario/get-started/integrate-ktvapi)集成 KTV API。
...
- [合唱方案](/zh-CN/realtime-media/online-ktv/ktv-scenario/build/implementation/chorus)
