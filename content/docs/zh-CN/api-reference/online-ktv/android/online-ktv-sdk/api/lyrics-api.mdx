...
_migration:
  type: manual-mdx
  status: warning
  sourceUrl: https://doc.shengwang.cn/doc/online-ktv/android/online-ktv-sdk/api/lyrics-api
  sourcePath: docs/online-ktv/online-ktv-sdk/api/lyrics-api.android.mdx
