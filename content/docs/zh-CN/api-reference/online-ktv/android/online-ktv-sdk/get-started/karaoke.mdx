...
_migration:
  type: manual-mdx
  status: warning
  sourceUrl: https://doc.shengwang.cn/doc/online-ktv/android/online-ktv-sdk/get-started/karaoke
  sourcePath: docs/online-ktv/online-ktv-sdk/get-started/karaoke.android.mdx
...
:::info[信息]
如果你想简化集成步骤，请参考[场景化 API 解决方案](/zh-CN/api-reference/online-ktv/android/ktv-scenario/get-started/integrate-ktvapi)。
:::
...
6. 主唱在唱歌的同时，调用 `sendStreamMessage` 方法将当前歌曲播放进度同步到房间内所有用户。合唱者和听众可以结合歌词组件实现歌词同步显示，并自定义歌词界面，详见[歌词组件](/zh-CN/api-reference/online-ktv/android/online-ktv-sdk/advanced-features/lyrics-scoring)。
...
5. 合唱者通过 `onStreamMessage` 回调接收主唱发送的数据流，实现歌曲同步。同时结合歌词组件实现歌词同步显示，并自定义歌词界面，详见[歌词组件](/zh-CN/api-reference/online-ktv/android/online-ktv-sdk/advanced-features/lyrics-scoring)。
...
| 声网歌词打分组件 | [源码](https://github.com/AgoraIO-Community/LyricsView/tree/main) | [歌词组件](/zh-CN/api-reference/online-ktv/android/online-ktv-sdk/advanced-features/lyrics-scoring) |
...
| API | 实现功能 |
| --- | --- |
| `setClientRole` | <Slot name="karaoke-android-markdown-4-1-1" /> |

<Slot for="karaoke-android-markdown-4-1-1">
...
参考[获取版权音乐](/zh-CN/api-reference/online-ktv/android/online-ktv-sdk/advanced-features/get-music)来创建并初始化音乐播放器，获取并加载版权音乐。
...
| 音乐资源类型 | 切换原唱/伴奏方式 |
| --- | --- |
| 左声道伴奏、右声道原唱的单音轨歌曲 | <Slot name="karaoke-android-markdown-7-1-1" /> |
| 多音轨的歌曲 | <Slot name="karaoke-android-markdown-7-2-1" /> |

<Slot for="karaoke-android-markdown-7-1-1">
...
<Slot for="karaoke-android-markdown-7-2-1">
...
调用 `enableAudioVolumeIndication` 方法开启歌唱评分功能，并通过 `onAudioVolumeIndication` 回调，结合声网歌词组件实现歌唱评分效果，详见[歌词打分组件](/zh-CN/api-reference/online-ktv/android/online-ktv-sdk/advanced-features/lyrics-scoring)。

### 相关文档

- [RESTful API](/zh-CN/api-reference/online-ktv/ios/online-ktv-sdk/api/music-content-center)
- [歌词打分组件](/zh-CN/api-reference/online-ktv/android/online-ktv-sdk/advanced-features/lyrics-scoring)
- [实时互动 API 参考](/zh-CN/api-reference/online-ktv/android/online-ktv-sdk/api/rtc-api)
