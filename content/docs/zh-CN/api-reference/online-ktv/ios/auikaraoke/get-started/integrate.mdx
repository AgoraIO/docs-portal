...
_migration:
  ...
  warnings:
    - code: missing-source-text
      severity: warning
      message: >-
        image-alt:docs/online-ktv/auikaraoke/get-started/integrate.ios.mdx:https://web-cdn.agora.io/docs-files/1697770935216:used-context:快速实现
        图示
    - code: missing-source-text
      severity: warning
      message: >-
        image-alt:docs/online-ktv/auikaraoke/get-started/integrate.ios.mdx:https://web-cdn.agora.io/docs-files/1697794691823:used-context:快速实现
        图示
    - code: missing-source-text
      severity: warning
      message: >-
        image-alt:docs/online-ktv/auikaraoke/get-started/integrate.ios.mdx:/img/online-ktv/add-kit1-ios.png:used-context:快速实现
        图示
    - code: missing-source-text
      severity: warning
      message: >-
        image-alt:docs/online-ktv/auikaraoke/get-started/integrate.ios.mdx:/img/online-ktv/add-kit-ios.png:used-context:快速实现
        图示
    - code: missing-source-text
      severity: warning
      message: >-
        image-alt:docs/online-ktv/auikaraoke/get-started/integrate.ios.mdx:https://web-cdn.agora.io/docs-files/1696931506007:used-context:快速实现
        图示
...
4. 添加项目的设备权限。在项目导航栏中 `info` 下，配置麦克风权限，如下图所示：
   ...
   ![快速实现 图示](https://web-cdn.agora.io/docs-files/1697770935216)
...
![快速实现 图示](/img/api-center-generated/0d25f142831d-add-kit1-ios.png)

   2. 指定 `KaraokeUIKit.swift` 文件，勾选 **Destination: Copy items if neeed**，点击右下角 `Add`。

![快速实现 图示](/img/api-center-generated/43ba43dda255-add-kit-ios.png)
...
![快速实现 图示](https://web-cdn.agora.io/docs-files/1697794691823)
