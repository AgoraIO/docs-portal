...
<span className="index-desc-newvideoencodedimagesender">创建一个已编码视频数据发送模块。该方法创建一个 `VideoEncodedImageSender` 对象，可用于 [`NewCustomVideoTrackEncoded`](/zh-CN/api-reference/rtc-server-sdk/go-api/localvideotrack.go#newcustomvideotrackencoded) 方法。</span>
