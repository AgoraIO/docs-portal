...
<span className="index-desc-registervideoencodedimagereceiver">注册 [`VideoEncodedImageReceiver`](./videoencodedimagereceiver) 对象。 注册成功之后，SDK 在收到已编码视频帧时触发 [`OnEncodedVideoFrame`](./videoencodedimagereceiver#onencodedvideoframe) 回调。</span>
...
<span className="index-desc-unregistervideoencodedimagereceiver">销毁 [`VideoEncodedImageReceiver`](./videoencodedimagereceiver) 对象。</span>
