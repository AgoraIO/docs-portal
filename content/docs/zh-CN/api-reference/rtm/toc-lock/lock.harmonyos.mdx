...
配置成功后，频道中的所有用户会收到 `LOCK_SET` 类型的 `lock` 事件通知，详见[事件监听](/zh-CN/api-reference/rtm/toc-configuration/configuration.harmonyos#事件监听)。
...
成功获取锁后，频道中的其他用户会收到 `LOCK_ACQUIRED` 类型的 `lock` 事件通知，详见[事件监听](/zh-CN/api-reference/rtm/toc-configuration/configuration.harmonyos#事件监听)。
...
成功释放后，频道中的其他用户会收到 `LOCK_RELEASED` 类型的 `lock` 事件，详见[事件监听](/zh-CN/api-reference/rtm/toc-configuration/configuration.harmonyos#事件监听)。
...
成功收回后，频道中的所有用户会收到 `LOCK_RELEASED` 类型的 `lock` 事件，详见[事件监听](/zh-CN/api-reference/rtm/toc-configuration/configuration.harmonyos#事件监听)。
...
成功删除锁后，频道中的所有用户会收到 `LOCK_REMOVED` 类型的 `lock` 事件通知，详见[事件监听](/zh-CN/api-reference/rtm/toc-configuration/configuration.harmonyos#事件监听)。
