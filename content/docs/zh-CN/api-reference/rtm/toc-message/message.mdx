...
| --------- | --- | ----- | --- | -------- |
| `customType` | string |   选填   |   -    | 用户自定义字段。仅支持 string 型。     |
|   `channelType`   |  string  |   选填   |  -   | 频道类型。支持的取值见[频道类型](/zh-CN/api-reference/rtm/enumv#channeltype)。 |
...
| --- | --- | --- | --- | --- |
| `channelName` | string | 必填 | - | 频道名称。 |
| `channelType` | string | 必填 | - | 频道类型。详见 [HistoryChannelType](/zh-CN/api-reference/rtm/enumv#historychanneltype)。 |
...
| 属性 | 类型 | 是否必填 | 默认值 | 描述 |
| --- | --- | --- | --- | --- |
| `channelType` | `RtmChannelType` | 选填 | `MESSAGE` | 频道类型。详见 [`RtmChannelType`](/zh-CN/api-reference/rtm/enumv#channeltype)。 |
...
|     属性     |  类型  | 是否必填 | 默认值 | 描述          |
| --------- | --- | ----- | --- | -------- |
|   `channelType`   |  RtmChannelType  |   选填   |  message   | 频道类型。支持的取值见[频道类型](/zh-CN/api-reference/rtm/enumv#channeltype)。 |
| `messageType` | RtmMessageType | 选填 | binary | 消息类型。详见[消息类型](/zh-CN/api-reference/rtm/enumv#messagetype)。
| `customType` | string |   选填   |   -    | 用户自定义字段。仅支持 string 型。     |
| `storeInHistory` | boolean  |   选填   |  false  | 是否将消息存储在历史消息中。如果设置为 true，消息将会被存储在历史消息中，并可以通过 `getMessages` 方法获取。 |
...
:::info[信息]
成功调用该方法后，SDK 会触发 `messsage` 事件通知。订阅了该频道并且开启了事件监听的用户将会收到该事件通知，详见[事件监听](/zh-CN/api-reference/rtm/toc-configuration/configuration#事件监听)。
:::
...
| 属性 | 类型 | 是否必填 | 默认值 | 描述 |
| --- | --- | --- | --- | --- |
| `channelType` | `RTM_CHANNEL_TYPE` | 选填 | `RTM_CHANNEL_TYPE_MESSAGE` | 频道类型。详见 [`RTM_CHANNEL_TYPE`](/zh-CN/api-reference/rtm/enumv#channeltype)。 |
