...
| <code className="index-group-item-rtmeventlistener index-api-onconnection" id=onConnectionStateChanged>onConnectionStateChanged</code> | <span class="index-desc-onconnection">（已废弃）接收客户端网络连接状态变更的事件通知。详见 [SDK 连接状态](/zh-CN/api-reference/rtm/enumv.android.cpp#connectionstate)和 [SDK 连接状态改变原因](/zh-CN/api-reference/rtm/enumv.android.cpp#connectionreason)。</span> |
