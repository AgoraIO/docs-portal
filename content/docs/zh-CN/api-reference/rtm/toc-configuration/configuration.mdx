...
| `areaCode` | `EnumSet<RtmAreaCode>` | 选填 | `GLOB` | 服务区域代码，你可以根据自己业务部署的区域进行选择，详见 [`RtmAreaCode`](/zh-CN/api-reference/rtm/enumv#areacode)。 |
| `protocolType` | `RtmProtocolType` | 选填 | `TCP_UDP` | 消息传输协议类型。RTM 默认使用一路 TCP 和一路 UDP 协议进行传输，你可以根据需要修改协议类型。详见 [`RtmProtocolType`](/zh-CN/api-reference/rtm/enumv#protocoltype)。 |
...
| `level` | `RtmLogLevel` | 选填 | `INFO` | 日志信息的输出等级，详见 [`RtmLogLevel`](/zh-CN/api-reference/rtm/enumv#loglevel)。 |
...
| 属性  | 类型             |  是否必填  |  默认值  | 描述  |
|-----------|----------------|--------|-------| ----------- |
| `proxyType` | `RtmProxyType` |  选填  | `NONE` | Proxy 协议类型。详见 [`RtmProxyType`](/zh-CN/api-reference/rtm/enumv#proxytype)。 |
...
| 属性          | 类型                  |  是否必填  |  默认值  | 描述             |
|-----|-------|--------|------------| -------------- |
| `encryptionMode`    | `RtmEncryptionMode` |  选填  |`NONE` | 加密方式。详见 [`RtmEncryptionMode`](/zh-CN/api-reference/rtm/enumv#encryptionmode)。 |
...
| 属性          | 类型                  |  是否必填  |  默认值  | 描述              |
|-----|-------|--------|------------| ------- |
| `serviceType`    | `EnumSet<RtmServiceType>` |  选填  | - | 服务类型。详见 [`RtmServiceType`](/zh-CN/api-reference/rtm/enumv#rtmservicetype)。 |
...
|        <code className="index-group-item-rtmeventlistener index-api-onconnection" id="onConnectionStateChanged">onConnectionStateChanged</code>         | <span className="index-desc-onconnection">（已废弃）接收客户端网络连接状态变更的事件通知。详见 [SDK 连接状态](/zh-CN/api-reference/rtm/enumv#connectionstate)和 [SDK 连接状态改变原因](/zh-CN/api-reference/rtm/enumv#connectionreason)。</span> |
...
| `data`              |       byte[]          |  Byte 型消息。   |
| `messageType`            | `RtmMessageType`    |  消息类型。详见 [`RtmMessageType`](/zh-CN/api-reference/rtm/enumv#messagetype)。   |
...
|----|-----| --------------- |
| `channelType`            | `RtmChannelType`    |  频道类型。详见 [`RtmChannelType`](/zh-CN/api-reference/rtm/enumv#channeltype)。   |
| `eventType`            | `RtmLockEventType`    |  Lock 事件类型。详见 [`RtmLockEventType`](/zh-CN/api-reference/rtm/enumv#locktype)。    |
| `channelName`              | String                |  频道名称。   |
...
- 调用失败，则会执行 `onFailure` 方法并且 `onFailure` 方法会返回一个 `ErrorInfo` 类型的 `errorInfo` 返回值，其中包含本次调用错误码、错误原因及 API 操作名称，如下表所示：
  ...
  你可以通过检索 `errorCode` 字段所包含的[错误码](/zh-CN/realtime-media/rtm/error-codes)了解错误原因，并找到对应的解决方法。
...
| `areaCode` | `AgoraRtmAreaCode` | 选填 | `AgoraRtmAreaCodeGLOB` | 服务区域代码，你可以根据自己业务部署的区域进行选择，详见 [`AgoraRtmAreaCode`](/zh-CN/api-reference/rtm/enumv#areacode)。 |
| `protocolType` | `AgoraRtmProtocolType` | 选填 | `AgoraRtmProtocolTypeTcpUdp` | 消息传输协议类型。RTM 默认使用一路 TCP 和一路 UDP 协议进行传输，你可以根据需要修改协议类型。详见 [`AgoraRtmProtocolType`](/zh-CN/api-reference/rtm/enumv#protocoltype)。 |
...
| `level` | `AgoraRtmLogLevel` | 选填 | `AgoraRtmLogLevelInfo` | 日志信息的输出等级，详见 [`AgoraRtmLogLevel`](/zh-CN/api-reference/rtm/enumv#loglevel)。 |
...
| 属性  | 类型             |  是否必填  |  默认值  | 描述  |
|-----------|----------------|--------|-------| ----------- |
| `proxyType` | `AgoraRtmProxyType` |  选填  | `AgoraRtmProxyTypeNone` | Proxy 协议类型。详见 [`AgoraRtmProxyType`](/zh-CN/api-reference/rtm/enumv#proxytype)。 |
...
| 属性          | 类型                  |  是否必填  |  默认值  | 描述             |
|-----|-------|--------|------------| ------ |
| `encryptionMode`    | `AgoraRtmEncryptionMode` |  选填  |`AgoraRtmEncryptionNone` | 加密方式。详见 [`AgoraRtmEncryptionMode`](/zh-CN/api-reference/rtm/enumv#encryptionmode)。 |
...
| 属性          | 类型                  |  是否必填  |  默认值  | 描述             |
|-----|-------|--------|------------| ------ |
| `serviceType`    | `AgoraRtmServiceType` |  选填  | - | 服务类型。详见 [`AgoraRtmServiceType`](/zh-CN/api-reference/rtm/enumv#rtmservicetype)。 |
...
| <code className="index-group-item-rtmeventlistener index-api-onconnection" id="connectionChangedToState">connectionChangedToState</code>    | <span className="index-desc-onconnection">（已废弃）接收客户端网络连接状态变更的事件通知。详见 [`AgoraRtmClientConnectionState`](/zh-CN/api-reference/rtm/enumv#connectionstate) 和 [`AgoraRtmClientConnectionChangeReason`](/zh-CN/api-reference/rtm/enumv#connectionreason)。</span>              |
...
|----|-----| ------ |
| `channelType`            | `AgoraRtmChannelType`    |  频道类型。详见 [`AgoraRtmChannelType`](/zh-CN/api-reference/rtm/enumv#channeltype)。   |
| `eventType`            | `AgoraRtmLockEventType`    |  Lock 事件类型。详见 [`AgoraRtmLockEventType`](/zh-CN/api-reference/rtm/enumv#locktype)。    |
| `channelName`              | NSString                |  频道名称。   |
| `lockDetailList`            | `ArrayList<LockDetail>`               |  Lock 的详情。   |
| `timestamp` | unsigned long long | 事件发生的时间戳。                |
...
| 属性        |  类型  |   描述                   |
|-----|------| ---------- |
| `currentState`            | `AgoraRtmLinkState`    |  当前的连接状态。详见 [`AgoraRtmLinkState`](/api-ref/rtm2/ios/enumv#linkstate)。   |
| `previousState`            | `AgoraRtmLinkState`    |  之前的连接状态。详见 [`AgoraRtmLinkState`](/api-ref/rtm2/ios/enumv#linkstate)。   |
| `serviceType`    | `AgoraRtmServiceType` | 网络连接类型。详见 [`AgoraRtmServiceType`](/api-ref/rtm2/ios/enumv#rtmservicetype)。 |
| `operation`    | `AgoraRtmLinkOperation` | 触发本次状态迁移的操作。详见 [`AgoraRtmLinkOperation`](/api-ref/rtm2/ios/enumv#linkoperation)。 |
| `reasonCode`    | `AgoraRtmLinkStateChangeReason` | 本次状态迁移的原因。详见 [`AgoraRtmLinkStateChangeReason`](/api-ref/rtm2/ios/enumv#linkstatechangereason)。 |
...
| 属性 | 类型 | 是否必填 | 默认值 | 描述 |
| --- | --- | --- | --- | --- |
| `encryptionMode` | string | 选填 | - | 端侧消息加密模式。如果不设置或设置为 `NONE`，则表示不启用端侧加密功能。支持的取值见[端侧加密模式](/zh-CN/api-reference/rtm/enumv#端侧加密模式)。 |
...
| `logLevel` | string | 选填 | - | 开启及设置 SDK 的输出日志输出等级。支持的取值见[日志输出等级](/zh-CN/api-reference/rtm/enumv#日志输出等级)。 |
...
| 属性 | 类型 | 是否必填 | 默认值 | 描述 |
| --- | --- | --- | --- | --- |
| `serviceType` | string[] | 选填 | - | 服务类型。支持的取值见[服务类型](/zh-CN/api-reference/rtm/enumv#rtmservicetype)。 |
...
| `appId` | string | 必填 | - | 声网控制台创建项目时获得的 App ID。 |
| `userId` | string | 必填 | - | 用户 ID，用于标识用户或设备。为区分各用户和设备，你需要确保 `userId` 全局唯一，并且在用户或设备的生命周期内保持不变。 |
| `areaCode` | `RtmAreaCode` | 选填 | `GLOBAL` | 服务区域代码，你可以根据自己业务部署的区域进行选择，详见 [`RtmAreaCode`](/zh-CN/api-reference/rtm/enumv#areacode)。 |
| `protocolType` | `RtmProtocolType` | 选填 | `TCP_UDP` | 消息传输协议类型。RTM 默认使用一路 TCP 和一路 UDP 协议进行传输，你可以根据需要修改协议类型。详见 [`RtmProtocolType`](/zh-CN/api-reference/rtm/enumv#protocoltype)。 |
| `presenceTimeout` | number | 选填 | `300` | Presence 的超时时间。单位为秒，取值范围为 [5,300]。即 RTM 服务器在判定客户端超时后，延迟多久向其他用户发送 `REMOTE_TIMEOUT` 事件通知。如果客户端在该参数设置的时间内重新建立连接并返回频道，则 RTM 服务器不会向频道中其他人发送 `REMOTE_TIMEOUT` 事件通知，也不会删除该用户的临时用户数据。 |
...
| 属性          | 类型                  |  是否必填  |  默认值  | 描述                      |
|-----|-------|--------|------------| ---------------- |
| `serviceType`    | `RtmServiceType` |  选填  | - | 服务类型。详见 [`RtmServiceType`](/zh-CN/api-reference/rtm/enumv#rtmservicetype)。 |
...
| 属性       |  类型  |   描述       |
|----|-----| ----------- |
| `eventType`            | `RtmPresenceEventType`    |   Presence 事件类型。详见 [`RtmPresenceEventType`](/api-ref/rtm2/harmonyos/enumv#presencetype)。  |
| `channelType`            | `RtmChannelType`    |  频道类型。详见 [`RtmChannelType`](/api-ref/rtm2/harmonyos/enumv#channeltype)。   |
| `channelName`            | string                |  事件发生的频道名称。  |
| `publisher`              | string                |  触发此事件的用户 ID。   |
...
| 属性        |  类型  |   描述   |
|----|-----| ------ |
| `eventType`            | `RtmTopicEventType`    |  Topic 事件类型。详见 [`RtmTopicEventType`](/api-ref/rtm2/harmonyos/enumv#topictype)。  |
| `channelName`            | string                |  事件发生的频道名称。   |
| `publisher`              | string                |  触发此事件的用户 ID。   |
...
|----|-----| ------- |
| `channelType`            | `RtmChannelType`    |  频道类型。详见 [`RtmChannelType`](/api-ref/rtm2/harmonyos/enumv#channeltype)。   |
| `storageType`            | `RtmStorageType`    |  Storage 类型。详见 [`RtmStorageType`](/api-ref/rtm2/harmonyos/enumv#storagetype)。  |
| `eventType`            | `RtmStorageEventType`    |  Storage 事件类型。详见 [`RtmStorageEventType`](/api-ref/rtm2/harmonyos/enumv#storageeventtype)。  |
| `target`              | string                |  用户 ID 或频道名称。   |
| `data`            | `Metadata`               |   Metadata Item。详见 [`Metadata`](/api-ref/rtm2/harmonyos/toc-storage/storage#setChannelMetadata)。   |
| `timestamp` | number | 事件发生的时间戳。                |
...
| 属性        |  类型  |   描述            |
|----|-----| ------------- |
| `currentState`            | `RtmLinkState`    |  当前的连接状态。详见 [`RtmLinkState`](/api-ref/rtm2/harmonyos/enumv#linkstate)。   |
| `previousState`            | `RtmLinkState`    |  之前的连接状态。详见 [`RtmLinkState`](/api-ref/rtm2/harmonyos/enumv#linkstate)。   |
| `serviceType`    | `RtmServiceType` | 网络连接类型。详见 [`RtmServiceType`](/api-ref/rtm2/harmonyos/enumv#rtmservicetype)。 |
| `operation`    | `RtmLinkOperation` | 触发本次状态迁移的操作。详见 [`RtmLinkOperation`](/api-ref/rtm2/harmonyos/enumv#linkoperation)。 |
| `reasonCode`    | `RtmLinkStateChangeReason` | 本次状态迁移的原因。详见 [`RtmLinkStateChangeReason`](/api-ref/rtm2/harmonyos/enumv#linkstatechangereason)。 |
...
- Promise reject：抛出 `RtmError` 异常，包含错误码和错误原因。详见[错误排查](/zh-CN/realtime-media/rtm/error-codes)。
...
| `appId` | string | 必填 | - | 声网控制台创建项目时获得的 App ID。 |
| `userId` | string | 必填 | - | 用户 ID，用于标识用户或设备。为区分各用户和设备，你需要确保 `userId` 全局唯一，并且在用户或设备的生命周期内保持不变。 |
| `areaCode` | `RTM_AREA_CODE` | 选填 | `GLOB` | 服务区域代码，你可以根据自己业务部署的区域进行选择，详见 [`RTM_AREA_CODE`](/zh-CN/api-reference/rtm/enumv#areacode)。 |
...
| `level` | `RTM_LOG_LEVEL` | 选填 | `INFO` | 日志信息的输出等级，详见 [`RTM_LOG_LEVEL`](/zh-CN/api-reference/rtm/enumv#loglevel)。 |
...
| 属性  | 类型             |  是否必填  |  默认值  | 描述  |
|-----------|----------------|--------|-------| ----------- |
| `proxyType` | `RTM_PROXY_TYPE` |  选填  | `NONE` | Proxy 协议类型。详见 [`RTM_PROXY_TYPE`](/zh-CN/api-reference/rtm/enumv#proxytype)。 |
| `server`    | string           |  选填  | -             | Proxy 服务器域名或 IP 地址。                |
...
| 属性          | 类型                  |  是否必填  |  默认值  | 描述      |
|-----|-------|--------|------------| ------ |
| `encryptionMode`    | `RTM_ENCRYPTION_MODE` |  选填  |`NONE` | 加密方式。详见 [`RTM_ENCRYPTION_MODE`](/zh-CN/api-reference/rtm/enumv#encryptionmode)。 |
| `encryptionKey`     | string                |  选填  |     -      | 用户自定义加密密钥，长度无限制。声网推荐使用 32 字节的密钥。              |
...
|        <code className="index-group-item-irtmclient index-api-onconnection" id="OnConnectionStateChanged">OnConnectionStateChanged</code>         | <span className="index-desc-onconnection">接收客户端网路连接状态变更的事件通知。详见 [`RTM_CONNECTION_STATE`](/zh-CN/api-reference/rtm/enumv#connectionstate) 和 [`RTM_CONNECTION_CHANGE_REASON`](/zh-CN/api-reference/rtm/enumv#connectionreason)。</span> |
...
| `messageType`  | `RTM_MESSAGE_TYPE` | 消息类型。详见 [`RTM_MESSAGE_TYPE`](/zh-CN/api-reference/rtm/enumv#messagetype)。 |
| `channelName`  |    string     | 频道名称。                    |
| `channelTopic` |    string     | Topic 名称。                  |
...
| -------------- | ------------- | -------- |
|  `channelType`   |                   `RTM_CHANNEL_TYPE`                   | 频道类型。                   |
|   `eventType`    | `RTM_LOCK_EVENT_TYPE` | Lock 事件类型。详见 [`RTM_LOCK_EVENT_TYPE`](/zh-CN/api-reference/rtm/enumv#locktype)。 |
|  `channelName`   |   string   | 频道名称。                   |
...
| 属性 | 类型 | 必填 | 默认值 | 描述 |
| --- | --- | --- | --- | --- |
| `areaCode` | `RtmAreaCode` | 选填 | `glob` | 服务区域代码，你可以根据自己业务部署的区域进行选择，详见 [`RtmAreaCode`](/zh-CN/api-reference/rtm/enumv#areacode)。 |
| `protocolType` | `RtmProtocolType` | 选填 | `tcpUdp` | 消息传输协议类型。RTM 默认使用一路 TCP 和一路 UDP 协议进行传输，你可以根据需要修改协议类型。详见 [`RtmProtocolType`](/zh-CN/api-reference/rtm/enumv#protocoltype)。 |
...
|        属性        |       类型       | 必填 | 默认值 | 描述          |
| ---------------- | ----- | ------ | ---- | --------------- |
|   `serviceType`    | `Set<RtmServiceType>` |   选填   |   -    | 服务类型。详见 [`RtmServiceType`](/zh-CN/api-reference/rtm/enumv#rtmservicetype)。 |
...
| `target`              | String                |  用户 ID 或频道名称。   |
| `data`            | `Metadata`               |   Metadata Item。详见 [`Metadata`](/api-ref/rtm2/flutter/toc-storage/storage#Metadata)。   |
| `timestamp` | int | 事件发生的时间戳。                |
...
| 属性        |  类型  |   描述               |
|-----|------| ---------- |
| `currentState`            | `RtmLinkState`    |  当前的连接状态。详见 [`RtmLinkState`](/api-ref/rtm2/flutter/enumv#linkstate)。   |
| `previousState`            | `RtmLinkState`    |  之前的连接状态。详见 [`RtmLinkState`](/api-ref/rtm2/flutter/enumv#linkstate)。   |
| `serviceType`    | `RtmServiceType` | 网络连接类型。详见 [`RtmServiceType`](/api-ref/rtm2/flutter/enumv#rtmservicetype)。 |
| `operation`    | `RtmLinkOperation` | 触发本次状态迁移的操作。详见 [`RtmLinkOperation`](/api-ref/rtm2/flutter/enumv#linkoperation)。 |
| `reason`    | String | 本次状态迁移的原因。 详见 [`RtmLinkStateChangeReason`](/zh-CN/api-reference/rtm/enumv#linkstatechangereason)。 |
...
| `appId` | string | 必填 | - | 声网控制台创建项目时获得的 App ID。 |
| `userId` | string | 必填 | - | 用户 ID，用于标识用户或设备。为区分各用户和设备，你需要确保 `userId` 全局唯一，并且在用户或设备的生命周期内保持不变。 |
| `areaCode` | `RtmAreaCode` | 选填 | `glob` | 服务区域代码，你可以根据自己业务部署的区域进行选择，详见 [`RtmAreaCode`](/zh-CN/api-reference/rtm/enumv#rtmareacode)。 |
| `protocolType` | `RtmProtocolType` | 选填 | `tcpUdp` | 消息传输协议类型。RTM 默认使用一路 TCP 和一路 UDP 协议进行传输，你可以根据需要修改协议类型。详见 [`RtmProtocolType`](/zh-CN/api-reference/rtm/enumv#rtmprotocoltype)。 |
...
| `level` | `RtmLogLevel` | 选填 | `info` | 日志信息的输出等级，详见 [`RtmLogLevel`](/zh-CN/api-reference/rtm/enumv#rtmloglevel)。 |
...
| 属性  | 类型             |  是否必填  |  默认值  | 描述  |
|-----------|----------------|--------|-------| ----------- |
| `proxyType` | `RtmProxyType` |  选填  | `none` | Proxy 协议类型。详见 [`RtmProxyType`](/zh-CN/api-reference/rtm/enumv#rtmproxytype)。 |
| `server`    | string           |  选填  | -             | Proxy 服务器域名或 IP 地址。                |
...
| 属性          | 类型                  |  是否必填  |  默认值  | 描述             |
|-----|-------|--------|------------| -------------- |
| `encryptionMode`    | `RtmEncryptionMode` |  选填  | `none` | 加密方式。详见 [`RtmEncryptionMode`](/zh-CN/api-reference/rtm/enumv#rtmencrptionmode)。 |
| `encryptionKey`     | string                |  选填  |     -                       | 用户自定义加密密钥，长度无限制。声网推荐使用 32 字节的密钥。       |
...
| 属性          | 类型                  |  是否必填  |  默认值  | 描述              |
|-----|-------|--------|------------| ------- |
| `serviceType`    | `RtmServiceType` |  选填  | `none` | 服务类型。详见 [`RtmServiceType`](/zh-CN/api-reference/rtm/enumv#rtmservicetype)。 |
| `accessPointHosts`    | string[] |  选填  | - | 服务器的地址数组，数组中支持填写域名或 IP 地址。 |
...
| `areaCode` | `RTM_AREA_CODE` | 选填 | `RTM_AREA_CODE_GLOB` | 服务区域代码，你可以根据自己业务部署的区域进行选择，详见 [`RTM_AREA_CODE`](/zh-CN/api-reference/rtm/enumv#areacode)。 |
| `protocolType` | `RTM_PROTOCOL_TYPE` | 选填 | `RTM_PROTOCOL_TYPE_TCP_UDP` | 消息传输协议类型。RTM 默认使用一路 TCP 和一路 UDP 协议进行传输，你可以根据需要修改协议类型。详见 [`RTM_PROTOCOL_TYPE`](/zh-CN/api-reference/rtm/enumv#protocoltype)。 |
...
| `level` | `RTM_LOG_LEVEL` | 选填 | `RTM_LOG_LEVEL_INFO` | 日志信息的输出等级，详见 [`RTM_LOG_LEVEL`](/zh-CN/api-reference/rtm/enumv#loglevel)。 |
...
| `proxyType` | `RTM_PROXY_TYPE` |  选填  | `RTM_PROXY_TYPE_NONE` | Proxy 协议类型。详见 [`RTM_PROXY_TYPE`](/zh-CN/api-reference/rtm/enumv#proxytype)。 |
...
| 属性 | 类型 | 是否必填 | 默认值 | 描述 |
| --- | --- | --- | --- | --- |
| `encryptionMode` | `RTM_ENCRYPTION_MODE` | 选填 | `RTM_ENCRYPTION_MODE_NONE` | 加密方式。详见 [`RTM_ENCRYPTION_MODE`](/zh-CN/api-reference/rtm/enumv#encryptionmode)。 |
...
| 属性          | 类型                  |  是否必填  |  默认值  | 描述                      |
|-----|-------|--------|------------| ---------------- |
| `serviceType`    | `RTM_SERVICE_TYPE` |  选填  | - | 服务类型。详见 [`RTM_SERVICE_TYPE`](/zh-CN/api-reference/rtm/enumv#rtmservicetype)。 |
...
| ------ | --------- | ------ | ---- | -------------- |
| `config` | `RtmConfig` |   必填   |   -    | 初始化 RTM Client 的配置参数。详见 `RtmConfig`。 |
| `errorCode` | int& |   必填   |   -    | （输出参数）[错误码](/zh-CN/realtime-media/rtm/error-codes#errorcode)。 |
...
| `appId` | String | 必填 | - | 你在声网控制台创建项目时获得的 App ID。 |
| `userId` | String | 必填 | - | 用户 ID，用于标识用户或设备。为区分各用户和设备，你需要确保 `userId` 全局唯一，并且在用户或设备的生命周期内保持不变。 |
| `areaCode` | `AgoraRtmAreaCode` | 选填 | `GLOB` | 服务区域代码，你可以根据自己业务部署的区域进行选择，详见 [`AgoraRtmAreaCode`](/zh-CN/api-reference/rtm/enumv#areacode)。 |
| `protocolType` | `AgoraRtmProtocolType` | 选填 | `tcpUdp` | 消息传输协议类型。RTM 默认使用一路 TCP 和一路 UDP 协议进行传输，你可以根据需要修改协议类型。详见 [`AgoraRtmProtocolType`](/zh-CN/api-reference/rtm/enumv#protocoltype)。 |
...
| `level` | `AgoraRtmLogLevel` | 选填 | `info` | 日志信息的输出等级，详见 [`AgoraRtmLogLevel`](/zh-CN/api-reference/rtm/enumv#loglevel)。 |
...
| 属性        | 类型            | 必填 | 默认值             | 描述               |
| ---------- | --------------- | --- | ----------------- | ----------- |
| `proxyType` | `AgoraRtmProxyType` | 选填 | `none` | Proxy 协议类型。详见 [`AgoraRtmProxyType`](/zh-CN/api-reference/rtm/enumv#proxytype)。 |
| `server`    | String             | 必填 | -                  | Proxy 服务器域名或 IP 地址。    |
| `port`      | UInt16             | 选填 | -                  | Proxy 监听端口。                |
| `account`   | String             | 选填 | -                  | Proxy 登录账号。                |
| `password`  | String             | 选填 | -                  | Proxy 登录密码。                |
...
| 属性                | 类型               | 必填 | 默认值         | 描述           |
| ---- | ------ | --- | ------- | --------------- |
| `encryptionMode`    | `AgoraRtmEncryptionMode` | 选填 | `none` | 加密方式。详见 [`AgoraRtmEncryptionMode`](/zh-CN/api-reference/rtm/enumv#encryptionmode)。 |
| `encryptionKey`     | String           | 选填 | -          | 用户自定义加密密钥，长度无限制。声网推荐使用 32 字节的密钥。       |
