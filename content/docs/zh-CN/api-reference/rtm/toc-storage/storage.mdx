...
| --- | --- | --- | --- | --- |
| `channelName` | String | 必填 | - | 频道名称。 |
| `channelType` | `RtmChannelType` | 必填 | `message` | 频道类型。详见 [`RtmChannelType`](/zh-CN/api-reference/rtm/enumv#channeltype)。 |
...
| 属性 | 类型 | 是否必填 | 默认值 | 描述 |
| --- | --- | --- | --- | --- |
| `majorRevision` | number | 选填 | `-1` | <Slot name="storage-rn-html-0-1-4" /> |
| `items` | MetadataItem | 选填 | 空数组 | Metadata Item 数组。 |
| `itemCount` | number | 选填 | 0 | Metadata Item 的个数。 |

<Slot for="storage-rn-html-0-1-4">
...
其中，Metadata Item 包含以下属性：

```typescript
class MetaDataItem = {
    key: string,             // Metadata Item 的键
    value: string,           // Metadata Item 的值
    revision: number,        // Metadata Item 的版本号
    updatedTs: string,       // 最后一次更新时间戳
    authorUserId: string,    // 最后一次编辑者的用户 ID
}
```
...
| 属性 | 类型 | 是否必填 | 默认值 | 描述 |
| --- | --- | --- | --- | --- |
| `majorRevision` | number | 选填 | `-1` | <Slot name="storage-rn-html-1-1-4" /> |
| `lockName` | string | 选填 | 空字符串 `''` | Lock 名称。设置后，只有调用 `acquireLock` 方法获取该锁的用户才能执行操作。 |
| `addTimeStamp` | boolean | 选填 | `false` | 是否记录编辑的时间戳。 |
| `addUserId` | boolean | 选填 | `false` | 是否记录编辑者的用户 ID。 |

<Slot for="storage-rn-html-1-1-4">
...
type GetChannelMetadataResponse = {
    ...
    channelType: RtmChannelType,     // 频道类型
    majorRevision: number,           // 版本号
    items: MetadataItem[],           // 包含 Metadata Item 数据的 JSON Object
    itemCount: number                // Metadata Item 个数
}
```
...
| 属性 | 类型 | 是否必填 | 默认值 | 描述 |
| --- | --- | --- | --- | --- |
| `items` | Array\<object\> | 必填 | - | Metadata Item 数组。Metadata Item 是一个 JSON 格式的 object，包含预定义属性。该 object 中不支持设置预定义之外的属性。 |
| `itemCount` | number | 选填 | 0 | Metadata Item 的个数。 |
| `majorRevision` | number | 选填 | `-1` | <Slot name="storage-rn-html-2-3-4" /> |
| `lockName` | string | 选填 | 空字符串 `''` | Lock 名称。设置后，只有调用 `acquireLock` 方法获取该锁的用户才能执行操作。 |
| `addTimeStamp` | boolean | 选填 | `false` | 是否记录编辑的时间戳。 |
| `addUserId` | boolean | 选填 | `false` | 是否记录编辑者的用户 ID。 |

<Slot for="storage-rn-html-2-3-4">
...
| 属性 | 类型 | 是否必填 | 默认值 | 描述 |
| --- | --- | --- | --- | --- |
| `majorRevision` | number | 选填 | `-1` | <Slot name="storage-rn-html-3-1-4" /> |
| `items` | MetadataItem | 选填 | 空数组 | Metadata Item 数组。 |
| `itemCount` | number | 选填 | 0 | Metadata Item 的个数。 |

<Slot for="storage-rn-html-3-1-4">
...
| 属性 | 类型 | 是否必填 | 默认值 | 描述 |
| --- | --- | --- | --- | --- |
| `majorRevision` | number | 选填 | `-1` | <Slot name="storage-rn-html-4-1-4" /> |
| `lockName` | string | 选填 | 空字符串 `''` | Lock 名称。设置后，只有调用 `acquireLock` 方法获取该锁的用户才能执行操作。 |
| `addTimeStamp` | boolean | 选填 | `false` | 是否记录编辑的时间戳。 |
| `addUserId` | boolean | 选填 | `false` | 是否记录编辑者的用户 ID。 |

<Slot for="storage-rn-html-4-1-4">
...
成功设置 User Metadata 后，订阅该用户 Metadata 且开启事件监听的用户会收到 `user` 类型的 `event` 事件通知。详见[事件监听](/zh-CN/api-reference/rtm/toc-configuration/configuration#事件监听)。
...
| 属性 | 类型 | 是否必填 | 默认值 | 描述 |
| --- | --- | --- | --- | --- |
| `majorRevision` | number | 选填 | `-1` | <Slot name="storage-rn-html-5-1-4" /> |
| `items` | MetadataItem | 选填 | 空数组 | Metadata Item 数组。 |
| `itemCount` | number | 选填 | 0 | Metadata Item 的个数。 |

<Slot for="storage-rn-html-5-1-4">
...
| --- | --- | --- | --- | --- |
| `userId` | string | 选填 | 当前用户的 `userId` | 用户 ID。 |
| `majorRevision` | number | 选填 | `-1` | <Slot name="storage-rn-html-6-2-4" /> |
| `lockName` | string | 选填 | 空字符串 `''` | Lock 名称。设置后，只有调用 `acquireLock` 方法获取该锁的用户才能执行操作。 |
| `addTimeStamp` | boolean | 选填 | `false` | 是否记录编辑的时间戳。 |
| `addUserId` | boolean | 选填 | `false` | 是否记录编辑者的用户 ID。 |

<Slot for="storage-rn-html-6-2-4">
...
type GetUserMetadataResponse = {
    ...
    itemCount : number,      // Metadata Item 个数
    majorRevision : number,  // 版本号
    items : MetadataItem[]   // 包含 MetadataItem 数据的 JSON Object
}
```

Metadata Item 包含如下属性：
...
| `userId` | string | 选填 | 当前用户的 `userId` | 用户 ID。 |
| `data` | Array\<object\> | 选填 | - | Metadata Item 数组。Metadata Item 是一个 JSON 格式的 object，包含预定义属性。该 object 中不支持设置预定义之外的属性。如果不填写该参数，则删除全部 Metadata。 |
| `majorRevision` | number | 选填 | `-1` | <Slot name="storage-rn-html-7-3-4" /> |
| `lockName` | string | 选填 | 空字符串 `''` | Lock 名称。设置后，只有调用 `acquireLock` 方法获取该锁的用户才能执行操作。 |
| `addTimeStamp` | boolean | 选填 | `false` | 是否记录编辑的时间戳。 |
| `addUserId` | boolean | 选填 | `false` | 是否记录编辑者的用户 ID。 |

<Slot for="storage-rn-html-7-3-4">
...
| 属性 | 类型 | 是否必填 | 默认值 | 描述 |
| --- | --- | --- | --- | --- |
| `majorRevision` | number | 选填 | `-1` | <Slot name="storage-rn-html-8-1-4" /> |
| `items` | MetadataItem | 选填 | 空数组 | Metadata Item 数组。 |
| `itemCount` | number | 选填 | 0 | Metadata Item 的个数。 |

<Slot for="storage-rn-html-8-1-4">
...
<a id="updateusermetadata"></a>
## updateUserMetadata

### 接口描述

`updateUserMetadata` 方法可以更新已有的 User Metadata 或 Metadata Item。成功更新后，订阅该 User Metadata 且开启事件监听的用户会收到 `user` 类型的 `event` 事件通知。详见[事件监听](/zh-CN/api-reference/rtm/toc-configuration/configuration#事件监听)。
...
| 属性 | 类型 | 是否必填 | 默认值 | 描述 |
| --- | --- | --- | --- | --- |
| `majorRevision` | number | 选填 | `-1` | <Slot name="storage-rn-html-9-1-4" /> |
| `items` | MetadataItem | 选填 | 空数组 | Metadata Item 数组。 |
| `itemCount` | number | 选填 | 0 | Metadata Item 的个数。 |

<Slot for="storage-rn-html-9-1-4">
...
| --- | --- | --- | --- | --- |
| `userId` | string | 选填 | 当前用户的 `userId` | 用户 ID。 |
| `majorRevision` | number | 选填 | `-1` | <Slot name="storage-rn-html-10-2-4" /> |
| `lockName` | string | 选填 | 空字符串 `''` | Lock 名称。设置后，只有调用 `acquireLock` 方法获取该锁的用户才能执行操作。 |
| `addTimeStamp` | boolean | 选填 | `false` | 是否记录编辑的时间戳。 |
| `addUserId` | boolean | 选填 | `false` | 是否记录编辑者的用户 ID。 |

<Slot for="storage-rn-html-10-2-4">
...
<a id="unsubscribeusermetadata"></a>
## unsubscribeUserMetadata
...
成功设置 Channel Metadata 后，订阅该频道且开启事件监听的用户会收到 `RTM_STORAGE_TYPE_CHANNEL` 类型的 `onStorageEvent` 事件通知。详见[事件监听](/zh-CN/api-reference/rtm/toc-configuration/configuration#事件监听)。
...
成功删除 Channel Metadata 或 Metadata Item 后，订阅该频道且开启事件监听的用户会收到 `RTM_STORAGE_TYPE_CHANNEL` 类型的 `onStorageEvent` 事件通知。详见[事件监听](/zh-CN/api-reference/rtm/toc-configuration/configuration#事件监听)。
...
成功更新后，订阅该频道且开启事件监听的用户会收到 `RTM_STORAGE_TYPE_CHANNEL` 类型的 `onStorageEvent` 事件通知。详见[事件监听](/zh-CN/api-reference/rtm/toc-configuration/configuration#事件监听)。
...
成功设置 User Metadata 后，订阅该用户 Metadata 且开启事件监听的用户会收到 `RTM_STORAGE_TYPE_USER` 类型的 `onStorageEvent` 事件通知。详见[事件监听](/zh-CN/api-reference/rtm/toc-configuration/configuration#事件监听)。
...
成功删除后，订阅该用户 Metadata 且开启事件监听的用户会收到 `RTM_STORAGE_TYPE_USER` 类型的 `onStorageEvent` 事件通知。详见[事件监听](/zh-CN/api-reference/rtm/toc-configuration/configuration#事件监听)。
...
成功更新后，订阅该 User Metadata 且开启事件监听的用户会收到 `RTM_STORAGE_TYPE_USER` 类型的 `onStorageEvent` 事件通知。详见[事件监听](/zh-CN/api-reference/rtm/toc-configuration/configuration#事件监听)。
...
成功订阅且开启事件监听后，当该用户的 Metadata 发生变更时会收到 `RTM_STORAGE_TYPE_USER` 类型的 `onStorageEvent` 事件通知。详见[事件监听](/zh-CN/api-reference/rtm/toc-configuration/configuration#事件监听)。
...
成功设置 Channel Metadata 后，订阅该频道且开启事件监听的用户会收到 `channel` 类型的 `didReceiveStorageEvent` 事件通知。详见[事件监听](/zh-CN/api-reference/rtm/toc-configuration/configuration#事件监听)。
...
成功删除 Channel Metadata 或 Metadata Item 后，订阅该频道且开启事件监听的用户会收到 `channel` 类型的 `didReceiveStorageEvent` 事件通知。详见[事件监听](/zh-CN/api-reference/rtm/toc-configuration/configuration#事件监听)。
...
成功更新后，订阅该频道且开启事件监听的用户会收到 `channel` 类型的 `didReceiveStorageEvent` 事件通知。详见[事件监听](/zh-CN/api-reference/rtm/toc-configuration/configuration#事件监听)。
...
成功设置 User Metadata 后，订阅该用户 Metadata 且开启事件监听的用户会收到 `user` 类型的 `didReceiveStorageEvent` 事件通知。详见[事件监听](/zh-CN/api-reference/rtm/toc-configuration/configuration#事件监听)。
...
成功删除后，订阅该用户 Metadata 且开启事件监听的用户会收到 `user` 类型的 `didReceiveStorageEvent` 事件通知。详见[事件监听](/zh-CN/api-reference/rtm/toc-configuration/configuration#事件监听)。
...
`updateUserMetadata` 方法可以更新已有的 User Metadata 或 Metadata Item。成功更新后，订阅该 User Metadata 且开启事件监听的用户会收到 `user` 类型的 `didReceiveStorageEvent` 事件通知。详见[事件监听](/zh-CN/api-reference/rtm/toc-configuration/configuration#事件监听)。
...
`subscribeUserMetadata` 方法可以订阅指定用户的 Metadata。成功订阅且开启事件监听后，当该用户的 Metadata 发生变更时会收到 `user` 类型的 `didReceiveStorageEvent` 事件通知。详见[事件监听](/zh-CN/api-reference/rtm/toc-configuration/configuration#事件监听)。
