...
_migration:
  type: manual-mdx
  status: migrated
  sourceUrl: https://doc.shengwang.cn/api-ref/rtm2/cpp/toc-storage/storage
  sourcePath: docs-api-reference/rtm2/toc-storage/storage.cpp.mdx
  ...
  warnings:
    ...
    - code: manual-fragment-normalized
      severity: info
      message: Normalized 15 legacy fragment link(s) to stable local anchors.
---
...
| `channelType` | `RTM_CHANNEL_TYPE` | 必填 | - | 频道类型。详见 [`RTM_CHANNEL_TYPE`](/zh-CN/api-reference/rtm/ios/enumv.cpp#channeltype)。 |
