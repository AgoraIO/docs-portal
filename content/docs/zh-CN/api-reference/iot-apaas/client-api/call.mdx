...
- `config`：包含以下参数：
  ...
  - `APPID`：声网的 App ID。详见[开通灵隼服务](/zh-CN/solutions/iot-apaas/get-started/enable-service)。
  - `PRODUCT_KEY`：Product Key。详见[开通灵隼服务](/zh-CN/solutions/iot-apaas/get-started/enable-service)。
  - `PROJECT_ID`：声网项目 ID。详见[开通灵隼服务](/zh-CN/solutions/iot-apaas/get-started/enable-service)。
