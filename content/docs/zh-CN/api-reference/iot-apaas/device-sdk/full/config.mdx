...
---
本页提供声网灵隼设备端 SDK 的 `agora_iot_api.h` 文件的 API 参考。
...
SDK 句柄。详见 [agora_iot_handle_t](/zh-CN/api-reference/iot-apaas/device-sdk/full/base#agoraiothandlet)。
...
| 参数                  | 描述                                                         |
| :-------------------- | :----------------------------------------------------------- |
| [in] `handle`         | SDK 句柄。详见 [agora_iot_handle_t](/zh-CN/api-reference/iot-apaas/device-sdk/full/base#agoraiothandlet)。                        |
...
| 参数             | 描述                                                         |
| :--------------- | :----------------------------------------------------------- |
| [in] `handle`    | `agora_iot_init` 返回的 SDK 句柄。详见 [agora_iot_handle_t](/zh-CN/api-reference/iot-apaas/device-sdk/full/base#agoraiothandlet)。 |
...
| `client_id` | Client ID，用于呼叫。调用 [agora_iot_register_and_bind](/zh-CN/api-reference/iot-apaas/device-sdk/full/device-manager#agoraiotregisterandbind) 注册设备成功后返回。 |
| `domain` | 设备端域名。可以从 [agora_iot_register_and_bind](/zh-CN/api-reference/iot-apaas/device-sdk/full/device-manager#agoraiotregisterandbind) 方法返回的 `agora_iot_device_info_t::domain` 参数获取。 |
...
| `client_crt` | 设备端证书。可以从 [agora_iot_register_and_bind](/zh-CN/api-reference/iot-apaas/device-sdk/full/device-manager#agoraiotregisterandbind) 方法返回的 `agora_iot_device_info_t::certificate` 参数获取。 |
| `client_key` | 设备端私钥。可以从 [agora_iot_register_and_bind](/zh-CN/api-reference/iot-apaas/device-sdk/full/device-manager#agoraiotregisterandbind) 方法返回的 `agora_iot_device_info_t::private_key` 参数获取。 |
| `enable_rtc` | <Slot name="config-html-5-8-1" /> |
| `certificate` | [agora_license_activate](/zh-CN/api-reference/iot-apaas/device-sdk/full/device-manager#agora_license_activate) 方法返回的证书。 |
...
| `call_cb` | 呼叫事件回调。详见 [agora_iot_call_callback_t](/zh-CN/api-reference/iot-apaas/device-sdk/full/make-call#agoraiotcallcallback) 结构体。 |
...
| `call_mode` | 通话模式，详见 [agora_call_mode_e](/zh-CN/api-reference/iot-apaas/device-sdk/full/make-call#agoracallmodee) 枚举。 |
