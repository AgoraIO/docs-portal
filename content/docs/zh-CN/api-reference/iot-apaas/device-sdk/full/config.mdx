...
| `product_id` | 你的产品 ID，即 Product Key。详见[开通并配置声网灵隼服务](/doc/iot-apaas//get-started/enable-service)。 |
...
| `slave_server_url` | SDK 使用的 AWS OpenAPI 服务的主机域名。你可以在声网灵隼控制台的**应用配置&gt;&gt;开发者选项&gt;&gt;呼叫服务&gt;&gt;Slave Server URL** 处获取。详见[开通并配置声网灵隼服务](/doc/iot-apaas//get-started/enable-service)。 |
