...
| 参数 | 描述 |
| --- | --- |
| [in] `handle` | [agora_iot_init](/zh-CN/api-reference/iot-apaas/device-sdk/call/config#agoraiotinit) 返回的 SDK 句柄。详见 [agora_iot_handle_t](/zh-CN/api-reference/iot-apaas/device-sdk/call/base#agoraiothandlet)。 |
