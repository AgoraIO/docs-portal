...
\{dimensions: [Dimensions](/zh-CN/api-reference/flexible-classroom/web/api-reference/modules/agora-edu-core-src-stores-domain-common-widget-type#Dimensions); position: \{x: number; y: number \} \}
