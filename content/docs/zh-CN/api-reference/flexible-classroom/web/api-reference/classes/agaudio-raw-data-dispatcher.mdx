...
Returns [AGAudioRawDataDispatcher](/zh-CN/api-reference/flexible-classroom/web/api-reference/classes/agaudio-raw-data-dispatcher)
...
Returns [AgoraRteAudioRawDataConfig](/zh-CN/api-reference/flexible-classroom/web/api-reference/interfaces/agora-rte-audio-raw-data-config)
