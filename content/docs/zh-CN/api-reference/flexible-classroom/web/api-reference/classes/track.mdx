...
Returns [Track](/zh-CN/api-reference/flexible-classroom/web/classes/track)
...
Returns [TrackContext](/zh-CN/api-reference/flexible-classroom/web/modules/agora-edu-core-src-stores-domain-common-widget-type#TrackContext)
