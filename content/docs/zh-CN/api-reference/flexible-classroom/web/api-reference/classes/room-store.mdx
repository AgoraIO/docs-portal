...
Returns [HandUpProgress](/zh-CN/api-reference/flexible-classroom/web/api-reference/modules/agora-edu-core-src-stores-domain-common-room-type#HandUpProgress) []
...
Returns [CarouselSetting](/zh-CN/api-reference/flexible-classroom/web/api-reference/modules/agora-edu-core-src-stores-domain-common-room-type#CarouselSetting)
...
Returns undefined | [ExpandedScope](/zh-CN/api-reference/flexible-classroom/web/api-reference/modules/agora-edu-core-src-stores-domain-common-room-type#ExpandedScope)
...
Returns [RecordStatus](/zh-CN/api-reference/flexible-classroom/web/api-reference/enums/record-status)
...
Returns undefined | [RecordStreamingUrl](/zh-CN/api-reference/flexible-classroom/web/api-reference/modules/agora-edu-core-src-stores-domain-common-room-type#RecordStreamingUrl)
