...
Returns [AGRtmManager](/zh-CN/api-reference/flexible-classroom/web/classes/agrtm-manager)
...
Returns [AgoraRtmConnectionState](/zh-CN/api-reference/flexible-classroom/web/enums/agora-rtm-connection-state)
