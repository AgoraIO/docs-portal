...
Returns [AGRtmManager](/zh-CN/api-reference/flexible-classroom/web/api-reference/classes/agrtm-manager)
...
Returns [AgoraRtmConnectionState](/zh-CN/api-reference/flexible-classroom/web/api-reference/enums/agora-rtm-connection-state)
