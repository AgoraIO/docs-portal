...
Returns [AGRtcManager](/zh-CN/api-reference/flexible-classroom/web/api-reference/classes/agrtc-manager)
...
Returns [AGRtcChannel](/zh-CN/api-reference/flexible-classroom/web/api-reference/classes/agrtc-channel)
