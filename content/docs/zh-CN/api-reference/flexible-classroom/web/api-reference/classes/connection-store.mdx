...
undefined | [AgoraRteScene](/zh-CN/api-reference/flexible-classroom/web/api-reference/classes/agora-rte-scene)
...
[AGRtcState](/zh-CN/api-reference/flexible-classroom/web/api-reference/enums/agrtc-state)
