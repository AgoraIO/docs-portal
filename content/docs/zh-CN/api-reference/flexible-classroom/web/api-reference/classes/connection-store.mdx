...
Returns undefined | [AgoraRteScene](/zh-CN/api-reference/flexible-classroom/web/classes/agora-rte-scene)
...
Returns [AGRtcState](/zh-CN/api-reference/flexible-classroom/web/enums/agrtc-state)
