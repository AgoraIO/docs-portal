...
- [RtcAdapterBase](/zh-CN/api-reference/flexible-classroom/web/classes/rtc-adapter-base)
...
Returns [RtcAdapterWeb](/zh-CN/api-reference/flexible-classroom/web/classes/rtc-adapter-web)
...
Returns [AGChannelProfile](/zh-CN/api-reference/flexible-classroom/web/enums/agchannel-profile)
...
Returns [RtcChannelAdapterBase](/zh-CN/api-reference/flexible-classroom/web/classes/rtc-channel-adapter-base)
