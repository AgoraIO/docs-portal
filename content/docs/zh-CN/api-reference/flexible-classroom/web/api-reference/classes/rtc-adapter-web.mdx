...
Returns [RtcAdapterWeb](/zh-CN/api-reference/flexible-classroom/web/api-reference/classes/rtc-adapter-web)
...
Returns [AGChannelProfile](/zh-CN/api-reference/flexible-classroom/web/api-reference/enums/agchannel-profile)
