...
- [ApiBase](/zh-CN/api-reference/flexible-classroom/web/classes/api-base)
...
Returns [EduApiService](/zh-CN/api-reference/flexible-classroom/web/classes/edu-api-service)
