...
Returns [AgoraRteSubscribeThread](/zh-CN/api-reference/flexible-classroom/web/api-reference/classes/agora-rte-subscribe-thread)
...
Returns undefined | [AgoraRtcVideoCanvas](/zh-CN/api-reference/flexible-classroom/web/api-reference/classes/agora-rtc-video-canvas)
