...
Returns [AgoraRteLocalUser](/zh-CN/api-reference/flexible-classroom/web/api-reference/classes/agora-rte-local-user)
...
Returns [AgoraUser](/zh-CN/api-reference/flexible-classroom/web/api-reference/classes/agora-user)
