...
Returns [AgoraRteSubscribeThread](/zh-CN/api-reference/flexible-classroom/electron/classes/agora-rte-subscribe-thread)
...
Returns undefined | [AgoraRtcVideoCanvas](/zh-CN/api-reference/flexible-classroom/electron/classes/agora-rtc-video-canvas)
