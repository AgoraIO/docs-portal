...
Returns [Track](/zh-CN/api-reference/flexible-classroom/electron/classes/track)
...
Returns [TrackContext](/zh-CN/api-reference/flexible-classroom/electron/modules/agora-edu-core-src-stores-domain-common-widget-type#TrackContext)
