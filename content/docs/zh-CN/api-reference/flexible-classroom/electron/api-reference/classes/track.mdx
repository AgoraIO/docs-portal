...
Returns [Track](/zh-CN/api-reference/flexible-classroom/electron/api-reference/classes/track)
...
Returns [TrackContext](/zh-CN/api-reference/flexible-classroom/electron/api-reference/modules/agora-edu-core-src-stores-domain-common-widget-type#TrackContext)
