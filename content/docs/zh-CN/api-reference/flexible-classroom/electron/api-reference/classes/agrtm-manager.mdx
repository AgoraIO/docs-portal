...
Returns [AGRtmManager](/zh-CN/api-reference/flexible-classroom/electron/classes/agrtm-manager)
...
Returns [AgoraRtmConnectionState](/zh-CN/api-reference/flexible-classroom/electron/enums/agora-rtm-connection-state)
