...
Returns [RtcAdapterBase](/zh-CN/api-reference/flexible-classroom/electron/api-reference/classes/rtc-adapter-base)
...
Returns Promise &lt; void | [AGSnapshotInfo](/zh-CN/api-reference/flexible-classroom/electron/api-reference/interfaces/agsnapshot-info) &gt;
