...
Returns undefined | [AgoraRteScene](/zh-CN/api-reference/flexible-classroom/electron/classes/agora-rte-scene)
...
Returns [AGRtcState](/zh-CN/api-reference/flexible-classroom/electron/enums/agrtc-state)
