...
Returns undefined | [AgoraRteScene](/zh-CN/api-reference/flexible-classroom/electron/api-reference/classes/agora-rte-scene)
...
Returns [AGRtcState](/zh-CN/api-reference/flexible-classroom/electron/api-reference/enums/agrtc-state)
