...
Returns [AGAudioRawDataDispatcher](/zh-CN/api-reference/flexible-classroom/electron/api-reference/classes/agaudio-raw-data-dispatcher)
...
Returns [AgoraRteAudioRawDataConfig](/zh-CN/api-reference/flexible-classroom/electron/api-reference/interfaces/agora-rte-audio-raw-data-config)
