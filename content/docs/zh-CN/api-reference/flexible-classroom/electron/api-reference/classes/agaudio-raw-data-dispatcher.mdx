...
Returns [AGAudioRawDataDispatcher](/zh-CN/api-reference/flexible-classroom/electron/classes/agaudio-raw-data-dispatcher)
...
Returns [AgoraRteAudioRawDataConfig](/zh-CN/api-reference/flexible-classroom/electron/interfaces/agora-rte-audio-raw-data-config)
