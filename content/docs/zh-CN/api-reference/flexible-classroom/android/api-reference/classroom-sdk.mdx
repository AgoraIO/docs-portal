...
ExtApp 是灵动课堂 UIKit 的补充插件。详见[自定义插件](/zh-CN/solutions/flexible-classroom/build/customize-classroom-experience/widget)。
...
| `rtmToken` | 用于鉴权的 RTM Token，详见[使用 AccessToken 鉴权](/zh-CN/solutions/flexible-classroom/build/create-classroom/generate-token)。 |
