...
| `rtmToken` | （必填）用于鉴权的 RTM Token。详见[使用 Token 鉴权](/zh-CN/solutions/flexible-classroom/basic-features/generate-token.android.javascript)。 |
...
主副设备介绍详见 [userUuid 的填写方式](/zh-CN/solutions/flexible-classroom/get-started/integrate.javascript)。
