...
使用正确的配置启动智能体后，你可以通过调用 [POST 开启云端录制](/doc/cloud-recording/restful/cloud-recording/operations/post-v1-apps-appid-cloud_recording-resourceid-resourceid-mode-mode-start)启动云端录制服务。
