...
声网推荐你在后端生成 Token，前端调用生成的 Token，详情参考[使用 Token 鉴权](/zh-CN/solutions/flexible-classroom/build/setup-and-access/generate-token)。
...
其他相关服务端错误码可参考[响应状态码](/zh-CN/solutions/flexible-classroom/reference/response-code)。
