...
删除 `bg-black` 即可。更多自定义 UI 信息参考[自定义课堂 UI](/zh-CN/solutions/flexible-classroom/build/customize-and-extend/custom-ui)。
...
更多自定义 UI 信息参考[自定义课堂 UI](/zh-CN/solutions/flexible-classroom/build/customize-and-extend/custom-ui)。
...
如有更多需求，可[下载源码](/zh-CN/solutions/flexible-classroom/reference/downloads)并参照[自定义课堂 UI](/zh-CN/solutions/flexible-classroom/build/customize-and-extend/custom-ui)进行修改定制。
