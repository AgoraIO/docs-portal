...
Windows 7 系统中开启 Aero 主题特效时，窗口具有 [WS_EX_LAYERED](https://docs.microsoft.com/en-us/windows/win32/winmsg/extended-window-styles) 属性，RTC SDK 通过 GDI（Graphics Device Interface）DC（Device Context）拷贝方式拿到的窗口图像为黑色。
