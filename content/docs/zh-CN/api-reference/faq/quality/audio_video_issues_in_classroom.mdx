...
![打开权限 1](/img/flexible-classroom/browser-setting.png)

点击**摄像头**：

![打开权限 2](/img/flexible-classroom/browser-camera.png)

勾选**设置网站可以请求使用您的摄像头**：

![打开权限 3](/img/flexible-classroom/browser-camera-grant.png)
...
![禁用视频设备](/img/flexible-classroom/audio-video-disable-1.png)

- 音频被禁用：

![禁用音频设备](/img/flexible-classroom/audio-video-disable-2.png)
...
![设置屏幕共享带声音](/img/flexible-classroom/screensharewithaudio001.png)
...
![传入虚拟声卡的名称](/img/flexible-classroom/screensharewithaudio002.png)
