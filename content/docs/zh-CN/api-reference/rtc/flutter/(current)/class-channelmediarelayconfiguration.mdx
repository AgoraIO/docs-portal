...
_migration:
  type: generated-html
  status: migrated
  sourceUrl: https://doc.shengwang.cn/api-ref/rtc/flutter/API/class_channelmediarelayconfiguration
  sourcePath: html-docs/rtc/Flutter/API/class_channelmediarelayconfiguration.html
  generator: oxygen
  warnings: []
---
...
源频道信息 [ChannelMediaInfo](/zh-CN/api-reference/rtc/flutter/class-channelmediainfo)，包含如下成员：
...
目标频道信息 [ChannelMediaInfo](/zh-CN/api-reference/rtc/flutter/class-channelmediainfo)，包含如下成员：
...
目标频道数量，默认值为 0，取值范围为 [0,6]。该参数应与你在 `destInfos` 中定义的 [ChannelMediaInfo](/zh-CN/api-reference/rtc/flutter/class-channelmediainfo) 数组的数目一致。
