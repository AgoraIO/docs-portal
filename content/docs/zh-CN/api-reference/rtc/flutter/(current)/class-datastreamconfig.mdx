...
设置数据流与音频流同步后，如果数据包的延迟在音频延迟的范围内，SDK 会在播放音频的同时触发与该音频包同步的 [onStreamMessage](/zh-CN/api-reference/rtc/flutter/datastream#callback_irtcengineeventhandler_onstreammessage) 回调。
