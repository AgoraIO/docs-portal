...
_migration:
  type: generated-html
  status: migrated
  sourceUrl: https://doc.shengwang.cn/api-ref/rtc/flutter/API/class_virtualbackgroundsource
  sourcePath: html-docs/rtc/Flutter/API/class_virtualbackgroundsource.html
  generator: oxygen
  warnings: []
---
