...
_migration:
  type: generated-html
  status: migrated
  sourceUrl: https://doc.shengwang.cn/api-ref/rtc/flutter/API/callback_ifaceinfoobserver_onfaceinfo
  sourcePath: html-docs/rtc/Flutter/API/callback_ifaceinfoobserver_onfaceinfo.html
  generator: oxygen
  warnings: []
---
...
- [FaceInfoObserver](/zh-CN/api-reference/rtc/flutter/rtc-interface-class#class_ifaceinfoobserver)
