...
### audio-context-state-changed [#event_audio_context_state_changed]
...
### autoplay-failed [#event_autoplay_failed]
...
### camera-changed [#event_camera_changed]
...
### microphone-changed [#event_microphone_changed]
...
### playback-device-changed [#event_playback_device_changed]
...
### security-policy-violation [#event_security_policy_violation]
...
### Optional onAudioAutoplayFailed [#onaudioautoplayfailed]
...
### Optional onAutoplayFailed [#onautoplayfailed]
...
### Optional onCameraChanged [#oncamerachanged]
...
### Optional onMicrophoneChanged [#onmicrophonechanged]
...
### Optional onPlaybackDeviceChanged [#onplaybackdevicechanged]
...
### Optional onSecurityPolicyViolation [#onsecuritypolicyviolation]
...
### processExternalMediaAEC [#processexternalmediaaec]
...
### startLastmileProbeTest [#startlastmileprobetest]
