...
description: "LiveStreamingTranscodingConfig API 参考。"
---
...
### Optional audioBitrate [#audiobitrate]
...
### Optional audioChannels [#audiochannels]
...
### Optional audioSampleRate [#audiosamplerate]
...
### Optional transcodingUsers [#transcodingusers]
...
### Optional userConfigExtraInfo [#userconfigextrainfo]
...
### Optional videoBitrate [#videobitrate]
...
### Optional videoCodecProfile [#videocodecprofile]
...
### Optional videoFrameRate [#videoframerate]
