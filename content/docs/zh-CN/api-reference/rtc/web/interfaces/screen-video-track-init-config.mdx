...
### Optional electronScreenSourceId [#electronscreensourceid]
...
### Optional monitorTypeSurfaces [#monitortypesurfaces]
...
### Optional preferCurrentTab [#prefercurrenttab]
...
### Optional screenSourceType [#screensourcetype]
...
### Optional selfBrowserSurface [#selfbrowsersurface]
...
### Optional surfaceSwitching [#surfaceswitching]
...
### Optional systemAudio [#systemaudio]
...
### Optional windowAudio [#windowaudio]
