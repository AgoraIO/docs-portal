...
_migration:
  type: manual-mdx
  status: migrated
  sourceUrl: https://doc.shengwang.cn/api-ref/rtc/android/error-code
  sourcePath: docs-api-reference/rtc/error-code.mdx
  generator: legacy-mdx
  sourceUrls:
    - https://doc.shengwang.cn/api-ref/rtc/android/error-code
    - https://doc.shengwang.cn/api-ref/rtc/electron/error-code
    - https://doc.shengwang.cn/api-ref/rtc/flutter/error-code
    - https://doc.shengwang.cn/api-ref/rtc/harmonyos/error-code
    - https://doc.shengwang.cn/api-ref/rtc/ios/error-code
    - https://doc.shengwang.cn/api-ref/rtc/macos/error-code
    - https://doc.shengwang.cn/api-ref/rtc/rn/error-code
    - https://doc.shengwang.cn/api-ref/rtc/unity/error-code
    - https://doc.shengwang.cn/api-ref/rtc/unreal-blueprint/error-code
    - https://doc.shengwang.cn/api-ref/rtc/unreal-cpp/error-code
    - https://doc.shengwang.cn/api-ref/rtc/windows/error-code
  platforms:
    - android
    - electron
    - flutter
