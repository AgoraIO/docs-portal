...
description: "InspectConfiguration API reference."
---

视频截图上传配置，用于 [enableContentInspect](/zh-CN/api-reference/rtc/react-sdk/interfaces/iagora-rtcclient#enablecontentinspect)。
