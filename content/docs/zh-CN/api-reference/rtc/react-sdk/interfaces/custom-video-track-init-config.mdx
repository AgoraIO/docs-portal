...
description: "CustomVideoTrackInitConfig API reference."
---

创建自定义视频轨道时的配置参数，用于 [AgoraRTC.createCustomVideoTrack](/zh-CN/api-reference/rtc/react-sdk/interfaces/iagora-rtc#createcustomvideotrack)。
