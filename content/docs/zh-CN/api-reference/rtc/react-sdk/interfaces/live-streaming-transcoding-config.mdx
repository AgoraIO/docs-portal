...
管理 CDN 直播推流转码的接口，在调用 [AgoraRTCClient](/zh-CN/api-reference/rtc/react-sdk/interfaces/iagora-rtcclient#setlivetranscoding) 时使用。
...
推荐使用 [LiveStreamingTranscodingConfig.watermark](/zh-CN/api-reference/rtc/react-sdk/interfaces/live-streaming-transcoding-config#watermark) 为直播推流的视频添加水印。
