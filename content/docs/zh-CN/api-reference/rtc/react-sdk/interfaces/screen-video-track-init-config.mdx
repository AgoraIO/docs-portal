...
创建屏幕共享视频轨道时的配置对象，用于 [AgoraRTC.createScreenVideoTrack](/zh-CN/api-reference/rtc/react-sdk/interfaces/iagora-rtc#createscreenvideotrack)。
...
- 通过 [ScreenEncoderConfigurationPreset](/zh-CN/api-reference/rtc/react-sdk/globals#screenencoderconfigurationpreset) 传入 SDK 内置的编码配置。
- 通过传入一个 [VideoEncoderConfiguration](/zh-CN/api-reference/rtc/react-sdk/interfaces/video-encoder-configuration) 对象来自定义视频编码配置。
...
自 v4.17.1 起废弃，请改用 [displaySurface](/zh-CN/api-reference/rtc/react-sdk/interfaces/screen-video-track-init-config#displaysurface)。
