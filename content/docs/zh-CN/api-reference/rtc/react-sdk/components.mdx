...
| 属性名     | 类型               | 默认值 | 描述                                                                                                |
| ---------- | ------------------ | ------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `track`    | `ILocalVideoTrack` |  无    | 要播放的本地视频轨道。通过 [`useLocalCameraTrack`](/zh-CN/api-reference/rtc/react-sdk/hooks#uselocalcameratrack) 或 Web SDK 的 [`IAgoraRTC.createScreenVideoTrack`](/api-ref/rtc/react/interfaces/iagorartc.html#createscreenvideotrack) 创建。 |
...
| `playVideo` | `boolean` | [user.hasVideo](/api-ref/rtc/react/interfaces/iagorartcremoteuser.html#hasvideo) 属性的值 | <Slot name="components-slot-7-3-3" /> |
| `playAudio` | `boolean` | [user.hasAudio](/api-ref/rtc/react/interfaces/iagorartcremoteuser.html#hasaudio) 属性的值 | <Slot name="components-slot-7-4-3" /> |
| `playbackDeviceId` | `string`                      | 无                                                                                                                                                          | 要使用的播放设备 ID，例如扬声器。设备 ID 通过 [`IAgoraRTC.getPlaybackDevices`](/api-ref/rtc/react/interfaces/iagorartc.html#getplaybackdevices) 获取。该属性仅支持桌面端的 Chrome 浏览器，在其它浏览器上修改该属性的值将会抛出 `NOT_SUPPORTED` 错误。 |
| `volume`           | `number`                      | 无                                                                                                                                                          | 音量大小。取值范围 [0, 100]，0 代表静音，100 代表原始音量。                                                           |
