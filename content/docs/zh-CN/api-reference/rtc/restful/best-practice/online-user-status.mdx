...
_migration:
  type: manual-mdx
  status: migrated
  sourceUrl: https://doc.shengwang.cn/doc/rtc/restful/best-practice/online-user-status
  sourcePath: docs/rtc/best-practice/online-user-status.restful.mdx
...
开始前，请确保你的声网项目已经开启了消息通知服务。详见[接收 Webhook 事件](/zh-CN/api-reference/rtc/restful/webhook/receive-webhook)。
...
1. 开通声网消息通知服务，根据频道场景，至少监听以下频道事件回调：
   ...
   - [`103`](/zh-CN/api-reference/rtc/restful/webhook/events#103-broadcaster-join-channel)
   - [`105`](/zh-CN/api-reference/rtc/restful/webhook/events#105-audience-join-channel)
   - [`106`](/zh-CN/api-reference/rtc/restful/webhook/events#106-audience-leave-channel)
   - [`111`](/zh-CN/api-reference/rtc/restful/webhook/events#111-client-role-change-to-broadcaster)
   - [`112`](/zh-CN/api-reference/rtc/restful/webhook/events#112-client-role-change-to-audience)
