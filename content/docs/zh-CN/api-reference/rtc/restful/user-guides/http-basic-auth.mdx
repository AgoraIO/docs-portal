...
_migration:
  type: manual-mdx
  status: migrated
  sourceUrl: https://doc.shengwang.cn/doc/rtc/restful/user-guides/http-basic-auth
  sourcePath: docs/rtc/user-guides/http-basic-auth.restful.mdx
...
已经从声网控制台获取客户 ID 和客户密钥，详见[开通服务](/zh-CN/realtime-media/rtc/build/setup-and-access/enable-service)。
