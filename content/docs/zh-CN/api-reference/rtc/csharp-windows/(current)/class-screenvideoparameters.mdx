...
_migration:
  type: generated-html
  status: migrated
  sourcePath: html-docs/rtc/Csharp/API/class_screenvideoparameters.html
  generator: oxygen
  warnings: []
---
...
- 该值不代表最终视频输出的方向。详见 [ORIENTATION_MODE](/zh-CN/api-reference/rtc/csharp-windows/enum-orientationmode) 了解设置视频方向。
