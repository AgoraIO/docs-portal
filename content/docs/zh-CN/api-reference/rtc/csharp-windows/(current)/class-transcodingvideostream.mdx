...
_migration:
  type: generated-html
  status: migrated
  sourceUrl: https://doc.shengwang.cn/api-ref/rtc/csharp/API/class_transcodingvideostream
  sourcePath: html-docs/rtc/Csharp/API/class_transcodingvideostream.html
  generator: oxygen
  warnings: []
---
