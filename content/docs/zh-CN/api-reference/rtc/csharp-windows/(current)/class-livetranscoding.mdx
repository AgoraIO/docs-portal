...
_migration:
  type: generated-html
  status: migrated
  sourceUrl: https://doc.shengwang.cn/api-ref/rtc/csharp/API/class_livetranscoding
  sourcePath: html-docs/rtc/Csharp/API/class_livetranscoding.html
  generator: oxygen
  warnings: []
---
...
视频编码码率，单位为 Kbps。详见 [BITRATE](/zh-CN/api-reference/rtc/csharp-windows/enum-bitrate)。该参数无需设置，保留默认值 STANDARD_BITRATE 即可，SDK 会根据你设定的视频分辨率和帧率自动匹配最合适的码率。有关视频分辨率和帧率的对应关系，详见[视频属性](/zh-CN/realtime-media/rtc/build/video/video-profile)。
