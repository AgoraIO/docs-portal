...
_migration:
  type: generated-html
  status: migrated
  sourceUrl: https://doc.shengwang.cn/api-ref/rtc/csharp/API/class_encodedvideoframeinfo
  sourcePath: html-docs/rtc/Csharp/API/class_encodedvideoframeinfo.html
  generator: oxygen
  warnings: []
---
