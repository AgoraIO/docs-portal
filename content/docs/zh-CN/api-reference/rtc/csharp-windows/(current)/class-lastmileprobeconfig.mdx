...
用户期望的最高发送码率，单位为 bps，范围为 [100000,5000000]。建议参考 [SetVideoEncoderConfiguration](/zh-CN/api-reference/rtc/csharp-windows/video-basic#api_irtcengine_setvideoencoderconfiguration) 中的码率值设置该参数的值。
