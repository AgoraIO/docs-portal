...
连接模式。详见 [LocalProxyMode](/zh-CN/api-reference/rtc/react-native/enum-localproxymode)。

### `advancedConfig`

Local Access Point 的高级选项。详见 [AdvancedConfigInfo](/zh-CN/api-reference/rtc/react-native/class-advancedconfiginfo)。
