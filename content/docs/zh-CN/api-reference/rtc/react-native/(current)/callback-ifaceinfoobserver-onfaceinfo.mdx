...
_migration:
  type: generated-html
  status: migrated
  sourceUrl: https://doc.shengwang.cn/api-ref/rtc/rn/API/callback_ifaceinfoobserver_onfaceinfo
  sourcePath: html-docs/rtc/RN/API/callback_ifaceinfoobserver_onfaceinfo.html
  generator: oxygen
  warnings: []
---
...
- [IFaceInfoObserver](/zh-CN/api-reference/rtc/react-native/rtc-interface-class#class_ifaceinfoobserver)
