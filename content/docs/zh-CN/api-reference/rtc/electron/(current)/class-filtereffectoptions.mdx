...
_migration:
  type: generated-html
  status: migrated
  sourceUrl: https://doc.shengwang.cn/api-ref/rtc/electron/API/class_filtereffectoptions
  sourcePath: html-docs/rtc/Electron/API/class_filtereffectoptions.html
  generator: oxygen
  warnings: []
---
