...
_migration:
  type: generated-html
  status: migrated
  sourceUrl: https://doc.shengwang.cn/api-ref/rtc/electron/API/callback_ifaceinfoobserver_onfaceinfo
  sourcePath: html-docs/rtc/Electron/API/callback_ifaceinfoobserver_onfaceinfo.html
  generator: oxygen
  warnings: []
---
...
- [IFaceInfoObserver](/zh-CN/api-reference/rtc/electron/rtc-interface-class#class_ifaceinfoobserver)
