...
_migration:
  type: generated-html
  status: migrated
  sourceUrl: https://doc.shengwang.cn/api-ref/rtc/macos/API/class_metadata
  sourcePath: html-docs/rtc/macOS/API/class_metadata.html
  generator: oxygen
  warnings: []
---
...
- 对于接收方：发送该 [AgoraMetadata](/zh-CN/api-reference/rtc/macos/class-metadata) 的远端用户 ID。
- 对于发送方：忽略该字段。
...
发送该 [AgoraMetadata](/zh-CN/api-reference/rtc/macos/class-metadata) 时的时间戳（毫秒）。
