...
连接模式。详见 [AgoraLocalProxyMode](/zh-CN/api-reference/rtc/macos/enum-localproxymode)。

### `advancedConfig`

本地接入点的高级配置项。详见 [AdvancedConfigInfo](/zh-CN/api-reference/rtc/macos/class-advancedconfiginfo)。
