...
| --- | --- | --- |
| NO | NO | 接收端接收到数据包后，SDK 会立即触发 [rtcEngine:receiveStreamMessageFromUid:streamId:data:](/zh-CN/api-reference/rtc/macos/datastream#callback_irtcengineeventhandler_onstreammessage) 回调。 |
