...
_migration:
  type: generated-html
  status: migrated
  sourceUrl: https://doc.shengwang.cn/api-ref/rtc/macos/API/class_externalvideoframe
  sourcePath: html-docs/rtc/macOS/API/class_externalvideoframe.html
  generator: oxygen
  warnings: []
---
...
<a id="strideinpixels"></a>
<Parameter name="strideInPixels">
