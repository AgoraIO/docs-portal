...
_migration:
  type: generated-html
  status: migrated
  sourceUrl: https://doc.shengwang.cn/api-ref/rtc/macos/API/class_echotestconfiguration
  sourcePath: html-docs/rtc/macOS/API/class_echotestconfiguration.html
  generator: oxygen
  warnings: []
---
...
用于渲染本地用户视频的视图。该参数仅适用于测试视频设备的场景，即当 [enableVideo](/zh-CN/api-reference/rtc/macos/video/video-basic#api_irtcengine_enablevideo) 为 YES 时。
