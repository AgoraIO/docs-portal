...
_migration:
  type: generated-html
  status: migrated
  sourceUrl: https://doc.shengwang.cn/api-ref/rtc/harmonyos/API/class_videoframe
  sourcePath: html-docs/rtc/HarmonyOS/API/class_videoframe.html
  generator: oxygen
  warnings: []
---
...
<a id="sampleaspectratio"></a>
<Parameter name="sampleAspectRatio">
