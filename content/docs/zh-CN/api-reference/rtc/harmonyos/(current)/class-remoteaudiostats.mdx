...
_migration:
  type: generated-html
  status: migrated
  sourceUrl: https://doc.shengwang.cn/api-ref/rtc/harmonyos/API/class_remoteaudiostats
  sourcePath: html-docs/rtc/HarmonyOS/API/class_remoteaudiostats.html
  generator: oxygen
  warnings: []
---
...
:::caution
注意： 当接收端为观众且 [ClientRoleOptions](/zh-CN/api-reference/rtc/harmonyos/class-clientroleoptions) 的 audienceLatencyLevel 为 1 时，该参数不生效。
:::
