...
_migration:
  type: generated-html
  status: migrated
  sourceUrl: https://doc.shengwang.cn/api-ref/rtc/ios/API/class_videoencoderconfiguration
  sourcePath: html-docs/rtc/iOS/API/class_videoencoderconfiguration.html
  generator: oxygen
  warnings: []
---
...
编码视频帧的帧率（fps）。默认值为 15。详见 [AgoraVideoFrameRate](/zh-CN/api-reference/rtc/ios/enum-framerate)。
...
设置本地视频流发布时的镜像模式，仅影响远端用户看到的视频。详见 [AgoraVideoMirrorMode](/zh-CN/api-reference/rtc/ios/enum-videomirrormodetype)。
...
在带宽受限的情况下的视频降级偏好。详见 [AgoraDegradationPreference](/zh-CN/api-reference/rtc/ios/enum-degradationpreference)。
...
视频编码的高级选项。详见 [AgoraAdvancedVideoOptions](/zh-CN/api-reference/rtc/ios/class-advanceoptions)。
...
- [initWithSize\:frameRate\:bitrate\:orientationMode\:mirrorMode:](/zh-CN/api-reference/rtc/ios/api-videoencoderconfiguration-initwithsize)
- [initWithWidth\:height\:frameRate\:bitrate\:orientationMode\:mirrorMode:](/zh-CN/api-reference/rtc/ios/api-videoencoderconfiguration-initwithwidth)
