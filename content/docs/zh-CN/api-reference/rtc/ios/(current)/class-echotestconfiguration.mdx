...
_migration:
  type: generated-html
  status: migrated
  sourceUrl: https://doc.shengwang.cn/api-ref/rtc/ios/API/class_echotestconfiguration
  sourcePath: html-docs/rtc/iOS/API/class_echotestconfiguration.html
  generator: oxygen
  warnings: []
---
...
用于渲染本地用户视频的视图。该参数仅适用于测试视频设备的场景，即当 [enableVideo](/zh-CN/api-reference/rtc/ios/video/video-basic#api_irtcengine_enablevideo) 为 YES 时。
