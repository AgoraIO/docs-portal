...
_migration:
  type: generated-html
  status: migrated
  sourceUrl: https://doc.shengwang.cn/api-ref/rtc/ios/API/class_externalvideoframe
  sourcePath: html-docs/rtc/iOS/API/class_externalvideoframe.html
  generator: oxygen
  warnings: []
---
...
Alpha 通道拼接模式，表示 `alphaBuf` 与视频帧的相对位置。详见 [AgoraAlphaStitchMode](/zh-CN/api-reference/rtc/ios/enum-alphastitchmode)。
