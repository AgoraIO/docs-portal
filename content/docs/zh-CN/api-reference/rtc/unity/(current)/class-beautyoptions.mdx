...
_migration:
  type: generated-html
  status: migrated
  sourceUrl: https://doc.shengwang.cn/api-ref/rtc/unity/API/class_beautyoptions
  sourcePath: html-docs/rtc/Unity/API/class_beautyoptions.html
  generator: oxygen
  warnings: []
---
...
对比度，常与 `lighteningLevel` 搭配使用。取值越大，明暗对比程度越大。详见 [LIGHTENING_CONTRAST_LEVEL](/zh-CN/api-reference/rtc/unity/enum-lighteningcontrastlevel)。
