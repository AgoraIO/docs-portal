...
_migration:
  type: generated-html
  status: migrated
  sourceUrl: https://doc.shengwang.cn/api-ref/rtc/unity/API/class_videoencoderconfiguration
  sourcePath: html-docs/rtc/Unity/API/class_videoencoderconfiguration.html
  generator: oxygen
  warnings: []
---
...
:::note
注： 当该参数设置为 MAINTAIN_FRAMERATE (1) 或者 MAINTAIN_BALANCED (2) 时，需要同时将 `orientationMode` 设置为 ORIENTATION_MODE_ADAPTIVE (0)，否则设置不生效。
:::
