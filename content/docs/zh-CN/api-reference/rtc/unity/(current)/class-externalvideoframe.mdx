...
_migration:
  type: generated-html
  status: migrated
  sourceUrl: https://doc.shengwang.cn/api-ref/rtc/unity/API/class_externalvideoframe
  sourcePath: html-docs/rtc/Unity/API/class_externalvideoframe.html
  generator: oxygen
  warnings: []
---
...
视频类型。详见 [VIDEO_BUFFER_TYPE](/zh-CN/api-reference/rtc/unity/enum-videobuffertype)。

</Parameter>
<a id="format"></a>
<Parameter name="format">

像素格式。详见 [VIDEO_PIXEL_FORMAT](/zh-CN/api-reference/rtc/unity/enum-videopixelformat)。
...
当视频帧中包含 Alpha 通道数据时，设置 `alphaBuffer` 和视频帧的相对位置。详见 [ALPHA_STITCH_MODE](/zh-CN/api-reference/rtc/unity/enum-alphastitchmode)。
