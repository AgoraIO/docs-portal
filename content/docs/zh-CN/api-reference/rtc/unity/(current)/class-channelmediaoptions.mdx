...
[RtcConnection](/zh-CN/api-reference/rtc/unity/class-rtcconnection) `publishMicrophoneTrack` `publishCustomAudioTrack` `publishMediaPlayerAudioTrack` true `publishCameraTrack` `publishScreenCaptureVideo`、 `publishScreenTrack`、 `publishCustomVideoTrack` `publishEncodedVideoTrack` true
