...
_migration:
  type: generated-html
  status: migrated
  sourceUrl: https://doc.shengwang.cn/api-ref/rtc/unity/API/callback_ifaceinfoobserver_onfaceinfo
  sourcePath: html-docs/rtc/Unity/API/callback_ifaceinfoobserver_onfaceinfo.html
  generator: oxygen
  warnings: []
---
...
- [IFaceInfoObserver](/zh-CN/api-reference/rtc/unity/rtc-interface-class#class_ifaceinfoobserver)
