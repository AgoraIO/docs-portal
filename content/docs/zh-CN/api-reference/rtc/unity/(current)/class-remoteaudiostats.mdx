...
_migration:
  type: generated-html
  status: migrated
  sourceUrl: https://doc.shengwang.cn/api-ref/rtc/unity/API/class_remoteaudiostats
  sourcePath: html-docs/rtc/Unity/API/class_remoteaudiostats.html
  generator: oxygen
  warnings: []
---
...
远端用户发送的音频流质量。详见 [QUALITY_TYPE](/zh-CN/api-reference/rtc/unity/enum-qualitytype)。
...
:::note
注： 当接收端为观众且 [ClientRoleOptions](/zh-CN/api-reference/rtc/unity/class-clientroleoptions) 的 `audienceLatencyLevel` 为 1 时，该参数不生效。
:::
...
接收远端音频时，本地用户的主观体验质量。详见 [EXPERIENCE_QUALITY_TYPE](/zh-CN/api-reference/rtc/unity/enum-experiencequalitytype)。

</Parameter>
<a id="qualitychangedreason"></a>
<Parameter name="qualityChangedReason">

接收远端音频时，本地用户主观体验质量较差的原因。详见 [EXPERIENCE_POOR_REASON](/zh-CN/api-reference/rtc/unity/enum-experiencepoorreason)。
