...
要发布的自定义音频轨道的 ID。默认值为 0。你可以通过 [createCustomAudioTrack](/zh-CN/api-reference/rtc/cpp-all-platforms/audio-custom-capturenrendering#api_imediaengine_createcustomaudiotrack_imediaengine) 获取自定义音频轨道 ID。
