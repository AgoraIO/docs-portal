...
:::info[注]
@deprecated 在音视频同步场景中，可通过 [RemoteAudioStats](/zh-CN/api-reference/rtc/cpp-all-platforms/class-remoteaudiostats) 中的 `networkTransportDelay` 和 `jitterBufferDelay` 获取视频延迟数据。
:::
