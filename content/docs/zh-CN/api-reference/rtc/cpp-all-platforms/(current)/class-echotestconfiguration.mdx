...
_migration:
  type: generated-html
  status: migrated
  sourceUrl: https://doc.shengwang.cn/api-ref/rtc/windows/API/class_echotestconfiguration
  sourcePath: html-docs/rtc/Cpp/API/class_echotestconfiguration.html
  generator: oxygen
  warnings: []
---
...
用于渲染本地用户视频的视图。该参数仅在 [enableVideo](/zh-CN/api-reference/rtc/cpp-all-platforms/video/video-basic#api_irtcengine_enablevideo) 为 true 时生效。
