...
- 为达到更好的效果，建议在调用 SetVoiceBeautifierPreset 前将 SetAudioProfile 的 profile 参数设置为 AUDIO_PROFILE_MUSIC_HIGH_QUALITY (4) 或 AUDIO_PROFILE_MUSIC_HIGH_QUALITY_STEREO (5)，且 scenario 参数设置为 AUDIO_SCENARIO_GAME_STREAMING (3)。
