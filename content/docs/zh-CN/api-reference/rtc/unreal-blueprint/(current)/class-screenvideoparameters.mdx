---
title: FScreenVideoParameters
description: 共享屏幕流的视频编码配置。
_migration:
  type: generated-html
  status: migrated
  sourceUrl: https://doc.shengwang.cn/api-ref/rtc/unreal-blueprint/API/class_screenvideoparameters
  sourcePath: html-docs/rtc/Unreal-blueprint/API/class_screenvideoparameters.html
  generator: oxygen
  warnings: []
---
...
- 该值不代表最终视频输出的方向。详见 [EUABT_ORIENTATION_MODE](/zh-CN/api-reference/rtc/unreal-blueprint/enum-orientationmode) 了解设置视频方向。
...
屏幕共享视频的内容类型。详见 [EVIDEO_CONTENT_HINT](/zh-CN/api-reference/rtc/unreal-blueprint/enum-videocontenthint)。
