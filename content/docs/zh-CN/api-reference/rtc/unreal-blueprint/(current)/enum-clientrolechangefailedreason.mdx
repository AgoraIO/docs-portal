...
4: 网络连接断开。可根据 [OnConnectionStateChanged](/zh-CN/api-reference/rtc/unreal-blueprint/toc-network#callback_irtcengineeventhandler_onconnectionstatechanged) 报告的 reason，排查网络连接失败的具体原因。
