...
如需实现立体声，你还需要调用 [SetAdvancedAudioOptions](/zh-CN/api-reference/rtc/unreal-blueprint/toc-audio-effect#api_irtcengine_setadvancedaudiooptions) 并在 FAdvancedAudioOptions 中设置 audioProcessingChannels 为 AUDIO_PROCESSING_STEREO。
