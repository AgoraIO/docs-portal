---
title: FUABT_FilterEffectOptions
description: 滤镜效果选项。
_migration:
  type: generated-html
  status: migrated
  sourceUrl: https://doc.shengwang.cn/api-ref/rtc/unreal-blueprint/API/class_filtereffectoptions
  sourcePath: html-docs/rtc/Unreal-blueprint/API/class_filtereffectoptions.html
  generator: oxygen
  warnings: []
---
