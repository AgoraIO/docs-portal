...
:::info[注]
如果你设置关闭自动播放，打开媒体文件后，请调用 [Play](/zh-CN/api-reference/rtc/unreal-blueprint/toc-mediaplayer-control#api_imediaplayer_play) 方法来播放媒体文件。
:::
...
如果你在本地播放和发布音频至远端时，需要设置不同的音轨，你需要将该参数设为 `true`，然后再调用 [SelectMultiAudioTrack](/zh-CN/api-reference/rtc/unreal-blueprint/toc-audio-mixing#api_imediaplayer_selectmultiaudiotrack) 方法来设置音轨。
