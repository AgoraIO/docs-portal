...
_migration:
  type: generated-html
  status: migrated
  sourceUrl: https://doc.shengwang.cn/api-ref/rtc/unreal-blueprint/API/class_screencaptureconfiguration
  sourcePath: html-docs/rtc/Unreal-blueprint/API/class_screencaptureconfiguration.html
  generator: oxygen
  warnings: []
---
