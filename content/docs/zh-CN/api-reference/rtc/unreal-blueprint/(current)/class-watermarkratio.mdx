---
title: FWatermarkRatio
description: 水印在屏幕中的位置和大小。
_migration:
  type: generated-html
  status: migrated
  sourceUrl: https://doc.shengwang.cn/api-ref/rtc/unreal-blueprint/API/class_watermarkratio
  sourcePath: html-docs/rtc/Unreal-blueprint/API/class_watermarkratio.html
  generator: oxygen
  warnings: []
---
