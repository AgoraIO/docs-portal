...
_migration:
  type: generated-html
  status: migrated
  sourceUrl: https://doc.shengwang.cn/api-ref/rtc/unreal-blueprint/API/class_virtualbackgroundsource
  sourcePath: html-docs/rtc/Unreal-blueprint/API/class_virtualbackgroundsource.html
  generator: oxygen
  warnings: []
---
...
:::caution
注意： 该参数仅在自定义背景图类型为 BACKGROUND_IMG 或 BACKGROUND_VIDEO 时生效。
:::
