---
title: FEchoTestConfiguration
description: 音视频通话回路测试的配置。
_migration:
  type: generated-html
  status: migrated
  sourceUrl: https://doc.shengwang.cn/api-ref/rtc/unreal-blueprint/API/class_echotestconfiguration
  sourcePath: html-docs/rtc/Unreal-blueprint/API/class_echotestconfiguration.html
  generator: oxygen
  warnings: []
---
