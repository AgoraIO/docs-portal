...
_migration:
  type: generated-html
  status: migrated
  sourceUrl: https://doc.shengwang.cn/api-ref/rtc/unreal-blueprint/API/class_watermarkoptions
  sourcePath: html-docs/rtc/Unreal-blueprint/API/class_watermarkoptions.html
  generator: oxygen
  warnings: []
---
