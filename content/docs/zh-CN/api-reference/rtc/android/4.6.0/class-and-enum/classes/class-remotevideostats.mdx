...
该字段已废弃。在音视频同步场景下，你可以通过 [RemoteAudioStats](/zh-CN/api-reference/rtc/android/4.6.0/class-and-enum/classes/class-remoteaudiostats) 中的 `networkTransportDelay` 和 `jitterBufferDelay` 获取视频延迟数据。视频延迟（毫秒）。
