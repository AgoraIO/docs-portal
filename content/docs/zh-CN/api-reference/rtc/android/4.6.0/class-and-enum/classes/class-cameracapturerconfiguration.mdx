...
（可选）摄像头朝向。详见 [CAMERA_DIRECTION](/zh-CN/api-reference/rtc/android/4.6.0/class-and-enum/enums/enum-cameradirection)。
...
（可选）摄像头焦距类型。详见 [CAMERA_FOCAL_LENGTH_TYPE](/zh-CN/api-reference/rtc/android/4.6.0/class-and-enum/enums/enum-camerafocallengthtype)。
...
（可选）视频帧的格式。详见 [CaptureFormat](/zh-CN/api-reference/rtc/android/4.6.0/class-and-enum/classes/class-videoformat)。

### `followEncodeDimensionRatio`

（可选）是否遵循 [setVideoEncoderConfiguration](/zh-CN/api-reference/rtc/android/4.6.0/video/video-basic#api_irtcengine_setvideoencoderconfiguration) 中设置的视频宽高比。
