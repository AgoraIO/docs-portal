...
媒体输出流的音频采样率（Hz）。详见 [AudioSampleRateType](/zh-CN/api-reference/rtc/android/4.6.0/class-and-enum/enums/enum-audiosampleratetype)。
...
媒体推流使用的音频编码器配置类型。详见 [AudioCodecProfileType](/zh-CN/api-reference/rtc/android/4.6.0/class-and-enum/enums/enum-audiocodecprofiletype)。

### `videoCodecProfile`

媒体推流使用的视频编码器配置类型。可设置为 66、77 或默认值 100。详见 [VideoCodecProfileType](/zh-CN/api-reference/rtc/android/4.6.0/class-and-enum/enums/enum-videocodecprofiletype)。
...
媒体推流使用的视频编码器类型。详见 [VideoCodecType](/zh-CN/api-reference/rtc/android/4.6.0/class-and-enum/enums/enum-videocodectypeforstream)。
