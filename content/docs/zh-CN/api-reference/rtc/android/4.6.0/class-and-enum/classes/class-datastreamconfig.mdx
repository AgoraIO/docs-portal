...
| --- | --- | --- |
| false | false | 接收端接收到数据包后，SDK 会立即触发 [onStreamMessage](/zh-CN/api-reference/rtc/android/4.6.0/metadata/datastream#callback_irtcengineeventhandler_onstreammessage) 回调。 |
