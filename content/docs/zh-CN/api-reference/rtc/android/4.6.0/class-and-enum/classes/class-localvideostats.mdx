...
本地视频使用的编码器类型。可选值如下，详见 [VIDEO_CODEC_TYPE](/zh-CN/api-reference/rtc/android/4.6.0/class-and-enum/enums/enum-videocodectype)：
...
:::info[注]
等待几秒后，可从下一次回调中的 `captureBrightnessLevel` 获取亮度等级。
:::
