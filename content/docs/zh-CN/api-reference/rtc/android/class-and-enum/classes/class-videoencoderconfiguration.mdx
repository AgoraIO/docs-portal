...
详见 [VideoDimensions](/zh-CN/api-reference/rtc/android/class-and-enum/classes/class-videodimensions)。

### `frameRate`

编码视频帧的帧率（fps）。默认值为 15。详见 [FRAME_RATE](/zh-CN/api-reference/rtc/android/class-and-enum/enums/enum-framerate)。
...
编码视频的方向模式。详见 [ORIENTATION_MODE](/zh-CN/api-reference/rtc/android/class-and-enum/enums/enum-orientationmode)。

### `degradationPrefer`

带宽受限时的视频编码降级偏好。详见 [DEGRADATION_PREFERENCE](/zh-CN/api-reference/rtc/android/class-and-enum/enums/enum-degradationpreference)。
...
视频编码的高级选项。详见 [AdvanceOptions](/zh-CN/api-reference/rtc/android/class-and-enum/classes/class-advanceoptions)。

### `codecType`

本地视频流的首选编码器类型。详见 [VIDEO_CODEC_TYPE](/zh-CN/api-reference/rtc/android/class-and-enum/enums/enum-videocodectype)。
