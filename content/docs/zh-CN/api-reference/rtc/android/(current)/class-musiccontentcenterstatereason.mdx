...
### MUSIC_CONTENT_CENTER_STATE_REASON_ERROR

1：通用错误，无具体原因归属。

### MUSIC_CONTENT_CENTER_STATE_REASON_GATEWAY
...
### MUSIC_CONTENT_CENTER_STATE_REASON_MUSIC_LOADING

5：加载音乐资源时发生错误。请[联系技术支持](https://ticket.shengwang.cn/)。

### MUSIC_CONTENT_CENTER_STATE_REASON_MUSIC_DECRYPTION
