...
- 启用此参数后，声网建议你以固定周期（如 30 毫秒）调用 [updatePlayerPositionInfo](/zh-CN/api-reference/rtc/android/spatial-audio#api_ibasespatialaudioengine_updateplayerpositioninfo)、 [updateSelfPosition](/zh-CN/api-reference/rtc/android/spatial-audio#api_ibasespatialaudioengine_updateselfposition)、 [updateRemotePosition](/zh-CN/api-reference/rtc/android/spatial-audio#api_ilocalspatialaudioengine_updateremoteposition) 方法持续更新声源与接收器之间的相对距离。
