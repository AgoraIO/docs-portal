...
_migration:
  type: generated-html
  status: migrated
  sourceUrl: https://doc.shengwang.cn/api-ref/rtc/android/API/class_audioencodedframeobserverconfig
  sourcePath: html-docs/rtc/Android/API/class_audioencodedframeobserverconfig.html
  generator: oxygen
  warnings: []
---
