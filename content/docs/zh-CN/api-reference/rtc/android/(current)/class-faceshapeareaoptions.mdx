...
_migration:
  type: generated-html
  status: migrated
  sourceUrl: https://doc.shengwang.cn/api-ref/rtc/android/API/class_faceshapeareaoptions
  sourcePath: html-docs/rtc/Android/API/class_faceshapeareaoptions.html
  generator: oxygen
  warnings: []
---
