...
（可选）摄像头朝向。详见 [CAMERA_DIRECTION](/zh-CN/api-reference/rtc/android/class-and-enum/enums/enum-cameradirection)。
...
（可选）摄像头焦距类型。详见 [CAMERA_FOCAL_LENGTH_TYPE](/zh-CN/api-reference/rtc/android/class-and-enum/enums/enum-camerafocallengthtype)。
...
（可选）视频帧的格式。详见 [CaptureFormat](/zh-CN/api-reference/rtc/android/class-and-enum/classes/class-videoformat)。
