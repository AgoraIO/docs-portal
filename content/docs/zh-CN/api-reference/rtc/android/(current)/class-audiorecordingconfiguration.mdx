...
_migration:
  type: generated-html
  status: migrated
  sourceUrl: https://doc.shengwang.cn/api-ref/rtc/android/API/class_audiorecordingconfiguration
  sourcePath: html-docs/rtc/Android/API/class_audiorecordingconfiguration.html
  generator: oxygen
  warnings: []
---
