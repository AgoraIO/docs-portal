...
_migration:
  type: generated-html
  status: migrated
  sourceUrl: https://doc.shengwang.cn/api-ref/rtc/android/API/class_virtualbackgroundsource
  sourcePath: html-docs/rtc/Android/API/class_virtualbackgroundsource.html
  generator: oxygen
  warnings: []
---
...
:::note
注： 该参数仅在背景类型为 `BACKGROUND_BLUR` 时生效。
:::
