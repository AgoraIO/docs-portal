...
- `BACKGROUND_NONE` (0)：仅进行背景与人物分割处理，不替换背景图像。设置该值后，可调用 [startLocalVideoTranscoder](/zh-CN/api-reference/rtc/android/local-transcoder#api_irtcengine_startlocalvideotranscoder) 实现画中画效果。
