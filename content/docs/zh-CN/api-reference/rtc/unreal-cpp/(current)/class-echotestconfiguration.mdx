...
_migration:
  type: generated-html
  status: migrated
  sourceUrl: https://doc.shengwang.cn/api-ref/rtc/unreal-cpp/API/class_echotestconfiguration
  sourcePath: html-docs/rtc/Unreal-cpp/API/class_echotestconfiguration.html
  generator: oxygen
  warnings: []
---
