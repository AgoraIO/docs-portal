...
_migration:
  type: generated-html
  status: migrated
  sourceUrl: https://doc.shengwang.cn/api-ref/rtc/unreal-cpp/API/class_filtereffectoptions
  sourcePath: html-docs/rtc/Unreal-cpp/API/class_filtereffectoptions.html
  generator: oxygen
  warnings: []
---
