...
_migration:
  type: generated-html
  status: migrated
  sourceUrl: https://doc.shengwang.cn/api-ref/rtc/unreal-cpp/API/class_screenvideoparameters
  sourcePath: html-docs/rtc/Unreal-cpp/API/class_screenvideoparameters.html
  generator: oxygen
  warnings: []
---
