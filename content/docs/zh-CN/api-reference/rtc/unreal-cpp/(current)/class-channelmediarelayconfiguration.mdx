...
_migration:
  type: generated-html
  status: migrated
  sourceUrl: https://doc.shengwang.cn/api-ref/rtc/unreal-cpp/API/class_channelmediarelayconfiguration
  sourcePath: html-docs/rtc/Unreal-cpp/API/class_channelmediarelayconfiguration.html
  generator: oxygen
  warnings: []
---
...
源频道信息 [ChannelMediaInfo](/zh-CN/api-reference/rtc/unreal-cpp/class-channelmediainfo)，包含如下成员：
