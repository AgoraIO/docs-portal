...
如需实现立体声，你还需要调用 [setAdvancedAudioOptions](/zh-CN/api-reference/rtc/unreal-cpp/audio-effect#api_irtcengine_setadvancedaudiooptions) 并在 AdvancedAudioOptions 中设置 audioProcessingChannels 为 AUDIO_PROCESSING_STEREO。
