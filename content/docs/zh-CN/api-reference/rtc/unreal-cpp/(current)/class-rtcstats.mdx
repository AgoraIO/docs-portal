...
:::warning[注意]
- [onLeaveChannel](/zh-CN/api-reference/rtc/unreal-cpp/toc-channel#callback_irtcengineeventhandler_onleavechannel) 回调中报告的 cpuAppUsage 恒为 0。
...
:::warning[注意]
- [onLeaveChannel](/zh-CN/api-reference/rtc/unreal-cpp/toc-channel#callback_irtcengineeventhandler_onleavechannel) 回调中报告的 cpuTotalUsage 恒为 0。
