...
_migration:
  type: generated-html
  status: migrated
  sourceUrl: https://doc.shengwang.cn/api-ref/rtc/unreal-cpp/API/class_externalvideoframe
  sourcePath: html-docs/rtc/Unreal-cpp/API/class_externalvideoframe.html
  generator: oxygen
  warnings: []
---
...
视频类型。详见 [VIDEO_BUFFER_TYPE](/zh-CN/api-reference/rtc/unreal-cpp/enum-videobuffertype)。
...
<a id="class_externalvideoframe__ul_fsv_shd_krb"></a>
...
:::caution
注意： 在自定义视频渲染场景下，需确保传入的视频帧和 alphaBuffer 均为 Full Range 类型；其他类型可能导致 Alpha 数据渲染不正常。
:::
