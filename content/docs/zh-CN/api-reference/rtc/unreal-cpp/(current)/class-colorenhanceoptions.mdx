...
_migration:
  type: generated-html
  status: migrated
  sourceUrl: https://doc.shengwang.cn/api-ref/rtc/unreal-cpp/API/class_colorenhanceoptions
  sourcePath: html-docs/rtc/Unreal-cpp/API/class_colorenhanceoptions.html
  generator: oxygen
  warnings: []
---
