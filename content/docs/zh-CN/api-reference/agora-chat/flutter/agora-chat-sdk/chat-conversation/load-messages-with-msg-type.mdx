...
| `direction` | The direction in which the message is loaded: [ChatSearchDirection](/zh-CN/api-reference/agora-chat/flutter/agora-chat-sdk/chat-search-direction). |
