...
- @ [Deprecated](https://api.flutter.dev/flutter/dart-core/Deprecated-class.html) ("Use ChatMultiDeviceEventHandler to instead")
...
[ChatMultiDeviceListener](/zh-CN/api-reference/agora-chat/flutter/agora-chat-sdk/chat-multi-device-listener/chat-multi-device-listener)
...
[onChatThreadEvent](/zh-CN/api-reference/agora-chat/flutter/agora-chat-sdk/chat-multi-device-listener/on-chat-thread-event)
...
[onContactEvent](/zh-CN/api-reference/agora-chat/flutter/agora-chat-sdk/chat-multi-device-listener/on-contact-event)
...
[onGroupEvent](/zh-CN/api-reference/agora-chat/flutter/agora-chat-sdk/chat-multi-device-listener/on-group-event)
