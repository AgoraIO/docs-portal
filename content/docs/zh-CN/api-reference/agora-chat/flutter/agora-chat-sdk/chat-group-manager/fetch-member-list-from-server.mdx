...
**Return** The result of `ChatCursorResult`, including the cursor for getting data next time and the group member list. If [ChatCursorResult.cursor](/zh-CN/api-reference/agora-chat/flutter/agora-chat-sdk/chat-cursor-result/cursor) is an empty string (""), all data is fetched.
