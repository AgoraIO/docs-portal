...
| `domainArea` | `DomainArea` | REST Client 的域名区域，详见 [`DomainArea`](/zh-CN/api-reference/conversational-ai/restclient-java/enum#domainarea)。 |
| `httpProperty` | `HttpProperty` | REST Client 的 HTTP 属性。详见 [`HttpProperty`](/zh-CN/api-reference/conversational-ai/restclient-java/struct#httpproperty)。 |
| `serviceRegion` | `ConvoAIServiceRegionEnum` | 对话式智能体引擎的服务区域，详见 [`ConvoAIServiceRegionEnum`](/zh-CN/api-reference/conversational-ai/restclient-java/enum#convoaiserviceregionenum)。 |

<Slot for="struct-java-html-0-2-2">

用于访问声网服务的身份凭据。可用的凭据类型：

    - [`BasicAuthCredential`](/zh-CN/api-reference/conversational-ai/restclient-java/basicauthcredential)，详见 [`BasicAuthCredential`](/zh-CN/api-reference/conversational-ai/restclient-java/basicauthcredential)。
...
| `advancedFeatures` | `AdvancedFeatures` | （可选）高级功能配置。详见 [`AdvancedFeatures`](/zh-CN/api-reference/conversational-ai/restclient-java/struct#advancedfeatures)。 |
| `llmPayload` | `LLMPayload` | （必填）自定义语言模型（LLM）配置。详见 [`LLMPayload`](/zh-CN/api-reference/conversational-ai/restclient-java/struct#llmpayload)。 |
| `ttsPayload` | `TTSPayload` | （可选）文本转语音（TTS）模块配置。详见 [`TTSPayload`](/zh-CN/api-reference/conversational-ai/restclient-java/struct#ttspayload)。 |
| `vadPayload` | `VADPayload` | （可选）语音活动检测（VAD）配置。详见 [`VADPayload`](/zh-CN/api-reference/conversational-ai/restclient-java/struct#vadpayload)。 |
| `asrPayload` | `ASRPayload` | （可选）自动语音识别（ASR）配置。详见 [`ASRPayload`](/zh-CN/api-reference/conversational-ai/restclient-java/struct#asrpayload)。 |
...
| 参数 | 数据类型 | 描述 |
| --- | --- | --- |
| `vendor` | `TTSVendorEnum` | TTS 服务商。详见 [`TTSVendorEnum`](/zh-CN/api-reference/conversational-ai/restclient-java/enum#ttsvendorenum)。 |
| `params` | `TTSVendorParams` | TTS 服务商参数说明。详见 [`MinimaxTTSVendorParams`](/zh-CN/api-reference/conversational-ai/restclient-java/struct#minimaxttsvendorparams)、[`TencentTTSVendorParams`](/zh-CN/api-reference/conversational-ai/restclient-java/struct#tencentttsvendorparams)、[`BytedanceTTSVendorParams`](/zh-CN/api-reference/conversational-ai/restclient-java/struct#bytedancettsvendorparams) 和 [`MicrosoftTTSVendorParams`](/zh-CN/api-reference/conversational-ai/restclient-java/struct#microsoftttsvendorparams)。 |
...
| `vendor` | `ASRVendorEnum` | ASR 服务提供商，详见 [`ASRVendorEnum`](/zh-CN/api-reference/conversational-ai/restclient-java/enum#asrvendorenum)。 |
| `params` | `ASRVendorParams` | ASR 服务参数说明，详见 [`FengmingASRVendorParams`](/zh-CN/api-reference/conversational-ai/restclient-java/struct#fengmingasrvendorparams)、[`TencentASRVendorParams`](/zh-CN/api-reference/conversational-ai/restclient-java/struct#tencentasrvendorparams) 和 [`MicrosoftASRVendorParams`](/zh-CN/api-reference/conversational-ai/restclient-java/struct#microsoftasrvendorparams)。 |
...
用于调用对话式 AI 引擎 [`join`](/zh-CN/api-reference/conversational-ai/restclient-java/convoaiclient.java#join) API 的请求体参数。
...
| `properties` | `Properties` | 智能体的配置属性。详见 [`Properties`](/zh-CN/api-reference/conversational-ai/restclient-java/struct#properties)。 |
...
| `audioSetting` | `MinimaxTTSVendorAudioSettingParam` | 音频配置参数，详见 [`MinimaxTTSVendorAudioSettingParam`](/zh-CN/api-reference/conversational-ai/restclient-java/struct#minimaxttsvendoraudiosettingparam)。 |
| `voiceSetting` | `MinimaxTTSVendorVoiceSettingParam` | 语音配置参数，详见 [`MinimaxTTSVendorVoiceSettingParam`](/zh-CN/api-reference/conversational-ai/restclient-java/struct#minimaxttsvendorvoicesettingparam)。 |
| `pronunciationDict` | `PronunciationDictParam` | 发音词典参数。详见 [`PronunciationDictParam`](/zh-CN/api-reference/conversational-ai/restclient-java/struct#pronunciationdictparam)。 |
| `timberWeights` | `List<MinimaxTTSVendorTimberWeightParam>` | 音色权重参数。详见 [`MinimaxTTSVendorTimberWeightParam`](/zh-CN/api-reference/conversational-ai/restclient-java/struct#minimaxttsvendortimberweightparam)。 |
...
当智能体正在交互（说话或思考）时，人类语音打断智能体行为的模式，支持以下取值：
    ...
    - [`interrupt`](/zh-CN/api-reference/conversational-ai/restclient-java/convoaiclient.java#interrupt)（默认）：打断模式，用户语音会立即打断智能体当前交互，智能体将中止当前交互并直接处理新的语音输入。
...
| 参数 | 数据类型 | 描述 |
| --- | --- | --- |
| `fixedParams` | `FixedParams` | 智能体的固定参数。详见 [`FixedParams`](/zh-CN/api-reference/conversational-ai/restclient-java/struct#fixedparams)。 |
...
| 参数 | 数据类型 | 描述 |
| --- | --- | --- |
| `silenceConfig` | `SilenceConfig` | 静音配置。详见 [`SilenceConfig`](/zh-CN/api-reference/conversational-ai/restclient-java/struct#silenceconfig)。 |
...
（可选）当静默时间达到设定值后，智能体执行的操作：
    ...
    - [`speak`](/zh-CN/api-reference/conversational-ai/restclient-java/convoaiclient.java#speak)：使用 TTS 模块播报静默消息（默认）。
...
| `list` | `List<Agent>` | 符合条件的智能体列表。详见 [`Agent`](/zh-CN/api-reference/conversational-ai/restclient-java/struct#agent)。 |
| `getCount` | `Integer` | 获取响应中返回的智能体数量。 |
| `setCount` | `Integer` | 设置响应中返回的智能体数量。 |
| `getList` | `List<Agent>` | 获取满足条件的智能体列表。详见 [`Agent`](/zh-CN/api-reference/conversational-ai/restclient-java/struct#agent)。 |
| `setList` | `List<Agent>` | 设置满足条件的智能体列表。详见 [`Agent`](/zh-CN/api-reference/conversational-ai/restclient-java/struct#agent)。 |
...
| 参数 | 数据类型 | 描述 |
| --- | --- | --- |
| `data` | `Data` | 智能体数据信息。详见 [`Data`](/zh-CN/api-reference/conversational-ai/restclient-java/struct#data)。 |
| `meta` | `Meta` | 返回列表的元数据信息。详见 [`Meta`](/zh-CN/api-reference/conversational-ai/restclient-java/struct#meta)。 |
| `status` | `String` | 请求状态。 |
| `getData` | `Data` | 获取智能体的数据信息。详见 [`Data`](/zh-CN/api-reference/conversational-ai/restclient-java/struct#data)。 |
| `setData` | `Data` | 设置智能体的数据信息。详见 [`Data`](/zh-CN/api-reference/conversational-ai/restclient-java/struct#data)。 |
| `getMeta` | `Meta` | 获取返回列表的元数据。详见 [`Meta`](/zh-CN/api-reference/conversational-ai/restclient-java/struct#meta)。 |
| `setMeta` | `Meta` | 设置返回列表的元数据。详见 [`Meta`](/zh-CN/api-reference/conversational-ai/restclient-java/struct#meta)。 |
...
| `contents` | `List<HistoryContent>` | 智能体的短期记忆内容。详见 [`HistoryContent`](/zh-CN/api-reference/conversational-ai/restclient-java/struct#historycontent)。 |
...
| `llm` | `UpdateLLMParams` | `LLM` 参数。详见 [`UpdateLLMParams`](/zh-CN/api-reference/conversational-ai/restclient-java/struct#updatellmparams)。 |
...
[`UpdateLLMParams`](/zh-CN/api-reference/conversational-ai/restclient-java/struct#updatellmparams) 用于定义大语言模型的参数。
...
用于响应 Conversational AI 引擎的 [`join`](/zh-CN/api-reference/conversational-ai/restclient-java/convoaiclient.java#join) API 请求。
