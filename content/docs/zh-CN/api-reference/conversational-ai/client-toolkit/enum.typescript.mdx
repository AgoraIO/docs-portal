...
[`EModuleType`](/zh-CN/api-reference/conversational-ai/client-toolkit/enum.typescript#emoduletype) 表示 AI 能力的模块类型。
...
[`EAgentState`](/zh-CN/api-reference/conversational-ai/client-toolkit/enum.typescript#eagentstate) 表示会话智能体的状态。
