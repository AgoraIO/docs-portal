...
- 参考[使用 AI 降噪插件](/zh-CN/realtime-media/rtc/build/extensions/web/noise-reduction)集成 AI 降噪插件：`agora-extension-ai-denoiser`。
...
参考[使用 AI 降噪插件](/zh-CN/realtime-media/rtc/build/extensions/web/noise-reduction)了解如何集成 AI 降噪插件以提高 AI 对话音频体验。
