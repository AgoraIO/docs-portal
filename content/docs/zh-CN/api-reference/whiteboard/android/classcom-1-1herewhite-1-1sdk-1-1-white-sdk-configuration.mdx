...
| Name | Description |
| --- | --- |
| enableImgErrorCallback | 是否开启对图片加载失败事件的监听：<br />- true：开启。开启后，所有 img 标签加载事件都会在 [onMessage](/zh-CN/api-reference/whiteboard/android/interfacecom-1-1herewhite-1-1sdk-1-1-common-callback#a2a843f00164c64d248143d2194beecae) 中回调。<br />- false：（默认）关闭。 |
