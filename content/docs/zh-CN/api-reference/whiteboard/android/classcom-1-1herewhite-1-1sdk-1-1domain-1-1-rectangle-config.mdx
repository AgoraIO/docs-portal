...
description: "RectangleConfig 类，用于配置白板的视觉矩形。"
---
...
```cpp
com.herewhite.sdk.domain.RectangleConfig.RectangleConfig(Double width, Double height, AnimationMode mode)
```
...
```cpp
com.herewhite.sdk.domain.RectangleConfig.RectangleConfig(Double originX, Double originY, Double width, Double height, AnimationMode mode)
```
