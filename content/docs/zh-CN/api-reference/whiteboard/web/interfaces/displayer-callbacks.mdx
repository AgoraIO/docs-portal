---
title: "Displayer<CALLBACKS>"
description: "Displayer<CALLBACKS> API reference."
---
...
- Displayer
  ...
  - [Room](/zh-CN/api-reference/whiteboard/web/interfaces/room-callbacks)
  - [Player](/zh-CN/api-reference/whiteboard/web/interfaces/player-callbacks)
...
该方法已废弃，请使用 [screenshotToCanvasAsync](/zh-CN/api-reference/whiteboard/web/interfaces/displayer-callbacks#screenshottocanvasasync) 方法。
...
- 如果你希望生成的屏幕快照不包含图片，请使用 [screenshotToCanvas](/zh-CN/api-reference/whiteboard/web/interfaces/displayer-callbacks#screenshottocanvas)。
