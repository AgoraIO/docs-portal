...
_migration:
  type: manual-mdx
  status: migrated
  sourceUrl: https://doc.shengwang.cn/doc/whiteboard/restful/fastboard-sdk/get-started/call-api
  sourcePath: docs/whiteboard/fastboard-sdk/get-started/call-api.restful.mdx
...
在调用 RESTful API 之前，你需要参考[开启和配置互动白板服务](/zh-CN/realtime-media/whiteboard/fastboard-sdk/build/setup-and-access/enable-service)完成以下准备工作：
...
以[生成 SDK Token](/zh-CN/api-reference/api-ref/whiteboard/restful/generate-sdk-token)的请求 URL 示例如下：
...
以下是[发起文档转换](/zh-CN/api-reference/api-ref/whiteboard/restful/start-file-conversion)的请求示例：
...
- 如果 HTTP 状态码不为 200 或 201，可参考[响应状态码](/zh-CN/realtime-media/whiteboard/fastboard-sdk/reference/response-code)排查问题。
...
以下是[查询转换任务进度](/zh-CN/api-reference/api-ref/whiteboard/restful/get-file-conversion-task)的响应示例：
...
当你遇到问题时，可以使用开发者工具查看请求和响应，结合[响应状态码](/zh-CN/realtime-media/whiteboard/fastboard-sdk/reference/response-code)进行排查。如未能解决问题，可联系[技术支持](https://ticket.shengwang.cn)。
