...
_migration:
  type: generated-html
  status: migrated
  sourceUrl: https://doc.shengwang.cn/api-ref/whiteboard/ios/Constants/WhiteObserverMode
  sourcePath: html-docs/whiteboard/iOS/Constants/WhiteObserverMode.html
  generator: appledoc
  warnings: []
---
