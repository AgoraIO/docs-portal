...
1：Agora Native SDK 产生的错误，请参考 [Agora Native SDK 错误代码](/doc/rtc/android/error-code)。
...
4：合流视频参数设置错误。请参考 [分辨率、帧率、码率对照表](/doc/recording/java/best-practices/set-output-video) 设置合流视频编码属性。
