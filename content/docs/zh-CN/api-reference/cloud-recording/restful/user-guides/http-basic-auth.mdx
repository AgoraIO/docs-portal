...
_migration:
  type: manual-mdx
  status: migrated
  sourceUrl: https://doc.shengwang.cn/doc/cloud-recording/restful/user-guides/http-basic-auth
  sourcePath: docs/cloud-recording/user-guides/http-basic-auth.mdx
...
已经从声网控制台获取客户 ID 和客户密钥，详见[开通服务](/zh-CN/api-reference/cloud-recording/restful/get-started/enable-service)。
