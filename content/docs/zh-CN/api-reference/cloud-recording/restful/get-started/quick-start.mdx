...
_migration:
  type: manual-mdx
  status: migrated
  sourceUrl: https://doc.shengwang.cn/doc/cloud-recording/restful/get-started/quick-start
  sourcePath: docs/cloud-recording/get-started/quick-start.mdx
...
参考[开通服务](/zh-CN/api-reference/cloud-recording/restful/get-started/enable-service)在声网控制台开通云端录制，并复制保存如下参数，以供后续使用：
...
![阿里云 OSS 中录制文件目录示意图](/img/api-center-generated/e8b454c06cd9-quick-oss-1.png)
...
有关录制文件的详细信息，请参考[录制文件介绍](/zh-CN/api-reference/cloud-recording/restful/user-guides/manage-file/introduce-recorded-files)。
