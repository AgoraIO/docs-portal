---
title: "实现 HTTP 鉴权"
description: "本文介绍在对话式 AI 引擎中进行 HTTP 鉴权的方法，包括使用 RTC Token 鉴权和 HTTP 基本认证。"
---
## 前提条件
...
进行 HTTP 鉴权时，你可以将用于声网对话式 AI 引擎项目的 RTC Token 填入 HTTP 请求 Header 的 `Authorization` 字段中。本节介绍如何获取和填入 RTC Token，你可以根据需求选择以下任一方式获取 RTC Token。
