...
集成方式请参考[减小 App 体积](/zh-CN/realtime-media/rtc/best-practice/reduce-app-size#删除不需要的插件)。
...
- 参考[使用 AI 降噪插件](/zh-CN/realtime-media/rtc/advanced-features/extensions/noise-reduction)集成 AI 降噪插件：`agora-extension-ai-denoiser`。
...
参考[使用 AI 降噪插件](/zh-CN/realtime-media/rtc/advanced-features/extensions/noise-reduction)了解如何集成 AI 降噪插件以提高 AI 对话音频体验。
