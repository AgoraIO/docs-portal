...
集成方式请参考[减小 App 体积](/zh-CN/realtime-media/rtc/best-practice/reduce-app-size.android.android#删除不需要的插件)。
...
集成方式请参考[减小 App 体积](/zh-CN/realtime-media/rtc/best-practice/reduce-app-size.android.ios#删除不需要的插件)。

</TabsContent>

<TabsContent value="web">

- 参考[使用 AI 降噪插件](/zh-CN/realtime-media/rtc/advanced-features/extensions/noise-reduction.javascript)集成 AI 降噪插件：`agora-extension-ai-denoiser`。
...
- [实时字幕](/zh-CN/ai/user-guides/realtime-sub)
- [监听智能体相关事件](/zh-CN/ai/user-guides/listen-agent-events)
- [设置最佳音频参数](/zh-CN/ai/best-practice/audio-settings) （仅支持 Android 和 iOS）
...
参考[使用 AI 降噪插件](/zh-CN/realtime-media/rtc/advanced-features/extensions/noise-reduction.javascript)了解如何集成 AI 降噪插件以提高 AI 对话音频体验。
