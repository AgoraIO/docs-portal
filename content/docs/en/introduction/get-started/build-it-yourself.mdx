...
If you are still evaluating the platform, read [Agora Platform Overview](/en/introduction/about-agora) first. When project setup or authentication terms are unfamiliar, use [Platform concepts](/en/introduction/core-concepts). If you want an AI-assisted setup workflow, switch to [Start with AI](/en/introduction/start-with-ai).
