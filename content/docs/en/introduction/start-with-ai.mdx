...
```text
Use Agora Skills to help me build a web-based conversational AI demo.
Check the official Agora docs first.
Use the Agora CLI to choose the right official starter and explain the setup steps.
Target platform: web.
Language: TypeScript.
Goal: browser voice conversation with minimal UI.
```
