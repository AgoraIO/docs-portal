...
Click the user name at the bottom of the navigation sidebar to open the account menu popup. Items in this menu apply to your Agora account and not to any single project. From here, you can create and manage your projects, view billing status and invoices, see usage statistics, quotas and breakdown, Open the extensions marketplace, manage your profile and account wide preferences, and manage subscription plans.
...
- **Roles**: Manage the roles available to assign to members.
...
The **View all Projects** page lists every project in your account, including its App ID, status, and last updated and created dates. Use the **Active** and **Archived** tabs to filter the list, and the search box to find a specific project by name. Select **Create New Project** to create a new project.
...
- **Security**: View and manage the project's Primary and Secondary Certificates. See Project Settings for details on these certificates.
...
Each key consists of a Customer ID and Customer Secret. Select **Add Secret** to generate a new key, and add a note to a key to help identify it. Select the trash icon to delete a key. You can have a maximum of 10 keys per account.
...
![Console profile page](https://assets-docs.agora.io/images/common/console-profile-page.png)
...
- If you choose **APP ID** as the authentication mechanism when creating a project, you need to enable the Primary Certificate manually. On the project detail page, click **Enable** under **Primary Certificate**.
  ...
  ![Enable Primary Certificate](https://assets-docs.agora.io/images/common/console-enable-primary-certificate.png)
...
![Add a certificate](https://assets-docs.agora.io/images/common/console-add-certificate.png)

The **Secondary Certificate** is now enabled.

![Enable econdary Certificate](https://assets-docs.agora.io/images/common/console-enable-secondary-certificate.png)
...
3. Turn off the switch next to the **Secondary Certificate** to disable it.
    ...
    ![Enable Secondary Certificate](https://assets-docs.agora.io/images/common/console-enable-secondary-certificate.png)
...
4. Follow the on-screen instructions to complete verification. If verified successfully, the status of the Secondary Certificate is updated to **Disabled**, and the **Delete** icon appears.
    ...
    ![Delete Certificate](https://assets-docs.agora.io/images/common/console-delete-certificate.png)
...
6. Follow the on-screen instructions to complete verification. If verified successfully, the **Delete** button disappears, and the current Secondary Certificate (the original Primary Certificate) is deleted.
    ...
    :::warning
    Once a certificate is deleted, it cannot be restored. Before deleting the secondary certificate, make sure that users have switched to the new certificate to avoid the following consequences:
...
2. (Optional) Add filters for the usage data, as follows:
    ...
    ![Console Usage](https://assets-docs.agora.io/images/common/console-usage-details.png)
...
3. Click the **Add New Member** button, fill in the email address of the new member, and choose a team from the dropdown menu. Then click **OK**.
    ...
    ![Add new member](https://assets-docs.agora.io/images/common/console-add-new-member.png)
...
1. On the **Teams and Members** page, **Teams** tab, click **Add New Team**.
    ...
    ![Add new team](https://assets-docs.agora.io/images/common/console-add-team.png)
...
1. Apply for Okta integration in Agora Console.
   ...
   ![okta-application](https://assets-docs.agora.io/images/common/okta-application.png)

   Once you apply, a request is sent to Agora to enable integration for you.

   ![okta-applied](https://assets-docs.agora.io/images/common/okta-applied.png)
...
1. Create a SAML integration for Agora in Okta Console.
   ...
   1. Log in to your Okta developer account as a user with administrative privileges and click **Admin** in the upper right corner.
       ...
       ![okta-admin](https://assets-docs.agora.io/images/common/okta-admin.png)

   1. Go to **Applications** > **Applications** and click **Create App Integration**.

       ![okta-create-app-integration](https://assets-docs.agora.io/images/common/okta-create-app-integration.png)
   ...
   1. On the **Configure SAML** tab, fill in the following SAML configurations generated in Agora Console:
      ...
      ![okta-saml-config](https://assets-docs.agora.io/images/common/okta-saml-config.png)
   ...
   1. On the **Feedback** tab, select **I'm an Okta customer adding an internal app** and tick **This is an internal app that we have created**, then click **Finish**.
       ...
       ![okta-feedback](https://assets-docs.agora.io/images/common/okta-feedback.png)
...
1. View IdP information in Okta Console
   ...
   1. In Okta Console, select the **Sign On** tab for Agora integration and click **View Setup Instructions**. You see the following information:
      ...
      ![okta-saml-setup](https://assets-docs.agora.io/images/common/okta-saml-setup.png)
   ...
   **Note**: Once enabled, SAML is applicable for both, existing and newly created Agora accounts for team members. For new accounts, however, log in as the admin in Agora Console and create an account *before* it is configured in Okta. SCIM is applicable only for new accounts.
   ...
   - Automated management with SCIM
     ...
     1. In Agora Console, enable **SCIM API Basic Auth** on the **SSO Management** page. A set of username and password is generated, along with the SCIM connector base URL.
         ![scim-enabled](https://assets-docs.agora.io/images/common/scim-enabled.png)
     ...
     1. Select the **Provisioning** tab under **Agora integration**, then under **Settings** > **Integration** click **Edit**. Make the following changes:
        ...
        ![scim-configured](https://assets-docs.agora.io/images/common/scim-configured.png)
...
2. (Optional) If you have not added a credit card to your account, follow these steps:
    ...
    1. Click **Add New Card**.
        ...
        ![Add new card](https://assets-docs.agora.io/images/common/console-add-new-card.png)
...
2. Click **Get Support** > **Create Support Ticket**
    ...
    ![Create a support ticket](https://assets-docs.agora.io/images/common/console-create-support-ticket.png)
...
2. In the left navigation panel, click **Account**.
    ...
    ![Delete an account](https://assets-docs.agora.io/images/common/console-delete-account.png)
