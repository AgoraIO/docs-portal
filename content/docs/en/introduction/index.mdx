...
<SolutionCardGrid>
  <SolutionCard
    title="Explore Voice Agents"
    href="/en/ai"
    icon="ai"
    tone="blue"
    description="Understand how Agora Voice Agents work and choose the right path for apps or dedicated devices."
  />
  <SolutionCard
    title="Build a Voice Agent App"
