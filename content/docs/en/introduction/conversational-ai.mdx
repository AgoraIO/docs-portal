...
<OverviewSpotlightGrid>
  ...
  />
  <OverviewSpotlightCard
    href="/en/ai/apps/reference/openai-realtime-integration"
...
<CardGrid>
  ...
  <FeatureCard title="Built on realtime transport">
...
- [AI quickstart](/en/ai/apps/get-started/quickstart)
- [OpenAI Realtime](/en/ai/apps/reference/openai-realtime-integration)
