...
- Web client:
  ...
  - Introduces [EDUClassroomUIStore](/en/solutions/flexible-classroom/build/set-up-your-account-and-authentication/enable-flexible-classroom) for customizing the classroom UI, which replaces the UIKit in previous versions.
...
The charges for low latency and ultra-low latency are different. For details, see the [pricing page](/en/solutions/interactive-live-streaming/reference/pricing).
