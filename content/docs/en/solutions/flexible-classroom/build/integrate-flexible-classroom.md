...
1. Modify the code according to your needs. See [Classroom and Proctor SDK UI customization guide](customize-classroom.md) for details.
1. Debug your code.
...
1. Modify the code according to your needs. See [Classroom and Proctor SDK](customize-classroom.md) for details.
1. Debug your code.
