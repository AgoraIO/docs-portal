...
- For more information on how to enable Signaling token authentication, see [Secure authentication with tokens](authentication-workflow.md).
- For how to generate a Signaling token on the app backend, see [Secure authentication with tokens](authentication-workflow.md).
...
3. [Deploy a Signaling token server](authentication-workflow.md) in your backend services.
