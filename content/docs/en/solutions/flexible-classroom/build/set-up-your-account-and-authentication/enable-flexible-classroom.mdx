...
3. In the **Features** section of the **Edit Project** page, click **Enable/Configure** next to **Chat**.
    ...
    ![Enable Chat on the Edit Project page](/images/flexible-classroom/enable-chat.png)

4. Select the data center location.

    ![Select the Chat data center location](/images/flexible-classroom/select-data-center.png)
...
6. In the **Chat** section, complete the required fields:
    ...
    ![Synchronize Chat settings to Flexible Classroom](/images/flexible-classroom/synchronize-chat.png)
...
* Bucket policy
   ...
   ```
   ![AWS S3 bucket policy configuration](/images/flexible-classroom/configure-aws-ss1.png)
...
* Cross-origin resource sharing
   ...
   ```
   ![AWS S3 cross-origin resource sharing configuration](/images/flexible-classroom/configure-aws-ss2.png)
