...
1. Click **Cloud Drive** in the tool bar, and then click **Upload** as shown in the following screenshot:
    ...
    ![Cloud Drive upload button in Flexible Classroom](https://web-cdn.agora.io/docs-files/1663562311451)
   ...
   ![Cloud Drive delete option for a personal resource](https://web-cdn.agora.io/docs-files/1663562326661)
...
* Alibaba Cloud OSS account
   ...
   * Cross domain rule configuration
     ...
     ![alibaba-cloud-storage-config](https://assets-docs.agora.io/images/flexible-classroom/alibaba-cloud-storage-config.png)
