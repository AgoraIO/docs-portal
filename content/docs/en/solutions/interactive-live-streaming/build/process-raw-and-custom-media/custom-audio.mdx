...
To retrieve audio data for playback, implement collection and processing of raw audio data. Refer to [Raw audio processing](/en/solutions/interactive-live-streaming/build/process-raw-and-custom-media/stream-raw-audio).
