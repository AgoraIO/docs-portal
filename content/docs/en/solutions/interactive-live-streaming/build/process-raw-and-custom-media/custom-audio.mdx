...
To retrieve audio data for playback, implement collection and processing of raw audio data. Refer to [Raw audio processing](https://docs-md.agora.io/en/interactive-live-streaming/advanced-features/advanced-features/stream-raw-audio.md).
