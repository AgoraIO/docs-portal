 ...
 * [`setAINSMode`]({{global.API_REF_ANDROID_ROOT}}/class_irtcengine.html#api_irtcengine_setainsmode)
</TabsContent>
...
* [`setAINSMode`]({{global.API_REF_IOS_ROOT_RTC_ENGINE_KIT}}/setainsmode(_:mode:))
</TabsContent>
...
> 📝 **Note**
> The following implementation steps apply to the latest version of the AI Noise Suppression extension. Refer to the [extension release notes](https://docs-md.agora.io/en/video-calling/overview/release-notes.md) for details.
...
4. Register the AI Noise Suppression extension
  ...
  Call [AgoraRTC.registerExtensions]({{global.API_REF_WEB_ROOT}}/interfaces/iagorartc.html#registerextensions), and pass in the created `AIDenoiserExtension` instance. Optionally, listen for the callback reporting that the Wasm and JS files fail to load.
...
This method must be called after [`pipe`](https://docs-md.agora.io/en/api-ref/rtc/javascript/interfaces/imicrophoneaudiotrack.html.md).
 ...
 * [`setAINSMode`]({{global.API_REF_ELECTRON_ROOT}}/api_irtcengine_setainsmode.html)
</TabsContent>
 ...
 * [`setAINSMode`]({{global.API_REF_RN_ROOT}}/api_irtcengine_setainsmode.html)
</TabsContent>
