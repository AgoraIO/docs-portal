...
To learn how to use a Web extension, see [AI Noise Suppression](https://docs-md.agora.io/en/video-calling/advanced-features/ai-noise-suppression.md).
...
- [`AgoraRTC.registerExtensions`]({{global.API_REF_WEB_ROOT}}/interfaces/iagorartc.html#registerextensions)
</TabsContent>
