...
**v4.0.0-v4.2.1**
5. Enable Cloud Proxy in [Agora Console](https://console.agora.io/):
...
2. To turn on cloud proxy server before joining the channel, call:

  `client.startProxyServer();`

3. To turn off cloud proxy server after leaving the channel, call:
