...
### Use the Voice SDK
Video SDK supports both audio and video functions, and the package size is large. If you only need to use audio features, best practice is to integrate the [Voice SDK](../../../sdks.md). For details, see [Voice SDK Quickstart](https://docs-md.agora.io/en/en/voice-calling/get-started/get-started-sdk_android.md).
...
When integrating through the [Direct download](https://docs-md.agora.io/en/en/sdks.md) link, manually delete the extension files that you do not need to use.
