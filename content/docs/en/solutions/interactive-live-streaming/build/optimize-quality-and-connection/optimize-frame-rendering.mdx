---
title: "Optimize video rendering"
...
Complete the steps in the [SDK Quickstart](/en/solutions/interactive-live-streaming/quickstart) to build a basic Interactive Live Streaming app.
...
If you can’t retrieve a token early, consider using a [wildcard token](/en/solutions/interactive-live-streaming/build/authenticate-users/deploy-token-server#generate-wildcard-tokens).
