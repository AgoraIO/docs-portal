...
- After turning on screen sharing, Agora uses the resolution of the screen sharing video stream as the billing standard. Please see [Pricing](../reference/pricing.md) for details. The default resolution is 1280 × 720, but you can adjust it according to your business needs.
