...
**Manual integration**
1. Download the latest version of Video SDK from the the [SDKs](../../../sdks.md) page and unzip it.
...
![image](/images/video-sdk/quick-start-sequence.svg)
...
1. Use the following code to handle runtime permissions in your Android app. The logic ensures that the necessary permissions are granted before starting Interactive Live Streaming. In your `MainActivity` file, add the following code:
...
* [Error codes](https://docs-md.agora.io/en/interactive-live-streaming/troubleshooting/error-codes.md)
...
1. For basic Interactive Live Streaming, select **RtcBasic**.
...
* [How can I solve channel-related issues?](https://docs-md.agora.io/en/help/integration-issues/channel.md)
* [How can I set the log file?](https://docs-md.agora.io/en/help/integration-issues/log.md)
* [How can I troubleshoot the issue of no sound?](https://docs-md.agora.io/en/help/quality-issues/audio_noaudio.md)
...
* [How can I add a privacy manifest to my iOS app?](https://docs-md.agora.io/en/help/other-issues/ios_privacy_manifest.md)
...
![image](/images/video-sdk/quick-start-sequence-macos.svg)
...
**Complete sample code for Interactive Live Streaming**
...
- A [supported browser](https://docs-md.agora.io/en/interactive-live-streaming/reference/supported-platforms.md).
...
![image](/images/video-sdk/ils-quick-start-sequence-web.svg)
...
1. Open your browser and navigate to the URL displayed in your terminal, for example, `http://localhost:5173`.
  ...
  ![image](/images/video-sdk/quickstart-ui-web-ils.png)
...
- [`AgoraRTC.createClient`]({{global.API_REF_WEB_ROOT}}/interfaces/iagorartc.html#createclient)
- [`IAgoraRTCRemoteUser`]({{global.API_REF_WEB_ROOT}}/interfaces/iagorartcremoteuser.html)
- [`play`]({{global.API_REF_WEB_ROOT}}/interfaces/iremoteaudiotrack.html#play)
- [`join`]({{global.API_REF_WEB_ROOT}}/interfaces/iagorartcclient.html#join)
...
- [`publish`]({{global.API_REF_WEB_ROOT}}/interfaces/iagorartcclient.html#publish)
- [AgoraRTCClient events]({{global.API_REF_WEB_ROOT}}/interfaces/iagorartcclient.html#event_channel_media_relay_event)
...
1. To add join and leave channel buttons, open **View > Toolbox** and add two **Button** controls. In **Properties > Miscellaneous** , set the IDs to `ID_BTN_JOIN` and `ID_BTN_LEAVE`, and set the description text to **Join** and **Leave** respectively. Your user interface looks similar to the following:
  ...
  ![image](/images/video-sdk/windows-quickstart-ui.png)
...
* [How can I resolve common development issues on Electron?](https://docs-md.agora.io/en/help/integration-issues/electron_faq.md)
* [How can I fix black screen issues?](https://docs-md.agora.io/en/help/quality-issues/video_blank.md)
* [Why can't I turn on the camera?](https://docs-md.agora.io/en/help/quality-issues/video_camera.md)
...
1. Go to the [Download SDKs](https://docs-md.agora.io/en/sdks_unity.md) page and download the latest version of the Unity SDK.
...
1. To start Interactive Live Streaming, initialize the engine and set up the event handler.
...
![image](/images/video-sdk/video-call-ui-unity.png)
...
1. Download the latest version of Agora Unreal Video SDK from [Download SDKs](../../../sdks.md) and unzip it.
...
**iOS and macOS**
1. Refer to [How to add the permissions required for real-time interaction to an Unreal Engine project?](https://docs-md.agora.io/en/interactive-live-streaming/get-started.md)
...
1. Save the changes. Your user interface in **Widget Blueprint** looks similar to the following:
  ...
  ![image](/images/video-sdk/unreal-setup-ui-3.png)
...
5. Create a **Level Blueprint** and associate it with the created **Widget Blueprint**
  ...
  3. Save your changes and run the project. The UI you have created looks similar to the following:
    ...
    ![image](/images/video-sdk/unreal-setup-ui-6.png)
...
To learn about Agora Unreal Blueprint development, refer to the [Unreal (Blueprint) Quickstart](https://docs-md.agora.io/en/get-started-sdk_blueprint.md).
...
![image](/images/video-sdk/quickstart-implementation-blueprint-2.png)

The following table lists the main nodes:

| # | Node | Type | Description |
| :-- | :----- | :----- | :------------ |
| 1 | **Set Show Mouse Cursor** | Native* | (Optional) Set whether to display the mouse cursor. Check to display it. Note: This node is available on Windows and macOS only. If the node is not retrieved at creation time, uncheck **Context Sensitive**. ![image](/images/video-sdk/quickstart-implementation-blueprint-3.png) |
| 2 | **Load Agora Config** | Custom** | Loads Agora configuration. Used to verify user identity when creating and joining channels. |
| 3 | **Create BP Video Widget** | Native | <Slot name="3" /> |
| 4 | **Set Basic Video Call Widget** | Custom | <Slot name="4" /> |
...
1. If your target platform is Android, check whether system permissions have been granted before initializing the RTC engine. Refer to the following figure to create nodes for adding permissions to access the microphone and camera in the **CheckPermission** function.
  ...
  :::note
  If your target platform is macOS or iOS, please refer to [How do I add the permissions needed for real-time interaction to my Unreal Engine project?](https://docs-md.agora.io/en/help/integration-issues/unreal_permissions.md)
:::

1. To initialize the RTC engine, in the **InitRtcEngine** function, create and connect nodes as shown in the following figure:

  ![image](/images/video-sdk/quickstart-implementation-blueprint-6.png)
