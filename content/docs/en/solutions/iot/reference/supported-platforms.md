...
- *Platforms*:
  ...
  |-----------------|--------------------------|---------------------------------------|
  | Android         | Android 4.1 or later.  IoT SDK supports the following ABIs: <ul><li>armeabi-v7a</li><li>arm64-v8a</li><li>x86</li><li>x86-64</li></ul>    | Android Studio 3.0 or later
