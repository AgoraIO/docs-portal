...
In order to create the environment necessary to implement Agora multi-streaming feature into your app, open the IoT SDK [SDK quickstart](../get-started/get-started-sdk) project you created previously.
