...
The following figure shows the call flow you implement to create step-up-authentication with Agora IoT SDK:
...
* Implemented the [Quickstart](../index.md) in your project.
...
* Deployed a token server using either of the following guides:
    ...
    - [Deploy a middleware server](https://docs.agora.io/en/video-calling/token-authentication/middleware-token-server)
