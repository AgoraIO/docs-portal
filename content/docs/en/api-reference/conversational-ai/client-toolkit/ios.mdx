...
| `rtmEngine`  | `AgoraRtmClientKit?`     | Client instance for real-time messaging. See [`AgoraRtmClientKit`](https://doc.shengwang.cn/signaling/reference/api?platform=ios#configcreatepropsag_platform). |
