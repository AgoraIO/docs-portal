...
| `rtmClient`  | `RtmClient`              | Real-time messaging client. See [`RtmClient`](https://doc.shengwang.cn/signaling/reference/api?platform=android#configcreatepropsag_platform).       |
