...
See [Authentication](https://doc.shengwang.cn/conversational-ai/reference/sdk/python/authentication) for details on each mode.
...
For full method signatures and request parameters, see the [REST API reference](../rest-api/agent/join.md).
...
| Parameter | Type | Required | Default | Description |
|---|---|---|---|---|
| `api_key` | `str` | No | `None` | OpenAI API key. Omit to use Agora-managed credentials for [supported models](../rest-api/agent/join.md) |
...
| Parameter | Type | Required | Default | Description |
|---|---|---|---|---|
| `key` | `str` | No | `None` | MiniMax API key. Omit to use Agora-managed credentials for [supported models](../rest-api/agent/join.md) |
...
| Parameter | Type | Required | Default | Description |
|---|---|---|---|---|
| `api_key` | `str` | No | `None` | Deepgram API key. Omit to use Agora-managed credentials for [supported models](../rest-api/agent/join.md) |
