...
All sub-client methods take `context.Context` as their first argument. For full method signatures and request parameters, see the [REST API reference](../rest-api/agent/join.md).
