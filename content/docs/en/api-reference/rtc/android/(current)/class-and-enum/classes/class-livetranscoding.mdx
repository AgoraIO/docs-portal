...
媒体输出流的音频采样率（Hz）。详见 [AudioSampleRateType](/en/api-reference/rtc/android/class-and-enum/enums/enum-audiosampleratetype)。
...
媒体推流使用的音频编码器配置类型。详见 [AudioCodecProfileType](/en/api-reference/rtc/android/class-and-enum/enums/enum-audiocodecprofiletype)。

### `videoCodecProfile`

媒体推流使用的视频编码器配置类型。可设置为 66、77 或默认值 100。详见 [VideoCodecProfileType](/en/api-reference/rtc/android/class-and-enum/enums/enum-videocodecprofiletype)。
...
媒体推流使用的视频编码器类型。详见 [VideoCodecType](/en/api-reference/rtc/android/class-and-enum/enums/enum-videocodectypeforstream)。
