...
1. In [Agora Console](https://console.agora.io/v2), click the username at the bottom of the navigation sidebar to open the account menu, then select **Developer Hub**.
