...
| :-------- | :----------------------------------------------------------- |
| `appId` | The Agora App ID. See [Get the Agora App ID](/en/realtime-media/flexible-classroom/build/manage-agora-account#get-the-app-id-and-app-certificate). |
...
| Attributes | Description |
| :------- | :----------------------------------------------------------- |
| `appId` | (Required) The Agora App ID. See [Get the Agora App ID](/en/realtime-media/flexible-classroom/build/manage-agora-account#get-the-app-id-and-app-certificate). |
| `region` | <Slot name="region" /> |
