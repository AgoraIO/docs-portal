...
Register an extension application by using the ExtApp tool. ExtApp is a tool for embedding extension applications in Flexible Classroom. For details, see [Customize Flexible Classroom with ExtApp](/en/solutions/flexible-classroom/build/customize-classroom).
...
| `rtmToken` | The Signaling token used for authentication. For details, see [Secure authentication with tokens](/en/solutions/flexible-classroom/build/authentication-workflow). |
...
| `token` | The Signaling token used for authentication. For details, see [Generate a Signaling Token](/en/solutions/flexible-classroom/build/authentication-workflow). |
| `startTime` | The start time (ms) of the class, determined by the first user joining the classroom. |
| `duration` | The duration (ms) of the class, determined by the first user joining the classroom. |
...
| Parameter | Description |
| :----------------------- | :----------------------------------------------------------- |
| `rtmToken` | (Required) The Signaling token used for authentication. For details, see [Secure authentication with tokens](/en/solutions/flexible-classroom/build/authentication-workflow). |
| `userUuid` | <Slot name="useruuid" /> |
...
| `widgets` | (Optional) Extensive widgets that  extend the classroom capabilities. See [Embed a custom plugin](/en/solutions/flexible-classroom/build/embed-custom-plugin) for details. |
