...
| `rtmToken` | The Signaling token used for authentication. See [Secure authentication with tokens](/en/solutions/flexible-classroom/build/set-up-your-account-and-authentication/authentication-workflow). |
...
| `widgets` | (Optional) Extensive widgets that extend the classroom capabilities. See [Embed a custom plugin](/en/solutions/flexible-classroom/build/customize-the-ui-and-plugins/embed-custom-plugin). |
...
For more about main devices and secondary devices, see [Proctor exams online](/en/solutions/flexible-classroom/build/enable-teaching-features/proctor-exams-online).
