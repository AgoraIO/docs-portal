...
| `token` | The Signaling token. See [Secure your classrooms](/en/solutions/flexible-classroom/build/set-up-your-account-and-authentication/authentication-workflow). |
...
| `widgets` | (Optional) The widget list, which extends the capabilities of the classroom. See [Embed a custom plugin](/en/solutions/flexible-classroom/build/customize-the-ui-and-plugins/embed-custom-plugin). |
