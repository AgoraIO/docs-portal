...
- `userPayload`: User information displayed by the user's cursor, including the user's nickname and avatar. See [`FastUserPayload`](#fastuserpayload-ios) for details.
...
- `appliance`: The name of the whiteboard tool. See [`ApplianceNames`](#appliance-web).
...
- `sdkConfig`: (Required) Object. Configurations for the [WhiteWebSdk](https://github.com/netless-io/fastboard/blob/main/packages/fastboard-core/docs/classes/WhiteWebSdk.md) object, in which you must pass the following parameters:
...
- `joinRoom`: (Required) Object. Parameters for joining a room:
  ...
  - `callbacks`: (Optional) Event callbacks for the whiteboard room. See [RoomCallbacks](https://github.com/netless-io/fastboard/blob/main/packages/fastboard-core/docs/modules.md#roomcallbacks) for details.
