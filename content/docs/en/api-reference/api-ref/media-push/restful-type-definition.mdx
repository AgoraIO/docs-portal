...
| :---- | :--- | :----------- |
| `codecProfile` | (Optional) String | <Slot name="audio-codec-profile-description" /> |
...
| `rtcStreamUids` | (Optional) JSON Array of Numbers | <Slot name="audio-rtc-stream-uids-description" /> |
| `volumes` | (Optional) JSON Array | <Slot name="audio-volumes-description" /> |
| `volumes.rtcStreamUid` | Number | <Slot name="audio-volumes-rtc-stream-uid-description" /> |
| `volumes.volume` | Number | The volume of the specified mix user. The default value is `100`, and the value range is [0, 200]. |

<Slot for="audio-codec-profile-description">
...
<Slot for="audio-rtc-stream-uids-description">
...
<Slot for="audio-volumes-description">
...
<Slot for="audio-volumes-rtc-stream-uid-description">
