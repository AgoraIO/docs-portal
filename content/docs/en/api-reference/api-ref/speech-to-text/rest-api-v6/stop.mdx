...
description: Use this method to leave the channel and stop transcription.
---
...
Use this method to leave the channel and stop Real-Time STT. To restart transcription, [`acquire`](acquire) a new one `buildToken` and call [`start`](start) again.
