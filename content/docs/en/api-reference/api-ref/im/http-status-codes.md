...
| `400` | `invalid_parameter` | "Some of `{group_id}` are not valid fields." | The specified name, description, or size of the  is invalid when creating a . | [Create a group](/en/api-reference/api-ref/im/chat-group-management/create-delete-retrieve-groups#creating-a-group). Enter a valid group name, description, and maximum number of members. |
