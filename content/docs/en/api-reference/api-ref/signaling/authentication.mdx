...
- **Basic HTTP authentication**
  ...
  Generate a Base64-encoded credential with the [Customer ID and Customer Secret](/en/introduction/console-setup#restful-api-keys) provided by Agora, and pass the credential with the `Authorization` parameter in the request header.
