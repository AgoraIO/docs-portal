...
| `areaCode` | `AgoraRtmAreaCode` | Optional | `GLOB` | Service area code, you can choose according to the region where your business is deployed. See [`AgoraRtmAreaCode`](#agorartmareacode). |
...
| `level` | `AgoraRtmLogLevel` | Optional | `info` | Output level of log information. See [`AgoraRtmLogLevel`](#agorartmloglevel). |
...
| Properties | Type | Required | Default | Description |
|:-------------------:|:---------------------:|:--------:|:--------------------------:| ----------------------------------------------------------------------------------------------------------------------------------- |
| `encryptionMode` | `AgoraRtmEncryptionMode` | Optional | `none` | Encryption mode. See [`AgoraRtmEncryptionMode`](#agorartmencryptionmode). |
...
| Properties | Type | Required | Default | Description |
|:-------------------:|:---------------------:|:--------:|:--------------------------:| ----------------------------------------------------------------------------------------------------------------------------------- |
| `serviceType` | `EnumSet&lt;RtmServiceType&gt;` | Optional | - | Service type. See [`AgoraRtmServiceType`](#agorartmservicetype). |
...
|:------------------:|:-------------------:| ----------------------------------------------------------------------------------------------------------------------------------- |
| `channelType` | `AgoraRtmChannelType` | Channel types. See [`AgoraRtmChannelType`](#agorartmchanneltype). |
...
| Properties | Type | Description |
|:------------------:|:-------------------:| ----------------------------------------------------------------------------------------------------------------------------------- |
| `type` | `AgoraRtmPresenceEventType` | Presence event type. See [`AgoraRtmPresenceEventType`](#agorartmpresenceeventtype). |
| `channelType` | `AgoraRtmChannelType` | Channel types. See [`AgoraRtmChannelType`](#agorartmchanneltype). |
| `channelName` | String | Channel name. |
| `publisher` | String | User ID of the message publisher. |
...
| Properties | Type | Description |
|:------------------:|:-------------------:| ----------------------------------------------------------------------------------------------------------------------------------- |
| `type` | `AgoraRtmTopicEventType` | Topic event type. See [`AgoraRtmTopicEventType`](#agorartmtopiceventtype). |
| `channelName` | String | Channel name. |
...
|:------------------:|:-------------------:| ----------------------------------------------------------------------------------------------------------------------------------- |
| `channelType` | `AgoraRtmChannelType` | Channel types. See [`AgoraRtmChannelType`](#agorartmchanneltype). |
| `storageType` | `AgoraRtmStorageType` | Storage type. See [`AgoraRtmStorageType`](#agorartmstoragetype). |
| `eventType` | `AgoraRtmStorageEventType` | Storage event type. See [`AgoraRtmStorageEventType`](#agorartmstorageeventtype). |
...
|:------------------:|:-------------------:| ----------------------------------------------------------------------------------------------------------------------------------- |
| `channelType` | `AgoraRtmChannelType` | Channel types. See [`AgoraRtmChannelType`](#agorartmchanneltype). |
| `eventType` | `AgoraRtmLockEventType` | Lock event type. See [`AgoraRtmLockEventType`](#agorartmlockeventtype). |
| `channelName` | String | Channel name. |
...
|:----------:|:-----:|:--------------------------- |
| `currentState` | `AgoraRtmLinkState` | The current link state. See [`AgoraRtmLinkState`](#agorartmlinkstate). |
| `previousState` | `AgoraRtmLinkState` | The previous link state. See [`AgoraRtmLinkState`](#agorartmlinkstate). |
| `serviceType` | `AgoraRtmServiceType` | The network connection type. See [`AgoraRtmServiceType`](#agorartmservicetype). |
| `operation` | `AgoraRtmLinkOperation` | The operation that triggered the current state transition. See [`AgoraRtmLinkOperation`](#agorartmlinkoperation). |
| `reasonCode` | `AgoraRtmLinkStateChangeReason` | The reason for this state transition. See [`AgoraRtmLinkStateChangeReason`](#agorartmlinkstatechangereason). |
...
The `errorInfo` of type `AgoraRtmErrorInfo` contains the error code, error reason, and API operation name for this call:
...
rtmClient.logout { response, error in
  ...
  } else if let logoutResponse = response {
...
```swift
// async-await
let (response, error) = await rtmClient.renewToken("your_token_here")
if let error = error {
    print("Login failed with error: \(error.reason)")
} else if let response = response {
...
```swift
// callback
rtmClient.renewToken("your_token_here") { response, error in
    if let errorInfo = error {
...
```swift
// async-await
let (response, error) = await streamChannel.renewToken("your_token_here")
if let error = error {
    print("Login failed with error: \(error.reason)")
} else if let response = response {
    print("renew token successful!")
...
```swift
// callback
streamChannel.renewToken("your_token_here") { response, error in
    if let errorInfo = error {
        print("renew token failed with error: \(errorInfo.reason)")
    } else if let loginResponse = response {
        print("renew token successful: \(loginResponse)")
...
| Properties | Type | Required | Default | Description |
| :-------------: | :---------------: | :------: | :--------------: | ----------------------------------- |
| `qos` | `AgoraRtmMessageQos` | Optional | `unordered` | Whether the data transmitted in the topic is ordered. See [`AgoraRtmMessageQos`](#agorartmmessageqos). |
| `priority` | `AgoraRtmMessagePriority` | Optional | `normal` | The priority of data transmission in the topic compared to other topics in the same channel. See [`AgoraRtmMessagePriority`](#agorartmmessagepriority). |
...
messageOptions.customType = "PlainText"
...
let topic = "exampleTopic"
let messageOptions = AgoraRtmTopicMessageOptions()
messageOptions.customType = "BinaryData"
...
| Properties | Type | Required | Default | Description |
| :----------: | :----: | :------: | :----: | --------------------------------------- |
| `channelType` | `AgoraRtmChannelType` | Required | - | Channel types. See [`AgoraRtmChannelType`](#agorartmchanneltype). |
| `customType` | String | Required | - | A user-defined field. Only supports string type. |
...
| :---------------: | :--------------------------: | :------: | :-----: | ---- |
| `channelName` | String | Required | - | Channel name. |
| `channelType` | `AgoraRtmChannelType` | Required | - | Channel type. See [`AgoraRtmChannelType`](#agorartmchanneltype). |
...
| `channelName` | String | Required | - | Channel name. |
| `channelType` | `AgoraRtmChannelType` | Required | - | Channel type. See [`AgoraRtmChannelType`](#agorartmchanneltype). |
| `data` | `AgoraRtmMetadata` | Required | - | Metadata item. See [`AgoraRtmMetadata`](#agorartmmetadata). |
...
guard let storage = rtmClient.getStorage() else { return }
let (response, error) = await storage.setChannelMetadata(
...
// Set channel metadata
rtmClient.getStorage()?.setChannelMetadata(
    channelName: channelName,
    channelType: channelType,
    data: metadata,
    options: metadataOptions,
...
| Properties | Type | Description |
| :------------------ | :--------------------: | ------------------------------------- |
| `data` | `AgoraRtmMetadata` | Metadata item. See [`AgoraRtmMetadata`](#agorartmmetadata). |
...
guard let storage = rtmClient.getStorage() else { return }
let (response, error) = await storage.getChannelMetadata(
    channelName: channelName,
    channelType: channelType
)
if let errorInfo = error {
...
// Retrieve channel metadata
rtmClient.getStorage()?.getChannelMetadata(
    channelName: channelName,
    channelType: channelType,
    completion: { (response, error) in
        if let errorInfo = error {
...
guard let storage = rtmClient.getStorage() else { return }
let (response, error) = await storage.removeChannelMetadata(
    channelName: channelName,
    channelType: channelType,
    data: metadata,
    options: nil,
...
rtmClient.getStorage()?.removeChannelMetadata(
    channelName: channelName,
    channelType: channelType,
    data: metadata,
    options: nil,
...
guard let storage = rtmClient.getStorage() else { return }
let (response, error) = await storage.updateChannelMetadata(
    channelName: channelName,
    channelType: channelType,
    data: metadata,
    options: metadataOptions,
...
rtmClient.getStorage()?.updateChannelMetadata(
    channelName: channelName,
    channelType: channelType,
    data: metadata,
    options: metadataOptions,
...
guard let storage = rtmClient.getStorage() else { return }
let (response, error) = await storage.setUserMetadata(
    userId: userId,
    data: metadata,
    options: metadataOptions
)
...
rtmClient.getStorage()?.setUserMetadata(
    userId: userId,
    data: metadata,
    options: metadataOptions
) { (response, error) in
...
guard let storage = rtmClient.getStorage() else { return }
let (response, error) = await storage.getUserMetadata(userId: userId)
if let errorInfo = error {
    // Handle error
...
rtmClient.getStorage()?.getUserMetadata(userId: userId) { (response, error) in
    if let errorInfo = error {
        // Handle error
        print("Failed to get user metadata with error: \(errorInfo.reason)")
    } else if let getUserMetadataResponse = response {
...
guard let storage = rtmClient.getStorage() else { return }
let (response, error) = await storage.removeUserMetadata(
    userId: userId,
    data: metadata,
    options: nil
)
...
rtmClient.getStorage()?.removeUserMetadata(userId: userId, data: metadata, options: nil) { (response, error) in
    if let errorInfo = error {
        // Handle error
        print("Failed to remove user metadata with error: \(errorInfo.reason)")
    } else if let removeUserMetadataResponse = response {
...
guard let storage = rtmClient.getStorage() else { return }
let (response, error) = await storage.updateUserMetadata(
    userId: userId,
    data: metadata,
    options: metadataOptions
)
...
rtmClient.getStorage()?.updateUserMetadata(userId: userId, data: metadata, options: metadataOptions) { (response, error) in
    if let errorInfo = error {
        // Handle error
        print("Failed to update user metadata with error: \(errorInfo.reason)")
    } else if let updateUserMetadataResponse = response {
...
guard let storage = rtmClient.getStorage() else { return }
let (response, error) = await storage.subscribeUserMetadata(userId: userId)
if let errorInfo = error {
    // Handle error
...
rtmClient.getStorage()?.subscribeUserMetadata(userId: userId) { (response, error) in
    if let errorInfo = error {
        // Handle error
        print("Failed to subscribe to user metadata with error: \(errorInfo.reason)")
    } else if let subscribeResponse = response {
...
guard let storage = rtmClient.getStorage() else { return }
let (response, error) = await storage.unsubscribeUserMetadata(userId: userId)
if let errorInfo = error {
    // Handle error
...
rtmClient.getStorage()?.unsubscribeUserMetadata(userId: userId) { (response, error) in
    if let errorInfo = error {
        // Handle error
        print("Failed to unsubscribe from user metadata with error: \(errorInfo.reason)")
    } else if let unsubscribeResponse = response {
...
guard let lock = rtmClient.getLock() else { return }
let (response, error) = await lock.setLock(
    channelName: channelName,
    channelType: channelType,
    lockName: lockName,
    ttl: ttl)
...
guard let lock = rtmClient.getLock() else { return }
let (response, error) = await lock.acquireLock(
    channelName: channelName,
    channelType: channelType,
    lockName: lockName,
    retry: retry
...
guard let lock = rtmClient.getLock() else { return }
let (response, error) = await lock.releaseLock(
    channelName: channelName,
    channelType: channelType,
    lockName: lockName
)
...
guard let lock = rtmClient.getLock() else { return }
let (response, error) = await lock.revokeLock(
    channelName: channelName,
    channelType: channelType,
    lockName: lockName,
    userId: userId
...
let channelType: AgoraRtmChannelType = .message
guard let lock = rtmClient.getLock() else { return }
let (response, error) = await lock.getLocks(
    channelName: channelName,
    channelType: channelType
)
if let errorInfo = error {
...
guard let lock = rtmClient.getLock() else { return }
let (response, error) = await lock.removeLock(
    channelName: channelName,
    channelType: channelType,
    lockName: lockName
)
