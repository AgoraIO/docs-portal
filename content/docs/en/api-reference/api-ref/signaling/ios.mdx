...
| Properties | Type | Required | Default | Description |
|:-----------:|:----------------:|:--------:|:---------------------:| ------------------------------------------------------------------- |
| `proxyType` | `AgoraRtmProxyType` | Optional | `none` | Proxy protocol type. See [`AgoraRtmProxyType`](#enumvproxytyp-e). |
...
| `didReceiveLinkStateEvent` | Receive event notifications when client connection status changes. For details, see [`AgoraRtmLinkStateEvent`](#configlinkstateeven-t). |
