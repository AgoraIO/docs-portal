...
| `areaCode` | `AgoraRtmAreaCode` | Optional | `AgoraRtmAreaCodeGLOB` | Service area code, you can choose according to the region where your business is deployed. See [`AgoraRtmAreaCode`](#agorartmareacode). |
...
| `level` | `AgoraRtmLogLevel` | Optional | `AgoraRtmLogLevelInfo` | Output level of log information. See [`AgoraRtmLogLevel`](#agorartmloglevel). |
...
| Properties | Type | Required | Default | Description |
|:-------------------:|:---------------------:|:--------:|:--------------------------:| ----------------------------------------------------------------------------------------------------------------------------------- |
| `encryptionMode` | `AgoraRtmEncryptionMode` | Optional | `AgoraRtmEncryptionNone` | Encryption mode. See [`AgoraRtmEncryptionMode`](#agorartmencryptionmode). |
...
|:----------:|------------------------------|
| `didReceiveMessageEvent` | Receive message notifications from all subscribed Message Channels or topic message notifications subscribed to, in all Stream Channels you join. See [`AgoraRtmMessageEvent`](#agorartmmessageevent) . |
...
| Properties | Type | Required | Default | Description |
| :-------------: | :------------------------------------------------------: | :------: | :-----------------------------------------------------: | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `qos` | `AgoraRtmMessageQos` | Optional | `AgoraRtmMessageQosUnordered` | Whether the data transmitted in the topic is ordered. See [`AgoraRtmMessageQos`](#agorartmmessageqos). |
| `priority` | `AgoraRtmMessagePriority` | Optional | `AgoraRtmMessagePriorityNormal` | The priority of data transmission in the topic compared to other topics in the same channel. See [`AgoraRtmMessagePriority`](#agorartmmessagepriority). |
...
| `-11040` | `AgoraRtmErrorChannelSubscribeCanceled` | The channel subscription is canceled before it completes. |
...
| `-13014` | `AgoraRtmErrorPresenceInactive` | The Presence service is not enabled or is currently unavailable. |
| `-13015` | `AgoraRtmErrorPresencePendingRequestCancelled` | The pending Presence request is canceled. |
| `-13016` | `AgoraRtmErrorPresencePendingRequestExceedLimitation` | The number of pending Presence requests exceeds the limit. |
