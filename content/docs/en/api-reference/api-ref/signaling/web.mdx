...
| `status` | (Deprecated) Receive event notifications when client connection status changes. For details, see [SDK connection state](#enumvconnectionstat-e) and [SDK connection state change reason](#enumvconnectionreaso-n). |
