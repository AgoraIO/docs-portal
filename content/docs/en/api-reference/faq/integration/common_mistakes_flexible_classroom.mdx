...
- `600001-1` in the web terminal or `401` from the server when logging into a classroom
   ...
   Agora recommends that you generate a Token on backend and call it on frontend. For details, refer to [Secure authentication with tokens](/en/flexible-classroom/develop/integrate/authentication-workflow).
...
- `code 30409104 detailed information: roomType conflict`
  ...
  For other related server error codes, refer to [Response Status Codes](/en/flexible-classroom/restful-api/classroom-api#status-code).
