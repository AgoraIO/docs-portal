...
If you receive the `403 Forbidden` error when uploading courseware, please check whether the [whiteboard function has been configured](/en/flexible-classroom/get-started/enable-flexible-classroom#configure-the-whiteboard-feature) correctly and make sure that Agora can access your cloud storage space.
