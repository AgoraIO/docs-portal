...
:::info
The frequency of calling Agora server-side RESTful API is capped and high real-time performance is not guaranteed. In case of a large number of concurrent businesses, enable Agora Notifications and configure your business server to [Receive notifications about channel events](/en/video-calling/core-functionality/receive-notifications).
:::
