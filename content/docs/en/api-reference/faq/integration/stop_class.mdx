...
1. To end the class in the background, call [RESTful API](/en/flexible-classroom/restful-api/classroom-api#set-the-classroom-state) to set the classroom state to one of the following:
