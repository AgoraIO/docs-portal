...
- `kRolePublisher` (1): (Default) The user has the privilege to publish streams.
...
1. In [Agora Console](https://console.agora.io), select **Project Settings** from the sidebar, switch to the **Services** tab and find **Co-Host Authentication**.
2. Turn on the **Active** toggle, and follow the on-screen instructions. Co-host authentication takes effect in 5 minutes.
