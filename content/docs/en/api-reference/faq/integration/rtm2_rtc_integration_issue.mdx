...
:::info
You can find the `aosl` library version for the SDKs in the [Video SDK](/en/realtime-media/rtc/reference/release-notes) or [Voice SDK](/en/realtime-media/rtc/reference/release-notes) release notes and [Signaling release notes](/en/realtime-media/rtm/reference/release-notes).
:::
...
```text tab="Android" tabGroup="platform"
// ...
dependencies {
