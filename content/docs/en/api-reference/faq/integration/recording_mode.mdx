...
- On-Premise Recording: [Individual Recording](/en/on-premise-recording/develop/individual-mode/) and [Composite Recording](/en/on-premise-recording/develop/composite-mode/).
- Cloud Recording: [Individual Recording](/en/cloud-recording/develop/individual-mode/) and [Composite Recording](/en/cloud-recording/develop/composite-mode/).
