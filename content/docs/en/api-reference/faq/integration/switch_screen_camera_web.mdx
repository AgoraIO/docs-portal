...
This page introduces three solutions for switching between the screen-sharing stream and the stream captured by the camera in a [screen-sharing](/en/3.x/interactive-live-streaming/basic-features/screensharing) scenario using the Agora RTC SDK for Web.
