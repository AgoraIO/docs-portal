...
Due to business requirements or operational errors, some users need to switch their Agora Console account from the [International version](https://console.agora.io) to the [Domestic version](https://console.shengwang.cn/), but cannot find the switch settings in Agora Console.
