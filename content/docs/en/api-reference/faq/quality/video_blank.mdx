...
You can monitor the statistics of every call in [Agora Analytics](/en/solutions/agora-analytics/product-overview) in Console. For more information, see [Agora Analytics Tutorial](/en/agora-analytics/analyze/video-voice-sdk/call-search).
