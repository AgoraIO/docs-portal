...
2. Check if the camera access permission is enabled. Both Android and iOS have a runtime access permission function under System Settings. See [Add project permissions](/en/interactive-live-streaming/get-started/get-started-sdk#project-setup).
...
3. Check whether the remote user uses the [channel encryption](/en/video-calling/core-functionality/media-stream-encryption) function but the local user doesn't.
