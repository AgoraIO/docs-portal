...
You can monitor the statistics of every call in [Agora Analytics](/en/agora-analytics/overview/product-overview) in Console. For more information, see [Agora Analytics Tutorial](/en/agora-analytics/analyze/video-voice-sdk/call-search).
