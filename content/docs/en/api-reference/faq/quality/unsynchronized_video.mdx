...
- If you use a custom video renderer, check the source code of the video renderer. See the [Customer renderer](/en/video-calling/advanced-features/custom-video#custom-video-rendering) sample project provided by Agora for reference.
