...
You can monitor the statistics of every call in [Agora Analytics](https://dashboard.agora.io/analytics/call/search) in Console. See [Agora Analytics Tutorial](/en/agora-analytics/analyze/video-voice-sdk/call-search).
