...
1. Go to the browser settings page and select **Privacy and Security** > **Site Settings**:
    ...
    ![site settings](/images/faq/site_settings.png)

1. Click on the camera and mike permissions:

    ![camera and mike permissions](/images/faq/camera_mike_permissions.png)

1. Choose **Allow** in the dropdown:

    ![camera and mike allow access](/images/faq/camera_mike_allow.png)
...
Audio and video devices can be disabled, as shown below:
    ...
    ![video disabled](/images/faq/video_settings.png)

    ![audio disabled](/images/faq/audio_settings.png)
...
Adjust the resolution of class recordings in the web client by changing the `webRecordConfig` in the [Set recording state](/en/flexible-classroom/restful-api/classroom-api#set-the-recording-state) RESTful API:
...
Taking the macOS system as an example, you can enable the corresponding permission in **System Settings** > **Privacy and Security** > **Screen & System Audio Recording**.
    ...
    ![video disabled](/images/faq/screen_system_audio_recording.png)

Enable screen recording permission for AgoraFlexibleClassroom:

    ![enable fcr](/images/faq/enable_fcr.png)
...
1. Pass the name of the virtual sound card on macOS.
    ...
    ![screen share capture](/images/faq/screen_share_capture.png)
