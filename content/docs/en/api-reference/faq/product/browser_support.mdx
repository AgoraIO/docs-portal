...
:::info
This page only applies to the Agora Web SDK 3.x. If you use the Web SDK 4.x, see [Web SDK Compatibility](/en/realtime-media/video/reference/supported-platforms?platform=web).
:::
...
The support for in-app browsers on mobile devices is complicated. For details, see [Supported Platforms](/en/realtime-media/video/reference/supported-platforms).
...
[Supported Platforms](/en/realtime-media/video/reference/supported-platforms)
