...
- On Android, the SDK supports local and online files in Ogg, 3GP, TS, MKV, MP4, WAV, M4A, MP3, AAC, and ADTS formats.
...
- On Android, the SDK supports local and online files in M4A, MP4, and MKV formats. When playing a multi-track audio file in MP4 format, the SDK supports switching to the second audio track.
...
| -------------------------------- | ---------------- | ---------------------------- | ------------------------------------------------------------------------- | -------------------------------------------------- |
| Android, iOS, macOS, and Windows | Local and online | Single-track and multi-track | 3GP, AAC, AMR, ASF, AVI, FLAC, M4A, M4V, MOV, MP3, MP4, TS, Ogg, WAV, WMA | AAC, AMR, FLAC, MP2, MP3, PCM, Vorbis, WMAV2, OPUS |
...
- For Android, Lite SDK does not support playing audio files that the Android system's native media capabilities do not support. Some Android devices do not support the WMA format, so playing WMA files on those devices using the Agora APIs can fail.
