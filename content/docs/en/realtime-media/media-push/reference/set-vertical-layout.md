...
description: "Introduces how to set vertical layout"
---
...
:::info
These options also apply if a window is empty because there are not enough users in the channel to fill it.
:::
