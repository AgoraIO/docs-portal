...
| Custom transcoding parameters | Use template APIs in the [REST API overview](/en/api-reference/api-ref/rtmp-gateway) to create, update, delete, or set default transcoding templates for ingress streams. To transcode only when needed, see [Adaptive transcoding](./build/process-media/enable-adaptive-transcoding.md). |
