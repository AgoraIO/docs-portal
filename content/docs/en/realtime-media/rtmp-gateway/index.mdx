...
description: "Publish RTMP, SRT, and WHIP streams into Agora RTC channels with low latency and optional edge transcoding."
---
...
<Cards>
  <Card title="Media Gateway quickstart" href="./quickstart.md" description="Generate a streaming key and publish RTMP, SRT, or WHIP streams into Agora channels." />
  <Card title="Integration best practices" href="./reference/integration.md" description="Review Media Gateway integration notes and constraints." />
</Cards>
