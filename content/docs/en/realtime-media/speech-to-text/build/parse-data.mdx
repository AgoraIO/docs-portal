...
```
        ...
        Replace `./SttMessage.proto` with the path to the file you created in the [Create a Protobuf definition file](https://docs.agora.io/en/real-time-stt/develop/create-a-protobuf-definition-file) section.
