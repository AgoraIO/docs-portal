...
- [REST quickStart](/en/realtime-media/speech-to-text/get-started/quickstart): Use REST APIs to start, manage, query, and stop a real-time speech-to-text agent for live audio transcription and translation.
