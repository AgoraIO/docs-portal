...
- [SDK quickstart](/en/realtime-media/video/index)
- [Authentication](/en/realtime-media/video/build/authentication-workflow)
...
- **High-quality video at scale** - Consistent high-quality video from 1:1 calls to thousands of concurrent users, even under challenging network conditions.
...
- **Call recording** - Record video calls in the cloud or on premises with control over the format, path of storage, and quality.
