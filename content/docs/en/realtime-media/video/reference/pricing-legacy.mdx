...
Billing occurs monthly. At the end of each month, Agora calculates the total duration of the audio and video usage in all projects under your [Agora account](https://console.agora.io/).
