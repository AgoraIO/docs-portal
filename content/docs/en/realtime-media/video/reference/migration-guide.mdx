...
After updating from v4.0.0 Beta to v4.0.0, the SDK package name has changed from `electron-agora-rtc-ng` to `agora-electron-sdk`, see [Integrate the SDK](./start_live_electron_ng?platform=Electron#integrate-the-sdk).
...
After upgrading from v4.0.0 Beta to v4.0.0, the SDK package name has changed from `react-native-agora-rtc-ng` to `react-native-agora`, see [Integrate the SDK](./start_live_react_native_ng?platform=React%20Native#integrate-the-sdk).
