...
To synchronize the online status of hosts, you can use this endpoint or the [query user status](query-user-status.md) endpoint. This endpoint requires a lower call frequency and offers higher efficiency, so Agora recommends it for this purpose.
