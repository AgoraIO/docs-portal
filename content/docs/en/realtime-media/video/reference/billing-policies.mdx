...
:::info
Agora offers a new [pricing](/video-calling/overview/pricing#subscription-packages) model. If your account uses this model, you receive a monthly free usage package by default instead of the 10,000 free minutes described below.
:::
