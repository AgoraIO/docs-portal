---
title: Video SDK release notes (Blueprint)
---
...
<section id="blueprint-sdk-known-issues">
...
#### Blueprint SDK v4.4.0 [#blueprint-sdk-v440]
...
#### Blueprint SDK v4.2.1 [#blueprint-sdk-v421]
...
<Accordions type="multiple" defaultValue="v451-6">
...
<Accordion title="v4.2.1" id="v421-10" headingLevel={3} value="v421-10">
