---
title: Video SDK release notes (Flutter)
---
...
<section id="flutter-sdk-known-issues">
...
#### Flutter SDK v6.3.2 [#flutter-sdk-v632]
...
#### Flutter SDK v6.2.6 [#flutter-sdk-v626]
...
#### Flutter SDK v6.2.3 [#flutter-sdk-v623]
...
1. **Renaming parameters in callbacks**
   ...
   **Note:** For specific renaming of enumerations, please refer to [API changes](#api-changes-64).
...
1. **Channel media relay**
   ...
   | ----------------------------------------------------- | ---------------------------------- |
   | <Slot name="release-channel-relay-flutter-6-1-0-deleted" />     | `startOrUpdateChannelMediaRelay`   |
   | <Slot name="release-channel-relay-flutter-6-1-0-deleted-ex" /> | `startOrUpdateChannelMediaRelayEx` |
   | `onChannelMediaRelayEvent`                            | `onChannelMediaRelayStateChanged`  |

   <Slot for="release-channel-relay-flutter-6-1-0-deleted">
   ...
   <Slot for="release-channel-relay-flutter-6-1-0-deleted-ex">
...
In addition to the usability enhancements detailed in the [fixed issued](#issues-fixed-112) section, this release includes a number of functional improvements to screen sharing, as follows:
...
**5. Spatial audio**
    ...
    > **_NOTE:_** This feature is in experimental status. To enable this feature, contact [support@agora.io](mailto:support@agora.io). Contact Technical Support if needed.
