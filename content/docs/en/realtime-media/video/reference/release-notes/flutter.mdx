...
In addition to the usability enhancements detailed in the [fixed issued](#issues-fixed) section, this release includes a number of functional improvements to screen sharing, as follows:
