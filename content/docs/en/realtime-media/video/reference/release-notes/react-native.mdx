---
title: Video SDK release notes (React Native)
---
...
<section id="react-native-sdk-known-issues">
...
#### React Native SDK v4.2.3 [#react-native-sdk-v423]
...
#### React Native SDK v4.2.6 [#react-native-sdk-v426]
...
<Accordion title="v4.5.2" id="v452-5" headingLevel={3} value="v452-5">
...
- [onFaceInfo](https://api-ref.agora.io/en/video-sdk/react-native/4.x/API/callback_ifaceinfoobserver_onfaceinfo.html)
...
1. **Renaming parameters in callbacks**
   ...
   **Note:** For specific renaming of enumerations, please refer to [API changes](#api-changes-70).
...
> **_NOTE:_** This feature is in experimental status. To enable this feature, contact [support@agora.io](mailto:support@agora.io).
