---
title: Video SDK release notes (Electron)
---
...
<section id="electron-sdk-known-issues">
...
#### Electron SDK v4.4.0 [#electron-sdk-v440]
...
<Accordion title="v4.5.2" id="v452-4" headingLevel={3} value="v452-4">
...
1. **Renaming parameters in callbacks**
   ...
   **Note:** For specific renaming of enumerations, please refer to [API changes](#api-changes-58).
...
<Accordion title="v4.2.2" id="v422-5" headingLevel={3} value="v422-5">
...
In addition to the usability enhancements detailed in the [fixed issued](#issues-fixed-98) section, this release includes a number of functional improvements to screen sharing, as follows:
