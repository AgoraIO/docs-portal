---
title: Video SDK release notes (JavaScript)
---
...
<Accordions type="multiple" defaultValue="v251">

<Accordion title="v2.5.1" id="v251" headingLevel={3} value="v251">
...
<Accordion title="v2.5.0" id="v250" headingLevel={3} value="v250">
