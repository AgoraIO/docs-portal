---
title: Video SDK release notes (iOS)
---
...
<section id="ios-sdk-known-issues">
...
#### iOS SDK v4.2.6 [#ios-sdk-v426]

**AirPods Pro Bluetooth connection issue**

AirPods Pro does not support the A2DP protocol in communication audio mode, which can cause the Bluetooth connection to fail in that mode.

:::warning[Library conflict]
Starting from v4.5.0, both Video SDK and Signaling SDK v2.2.0 and later include the `aosl.xcframework` library. If you manually integrate Video SDK through a CDN and also use Signaling SDK, delete the earlier version of `aosl.xcframework` to avoid conflicts.
:::
...
1. **Renaming parameters in callbacks**
   ...
   **Note:** For specific renaming of enumerations, please refer to [API changes](#api-changes-8).
...
2. **Channel media relay**
   ...
   | ----------------------------- | ---------------------------------- |
   | <Slot name="release-channel-relay-ios-4-4-0-deleted" /> | `startOrUpdateChannelMediaRelay`   |
   | <Slot name="release-channel-relay-ios-4-4-0-deleted-ex" /> | `startOrUpdateChannelMediaRelayEx` |
   | `didReceiveChannelMediaRelayEvent`| `channelMediaRelayStateDidChange`  |

   <Slot for="release-channel-relay-ios-4-4-0-deleted">
   ...
   <Slot for="release-channel-relay-ios-4-4-0-deleted-ex">
...
:::info
Agora charges separately for this function. See [AI Noise Suppression unit pricing](/en/realtime-media/video/reference/pricing-legacy#ai-noise-suppression-pricing).
:::
...
<Accordions type="multiple" defaultValue="v220-2">

<Accordion title="v2.2.0" id="v220-2" headingLevel={3} value="v220-2">

v2.2.0 was released on September 13, 2024.

#### New features [#new-features-145]
...
<Accordion title="v2.1.0" id="v210-3" headingLevel={3} value="v210-3">
...
<Accordion title="v2.0.0" id="v200-4" headingLevel={3} value="v200-4">
...
<Accordions type="multiple" defaultValue="v120-2">

<Accordion title="v1.2.0" id="v120-2" headingLevel={3} value="v120-2">
...
<Accordion title="v1.0.0" id="v100-4" headingLevel={3} value="v100-4">
