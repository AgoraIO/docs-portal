...
- *Platforms*:
    ...
    macOS 10.11 or later. Video SDK supports the following:
...
- *Platforms*:
    ...
    Windows 7 or later. Video SDK supports the following:
...
- *Platforms*:
    ...
    Unity 2017 or later. Video SDK supports the following:
