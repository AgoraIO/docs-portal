...
- *Platforms*:
    ...
    |:-----------------|:-------|:-----|
    | Android         | Android 4.1 or later.  Video SDK supports the following ABIs. - armeabi-v7a
- arm64-v8a
- x86
...
- *Platforms*:
    ...
    | Target Platform | Operating system version | IDE version     |
    |:-----------------|:-------|:-----|
    | macOS| macOS 10.11 or later. Video SDK supports the following: - x86-64
...
- *Platforms*:
    | Target Platform | Operating system version | IDE version     |
    |:-----------------|:-------|:-----|
    | Windows         | Windows 7 or later. Video SDK supports the following: - x86
...
- *Platforms*:
    | Target Platform | Supported version |
    |:-----------------|:-------|
    | Unity| Unity 2017 or later. Video SDK supports the following: - Android (armeabi-v7a, arm64-v8a, x86)
- iOS
- Windows (x86, x86-64)
- macOS    |
</PlatformStructured>
