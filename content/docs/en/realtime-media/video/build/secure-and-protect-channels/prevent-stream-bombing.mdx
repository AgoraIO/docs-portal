...
- Ensure the secrecy of your app ID and app certificate. Agora recommends storing the app ID and app certificate securely on the app server. If you suspect leakage, [Switch to a new primary certificate](../manage-agora-account.mdx).
...
:::note
If your business use-case requires more refined streaming permission control, refer to the [Co-host token authentication](authentication-workflow.mdx) guide.
:::
