...
1. Integrate the [Virtual Background](/en/realtime-media/video/build/apply-video-effects/virtual-background#integrate-the-virtual-background-extension) extension. Ensure that you understand the [considerations](/en/realtime-media/video/build/apply-video-effects/virtual-background#considerations).

1. Run the following command to integrate the [Video Compositor extension](https://www.npmjs.com/package/agora-extension-video-compositor) into your project using npm:

   ```bash
   npm install agora-extension-video-compositor
   ```

1. Import the Video Compositor extension in either of the following ways:
