...
1. Enable the plugin
  ...
  1. Inject the plugin into the audio processing pipeline by calling the SDK's <Link to = "https://api-ref.agora.io/en/video-sdk/web/4.x/interfaces/imicrophoneaudiotrack.html#pipe">`pipe`</Link> method and specify the `processorDestination` property.
