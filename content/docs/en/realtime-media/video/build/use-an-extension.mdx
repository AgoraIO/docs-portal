...
* Same setup as the [Video SDK quickstart prerequisites](../index.mdx) for Video Calling.
...
1. Open your Flutter project
  ...
  Load the [SDK quickstart](../index.mdx) Video Calling project you created previously.
