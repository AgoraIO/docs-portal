...
{ /*
- If a firewall is deployed in your network environment, refer to [Connect through restricted networks with Cloud Proxy](/en/realtime-media/video/build/manage-connection-and-quality/cloud-proxy) to use Agora services normally.
*/ }
...
<Tabs defaultValue="Main level">
<TabsList>
  <TabsTrigger value="Main level">Main Level</TabsTrigger>
  <TabsTrigger value="sub level">Sub Level</TabsTrigger>
</TabsList>

<TabsContent value="Main level">
