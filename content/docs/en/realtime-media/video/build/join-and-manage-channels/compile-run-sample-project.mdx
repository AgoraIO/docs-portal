...
1. On the demo page, enter your [App ID](/en/realtime-media/video/manage-agora-account#get-the-app-id-and-app-certificate), [token](/en/realtime-media/video/manage-agora-account#generate-temporary-tokens), and channel name and join the channel.
