...
- Two local images.
- Source video track 1: Created from the video stream captured by the camera, with the background removed using the [Virtual Background extension](/en/realtime-media/video/build/virtual-background).
...
1. Integrate the [Virtual Background](/en/realtime-media/video/build/virtual-background) extension. Ensure that you understand the [considerations](/en/realtime-media/video/build/virtual-background).
