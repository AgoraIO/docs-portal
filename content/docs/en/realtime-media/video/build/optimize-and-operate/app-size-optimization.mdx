...
### Use the Voice SDK
Video SDK supports both audio and video functions, and the package size is large. If you only need to use audio features, best practice is to integrate the [Voice SDK](../../../sdks.md). For details, see [Voice SDK Quickstart](/en/realtime-media/voice/quickstart).
