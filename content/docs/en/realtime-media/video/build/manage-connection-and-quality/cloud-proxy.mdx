...
To enable Cloud Proxy, in [Agora Console](https://console.agora.io/v2) go to **Realtime Services**, select **Cloud Proxy** under **Security & Infrastructure**, and turn on the **Active** toggle.
