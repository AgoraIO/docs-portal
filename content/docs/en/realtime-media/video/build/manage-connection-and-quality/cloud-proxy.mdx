...
To enable Cloud Proxy, in [Agora Console](https://console.agora.io), Select **Project Settings**, from the sidebar, switch to the **Services** tab and find **Cloud Proxy**. Turn on the **Active** toggle to enable.
