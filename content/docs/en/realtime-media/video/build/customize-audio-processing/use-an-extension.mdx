...
* Implemented the [SDK quickstart](/en/realtime-media/video/get-started-sdk).
...
* Same setup as the [Video SDK quickstart prerequisites](/en/realtime-media/video/get-started-sdk) for Video Calling.
...
3. Open your Flutter project
  ...
  Load the [SDK quickstart](/en/realtime-media/video/get-started-sdk) Video Calling project you created previously.
