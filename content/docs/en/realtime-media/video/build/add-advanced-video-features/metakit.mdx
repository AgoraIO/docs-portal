...
To implement MetaKit effects in your app, open the [SDK quickstart for Video Calling](/en/realtime-media/video/quickstart/android) project and take the steps described below.
...
To implement MetaKit effects in your app, open the [SDK quickstart for Video Calling](/en/realtime-media/video/quickstart/ios) project and take the steps described below.
