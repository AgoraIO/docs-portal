...
- A computer that can access the Internet. If your network environment has a firewall deployed, refer to [Firewall requirements](../../reference/firewall.mdxx) to use the Agora services normally.
