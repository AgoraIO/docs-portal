...
| App Sandbox | Hardware | - Camera<br />2. Audio Input |
| Hardened Runtime | Resource Access | - Camera<br />2. Audio Input |
...
|:--|:-----|:-----|:------------|
| 1 | **Set Show Mouse Cursor** | Native* | (Optional) Set whether to display the mouse cursor. Check to display it.<br />**Information:**<br />- This node is available on Windows and macOS only.<br />2. If the node is not retrieved at creation time, uncheck **Context Sensitive**. ![](/images/video-sdk/quickstart-implementation-blueprint-3.png) |
...
| 7 | **Check Permission** | Custom | (Optional) Check whether you have obtained the system permissions required for real-time audio and video interaction, such as access to the camera and microphone.<br />**Note:** If your target platform is Android, create this node to check system permissions. |
