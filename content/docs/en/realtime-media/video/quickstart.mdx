...
1. On a second Video Calling device, repeat the previous steps to install and launch the client. Alternatively, use the [Web demo](https://webdemo-global.agora.io/example/quickStart/videoAndVoiceCalling/index.html) to join the same channel and test the following use-cases:
...
|:-----------|:---------|:----------------|
| App Sandbox | Network | <Slot name="macos-permissions-1-app-sandbox-network" /> |
| App Sandbox | Hardware | <Slot name="macos-permissions-1-app-sandbox-hardware" /> |
| Hardened Runtime | Resource Access | <Slot name="macos-permissions-1-hardened-runtime-resource-access" /> |

<Slot for="macos-permissions-1-app-sandbox-network">
...
<Slot for="macos-permissions-1-app-sandbox-hardware">
...
<Slot for="macos-permissions-1-hardened-runtime-resource-access">
...
4. On a second Video Calling device, repeat the previous steps to install and launch the client. Alternatively, use the [Web demo](https://webdemo-global.agora.io/example/quickStart/videoAndVoiceCalling/index.html) to join the same channel and test the following use-cases:
...
| Capability | Category | Permission      |
|:-----------|:---------|:----------------|
| App Sandbox | Network | <Slot name="macos-permissions-3-app-sandbox-network" /> |
| App Sandbox | Hardware | <Slot name="macos-permissions-3-app-sandbox-hardware" /> |
| Hardened Runtime | Resource Access | <Slot name="macos-permissions-3-hardened-runtime-resource-access" /> |

<Slot for="macos-permissions-3-app-sandbox-network">
...
<Slot for="macos-permissions-3-app-sandbox-hardware">
...
<Slot for="macos-permissions-3-hardened-runtime-resource-access">
...
4. Invite a friend to install and run the client on a second device. Alternatively, use the [Web demo](https://webdemo-global.agora.io/example/quickStart/videoAndVoiceCalling/index.html) to join the same channel. Once your friend joins the channel, you can see and hear each other.
...
1. Install the Agora server side Video Calling SDK.
...
To leave a channel, disconnect from Agora backend and release resources, refer to he following code.
...
Congratulations! You have successfully connected to the Agora backend and joined a channel.
