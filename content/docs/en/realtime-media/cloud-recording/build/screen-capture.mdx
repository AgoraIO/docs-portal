...
Set `mode` to `individual` when calling [`start`](/en/api-reference/cloud-recording/restful#start) to enable [individual recording mode](/en/realtime-media/cloud-recording/build/individual-mode).
