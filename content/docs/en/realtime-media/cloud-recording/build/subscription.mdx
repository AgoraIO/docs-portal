...
description: "Create a whitelist or blacklist for audio and video subscriptions."
---
...
When the recording starts, set the parameters in [`start`](/en/api-reference/cloud-recording/restful#start) to create subscription lists. During the recording, set the `streamSubscribe` parameter in [`update`](/en/api-reference/cloud-recording/restful#update) to update the subscription lists.
