...
For details, see [Merge Audio and Video Files](/en/realtime-media/cloud-recording/build/merge-files).
...
1. Get the M3U8 file
    ...
    - See [Manage Recorded Files](/en/realtime-media/cloud-recording/build/manage-files) for the detailed naming conventions of the M3U8 file in individual recording mode.
