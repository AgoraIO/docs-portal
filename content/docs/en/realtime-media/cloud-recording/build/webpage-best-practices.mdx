...
1. When calling [`start`](/en/api-reference/cloud-recording/restful#start) to start web page recording, the web page recording browser accesses and loads the web page to be recorded.
