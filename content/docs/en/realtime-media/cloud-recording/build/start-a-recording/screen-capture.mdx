...
For pricing details, see [Pricing](/en/realtime-media/cloud-recording/pricing).
To implement client-side screen capture, see [Screenshot Upload](../../../video-calling/advanced/screenshot-upload).

## Implementation

:::info[Note]
The initial Queries Per Second (QPS) limit is 10 per app ID when you register. If you need to extend the limit for QPS, contact support@agora.io. For more details on existing limitations, see [Integration best practices](/cloud-recording/best-practices/integration-best-practices#check-the-limits).
:::
