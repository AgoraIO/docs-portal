...
|-------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------|
| Web SDK 4.x | Call [setEnabled]({{global.API_REF_WEB_ROOT}}/interfaces/ilocaltrack.html#setenabled) method | Displays the last frame on the user screen in this slice and does not continue to generate video slices. |
