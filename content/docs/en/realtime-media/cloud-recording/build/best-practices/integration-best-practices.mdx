...
|:----------------|:----------------------|:---------------------|:----------------------|:--------------------------------|
| Cloud recording | <Slot name="cloud-recording-streams-mainland-china" /> | <Slot name="cloud-recording-streams-europe" /> | <Slot name="cloud-recording-streams-america" /> | <Slot name="cloud-recording-streams-asia" /> |

<Slot for="cloud-recording-streams-mainland-china">
...
<Slot for="cloud-recording-streams-europe">
...
<Slot for="cloud-recording-streams-america">
...
<Slot for="cloud-recording-streams-asia">
...
| 2 | required | request method | <Slot name="cloud-recording-checklist-request-method" /> |
| 3 | required | Get recording resources | <Slot name="cloud-recording-checklist-recording-resources" /> |
| 4 | required | channel scene | Make sure that the channel scene (`channelType`) is consistent with the settings of the Video SDK. |
| 5 | required | recording parameters | <Slot name="cloud-recording-checklist-recording-parameters" /> |
| 6 | required | Confirm that the recording service has started successfully | <Slot name="cloud-recording-checklist-start-success" /> |
| 7 | required | PCW & QPS limits | <Slot name="cloud-recording-checklist-pcw-qps" /> |
| 8 | optional | NCS Service Activation | <Slot name="cloud-recording-checklist-ncs-activation" /> |
...
<Slot for="cloud-recording-checklist-request-method">
...
<Slot for="cloud-recording-checklist-recording-resources">
...
<Slot for="cloud-recording-checklist-recording-parameters">
...
<Slot for="cloud-recording-checklist-start-success">
...
<Slot for="cloud-recording-checklist-pcw-qps">
...
<Slot for="cloud-recording-checklist-ncs-activation">

Activate the cloud recording callback service and subscribe to the following events as an auxiliary means of monitoring the recording service status:
