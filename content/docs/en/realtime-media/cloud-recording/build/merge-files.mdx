...
- Switching between different [AudioProfile](/en/api-reference/cloud-recording/restful#transcodingconfig) configuration at the streaming sender during a recording is not supported.
