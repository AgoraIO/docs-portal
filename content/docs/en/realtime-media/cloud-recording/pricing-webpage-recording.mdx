...
When starting a web page recording, you can [set the video profile](/en/realtime-media/cloud-recording/build/recording-video-profile)
...
You should set a reasonable [maxRecordingHour](/en/api-reference/cloud-recording/restful#extensionserviceconfig) based on the
