...
- Enabled the Agora Cloud Recording service for your project.
    ...
    <Accordions>
      <Accordion title="Enable cloud recording">
        In [Agora Console](https://console.agora.io), select **Project Settings** from the sidebar, switch to the **Services** tab and find **Cloud Recording**. Turn on the **Active** toggle to enable.
