...
such as [Video Calling](/en/realtime-media/video),
...
subscribed to a channel with a high-definition (HD) [aggregate video resolution](pricing#aggregate-video-resolution-in-dual-stream-use-cases), Agora waives the cost of the Video SDK usage during the web page recording; only the web page recording fees apply. Real-time communication at higher aggregate resolutions does not receive this discount.
