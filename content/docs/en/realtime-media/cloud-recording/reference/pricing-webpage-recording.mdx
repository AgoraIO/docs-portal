...
[10,000 free-of-charge minutes](billing-policies#free-of-charge-policy)
...
You should set a reasonable [maxRecordingHour](/en/api-reference/api-ref/cloud-recording/start) based on the
actual business use-case or actively stop the web page recording.

## See also

- [Agora's free-of-charge policy for the first 10,000 minutes](billing-policies#free-of-charge-policy)
- [Billing, free deduction, and account suspension](billing-policies#billing-and-account-policies)
