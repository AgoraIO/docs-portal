...
If your account balance is negative after the deduction, Agora sends you an email, reminding you to [top up your account](../../rtc/subscription-packages#top-up-package) at your earliest convenience and avoid account suspension.
...
2. Purchase a [pre-paid monthly package](../../rtc/subscription-packages) or [top-up package](../../rtc/subscription-packages#top-up-package). This option is highly recommended.
