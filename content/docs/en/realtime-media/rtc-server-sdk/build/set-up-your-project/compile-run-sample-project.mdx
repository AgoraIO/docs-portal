...
1. Use a PC or mobile device to open the [Agora RTC SDK Web SDK sample project](https://webdemo-global.agora.io/example/quickStart/videoAndVoiceCalling/index.html) and fill in the following fields:
...
1. Use a PC or mobile device to open the [Agora RTC SDK Web SDK sample project](https://webdemo-global.agora.io/example/quickStart/videoAndVoiceCalling/index.html) and specify the following fields:
