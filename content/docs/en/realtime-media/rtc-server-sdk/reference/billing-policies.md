...
2. Purchase a [pre-paid monthly package](https://docs.agora.io/en/server-gateway/overview/subscription-packages) or [top-up package](https://docs.agora.io/en/server-gateway/overview/subscription-packages). This option is highly recommended.
