...
<Cards>
  <Card title="SDK quickstart" href="quickstart.md" description="Integrate Server Gateway SDK and exchange media with RTC channels." />
  <Card title="Download SDKs" href="/en/api-reference/sdks?platform=linux" description="Get the latest Server Gateway SDK package for Linux." />
  <Card title="API reference" href="https://docs.agora.io/en/api-reference" description="Explore related API references for server-side RTC integrations." />
