...
<Cards>
  ...
  <Card title="Download SDKs" href="/en/api-reference/sdks" description="Get the latest Voice SDK package for your target platform." />
  ...
  <Card title="API reference" href="../../api-reference/rtc/index.md" description="Explore RTC API references for supported Voice SDK platforms." />
