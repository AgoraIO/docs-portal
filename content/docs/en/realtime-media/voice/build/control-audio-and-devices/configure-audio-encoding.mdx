...
For more audio settings, see [Achieve high audio quality](https://docs.agora.io/en/video-calling/best-practices/best-practices-sound-quality).

### Frequently asked questions

* [What is the difference between the in-call volume and the media volume?](https://docs.agora.io/en/help/integration-issues/system_volume)
