...
Alternatively, you can whitelist the following domains and ports to ensure seamless communication with Agora's services. For the complete and current Web SDK allowlist, see [Firewall requirements](../../reference/firewall.md).
