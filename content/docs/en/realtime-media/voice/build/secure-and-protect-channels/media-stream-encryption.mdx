...
Voice SDK supports the following encryption modes:
...
2. Implement client-side logic
     ...
     * Converts the key from Hex to ASCII, before passing it to the Voice SDK.

     * Converts the salt from Base64 to Uint8Array, before passing it to the Voice SDK.
