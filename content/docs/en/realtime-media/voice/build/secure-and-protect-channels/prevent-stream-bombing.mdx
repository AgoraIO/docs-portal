...
Store the app ID and app certificate securely on your app server. If you suspect leakage, [switch to a new primary certificate](/en/introduction/account).
...
To ensure that you have the latest security updates, upgrade to the latest version of Voice SDK for Web. Visit the [SDKs](../../../sdks.md) page and download the latest SDK.
