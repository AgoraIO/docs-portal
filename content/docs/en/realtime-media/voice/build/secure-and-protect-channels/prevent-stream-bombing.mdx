...
To ensure you have the latest security updates, best practice is to upgrade to the latest version of the Voice SDK. Visit the [SDKs](/sdks) page and download the latest version of the Android Voice SDK.
