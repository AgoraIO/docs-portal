...
- Go to the [SDKs](/sdks) page, download the latest version of the Agora Voice SDK, and unzip it. You see a `.unitypackage` file.
...
1. Go to [SDKs](/sdks) to download the latest version of the Agora Voice SDK and unzip it.
