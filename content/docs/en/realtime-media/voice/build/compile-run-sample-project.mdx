...
This page shows how to compile, configure, and run the Voice SDK Android sample project.
...
1. Turn on developer options on your Android device, enable USB debugging, and connect the device to the development machine through a USB cable. Your Android device appears in the Android device options.
  ...
  ![image](/images/video-sdk/run-compile-android-step-2.png)
...
1. Open the app and choose the example you want to run. For example, to test **Live Interactive Video Streaming**, select the option from the menu, enter the channel name, and click **Join**.
  ...
  ![image](/images/video-sdk/run-compile-android-step-6.jpg)
...
1. To test various audio and video interaction use-cases, connect to the [Agora web demo](https://webdemo.agora.io/basicVideoCall/index.html), or install and run the sample project on a second device. Make sure you use the same app ID on both devices. When you join the same channel from two devices, you can see and hear each other.
  ...
  ![image](/images/video-sdk/run-compile-android-step-7.png)
</PlatformStructured>

<PlatformStructured platform="ios">
Agora provides [Open-source sample projects on GitHub](https://github.com/AgoraIO/API-Examples/tree/main) to demonstrate the implementation of basic and advanced Voice SDK features.

This page shows how to compile, configure, and run the Voice SDK iOS sample project.
...
- Go to the [SDKs](../../../sdks.md) page, download the latest version of the Agora Voice SDK, and unzip it.
...
- Run the following command to clone the Github repository locally:
  ...
  This repository contains sample projects for all native platforms of Agora Voice SDK. The examples for iOS are located under `/iOS`.
...
1. Check your iOS device in the **iOS Device** options at the top of the Xcode interface.
  ...
  ![image](/images/video-sdk/run-compile-ios-step-2.png)
...
1. Check **Automatically manage signing** in **Signing & Capabilities** under **TARGETS**, then configure your Apple developer account and **Bundle Identifier** under each target.
  ...
  ![image](/images/video-sdk/run-compile-ios-step-3.png)
...
1. To test various audio and video interaction use-cases, connect to the [Agora web demo](https://webdemo.agora.io/basicVideoCall/index.html), or install and run the sample project on a second device. Make sure you use the same app ID on both devices. When you join the same channel from two devices, you can see and hear each other.
  ...
  ![image](/images/video-sdk/run-compile-ios-step-8.png)
</PlatformStructured>
...
1. Open the file `APIExample.xcworkspace` in Xcode. Check **Automatically manage signing** in **Signing & Capabilities** under **TARGETS**, and then configure your Apple developer account and **Bundle Identifier** under each target.
  ...
  ![image](/images/video-sdk/run-compile-macos-step-1.jpeg)
...
1. Select an example you want to try, then enter a channel name, such as *test*, and click the **Join Channel**.
  ...
  ![image](/images/video-sdk/run-compile-macos-step-4.png)

1. To test various audio and video interaction use-cases, connect to the [Agora web demo](https://webdemo.agora.io/basicVideoCall/index.html), or install and run the sample project on a second device. Make sure you use the same app ID on both devices. When you join the same channel from two devices, you can see and hear each other.

  ![image](/images/video-sdk/run-compile-macos-step-5.png)
</PlatformStructured>

<PlatformStructured platform="web">
Agora provides [Open-source sample projects on GitHub](https://github.com/AgoraIO/API-Examples-Web) to demonstrate the implementation of basic and advanced Voice SDK features.

This page shows how to compile, configure, and run the Voice SDK Web sample project.
...
- Go to the [SDKs](../../../sdks.md) page, download the latest version of Video SDK, and unzip it.
...
3. Set App ID and temporary Token
  ...
  ![image](/images/video-sdk/run-compile-web-step-1.png)
...
1. As an example, try the screen sharing demo, click **Join as host** to join a channel as the host. Ask a friend to run the sample project on another device and **Join as audience**, using the same app ID, app certificate, and channel name. Now you can share the screen with your friend.
  ...
  ![image](/images/video-sdk/run-compile-web-step-2.png)
</PlatformStructured>

<PlatformStructured platform="windows">
Agora provides [Open-source sample projects on GitHub](https://github.com/AgoraIO/API-Examples/tree/main) to demonstrate the implementation of basic and advanced Voice SDK features.

This page shows how to compile, configure, and run the Voice SDK Windows sample project.
...
1. After compilation is complete, you see the following window on your device:
  ...
  ![image](/images/video-sdk/run-compile-windows-step-3.png)
...
1. To test various audio and video interaction use-cases, use the [Agora web demo](https://webdemo.agora.io/basicVideoCall/index.html), or install and run the sample project on a second device. Make sure you use the same app ID on both devices. When you join the same channel from two devices, you can see and hear each other.
  ...
  ![image](/images/video-sdk/run-compile-windows-step-5.png)
</PlatformStructured>

<PlatformStructured platform="electron">
Agora provides [Open-source sample projects on GitHub](https://github.com/AgoraIO-Extensions/Electron-SDK) to demonstrate the implementation of basic and advanced Voice SDK features.

This page shows how to compile, configure, and run the Voice SDK Electron sample project.
...
1. After the operation is complete, you see the following application on your screen:
  ...
  ![image](/images/video-sdk/run-compile-electron-step-2.png)
...
1. After compilation is complete, you see the following application on your device:
  ...
  ![image](/images/video-sdk/run-compile-flutter-step-4.png)
...
1. To test various audio and video interaction use-cases, connect to the [Agora web demo](https://webdemo.agora.io/basicVideoCall/index.html), or install and run the sample project on a second device. Make sure you use the same app ID on both devices. When you join the same channel from two devices, you can see and hear each other.
  ...
  ![image](/images/video-sdk/run-compile-flutter-step-6.png)
</PlatformStructured>

<PlatformStructured platform="react-native">
Agora provides [Open-source sample projects on GitHub](https://github.com/AgoraIO-Extensions/react-native-agora/tree/main/example) to demonstrate the implementation of basic and advanced Voice SDK features.

This page shows how to compile, configure, and run the Voice SDK React Native sample project.
...
1. After the operation is complete, the following application appears on your device: 
  ...
  ![image](/images/video-sdk/run-compile-rn-step-2.png)
...
1. Select the demo you want to experience from the menu. Choose **JoinChannelVideo** under **Basic** as an example, and click **join channel**.
  ...
  ![image](/images/video-sdk/run-compile-rn-step-3.png)
...
1. On the demo page, enter your [App ID](../manage-agora-account.md), [token](../manage-agora-account.md), and channel name and join the channel.

  The channel name must be the same as the channel ID you used to generate the token.
</PlatformStructured>

<PlatformStructured platform="unity">
Agora provides [Open-source sample projects on GitHub](https:// github .com/ AgoraIO-Extensions /Agora-Unity-Quickstart/tree/main/API-Example-Unity) to demonstrate the implementation of basic and advanced Voice SDK features.
...
- Go to the [SDKs](../../../sdks.md) page, download the latest version of the Video SDK, and unzip it. You see a `.unitypackage` file.
  ...
  ![image](/images/video-sdk/run-compile-unity-get-project.png)
...
In `Agora-RTC-PLUGIN/API-Example/AppIdInput.asset`, fill in the App ID, temporary token, and channel name you obtained from the Agora Console.
  ...
  ![image](/images/video-sdk/run-compile-unity-get-project-2.png)
...
1. The `API-Example` folder contains two folders, `Basic` and `Advanced`, that contain usage examples of basic and advanced use-cases of Agora SDK. Select the demo you want to run and click **Play** to compile.
  ...
  ![image](/images/video-sdk/run-compile-unity-step-1.png)

1. Choose video calls as an example. After successful compilation, you see your local video preview.

  ![image](/images/video-sdk/run-compile-unity-step-2.png)

1. To test various audio and video interaction use-cases, connect to the [Agora web demo](https://webdemo.agora.io/basicVideoCall/index.html), or install and run the sample project on a second device. Make sure you use the same app ID on both devices. When you join the same channel from two devices, you can see and hear each other.

  ![image](/images/video-sdk/run-compile-unity-step-3.png)
</PlatformStructured>

<PlatformStructured platform="unreal">
Agora provides [Open-source sample projects on GitHub](https://github.com/AgoraIO-Extensions/Agora-Unreal-RTC-SDK/tree/main/Agora-Unreal-SDK-CPP-Example) to demonstrate the implementation of basic and advanced Voice SDK features.
...
1. Go to [SDKs](../../../sdks.md) to download the latest version of the Video SDK and unzip it.
...
1. Double-click **MainLevel**, then click **Compile** and **Run** the sample project. On Windows, you see the following interface:
  ...
  ![image](/images/video-sdk/run-compile-unreal-tab-1-step-3.png)
...
1. Click the button on the left to navigate from the main level to the sub-levels of the API example to experience the selected demo. Choose **BasicVideoCallScene** as an example, click **JoinChannel** to join the channel. You see yourself in the local view.
  ...
  ![image](/images/video-sdk/run-compile-unreal-tab-1-step-4.png)
...
1. Choose **BasicVideoCallScene** as an example, double-click the sub-level in the Content Browser, and then click the **BP_AgoraActor** blueprint in the **World Outliner panel**. Fill in the App ID, temporary token, and channel name of your project in the **Details panel**.
  ...
  ![image](/images/video-sdk/run-compile-unreal-tab-2-step-2.png)

1. Click **Compile** and run the sample project at the sublevel. You see the following interface:

  ![image](/images/video-sdk/run-compile-unreal-tab-2-step-4.png)
...
Agora provides [Open-source sample projects on GitHub](https://github.com/AgoraIO-Extensions/Agora-Unreal-RTC-SDK/tree/main/Agora-Unreal-SDK-Blueprint-Example) to demonstrate the implementation of basic and advanced Voice SDK features.

This page shows how to compile, configure, and run the Voice SDK Unreal (Blueprint) sample project.
...
1. Double-click **MainLevel**, then click **Compile** and run the sample project. You see the following interface:
  ...
  ![image](/images/video-sdk/run-compile-blueprint-tab-1-1.png)

1. Fill in the text box with the App ID and temporary token you obtained from the Agora Console, and the channel name you used to generate the token.

1. Click the button on the left to navigate from the main level to the sub-levels of the API example to experience the selected demo. Choose `BasicVideoCallScene` as an example, click **JoinChannel** to join the channel. You see yourself in the local view.

  ![image](/images/video-sdk/run-compile-blueprint-tab-1-2.png)
...
1. In the path of the Blueprint API example,, double-click **AgoraBPExample.uproject** to open the project.
  ...
  ![image](/images/video-sdk/run-compile-blueprint-tab-2-1.png)
...
1. Fill in the App ID, temporary token, and channel name of your project.
  ...
  ![image](/images/video-sdk/run-compile-blueprint-tab-2-2.png)

1. Click **Compile** and run the sample project at the sublevel. You see the following interface:

  ![image](/images/video-sdk/run-compile-blueprint-tab-2-3.png)
...
This page shows how to compile, configure, and run the Voice SDK Python sample project.
