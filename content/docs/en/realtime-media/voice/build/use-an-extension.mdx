...
To learn how to use a Web extension, see [AI Noise Suppression](https://docs.agora.io/en/video-calling/advanced-features/ai-noise-suppression).
...
1. **Define variables to integrate an extension with Agora Video SDK**
    ...
    ```
1. **Register extension callbacks to `<strong>`IRtcEngineEventHandler`</strong>` event handler**
