...
1. **Activate an extension**
    ...
    2. Under **Account**, select **Extensions Marketplace**, then on the **Marketplace** tab, select the extension you want to activate.
...
-  To implement the extension in your project, go to the detail page of the extension on [Extensions Marketplace](https://console.agora.io/extensions-marketplace), click **Implementation guides**, and follow the steps on the page.
