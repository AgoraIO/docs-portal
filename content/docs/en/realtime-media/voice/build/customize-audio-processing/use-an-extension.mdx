...
* [`RtcEngineConfig.addExtension`](https://api-ref.agora.io/en/voice-sdk/android/4.x/API/rtc_api_data_type.html#api_irtcengine_addextension)
...
1. Join the same channel from another test device or the [Agora web demo](https://webdemo.agora.io/basicVideoCall/index.html).
...
3. Join the same channel from another test device or the [Agora web demo](https://webdemo.agora.io/basicVideoCall/index.html).
