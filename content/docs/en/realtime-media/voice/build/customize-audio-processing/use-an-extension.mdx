...
1. **Activate an extension**
    ...
    1. Click the username to open the **Account** menu and select **Extensions**. 
    1. From the **Extensions Marketplace** panel, select the extension you want to activate and click **View details**.
...
* [`RtcEngineConfig.addExtension`](https://api-ref.agora.io/en/voice-sdk/android/4.x/API/class_irtcengine.html#api_irtcengine_addextension)

* [`enableExtension`](https://api-ref.agora.io/en/voice-sdk/android/4.x/API/class_irtcengine.html#api_irtcengine_enableextension)

* [`getExtensionProperty`](https://api-ref.agora.io/en/voice-sdk/android/4.x/API/class_irtcengine.html#api_irtcengine_getextensionproperty)

* [`setExtensionProperty`](https://api-ref.agora.io/en/voice-sdk/android/4.x/API/class_irtcengine.html#api_irtcengine_setextensionproperty)

* [`IMediaExtensionObserver`](https://api-ref.agora.io/en/voice-sdk/android/4.x/API/class_imediaextensionobserver.html)
</PlatformStructured>
...
-  To implement the extension in your project, go to the detail page of the extension on [Agora Console](https://console.agora.io/), click **Implementation guides**, and follow the steps on the page.
...
-  To implement the extension in your project, go to the detail page of the extension on [Extensions Marketplace](https://console.agora.io/legacy/extensions-marketplace), click **Implementation guides**, and follow the steps on the page.
...
1. [Generate a temporary token](/en/introduction/account) in Agora Console.

2. In your browser, navigate to the [Agora web demo](https://webdemo-global.agora.io/example/quickStart/videoAndVoiceCalling/index.html) and update _App ID_, _Channel_, and _Token_ with the values for your temporary token, then click **Join**.
...
* Same setup as the [Voice SDK quickstart prerequisites](../index.mdx) for Voice Calling.
...
1. **Define variables to integrate an extension with Agora Video SDK**
    ...
    ```
1. **Register extension callbacks to the `IRtcEngineEventHandler` event handler**
...
2. Run the app
    ...
    You see your app opens a window named **Get started with Voice Calling**.
...
* [`loadExtensionProvider`](https://api-ref.agora.io/en/voice-sdk/electron/4.x/API/class_irtcengine.html#api_irtcengine_loadextensionprovider)

* [`setExtensionProperty`](https://api-ref.agora.io/en/voice-sdk/electron/4.x/API/class_irtcengine.html#api_irtcengine_setextensionproperty)

* [`enableExtension`](https://api-ref.agora.io/en/voice-sdk/electron/4.x/API/class_irtcengine.html#api_irtcengine_enableextension)

* [`onExtensionStarted`](https://api-ref.agora.io/en/voice-sdk/electron/4.x/API/class_irtcengineeventhandler.html#callback_irtcengineeventhandler_onextensionstarted)

* [`onExtensionStopped`](https://api-ref.agora.io/en/voice-sdk/electron/4.x/API/class_irtcengineeventhandler.html#callback_irtcengineeventhandler_onextensionstopped)

* [`onExtensionError`](https://api-ref.agora.io/en/voice-sdk/electron/4.x/API/class_irtcengineeventhandler.html#callback_irtcengineeventhandler_onextensionerror)

* [`onExtensionEvent`](https://api-ref.agora.io/en/voice-sdk/electron/4.x/API/class_irtcengineeventhandler.html#callback_irtcengineeventhandler_onextensionevent)
</PlatformStructured>
...
1. Join the same channel from another test device or the [Agora web demo](https://webdemo-global.agora.io/example/quickStart/videoAndVoiceCalling/index.html).
...
3. Join the same channel from another test device or the [Agora web demo](https://webdemo-global.agora.io/example/quickStart/videoAndVoiceCalling/index.html).
...
3. In your browser, navigate to the [Agora web demo](https://webdemo-global.agora.io/example/quickStart/videoAndVoiceCalling/index.html) and update _App ID_, _Channel_, and _Token_ with the values for your temporary token, then click **Join**.
...
* [`EnableExtension`](https://api-ref.agora.io/en/voice-sdk/unity/4.x/API/class_irtcengine.html#api_irtcengine_enableextension)

* [`LoadExtensionProvider`](https://api-ref.agora.io/en/voice-sdk/unity/4.x/API/class_irtcengine.html#api_irtcengine_loadextensionprovider)

* [`SetExtensionProperty`](https://api-ref.agora.io/en/voice-sdk/unity/4.x/API/class_irtcengine.html#api_irtcengine_setextensionproperty)
</PlatformStructured>
