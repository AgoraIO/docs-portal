...
Want to try out AI Noise Suppression? Use the <a href="https://webdemo-global.agora.io/example/extension/aiDenoiser/index.html">online demo</a>.
...
* [`setAINSMode`](https://api-ref.agora.io/en/voice-sdk/android/4.x/API/class_irtcengine.html#api_irtcengine_setainsmode)
</PlatformStructured>
...
* [`setAINSMode`](https://api-ref.agora.io/en/voice-sdk/ios/4.x/documentation/agorartckit/agorartcenginekit/setainsmode(_:mode:))
</PlatformStructured>
...
4. Register the AI Noise Suppression extension
    ...
    Call [AgoraRTC.registerExtensions](https://api-ref.agora.io/en/video-sdk/web/4.x/interfaces/iagorartc.html#registerextensions), and pass in the created `AIDenoiserExtension` instance. Optionally, listen for the callback reporting that the Wasm and JS files fail to load.
...
- For a working example, check out the [AI Denoiser web demo](https://webdemo-global.agora.io/example/extension/aiDenoiser/index.html) and the associated [source code](https://github.com/AgoraIO/API-Examples-Web/tree/main/Demo/aiDenoiser).
...
* [`setAINSMode`](https://api-ref.agora.io/en/voice-sdk/cpp/4.x/API/class_irtcengine.html#api_irtcengine_setainsmode)
</PlatformStructured>
...
* [`setAINSMode`](https://api-ref.agora.io/en/voice-sdk/electron/4.x/API/class_irtcengine.html#api_irtcengine_setainsmode)
</PlatformStructured>
...
* [`setAINSMode`](https://api-ref.agora.io/en/voice-sdk/flutter/6.x/API/class_irtcengine.html#api_irtcengine_setainsmode)
</PlatformStructured>
...
* [`setAINSMode`](https://api-ref.agora.io/en/voice-sdk/react-native/4.x/API/class_irtcengine.html#api_irtcengine_setainsmode)
</PlatformStructured>
...
* [`setAINSMode`](https://api-ref.agora.io/en/voice-sdk/unity/4.x/API/class_irtcengine.html#api_irtcengine_setainsmode)
</PlatformStructured>
...
1. Configure the noise suppression extension
    ...
    This code initializes the Agora AI Noise Suppression extension, checks compatibility, and sets up a noise reduction processor for the local microphone track. It registers the extension, checks compatibility, and initializes the AI noise processor.
