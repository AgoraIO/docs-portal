...
:::note
The following implementation steps apply to the latest version of the AI Noise Suppression extension. Refer to the [extension release notes](https://docs.agora.io/en/video-calling/overview/release-notes) for details.
:::
...
This method must be called after [`pipe`](https://docs.agora.io/en/api-ref/rtc/javascript/interfaces/imicrophoneaudiotrack.html.md).
