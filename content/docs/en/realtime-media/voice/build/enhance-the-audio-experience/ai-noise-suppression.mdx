 ...
 * [`setAINSMode`](https://api-ref.agora.io/en/voice-sdk/android/4.x/api_irtcengine_setainsmode.html)
</PlatformStructured>
...
* [`setAINSMode`](https://api-ref.agora.io/en/voice-sdk/ios/4.x/setainsmode(_:mode:))
</PlatformStructured>
...
When AI Noise Suppression is enabled, if Voice SDK detects that the device performance is not sufficient, it:
...
* [`setAINSMode`](https://api-ref.agora.io/en/voice-sdk/macos/4.x/setainsmode(_:mode:))
</PlatformStructured>
...
* [`setAINSMode`](https://api-ref.agora.io/en/voice-sdk/cpp/4.x/api_irtcengine_setainsmode.html)
</PlatformStructured>
 ...
 * [`setAINSMode`](https://api-ref.agora.io/en/voice-sdk/electron/4.x/api_irtcengine_setainsmode.html)
</PlatformStructured>
...
* [`setAINSMode`](https://api-ref.agora.io/en/voice-sdk/flutter/6.x/api_irtcengine_setainsmode.html)
</PlatformStructured>
 ...
 * [`setAINSMode`](https://api-ref.agora.io/en/voice-sdk/react-native/4.x/api_irtcengine_setainsmode.html)
</PlatformStructured>
