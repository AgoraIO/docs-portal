...
See [Get started](/en/realtime-media/voice/quickstart#project-setup) for more information about integrating the `agora_rtc_engine` 6.x SDK into your project.
