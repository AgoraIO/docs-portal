...
- If you use cloud proxy with [Restricted media zones](../build/manage-connection-and-quality/geofencing.mdx), add only the IP addresses dedicated to your specified region.
