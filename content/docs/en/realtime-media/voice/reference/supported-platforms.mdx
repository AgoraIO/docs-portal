...
<Tabs defaultValue="mac" groupId="web-desktop-os" persist>
<TabsList>
...
<Tabs defaultValue="android" groupId="web-mobile-os" persist>
<TabsList>
  <TabsTrigger value="android">Android</TabsTrigger>
  <TabsTrigger value="ios">iOS</TabsTrigger>
  <TabsTrigger value="harmony">HarmonyOS</TabsTrigger>
</TabsList>
