...
- The Web client could fail to receive H.265 video and metadata sent from a Native client.
...
- [CameraStabilizationMode]({{Global.API_REF_FLUTTER_ROOT_VOICE_SDK}}/enum_camerastabilizationmode.html) (iOS)
