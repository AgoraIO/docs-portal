...
**Manual integration**
1. Download the latest version of Voice SDK from the [SDKs](/sdks) page and unzip it.
...
This iOS quickstart shows you how to create a basic Voice Calling app using the Agora Voice SDK. Switch to the [Android](/en/realtime-media/voice/quickstart/android) or [Web](/en/realtime-media/voice/quickstart/web) quickstart, or choose another platform from the selector.
...
This macOS quickstart shows you how to create a basic Voice Calling app using the Agora Voice SDK. Switch to [Android](/en/realtime-media/voice/quickstart/android), [iOS](/en/realtime-media/voice/quickstart/ios), [Web](/en/realtime-media/voice/quickstart/web), or another platform from the selector.
...
Visit the [Download](/sdks) page to obtain the link for the latest SDK version.
...
This Windows quickstart shows you how to create a basic Voice Calling app using the Agora Voice SDK. Switch to [Android](/en/realtime-media/voice/quickstart/android), [iOS](/en/realtime-media/voice/quickstart/ios), [Web](/en/realtime-media/voice/quickstart/web), or another platform from the selector.
...
This Electron quickstart shows you how to create a basic Voice Calling app using the Agora Voice SDK. Switch to [Android](/en/realtime-media/voice/quickstart/android), [iOS](/en/realtime-media/voice/quickstart/ios), [Web](/en/realtime-media/voice/quickstart/web), or another platform from the selector.
...
This Flutter quickstart shows you how to create a basic Voice Calling app using the Agora Voice SDK. Switch to [Android](/en/realtime-media/voice/quickstart/android), [iOS](/en/realtime-media/voice/quickstart/ios), [Web](/en/realtime-media/voice/quickstart/web), or another platform from the selector.
...
This React Native quickstart shows you how to create a basic Voice Calling app using the Agora Voice SDK. Switch to [Android](/en/realtime-media/voice/quickstart/android), [iOS](/en/realtime-media/voice/quickstart/ios), [Web](/en/realtime-media/voice/quickstart/web), or another platform from the selector.
...
This JavaScript quickstart shows you how to create a basic Voice Calling app using the Agora Voice SDK. Switch to [Android](/en/realtime-media/voice/quickstart/android), [iOS](/en/realtime-media/voice/quickstart/ios), [Web](/en/realtime-media/voice/quickstart/web), or another platform from the selector.
...
This Unity quickstart shows you how to create a basic Voice Calling app using the Agora Voice SDK. Switch to [Android](/en/realtime-media/voice/quickstart/android), [iOS](/en/realtime-media/voice/quickstart/ios), [Web](/en/realtime-media/voice/quickstart/web), or another platform from the selector.
...
1. Go to the [Download SDKs](/sdks) page and download the latest version of the Unity SDK.
...
This Unreal Engine quickstart shows you how to create a basic Voice Calling app using the Agora Voice SDK. Switch to [Android](/en/realtime-media/voice/quickstart/android), [iOS](/en/realtime-media/voice/quickstart/ios), [Web](/en/realtime-media/voice/quickstart/web), or another platform from the selector.
...
1. Download the latest version of Agora Unreal Voice SDK from [Download SDKs](/sdks) and unzip it.
...
This Unreal Blueprint quickstart shows you how to create a basic Voice Calling app using the Agora Voice SDK. Switch to [Android](/en/realtime-media/voice/quickstart/android), [iOS](/en/realtime-media/voice/quickstart/ios), [Web](/en/realtime-media/voice/quickstart/web), or another platform from the selector.
...
This Python quickstart shows you how to create a basic Voice Calling app using the Agora Voice SDK. Switch to [Android](/en/realtime-media/voice/quickstart/android), [iOS](/en/realtime-media/voice/quickstart/ios), [Web](/en/realtime-media/voice/quickstart/web), or another platform from the selector.
