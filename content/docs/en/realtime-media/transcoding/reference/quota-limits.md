...
description: Learn the limits of Cloud Transcoder.
---
...
- The maximum number of requests to the Cloud Transcoding server is 10 requests per second (QPS) per account.
