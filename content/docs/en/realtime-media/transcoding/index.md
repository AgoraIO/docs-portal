...
description: Start cloud transcoding using the Go SDK.
---
...
- A way to test transcoding input streams:
  - Implement the [Video Calling Quickstart](https://docs.agora.io/en/video-calling/get-started/get-started-sdk), or
