...
This version adds the [`registerApp`](../../reference/uikit-sdk/#registerapp) method to the `FastRoom` class.

**Set stroke thickness range**

This version introduces the [`setStrokeRange`](../../reference/uikit-sdk/#setstrokerange) method in the `FastUiSettings` class.
...
- The brush color was not in the custom color list when first entering the room after setting it with [`setToolsColors`](../../reference/uikit-sdk/#settoolscolors).
...
- [API Reference](../reference/uikit-sdk/)
</PlatformStructured>
