...
description: "Track iOS release notes for the Fastboard SDK."
---
...
This release adds the  [`insertPptx`](https://docs.agora.io/en/en/realtime-media/whiteboard/reference/uikit-sdk/web/index.mdx#insertpptx) method to insert and display a dynamic document in the whiteboard sub-window.
...
- `FastRoomPanelItemAsset`:
  ...
  - `selectedBackgroundEdgeinset`: The padding of the background when selected.
	:::info
If you are migrating from v1.1.0 and earlier, you can set `selectedBackgroundCornerradius` to `0` and set `selectedBackgroundEdgeinset` to `UIEdgeInsetsZero`.
:::
