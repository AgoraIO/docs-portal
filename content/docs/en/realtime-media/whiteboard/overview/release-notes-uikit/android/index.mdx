...
description: "Track Android release notes for the Fastboard SDK."
---
...
* **Register third-party window apps**
  ...
  This version adds the [`registerApp`](../../../reference/uikit-sdk/web/index.mdx#registerapp) method to the `FastRoom` class, allowing you to register third-party window apps in the whiteboard room. This method enables the registration of external applications that can run as independent windows on the whiteboard, and supports two registration methods:
  ...
  Additionally, the [`FastRegisterAppParams`](../../../reference/uikit-sdk/web/index.mdx#fastregisterappparams) class is introduced to configure registration parameters, including options such as app name, script code, and URL.
...
- **Set stroke thickness range**
  ...
  This version introduces the [`setStrokeRange`](../../../reference/uikit-sdk/web/index.mdx#setstrokerange) method in the `FastUiSettings` class, which allows you to set the range of the line width slider in the toolbox. This method configures the minimum and maximum values of the line width slider in the toolbox extension panel. Users can adjust the line width within this range when using drawing tools like pencil, rectangle, circle, etc. The default range is 1 to 24.
...
- The brush color was not in the custom color list when first entering the room after setting it with [`setToolsColors`](../../../reference/uikit-sdk/web/index.mdx#settoolscolors), which was not expected.

#### API changes

- Added

  - [`registerApp`](../../../reference/uikit-sdk/web/index.mdx#registerapp)
  - [`FastRegisterAppParams`](../../../reference/uikit-sdk/web/index.mdx#fastregisterappparams)
  - [`setStrokeRange`](../../../reference/uikit-sdk/web/index.mdx#setstrokerange)
...
* **Manual loading of whiteboard view**
  ...
  This version adds the [`preloadWhiteboardView`](../../../reference/uikit-sdk/web/index.mdx#preloadwhiteboardview) method, which is used to manually perform a whiteboard view preload to improve the speed of joining the room next time. Before using this feature, ensure that the `autoPreload` in [`FastboardConfig`](../../../reference/uikit-sdk/web?platform=android#fastboardconfig) is set to `false`.
...
- [`preloadWhiteboardView`](../../../reference/uikit-sdk/web/index.mdx#preloadwhiteboardview)
- [`FastboardConfig`](../../../reference/uikit-sdk/web?platform=android#fastboardconfig) adds `autoPreload`
- [`insertStaticDoc`](../../../reference/uikit-sdk/web?platform=android#insertstaticdoc)
- [`insertPptx`](../../../reference/uikit-sdk/web?platform=android#insertpptx)
- [`DocPage`](../../../reference/uikit-sdk/web?platform=android#docpage)
- [`setConfig`](../../../reference/uikit-sdk/web?platform=android#setconfig)
- [`FastboardConfig`](../../../reference/uikit-sdk/web?platform=android#fastboardconfig)
- [`FastAppliance`](../../../reference/uikit-sdk/web?platform=android#fastappliance) adds:
  - `PENCIL_ERASER`
  - `HAND`
- [`FastLogger`](../../../reference/uikit-sdk/web?platform=android#fastlogger-class)
  - `setLogger`
  - `Logger`
  - `warn`
  - `debug`
...
The `setStokeWidth` method under the `FastRoom` class is renamed to `setStrokeWidth`. See [`setStrokeWidth`](https://docs.agora.io/en/en/realtime-media/whiteboard/reference/uikit-sdk/web/index.mdx#setstrokewidth).
...
This release adds the following properties to the [`FastInsertDocParams `](https://docs.agora.io/en/en/realtime-media/whiteboard/reference/uikit-sdk/web/index.mdx#fastinsertdocparams) class to support the new file conversion service:
...
- `converterType`: Enum. The version of the file conversion service. Contains the following enumerators:
  - `Projector`: The new file conversion service. See [File conversion overview](https://docs.agora.io/en/en/realtime-media/whiteboard/build/file-conversion-overview).
  - `WhiteboardConverter`: The old file conversion service (default). See [Deprecated file conversion overview](https://docs.agora.io/en/en/realtime-media/whiteboard/reference/file-conversion-overview-deprecated).
...
The UI Kit supports inserting and displaying files in multiple formats on the whiteboard, such as images in PNG and JPG formats, audio and video in MP3 and MP4 formats, and documents in PPT, PPTX, DOC, DOCX, and PDF formats. For detailed implementation steps, see [Display Files](../../../build/scenes/display-files-fast/web/).

#### Reference

Refer to the following documentation to integrate the UI Kit and add the whiteboard functionality to your project:

- [Join a Whiteboard Room](../../../build/get-started-sdk/web/): Describes how to quickly join a whiteboard room and experience interactive whiteboard features using the UI Kit.

- [Display Files](../../../build/scenes/display-files-fast/web/): Describes how to call the UI Kit's APIs to insert images, play audio and video, and present documents on the whiteboard.

- [API Reference](../../../reference/uikit-sdk/web/): Provides a detailed API reference for the UI Kit.
