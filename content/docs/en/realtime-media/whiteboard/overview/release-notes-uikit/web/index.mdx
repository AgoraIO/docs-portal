...
description: "Track Web release notes for the Fastboard SDK."
---
...
This release adds the `insertDocs [2/3]` method to insert PDF/PPTX docs converted by the [New file conversion service](https://docs.agora.io/en/en/realtime-media/whiteboard/build/file-conversion-overview?platform=web).
...
This release adds the  [`createUI`](https://docs.agora.io/en/en/realtime-media/whiteboard/reference/uikit-sdk/web/index.mdx#createui) and [`createReplayUI`](https://docs.agora.io/en/en/realtime-media/whiteboard/reference/uikit-sdk/web/index.mdx#createreplayui) methods to create a set of UI components for Fastboard and the playback mode, respectively.

**Delete whiteboard pages**

This release adds the [`removePage`](https://docs.agora.io/en/en/realtime-media/whiteboard/reference/uikit-sdk/web/index.mdx#removepage) method to delete the specified whiteboard pages.
...
- [`insertDocs [2/3]`](https://docs.agora.io/en/en/realtime-media/whiteboard/reference/uikit-sdk/web?platform=web#insertdocs-23)
- [`dispatchDocsEvent`](https://docs.agora.io/en/en/realtime-media/whiteboard/reference/uikit-sdk/web?platform=web#dispatchdocsevent)
- [`DocsEventOptions`](https://docs.agora.io/en/en/realtime-media/whiteboard/reference/uikit-sdk/web?platform=web#docseventoptions)
- [`removePage`](https://docs.agora.io/en/en/realtime-media/whiteboard/reference/uikit-sdk/web/index.mdx#removepage)
- [`createUI`](https://docs.agora.io/en/en/realtime-media/whiteboard/reference/uikit-sdk/web/index.mdx#createui)
- [`createReplayUI`](https://docs.agora.io/en/en/realtime-media/whiteboard/reference/uikit-sdk/web/index.mdx#createreplayui)
...
- [`mount`](https://docs.agora.io/en/en/realtime-media/whiteboard/reference/uikit-sdk/web/index.mdx#mount): Use [`createUI`](https://docs.agora.io/en/en/realtime-media/whiteboard/reference/uikit-sdk/web/index.mdx#createui) instead.

## v0.3.2
v0.3.2 was released on April 29, 2022.

#### Compatibility changes
This release replaces the framework used to build the whiteboard UI. As of this release, you do not need to add `react` and `react-dom` dependencies when integrating the SDK. For detailed SDK integration steps, see [Add dependencies](../../../build/get-started-uikit/web/).
...
:::info
The GeoGebra extension in the UI Kit is for demonstration purposes only. For commercial use, contact GeoGebra to apply for a license.
:::
