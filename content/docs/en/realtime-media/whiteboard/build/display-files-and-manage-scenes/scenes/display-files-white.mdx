...
- Ensure the format of the converted images or web pages is supported by the Whiteboard SDK.
  ...
  - HTML web pages converted from PPTX files. You must use the [dynamic-file conversion service](../../../reference/rest-api/file-conversion.md#dynamic-file-conversion) of Agora Interactive Whiteboard to do the conversion.
...
- Complete file conversion and generate a set of URLs for the converted images or web pages. If you need to use the file-conversion feature of the Agora Interactive Whiteboard, see [File Conversion Overview](../../../reference/rest-api/file-conversion.md).
...
1. Upload the PPTX source file to a third-party cloud storage service, and call the [Start file conversion](../../../reference/rest-api/file-conversion.md#start-file-conversion) API to create a dynamic-file conversion task that converts the PPTX file to HTML web pages.

2. Call the [Query file conversion progress](../../../reference/rest-api/file-conversion.md#query-the-progress-of-a-file-conversion-task) API to get the URLs of the converted HTML web pages from the `conversionFileUrl` parameter in the response body.
...
- [Start file conversion](../../../reference/rest-api/file-conversion.md#start-file-conversion)
- [Query file conversion progress](../../../reference/rest-api/file-conversion.md#query-the-progress-of-a-file-conversion-task)
