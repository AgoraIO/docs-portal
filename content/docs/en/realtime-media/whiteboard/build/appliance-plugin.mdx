...
description: "Extend the whiteboard tool experience with appliance plugin features and controls."
---
...
* Implemented the logic to [join a whiteboard room](get-started-uikit/web/index.mdx#join-the-whiteboard-room).
