...
Call the Interactive Whiteboard RESTful API on your app server to create a room. See [Create a room (POST)](/en/api-reference/api-ref/whiteboard/room-management#create-a-room-post).
...
Call [/v5/rooms (POST)](/en/api-reference/api-ref/whiteboard/room-management#create-a-room-post) on your app server to create a room.
