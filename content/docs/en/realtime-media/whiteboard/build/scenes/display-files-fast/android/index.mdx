...
description: "Display and manage files in Fastboard on Android."
---
...
Fastboard provides the [`insertImage`](../../../../reference/uikit-sdk/web/index.mdx#insertimage) method for inserting and displaying an image in the main window of the whiteboard. You can call this method and pass in the URL, width, and height of the image to display a specified image.
...
The Fastboard integrates the media player extension and provides the [`insertVideo`](../../../../reference/uikit-sdk/web/index.mdx#insertvideo) method for playing audio and video files. You can simply call `insertVideo
...
The following steps show how to implement presenting an animated PPTX document in the [Join the whiteboard room](../../../get-started-uikit/web/index.mdx#join-the-whiteboard-room) project:
