...
Fastboard provides the [`insertImage`](../../../../reference/uikit-sdk/web/index.mdx#insertimage) method for inserting and displaying an image in the main window of the whiteboard. You can call this method and pass in the URL of the image to display a specified image.

### Prerequisites

Before you start, make sure you meet the following requirements:

- Integrate Fastboard in your project, and join the room. See [Join the whiteboard room](../../../get-started-uikit/web/index.mdx#join-the-whiteboard-room).
...
The following steps show how to implement inserting an image in the [Join the whiteboard room](../../../get-started-uikit/web/index.mdx#join-the-whiteboard-room) project:
...
The following steps show how to implement playing a video in the [Join the whiteboard room](../../../get-started-uikit/web/index.mdx#join-the-whiteboard-room) project:
...
The following steps show how to implement presenting a three-page, animated PPTX file in the [Join the whiteboard room](../../../get-started-uikit/web/index.mdx#join-the-whiteboard-room) project:
...
3. Open the [Join the whiteboard room](../../../get-started-uikit/web/index.mdx#join-the-whiteboard-room) project, and add the following lines to the `main.js` file:
    ```javascript
...
<div class = "alert info">Fastboard also provides another `insertDocs method` for inserting and displaying documents. For details, see [API reference](../../../../reference/uikit-sdk/web/).</div>
