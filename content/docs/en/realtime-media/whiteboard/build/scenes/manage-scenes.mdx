---
title: "Manage scenes"
description: "Call Whiteboard SDK APIs to insert, switch, move, delete, and clear scenes."
---
...
The following section extends the [Join the Whiteboard Room](../get-started-uikit/web/index.mdx#join-the-whiteboard-room) sample code to show the implementation of scene management.
