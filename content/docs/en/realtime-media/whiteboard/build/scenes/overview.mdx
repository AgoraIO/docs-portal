...
- Static images in PNG, JPG/JPEG, and WEBP formats converted from PPT, PPTX, DOC, DOCX, and PDF files. You can convert them yourself or use the [static-file conversion service](../../reference/rest-api/file-conversion.md) of Interactive Whiteboard.
- HTML web pages converted from PPTX files. You must use the [dynamic-file conversion service](../../reference/rest-api/file-conversion.md) of Interactive Whiteboard to do the conversion.
