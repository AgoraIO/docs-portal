...
- Integrate the Agora Interactive Whiteboard SDK into your project and implement joining a room. For details, see [Join a Whiteboard Room](../get-started-sdk/).

## Implementation

The following section extends the [Join The Whiteboard Room](../get-started-uikit/#join-the-whiteboard-room) sample code to show the creation of multiple scenes and the display of a six-page, animated PPTX file.
