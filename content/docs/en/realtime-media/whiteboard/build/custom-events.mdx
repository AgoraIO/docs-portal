...
The following section extends the [Join the Whiteboard Room](get-started-uikit#join-the-whiteboard-room) sample code to show the implementation of sending and receiving simple text messages by using the custom event methods.
