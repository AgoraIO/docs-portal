...
The following section extends the [Join a Whiteboard Room](get-started-sdk/#join-the-interactive-whiteboard-room-from-your-app-client) sample code to show the implementation of getting or listening for room states.
