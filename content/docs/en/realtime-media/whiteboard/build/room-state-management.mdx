...
To follow the procedure on this page, ensure that you have integrated the Whiteboard SDK into your project and implemented joining a room. For details, see [Join the Whiteboard Room](get-started-uikit/web/index.mdx#join-the-whiteboard-room).

The following section extends the [Join a Whiteboard Room](get-started-sdk/web/index.mdx#join-the-whiteboard-room-from-your-app-client) sample code to show the implementation of getting or listening for room states.
