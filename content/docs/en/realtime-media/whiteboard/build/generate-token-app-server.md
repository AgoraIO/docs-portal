...
This article introduces how to generate tokens from your app server using these code samples and [your access keys (the AK and SK)](enable-whiteboard.md#get-security-credentials-for-your-whiteboard-project).
