...
You can directly set the whiteboard tool used in the current room in the program. This section uses the [Join the Whiteboard Room](get-started-uikit/web/index.mdx#join-the-whiteboard-room) sample code as an example.
...
This section extends the [Join the Whiteboard Room](get-started-uikit/web/index.mdx#join-the-whiteboard-room) sample code to show the implementation of a simple toolbar.
