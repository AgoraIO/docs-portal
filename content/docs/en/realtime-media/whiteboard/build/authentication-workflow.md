...
Access keys consist of an Access Key (AK) and a Secret Key (SK). Refer to [Get security credentials for your whiteboard project](enable-whiteboard.md#get-security-credentials-for-your-whiteboard-project) to obtain your access keys.
