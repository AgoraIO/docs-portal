...
![Composite recording canvas with user video regions](/images/on-premise-recording/user-region-canvas-diagram.png)
...
![Composite layout](/images/on-premise-recording/composite-layout.svg)
