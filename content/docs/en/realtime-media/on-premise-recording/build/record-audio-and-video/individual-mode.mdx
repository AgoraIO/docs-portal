...
2. Subscribe to the audio and video streams of the users you want to record.
3. Join the channel and listen for the [`onUserJoined`](/en/api-reference/api-ref/on-premise-recording-eventhandler#onuserjoined) callback to get the `userId` of each remote user.
