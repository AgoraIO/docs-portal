...
The implementation of individual recording is largely similar to the steps in the [Quickstart](/en/realtime-media/on-premise-recording/index) guide. The main differences are in the configuration parameters and the APIs used.
