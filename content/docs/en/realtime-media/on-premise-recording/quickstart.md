...
* [Create an Agora project](/on-premise-recording/get-started/manage-agora-account#generate-temporary-token/) in the Agora Console and obtain an App ID and a temporary token.
...
1. Download the latest On-Premise Recording SDK package from the [SDKs](/sdks?platform=linux) page.
