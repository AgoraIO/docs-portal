...
In this guide you retrieve a temporary token from a [Token Builder](https://agora-token-generator-demo.vercel.app/). To understand how to create an authentication server for development purposes, see [Secure authentication with tokens](authentication-workflow.md). 
...
* [Event listeners](add-event-listener.md)
</TabsContent>
