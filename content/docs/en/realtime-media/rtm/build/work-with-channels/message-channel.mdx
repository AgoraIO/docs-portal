...
Since v2.3.0, when the SDK is in the `CONNECTING`, `DISCONNECTED`, or `SUSPENDED` link state, you can still call `subscribe`. The SDK caches the subscription request and resumes it after the connection recovers.

A successful `subscribe` call means the message channel subscription is complete, but the Presence join may still be running asynchronously. If your app calls Presence APIs immediately after subscribing, handle cases where Presence is not yet ready or the asynchronous request fails.

If you call `unsubscribe` for the same channel before the subscription completes, the in-progress `subscribe` call returns `RTM_ERROR_CHANNEL_SUBSCRIBE_CANCELED` (-11040), and the SDK then completes the unsubscribe operation. Late messages that arrive after cancellation are no longer passed to your app.
...
- [`subscribe`](/en/api-reference/api-ref/signaling/web#subscribe)
- [`unsubscribe`](/en/api-reference/api-ref/signaling/web#unsubscribe)
- [`publish`](/en/api-reference/api-ref/signaling/web#publish)
...
- [`subscribe`](/en/api-reference/api-ref/signaling/android#subscribe)
- [`unsubscribe`](/en/api-reference/api-ref/signaling/android#unsubscribe)
- [`publish`](/en/api-reference/api-ref/signaling/android#publish)
...
- [`subscribe`](/en/api-reference/api-ref/signaling/ios#subscribe)
- [`unsubscribe`](/en/api-reference/api-ref/signaling/ios#unsubscribe)
- [`publish`](/en/api-reference/api-ref/signaling/ios#publish)

</TabsContent>

<TabsContent value="objc">

- [`subscribeWithChannel`](/en/api-reference/api-ref/signaling/ios#subscribe)
- [`unsubscribeWithChannel`](/en/api-reference/api-ref/signaling/ios#unsubscribe)
- [`publish`](/en/api-reference/api-ref/signaling/ios#publish)
...
- [`subscribe`](/en/api-reference/api-ref/signaling/macos#subscribewithchannel)
- [`unsubscribe`](/en/api-reference/api-ref/signaling/macos#unsubscribewithchannel)
- [`publish`](/en/api-reference/api-ref/signaling/macos#publish)

</TabsContent>

<TabsContent value="objc">

- [`subscribeWithChannel`](/en/api-reference/api-ref/signaling/macos#subscribewithchannel)
- [`unsubscribeWithChannel`](/en/api-reference/api-ref/signaling/macos#unsubscribewithchannel)
- [`publish`](/en/api-reference/api-ref/signaling/macos#publish)
...
- [`subscribe`](/en/api-reference/api-ref/signaling/flutter#subscribe)
- [`unsubscribe`](/en/api-reference/api-ref/signaling/flutter#unsubscribe)
- [`publish`](/en/api-reference/api-ref/signaling/flutter#publish)
...
- [`subscribe`](/en/api-reference/api-ref/signaling/windows-cpp#subscribe)
- [`unsubscribe`](/en/api-reference/api-ref/signaling/windows-cpp#unsubscribe)
- [`publish`](/en/api-reference/api-ref/signaling/windows-cpp#publish)
...
- [`subscribe`](/en/api-reference/api-ref/signaling/linux-cpp#subscribe)
- [`unsubscribe`](/en/api-reference/api-ref/signaling/linux-cpp#unsubscribe)
- [`publish`](/en/api-reference/api-ref/signaling/linux-cpp#publish)
...
- [`subscribe`](/en/api-reference/api-ref/signaling/linux-java#subscribe)
- [`unsubscribe`](/en/api-reference/api-ref/signaling/linux-java#unsubscribe)
- [`publish`](/en/api-reference/api-ref/signaling/linux-java#publish)
