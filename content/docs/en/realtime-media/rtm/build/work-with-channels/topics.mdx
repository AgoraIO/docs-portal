...
* Activated stream channel capability for Signaling. See [Enable and configure Signaling](/en/realtime-media/rtm/manage-agora-account#stream-channel-configuration).
