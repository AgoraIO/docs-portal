...
To set up an event listener for topic events, refer to [Add event listener](../send-and-receive-messages/add-event-listener.mdx). After successfully adding a topic event handler, you receive `onTopicEvent` notifications for all topics in all stream channels you join or subscribe to. The event returns the following data:
...
- [`joinTopic`](/en/api-reference/api-ref/signaling)
- [`leaveTopic`](/en/api-reference/api-ref/signaling)
- [`subscribeTopic`](/en/api-reference/api-ref/signaling)
- [`unsubscribeTopic`](/en/api-reference/api-ref/signaling)
