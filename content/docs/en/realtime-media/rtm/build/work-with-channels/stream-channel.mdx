...
- [`createStreamChannel `](/en/api-reference/api-ref/signaling/web#createstreamchannel)
- [`join`](/en/api-reference/api-ref/signaling/web#join)
- [`publishTopicMessage`](/en/api-reference/api-ref/signaling/web#publishtopicmessage)
- [`leave`](/en/api-reference/api-ref/signaling/web#leave)
...
```java tab="Java"
JoinChannelOptions options = new JoinChannelOptions("your_token", true, true, true, false);
mStreamChannel.join(options, new ResultCallback<Void>() {
    @Override
    public void onSuccess(Void responseInfo) {
        log(CALLBACK, "join stream channel success");
...
```kotlin tab="Kotlin"
val options = JoinChannelOptions("your_token", true, true, true, false)
...
// Send a string message
    ...
    options.setCustomType("PlainTxt"); // Set a custom type for the message
...
// Send a binary message
    byte[] message = new byte[] { 00, 01, 35, (byte) 196 }; // Binary message content
    String topicName = "chat_topic"; // Topic name for publishing
    var options = new TopicMessageOptions(); // Topic message sending options
    options.setCustomType("ByteArray"); // Set a custom type for the message
    mStreamChannel.publishTopicMessage(topicName, message, options, new ResultCallback<Void>() {
        @Override
        public void onSuccess(Void responseInfo) {
            // Log success
...
```kotlin tab="Kotlin"
// Send a binary message
    val message = byteArrayOf(0, 1, 35, 196.toByte()) // Binary message content
    val topicName = "chat_topic" // Topic name for publishing
    val options = TopicMessageOptions() // Topic message sending options
...
- [`createStreamChannel `](/en/api-reference/api-ref/signaling/android#createstreamchannel)
- [`join`](/en/api-reference/api-ref/signaling/android#join)
- [`publishTopicMessage`](/en/api-reference/api-ref/signaling/android#publishtopicmessage)
- [`leave`](/en/api-reference/api-ref/signaling/android#leave)
- [`release`](/en/api-reference/api-ref/signaling/android#rtmclientrelease)
...
let message = "Hello Agora!"
    ...
    streamChannel.publishTopicMessage(topic: "your_topic", message: message, option: nil) { response, errorInfo in
        if errorInfo == nil {
...
let bytes: [UInt8] = [ /* your raw values */ ]
    ...
    streamChannel.publishTopicMessage(topic: "your_topic", data: rawMessage, option: nil) { response, errorInfo in
        if errorInfo == nil {
            print("publish success!!")
        } else {
            print("publish failed, errorCode \\(errorInfo!.errorCode), reason \\(errorInfo!.reason)")
...
- [`createStreamChannel`](/en/api-reference/api-ref/signaling/ios#createstreamchannel)
- [`join`](/en/api-reference/api-ref/signaling/ios#join)
- [`publishTopicMessage`](/en/api-reference/api-ref/signaling/ios#publishtopicmessage)
- [`leave`](/en/api-reference/api-ref/signaling/ios#leave)
- [`destroy`](/en/api-reference/api-ref/signaling/ios#agorartmclientkitdestroy)
...
- [`createStreamChannel`](/en/api-reference/api-ref/signaling/ios#createstreamchannel)
- [`joinWithOption`](/en/api-reference/api-ref/signaling/ios#join)
- [`publishTopicMessage`](/en/api-reference/api-ref/signaling/ios#publishtopicmessage)
- [`leave`](/en/api-reference/api-ref/signaling/ios#leave)
- [`destroy`](/en/api-reference/api-ref/signaling/ios#agorartmclientkitdestroy)
...
- [`createStreamChannel`](/en/api-reference/api-ref/signaling/macos#createstreamchannel)
- [`join`](/en/api-reference/api-ref/signaling/macos#joinwithoption)
- [`publishTopicMessage`](/en/api-reference/api-ref/signaling/macos#publishtopicmessage)
- [`leave`](/en/api-reference/api-ref/signaling/macos#leave)
- [`destroy`](/en/api-reference/api-ref/signaling/macos#agorartmclientkitdestroy)
...
- [`createStreamChannel`](/en/api-reference/api-ref/signaling/macos#createstreamchannel)
- [`joinWithOption`](/en/api-reference/api-ref/signaling/macos#joinwithoption)
- [`publishTopicMessage`](/en/api-reference/api-ref/signaling/macos#publishtopicmessage)
- [`leave`](/en/api-reference/api-ref/signaling/macos#leave)
- [`destroy`](/en/api-reference/api-ref/signaling/macos#agorartmclientkitdestroy)
...
try {
    var (status, newChannel) = await rtmClient.createStreamChannel(channel);
...
- [`createStreamChannel `](/en/api-reference/api-ref/signaling/flutter#createstreamchannel)
- [`join`](/en/api-reference/api-ref/signaling/flutter#join)
- [`publishTextMessage`](/en/api-reference/api-ref/signaling/flutter#publishtextmessage)
- [`publishBinaryMessage`](/en/api-reference/api-ref/signaling/flutter#publishbinarymessage)
- [`leave`](/en/api-reference/api-ref/signaling/flutter#leave)
- [`release`](/en/api-reference/api-ref/signaling/flutter#release)
...
* String message
    ...
    uint64_t requestId;
    stream_channel->publishTopicMessage("topicName", message.c_str(), message.size(), options, requestId);
    ```
...
* Binary message
    ...
    uint64_t requestId;
    stream_channel->publishTopicMessage("topicName", message, 5, options, requestId);
    ```
...
- [`createStreamChannel `](/en/api-reference/api-ref/signaling/windows-cpp#createstreamchannel)
- [`join`](/en/api-reference/api-ref/signaling/windows-cpp#join)
- [`publishTopicMessage`](/en/api-reference/api-ref/signaling/windows-cpp#publishtopicmessage)
- [`leave`](/en/api-reference/api-ref/signaling/windows-cpp#leave)
- [`release`](/en/api-reference/api-ref/signaling/windows-cpp#irtmclientrelease)
...
- [`createStreamChannel `](/en/api-reference/api-ref/signaling/linux-cpp#createstreamchannel)
- [`join`](/en/api-reference/api-ref/signaling/linux-cpp#join)
- [`publishTopicMessage`](/en/api-reference/api-ref/signaling/linux-cpp#publishtopicmessage)
- [`leave`](/en/api-reference/api-ref/signaling/linux-cpp#leave)
- [`release`](/en/api-reference/api-ref/signaling/linux-cpp#irtmclientrelease)
...
- [`createStreamChannel `](/en/api-reference/api-ref/signaling/linux-java#createstreamchannel)
- [`join`](/en/api-reference/api-ref/signaling/linux-java#join)
- [`publishTopicMessage`](/en/api-reference/api-ref/signaling/linux-java#publishtopicmessage)
- [`leave`](/en/api-reference/api-ref/signaling/linux-java#leave)
- [`release`](/en/api-reference/api-ref/signaling/linux-java#rtmclientrelease)
...
* String message
    ...
    var result = await streamChannel.PublishTopicMessageAsync(topic, message, options); // Send the message asynchronously
    if (result.Status.Error)
    {
        Debug.Log(string.Format("{0} is failed, ErrorCode {1}, due to: {2}", result.Status.Operation, result.Status.ErrorCode, result.Status.Reason)); // Log error information if message send fails
    }
    ```
...
- [`CreateStreamChannel `](/en/api-reference/api-ref/signaling/unity#createstreamchannel)
- [`JoinAsync`](/en/api-reference/api-ref/signaling/unity#joinasync)
- [`PublishTopicMessageAsync`](/en/api-reference/api-ref/signaling/unity#publishtopicmessageasync)
- [`LeaveAsync`](/en/api-reference/api-ref/signaling/unity#leaveasync)
- [`Dispose`](/en/api-reference/api-ref/signaling/unity#dispose)
