...
- [`receive`](/en/api-reference/api-ref/signaling/android#receive)
...
- [Receive](/en/api-reference/api-ref/signaling/ios#receive)
...
- [Receive](/en/api-reference/api-ref/signaling/macos#receive)
...
- [`receive`](/en/api-reference/api-ref/signaling/linux-java#receive)
