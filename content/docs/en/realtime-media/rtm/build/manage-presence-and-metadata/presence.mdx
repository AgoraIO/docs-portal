...
:::info[Enable Presence in Agora Console]
...
:::info[Querying Presence right after login]
...
:::info[Querying remote user state]
Starting from v2.3.0, if Presence is still starting up when `login` succeeds, the SDK automatically waits and retries a remote `getState` call once Presence becomes available, as described in [Querying Presence right after login](#get-channel-users). Handle the result as you would any other asynchronous call, including failure.
:::
...
To receive presence event notifications, implement an event listener. See [event listeners](/en/api-reference/api-ref/signaling/web#event-listeners) for details. In addition, set the `withPresence` parameter to `true` when subscribing to or joining a channel.
...
- [`getOnlineUsers`](/en/api-reference/api-ref/signaling/web#getonlineusers)
- [`getUserChannels`](/en/api-reference/api-ref/signaling/web#getuserchannels)
- [`setState`](/en/api-reference/api-ref/signaling/web#setstate)
- [`getState`](/en/api-reference/api-ref/signaling/web#getstate)
- [`removeState`](/en/api-reference/api-ref/signaling/web#removestate)
...
val options = GetOnlineUsersOptions().apply {
...
mRtmClient.getPresence().getState("Chat_room", RtmChannelType.MESSAGE, userId, object : ResultCallback<UserState> {
    override fun onSuccess(state: UserState) {
        log(CALLBACK, "get users(${state.userId}) state success, ${state}")
    }
...
A presence event notification returns the [PresenceEvent](/en/api-reference/api-ref/signaling/android#presenceevent) data structure, which includes the [RtmPresenceEventType](/en/api-reference/api-ref/signaling/android#rtmpresenceeventtype) parameter.

To receive presence event notifications, implement an event listener. See [event listeners](/en/api-reference/api-ref/signaling/android#event-listeners) for details. In addition, set the `withPresence` parameter to `true` when subscribing to or joining a channel.
...
- [`getOnlineUsers`](/en/api-reference/api-ref/signaling/android#getonlineusers)
- [`getUserChannels`](/en/api-reference/api-ref/signaling/android#getuserchannels)
- [`setState`](/en/api-reference/api-ref/signaling/android#setstate)
- [`getState`](/en/api-reference/api-ref/signaling/android#getstate)
- [`removeState`](/en/api-reference/api-ref/signaling/android#removestate)
...
rtm.getPresence()?.getOnlineUser(channelName: "your_channel", channelType: .message, options: presenceOptions) { response, errorInfo in
    if errorInfo == nil {
...
```objc
AgoraRtmGetOnlineUsersOptions* presence_opt = [[AgoraRtmGetOnlineUsersOptions alloc] init];
...
When there is a large number of users in a channel, you may only care about the total number of online users, and not their identities or temporary status. To get the total channel occupancy, set `includeState` and `includeUserId` in `AgoraRtmGetOnlineUsersOptions` to `false`.
...
```swift tab="Swift"
rtm.getPresence()?.getUserChannels(userId: "userId") { response, errorInfo in
    if errorInfo == nil {
...
rtm.getPresence()?.removeState(channelName: "your_channel", channelType: .message, keys: keys) { response, errorInfo in
    if errorInfo == nil {
...
A presence event notification returns the [AgoraRtmPresenceEvent](/en/api-reference/api-ref/signaling/ios#agorartmpresenceevent) data structure, which includes the [AgoraRtmPresenceEventType](/en/api-reference/api-ref/signaling/ios#agorartmpresenceeventtype) parameter.

To receive presence event notifications, implement an event listener. See [event listeners](/en/api-reference/api-ref/signaling/ios#event-listeners) for details. In addition, include presence in the `features` parameter when subscribing to or joining a channel.
...
- [`getOnlineUsers`](/en/api-reference/api-ref/signaling/ios#getonlineusers)
- [`getUserChannels`](/en/api-reference/api-ref/signaling/ios#getuserchannels)
- [`setState`](/en/api-reference/api-ref/signaling/ios#setstate)
- [`getState`](/en/api-reference/api-ref/signaling/ios#getstate)
- [`removeState`](/en/api-reference/api-ref/signaling/ios#removestate)
...
A presence event notification returns the [AgoraRtmPresenceEvent](/en/api-reference/api-ref/signaling/macos#agorartmpresenceevent) data structure, which includes the [AgoraRtmPresenceEventType](/en/api-reference/api-ref/signaling/macos#agorartmpresenceeventtype) parameter.

To receive presence event notifications, implement an event listener. See [event listeners](/en/api-reference/api-ref/signaling/macos#event-listeners) for details. In addition, include presence in the `features` parameter when subscribing to or joining a channel.
...
- [`getOnlineUsers`](/en/api-reference/api-ref/signaling/macos#getonlineusers)
- [`getUserChannels`](/en/api-reference/api-ref/signaling/macos#getuserchannels)
- [`setState`](/en/api-reference/api-ref/signaling/macos#setstate)
- [`getState`](/en/api-reference/api-ref/signaling/macos#getstate)
- [`removeState`](/en/api-reference/api-ref/signaling/macos#removestate)
...
A presence event notification returns the [PresenceEvent](/en/api-reference/api-ref/signaling/flutter#presenceevent) data structure, which includes the [RtmPresenceEventType](/en/api-reference/api-ref/signaling/flutter#rtmpresenceeventtype) parameter.

To receive presence event notifications, implement an event listener. See [event listeners](/en/api-reference/api-ref/signaling/flutter#event-listeners) for details. In addition, set the `withPresence` parameter to `true` when subscribing to or joining a channel.
...
- [`getOnlineUsers`](/en/api-reference/api-ref/signaling/flutter#getonlineusers)
- [`getUserChannels`](/en/api-reference/api-ref/signaling/flutter#getuserchannels)
- [`setState`](/en/api-reference/api-ref/signaling/flutter#setstate)
- [`getState`](/en/api-reference/api-ref/signaling/flutter#getstate)
- [`removeState`](/en/api-reference/api-ref/signaling/flutter#removestate)
...
A presence event notification returns the [PresenceEvent](/en/api-reference/api-ref/signaling/windows-cpp#presenceevent) data structure, which includes the [RTM_PRESENCE_EVENT_TYPE.](/en/api-reference/api-ref/signaling/windows-cpp#rtm_presence_event_type) parameter.

To receive presence event notifications, implement an event listener. See [event listeners](/en/api-reference/api-ref/signaling/windows-cpp#event-listeners) for details. In addition, set the `withPresence` parameter to `true` when subscribing to or joining a channel.
...
- [`getOnlineUsers`](/en/api-reference/api-ref/signaling/windows-cpp#getonlineusers)
- [`getUserChannels`](/en/api-reference/api-ref/signaling/windows-cpp#getuserchannels)
- [`setState`](/en/api-reference/api-ref/signaling/windows-cpp#setstate)
- [`getState`](/en/api-reference/api-ref/signaling/windows-cpp#getstate)
- [`removeState`](/en/api-reference/api-ref/signaling/windows-cpp#removestate)
...
A presence event notification returns the [PresenceEvent](/en/api-reference/api-ref/signaling/linux-cpp#presenceevent) data structure, which includes the [RTM_PRESENCE_EVENT_TYPE.](/en/api-reference/api-ref/signaling/linux-cpp#rtm_presence_event_type) parameter.

To receive presence event notifications, implement an event listener. See [event listeners](/en/api-reference/api-ref/signaling/linux-cpp#event-listeners) for details. In addition, set the `withPresence` parameter to `true` when subscribing to or joining a channel.
...
- [`getOnlineUsers`](/en/api-reference/api-ref/signaling/linux-cpp#getonlineusers)
- [`getUserChannels`](/en/api-reference/api-ref/signaling/linux-cpp#getuserchannels)
- [`setState`](/en/api-reference/api-ref/signaling/linux-cpp#setstate)
- [`getState`](/en/api-reference/api-ref/signaling/linux-cpp#getstate)
- [`removeState`](/en/api-reference/api-ref/signaling/linux-cpp#removestate)
...
The `getOnlineUsers` method retrieves one page of data at a time. Each page contains up to 100 online users. If the channel has more than 100 users, the `nextPage` field in the returned `result` contains a bookmark for the next page. After each query, check if `result.getNextPage` is empty to determine if there is more data. To retrieve the next page, set the `page` field in `GetOnlineUsersOptions` to the value of `result.getNextPage`. Repeat this process until `result.getNextPage` is null. Refer to the following code:
...
When there is a large number of users in a channel, you may only care about the total number of online users, and not their identities or temporary status. To get the total channel occupancy, set `includeState` and `includeUserId` in `GetOnlineUsersOptions` to `false`.
...
A presence event notification returns the [PresenceEvent](/en/api-reference/api-ref/signaling/linux-java#presenceevent) data structure, which includes the [RtmPresenceEventType](/en/api-reference/api-ref/signaling/linux-java#rtmpresenceeventtype) parameter.

To receive presence event notifications, implement an event listener. See [event listeners](/en/api-reference/api-ref/signaling/linux-java#event-listeners) for details. In addition, set the `withPresence` parameter to `true` when subscribing to or joining a channel.
...
- [`getOnlineUsers`](/en/api-reference/api-ref/signaling/linux-java#getonlineusers)
- [`getUserChannels`](/en/api-reference/api-ref/signaling/linux-java#getuserchannels)
- [`setState`](/en/api-reference/api-ref/signaling/linux-java#setstate)
- [`getState`](/en/api-reference/api-ref/signaling/linux-java#getstate)
- [`removeState`](/en/api-reference/api-ref/signaling/linux-java#removestate)
...
var result = await rtmClient.GetPresence().GetOnlineUsersAsync("Chat_room", channelType, options);
if (result.Status.Error)
{
    Debug.Log(string.Format("{0} is failed!}", result.Status.Operation));
    Debug.Log(string.Format("Error code : {0}", result.Status.ErrorCode));
    Debug.Log(string.Format("Due to: {0}", result.Status.Reason));

}
else
{
    Debug.Log(string.Format("You have got {0} users information ", result.Response.TotalOccupancy));
    foreach (UserState user in result.Response.UserStateList)
    {
...
{
    Debug.Log(string.Format("{0} users online ", result.Response.TotalOccupancy));
}
```
...
else
{
    ...
    {
        foreach (ChannelInfo channel in result.Response.Channels)
        {
...
var result = await rtmClient.GetPresence().SetStateAsync("Chat_room", RTM_CHANNEL_TYPE.MESSAGE, myStates);
if (result.Status.Error)
{
    Debug.Log(string.Format("{0} is failed!}", result.Status.Operation));
    Debug.Log(string.Format("Error code : {0}", result.Status.ErrorCode));
...
```csharp
var result = await rtmClient.GetPresence().GetStateAsync("Chat_room", RTM_CHANNEL_TYPE.MESSAGE, "Tony");
if (result.Status.Error)
{
    Debug.Log(string.Format("{0} is failed!}", result.Status.Operation));
    Debug.Log(string.Format("Error code : {0}", result.Status.ErrorCode));
...
{
    var userState = result.Response.State;
    Debug.Log(string.Format("User:{0}, have stateCount:{1} states",userState.userId, userState.states.Length));
...
var result = await rtmClient.GetPresence().RemoveStateAsync("Chat_room", RTM_CHANNEL_TYPE.MESSAGE, keys);
if (result.Status.Error)
{
    Debug.Log(string.Format("{0} is failed!}", result.Status.Operation));
    Debug.Log(string.Format("Error code : {0}", result.Status.ErrorCode));
...
A presence event notification returns the [PresenceEvent](/en/api-reference/api-ref/signaling/unity#presenceevent) data structure, which includes the [RTM_PRESENCE_EVENT_TYPE](/en/api-reference/api-ref/signaling/unity#rtm_presence_event_type) parameter.

To receive presence event notifications, implement an event listener. See [event listeners](/en/api-reference/api-ref/signaling/unity#event-listeners) for details. In addition, set the `withPresence` parameter to `true` when subscribing to or joining a channel.
...
- [`GetOnlineUsersAsync`](/en/api-reference/api-ref/signaling/unity#getonlineusersasync)
- [`GetUserChannelsAsync`](/en/api-reference/api-ref/signaling/unity#getuserchannelsasync)
- [`SetStateAsync`](/en/api-reference/api-ref/signaling/unity#setstateasync)
- [`GetStateAsync`](/en/api-reference/api-ref/signaling/unity#getstateasync)
- [`RemoveStateAsync`](/en/api-reference/api-ref/signaling/unity#removestateasync)
