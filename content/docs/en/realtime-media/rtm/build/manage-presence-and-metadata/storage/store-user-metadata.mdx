...
To receive storage event notifications, implement an event listener. See [event listeners](/en/api-reference/api-ref/signaling) for details. You only receive user metadata update notifications for users that you have subscribed to.
...
- [`setUserMetaData`](/en/api-reference/api-ref/signaling)
- [`getUserMetadata​`](/en/api-reference/api-ref/signaling)
- [`removeUserMetadata​`](/en/api-reference/api-ref/signaling)
- [`updateUserMetadata​`](/en/api-reference/api-ref/signaling)
- [`subscribeUserMetadata`](/en/api-reference/api-ref/signaling)
- [`unsubscribeUserMetadata`](/en/api-reference/api-ref/signaling)
