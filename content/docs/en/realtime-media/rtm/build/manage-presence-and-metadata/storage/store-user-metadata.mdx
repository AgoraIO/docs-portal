...
To receive storage event notifications, implement an event listener. See [event listeners](/en/api-reference/api-ref/signaling/web#event-listeners) for details. You only receive user metadata update notifications for users that you have subscribed to.
...
- [`setUserMetaData`](/en/api-reference/api-ref/signaling/web#setusermetadata)
- [`getUserMetadata`](/en/api-reference/api-ref/signaling/web#getusermetadata)
- [`removeUserMetadata`](/en/api-reference/api-ref/signaling/web#removeusermetadata)
- [`updateUserMetadata`](/en/api-reference/api-ref/signaling/web#updateusermetadata)
- [`subscribeUserMetadata`](/en/api-reference/api-ref/signaling/web#subscribeusermetadata)
- [`unsubscribeUserMetadata`](/en/api-reference/api-ref/signaling/web#unsubscribeusermetadata)
...
To receive storage event notifications, implement an event listener. See [event listeners](/en/api-reference/api-ref/signaling/android#event-listeners) for details. You only receive user metadata update notifications for users that you have subscribed to.
...
- [`setUserMetaData`](/en/api-reference/api-ref/signaling/android#setusermetadata)
- [`getUserMetadata`](/en/api-reference/api-ref/signaling/android#getusermetadata)
- [`removeUserMetadata`](/en/api-reference/api-ref/signaling/android#removeusermetadata)
- [`updateUserMetadata`](/en/api-reference/api-ref/signaling/android#updateusermetadata)
- [`subscribeUserMetadata`](/en/api-reference/api-ref/signaling/android#subscribeusermetadata)
- [`unsubscribeUserMetadata`](/en/api-reference/api-ref/signaling/android#unsubscribeusermetadata)
...
To receive storage event notifications, implement an event listener. See [event listeners](/en/api-reference/api-ref/signaling/ios#event-listeners) for details. You only receive user metadata update notifications for users that you have subscribed to.
...
- [`setUserMetaData`](/en/api-reference/api-ref/signaling/ios#setusermetadata)
- [`getUserMetadata`](/en/api-reference/api-ref/signaling/ios#getusermetadata)
- [`removeUserMetadata`](/en/api-reference/api-ref/signaling/ios#removeusermetadata)
- [`updateUserMetadata`](/en/api-reference/api-ref/signaling/ios#updateusermetadata)
- [`subscribeUserMetadata`](/en/api-reference/api-ref/signaling/ios#subscribeusermetadata)
- [`unsubscribeUserMetadata`](/en/api-reference/api-ref/signaling/ios#unsubscribeusermetadata)
...
To receive storage event notifications, implement an event listener. See [event listeners](/en/api-reference/api-ref/signaling/macos#event-listeners) for details. You only receive user metadata update notifications for users that you have subscribed to.
...
- [`setUserMetaData`](/en/api-reference/api-ref/signaling/macos#setusermetadata)
- [`getUserMetadata`](/en/api-reference/api-ref/signaling/macos#getusermetadata)
- [`removeUserMetadata`](/en/api-reference/api-ref/signaling/macos#removeusermetadata)
- [`updateUserMetadata`](/en/api-reference/api-ref/signaling/macos#updateusermetadata)
- [`subscribeUserMetadata`](/en/api-reference/api-ref/signaling/macos#subscribeusermetadata)
- [`unsubscribeUserMetadata`](/en/api-reference/api-ref/signaling/macos#unsubscribeusermetadata)
...
Signaling also triggers a `storage` event notification within 100 ms of type `update` to notify other users subscribed to this user's metadata. For details, see [event listeners](/en/api-reference/api-ref/signaling/flutter#event-listeners).
...
Signaling triggers a `storage` event notification within 100 ms of type `update` to notify other users subscribed to this user's metadata. For details, see [event listeners](/en/api-reference/api-ref/signaling/flutter#event-listeners).
...
To receive storage event notifications, implement an event listener. See [event listeners](/en/api-reference/api-ref/signaling/flutter#event-listeners) for details. You only receive user metadata update notifications for users that you have subscribed to.
...
- `majorRevision` named parameter: Enable version number verification of the entire set of user metadata.
...
- [`setUserMetadata`](/en/api-reference/api-ref/signaling/flutter#setusermetadata)
- [`getUserMetadata`](/en/api-reference/api-ref/signaling/flutter#getusermetadata)
- [`removeUserMetadata`](/en/api-reference/api-ref/signaling/flutter#removeusermetadata)
- [`updateUserMetadata`](/en/api-reference/api-ref/signaling/flutter#updateusermetadata)
- [`subscribeUserMetadata`](/en/api-reference/api-ref/signaling/flutter#subscribeusermetadata)
- [`unsubscribeUserMetadata`](/en/api-reference/api-ref/signaling/flutter#unsubscribeusermetadata)
...
To receive storage event notifications, implement an event listener. See [event listeners](/en/api-reference/api-ref/signaling/windows-cpp#event-listeners) for details. You only receive user metadata update notifications for users that you have subscribed to.
...
- `majorRevision` field of the `Metadata` struct: Enable version number verification of the entire set of user metadata.
...
- [`setUserMetadata`](/en/api-reference/api-ref/signaling/windows-cpp#setusermetadata)
- [`getUserMetadata`](/en/api-reference/api-ref/signaling/windows-cpp#getusermetadata)
- [`removeUserMetadata`](/en/api-reference/api-ref/signaling/windows-cpp#removeusermetadata)
- [`updateUserMetadata`](/en/api-reference/api-ref/signaling/windows-cpp#updateusermetadata)
- [`subscribeUserMetadata`](/en/api-reference/api-ref/signaling/windows-cpp#subscribeusermetadata)
- [`unsubscribeUserMetadata`](/en/api-reference/api-ref/signaling/windows-cpp#unsubscribeusermetadata)
...
To receive storage event notifications, implement an event listener. See [event listeners](/en/api-reference/api-ref/signaling/linux-cpp#event-listeners) for details. You only receive user metadata update notifications for users that you have subscribed to.
...
- [`setUserMetadata`](/en/api-reference/api-ref/signaling/linux-cpp#setusermetadata)
- [`getUserMetadata`](/en/api-reference/api-ref/signaling/linux-cpp#getusermetadata)
- [`removeUserMetadata`](/en/api-reference/api-ref/signaling/linux-cpp#removeusermetadata)
- [`updateUserMetadata`](/en/api-reference/api-ref/signaling/linux-cpp#updateusermetadata)
- [`subscribeUserMetadata`](/en/api-reference/api-ref/signaling/linux-cpp#subscribeusermetadata)
- [`unsubscribeUserMetadata`](/en/api-reference/api-ref/signaling/linux-cpp#unsubscribeusermetadata)
...
To receive storage event notifications, implement an event listener. See [event listeners](/en/api-reference/api-ref/signaling/linux-java#event-listeners) for details. You only receive user metadata update notifications for users that you have subscribed to.
...
- [`setUserMetaData`](/en/api-reference/api-ref/signaling/linux-java#setusermetadata)
- [`getUserMetadata`](/en/api-reference/api-ref/signaling/linux-java#getusermetadata)
- [`removeUserMetadata`](/en/api-reference/api-ref/signaling/linux-java#removeusermetadata)
- [`updateUserMetadata`](/en/api-reference/api-ref/signaling/linux-java#updateusermetadata)
- [`subscribeUserMetadata`](/en/api-reference/api-ref/signaling/linux-java#subscribeusermetadata)
- [`unsubscribeUserMetadata`](/en/api-reference/api-ref/signaling/linux-java#unsubscribeusermetadata)
...
{
    Debug.Log(string.Format("{0} failed, ErrorCode: {1}, due to: {2}", result.Status.Operation, result.Status.ErrorCode, result.Status.Reason));
}
else
{
...
To receive storage event notifications, implement an event listener. See [event listeners](/en/api-reference/api-ref/signaling/unity#event-listeners) for details. You only receive user metadata update notifications for users that you have subscribed to.
...
- [`SetUserMetaDataAsync`](/en/api-reference/api-ref/signaling/unity#setusermetadataasync)
- [`GetUserMetadataAsync`](/en/api-reference/api-ref/signaling/unity#getusermetadataasync)
- [`RemoveUserMetadataAsync`](/en/api-reference/api-ref/signaling/unity#removeusermetadataasync)
- [`UpdateUserMetadataAsync`](/en/api-reference/api-ref/signaling/unity#updateusermetadataasync)
