...
Signaling also triggers a `storage` event notification within 100 ms of type `update` to notify other users subscribed to this user's metadata. For details see See [event listeners](/en/api-reference/api-ref/signaling#event-listeners).
...
Signaling triggers a `storage` event notification within 100 ms of type `update` to notify other users subscribed to this user's metadata. For details see See [event listeners](/en/api-reference/api-ref/signaling#event-listeners).
