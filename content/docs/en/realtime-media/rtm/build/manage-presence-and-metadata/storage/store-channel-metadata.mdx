...
To receive storage event notifications, implement an event listener. See [event listeners](/en/api-reference/api-ref/signaling/web#event-listeners) for details. In addition, set the `withMetadata` parameter to `true` when subscribing to or joining a channel.
...
For more information on setting, acquiring, releasing, revoking, and removing locks, see [Locks](/en/api-reference/api-ref/signaling/web#lock).
...
- [`setChannelMetaData`](/en/api-reference/api-ref/signaling/web#setchannelmetadata)
- [`getChannelMetadata`](/en/api-reference/api-ref/signaling/web#getchannelmetadata)
- [`removeChannelMetadata`](/en/api-reference/api-ref/signaling/web#removechannelmetadata)
- [`updateChannelMetadata`](/en/api-reference/api-ref/signaling/web#updatechannelmetadata)
- [Event listeners](/en/api-reference/api-ref/signaling/web#event-listeners)
- [Lock](/en/api-reference/api-ref/signaling/web#lock)

- [Storage](/en/api-reference/api-ref/signaling/web#storage)
...
mRtmClient.getStorage().setChannelMetadata("channel1", RtmChannelType.MESSAGE, metadata, new MetadataOptions(true, true), "", new ResultCallback<Void>() {
    @Override
...
A storage event notification returns the [StorageEvent](/en/api-reference/api-ref/signaling/android#storageevent) data structure, which includes the [RtmStorageEventType](/en/api-reference/api-ref/signaling/android#rtmstorageeventtype) parameter.

To receive storage event notifications, implement an event listener. See [event listeners](/en/api-reference/api-ref/signaling/android#event-listeners) for details. In addition, set the `withMetadata` parameter to `true` when subscribing to or joining a channel.
...
For more information on setting, acquiring, releasing, revoking, and removing locks, see [Locks](/en/api-reference/api-ref/signaling/android#lock).
...
- [`setChannelMetaData`](/en/api-reference/api-ref/signaling/android#setchannelmetadata)
- [`getChannelMetadata`](/en/api-reference/api-ref/signaling/android#getchannelmetadata)
- [`removeChannelMetadata`](/en/api-reference/api-ref/signaling/android#removechannelmetadata)
- [`updateChannelMetadata`](/en/api-reference/api-ref/signaling/android#updatechannelmetadata)
- [Event listeners](/en/api-reference/api-ref/signaling/android#event-listeners)
- [Lock](/en/api-reference/api-ref/signaling/android#lock)

- [Metadata](/en/api-reference/api-ref/signaling/android#metadata)
...
A storage event notification returns the [AgoraRtmStorageEvent](/en/api-reference/api-ref/signaling/ios#agorartmstorageevent) data structure, which includes the [AgoraRtmStorageEventType](/en/api-reference/api-ref/signaling/ios#agorartmstorageeventtype) parameter.

To receive storage event notifications, implement an event listener. See [event listeners](/en/api-reference/api-ref/signaling/ios#event-listeners) for details. In addition, add `metadata` to the `features` parameter under `options` when subscribing to or joining a channel.
...
For more information on setting, acquiring, releasing, revoking, and removing locks, see [Locks](/en/api-reference/api-ref/signaling/ios#lock).
...
- [`setChannelMetaData`](/en/api-reference/api-ref/signaling/ios#setchannelmetadata)
- [`getChannelMetadata`](/en/api-reference/api-ref/signaling/ios#getchannelmetadata)
- [`removeChannelMetadata`](/en/api-reference/api-ref/signaling/ios#removechannelmetadata)
- [`updateChannelMetadata`](/en/api-reference/api-ref/signaling/ios#updatechannelmetadata)
- [`AgoraRtmMetadata`](/en/api-reference/api-ref/signaling/ios#agorartmmetadata)
- [Event listeners](/en/api-reference/api-ref/signaling/ios#event-listeners)
- [Lock](/en/api-reference/api-ref/signaling/ios#lock)
...
A storage event notification returns the [AgoraRtmStorageEvent](/en/api-reference/api-ref/signaling/macos#agorartmstorageevent) data structure, which includes the [AgoraRtmStorageEventType](/en/api-reference/api-ref/signaling/macos#agorartmstorageeventtype) parameter.

To receive storage event notifications, implement an event listener. See [event listeners](/en/api-reference/api-ref/signaling/macos#event-listeners) for details. In addition, add `metadata` to the `features` parameter under `options` when subscribing to or joining a channel.
...
For more information on setting, acquiring, releasing, revoking, and removing locks, see [Locks](/en/api-reference/api-ref/signaling/macos#lock).
...
- [`setChannelMetaData`](/en/api-reference/api-ref/signaling/macos#setchannelmetadata)
- [`getChannelMetadata`](/en/api-reference/api-ref/signaling/macos#getchannelmetadata)
- [`removeChannelMetadata`](/en/api-reference/api-ref/signaling/macos#removechannelmetadata)
- [`updateChannelMetadata`](/en/api-reference/api-ref/signaling/macos#updatechannelmetadata)
- [`AgoraRtmMetadata`](/en/api-reference/api-ref/signaling/macos#agorartmmetadata)
- [Event listeners](/en/api-reference/api-ref/signaling/macos#event-listeners)
- [Lock](/en/api-reference/api-ref/signaling/macos#lock)
...
Signaling also triggers a `storage` event notification within 100 ms of type `update` to notify other users in the channel. For details, see [event listeners](/en/api-reference/api-ref/signaling/flutter#event-listeners).
...
A storage event notification returns the [StorageEvent](/en/api-reference/api-ref/signaling/flutter#storageevent) data structure, which includes the [RtmStorageEventType](/en/api-reference/api-ref/signaling/flutter#rtmstorageeventtype) parameter.

To receive storage event notifications, implement a `storage` event listener. See [event listeners](/en/api-reference/api-ref/signaling/flutter#event-listeners) for details. In addition, set the `withMetadata` parameter to `true` when subscribing to or joining a channel.
...
- `majorRevision` named parameter: Enable version number verification of the entire set of channel metadata.
...
For more information on setting, acquiring, releasing, revoking, and removing locks, see [Locks](/en/api-reference/api-ref/signaling/flutter#lock).
...
- [`setChannelMetadata`](/en/api-reference/api-ref/signaling/flutter#setchannelmetadata)
- [`getChannelMetadata`](/en/api-reference/api-ref/signaling/flutter#getchannelmetadata)
- [`removeChannelMetadata`](/en/api-reference/api-ref/signaling/flutter#removechannelmetadata)
- [`updateChannelMetadata`](/en/api-reference/api-ref/signaling/flutter#updatechannelmetadata)
- [Event listeners](/en/api-reference/api-ref/signaling/flutter#event-listeners)
- [Lock](/en/api-reference/api-ref/signaling/flutter#lock)

- [MetadataItem](/en/api-reference/api-ref/signaling/flutter#metadataitem)
...
A storage event notification returns the [StorageEvent](/en/api-reference/api-ref/signaling/windows-cpp#storageevent) data structure, which includes the [RTM_STORAGE_EVENT_TYPE](/en/api-reference/api-ref/signaling/windows-cpp#rtm_storage_event_type) parameter.

To receive storage event notifications, implement an event listener. See [event listeners](/en/api-reference/api-ref/signaling/windows-cpp#event-listeners) for details. In addition, set the `withMetadata` parameter to `true` when subscribing to or joining a channel.
...
- `majorRevision` field of the `Metadata` struct: Enable version number verification of the entire set of channel metadata.
...
rtm_client->getStorage()->updateChannelMetadata("channel1", RTM_CHANNEL_TYPE_MESSAGE, metadata, options, lockName.c_str(), requestId);
```

For more information on setting, acquiring, releasing, revoking, and removing locks, see [Locks](/en/api-reference/api-ref/signaling/windows-cpp#lock).
...
- [`setChannelMetadata`](/en/api-reference/api-ref/signaling/windows-cpp#setchannelmetadata)
- [`getChannelMetadata`](/en/api-reference/api-ref/signaling/windows-cpp#getchannelmetadata)
- [`removeChannelMetadata`](/en/api-reference/api-ref/signaling/windows-cpp#removechannelmetadata)
- [`updateChannelMetadata`](/en/api-reference/api-ref/signaling/windows-cpp#updatechannelmetadata)
- [Event listeners](/en/api-reference/api-ref/signaling/windows-cpp#event-listeners)
- [Lock](/en/api-reference/api-ref/signaling/windows-cpp#lock)

- [Metadata](/en/api-reference/api-ref/signaling/windows-cpp#metadata)
...
A storage event notification returns the [StorageEvent](/en/api-reference/api-ref/signaling/linux-cpp#storageevent) data structure, which includes the [RTM_STORAGE_EVENT_TYPE](/en/api-reference/api-ref/signaling/linux-cpp#rtm_storage_event_type) parameter.

To receive storage event notifications, implement an event listener. See [event listeners](/en/api-reference/api-ref/signaling/linux-cpp#event-listeners) for details. In addition, set the `withMetadata` parameter to `true` when subscribing to or joining a channel.
...
For more information on setting, acquiring, releasing, revoking, and removing locks, see [Locks](/en/api-reference/api-ref/signaling/linux-cpp#lock).
...
- [`setChannelMetadata`](/en/api-reference/api-ref/signaling/linux-cpp#setchannelmetadata)
- [`getChannelMetadata`](/en/api-reference/api-ref/signaling/linux-cpp#getchannelmetadata)
- [`removeChannelMetadata`](/en/api-reference/api-ref/signaling/linux-cpp#removechannelmetadata)
- [`updateChannelMetadata`](/en/api-reference/api-ref/signaling/linux-cpp#updatechannelmetadata)
- [Event listeners](/en/api-reference/api-ref/signaling/linux-cpp#event-listeners)
- [Lock](/en/api-reference/api-ref/signaling/linux-cpp#lock)

- [Metadata](/en/api-reference/api-ref/signaling/linux-cpp#metadata)
...
A storage event notification returns the [StorageEvent](/en/api-reference/api-ref/signaling/linux-java#storageevent) data structure, which includes the [RtmStorageEventType](/en/api-reference/api-ref/signaling/linux-java#rtmstorageeventtype) parameter.

To receive storage event notifications, implement an event listener. See [event listeners](/en/api-reference/api-ref/signaling/linux-java#event-listeners) for details. In addition, set the `withMetadata` parameter to `true` when subscribing to or joining a channel.
...
For more information on setting, acquiring, releasing, revoking, and removing locks, see [Locks](/en/api-reference/api-ref/signaling/linux-java#lock).
...
- [`setChannelMetaData`](/en/api-reference/api-ref/signaling/linux-java#setchannelmetadata)
- [`getChannelMetadata`](/en/api-reference/api-ref/signaling/linux-java#getchannelmetadata)
- [`removeChannelMetadata`](/en/api-reference/api-ref/signaling/linux-java#removechannelmetadata)
- [`updateChannelMetadata`](/en/api-reference/api-ref/signaling/linux-java#updatechannelmetadata)
- [Event listeners](/en/api-reference/api-ref/signaling/linux-java#event-listeners)
- [Lock](/en/api-reference/api-ref/signaling/linux-java#lock)

- [Metadata](/en/api-reference/api-ref/signaling/linux-java#metadata)
...
var result = await rtmClient.GetStorage().SetChannelMetadataAsync("channel1", RTM_CHANNEL_TYPE.MESSAGE, metadata, metadataOptions, lockName);
...
var result = await rtmClient.GetStorage().UpdateChannelMetadataAsync(
    "channel_name",
...
if (result.Status.Error)
{
    Debug.LogError(string.Format("{0} failed, ErrorCode: {1}, due to: {2}", result.Status.Operation, result.Status.ErrorCode, result.Status.Reason));
}
else
{
...
A storage event notification returns the [StorageEvent](/en/api-reference/api-ref/signaling/unity#storageevent) data structure, which includes the [RTM_STORAGE_EVENT_TYPE](/en/api-reference/api-ref/signaling/unity#rtm_storage_event_type) parameter.

To receive storage event notifications, implement an event listener. See [event listeners](/en/api-reference/api-ref/signaling/unity#event-listeners) for details. In addition, set the `withMetadata` parameter to `true` when subscribing to or joining a channel.
...
For more information on setting, acquiring, releasing, revoking, and removing locks, see [Locks](/en/api-reference/api-ref/signaling/unity#lock).
...
- [`SetChannelMetaDataAsync`](/en/api-reference/api-ref/signaling/unity#setchannelmetadataasync)
- [`GetChannelMetadataAsync`](/en/api-reference/api-ref/signaling/unity#getchannelmetadataasync)
- [`RemoveChannelMetadataAsync`](/en/api-reference/api-ref/signaling/unity#removechannelmetadataasync)
- [`UpdateChannelMetadataAsync`](/en/api-reference/api-ref/signaling/unity#updatechannelmetadataasync)
- [Event listeners](/en/api-reference/api-ref/signaling/unity#event-listeners)
- [Lock](/en/api-reference/api-ref/signaling/unity#lock)

- [Storage](/en/api-reference/api-ref/signaling/unity#storage)
