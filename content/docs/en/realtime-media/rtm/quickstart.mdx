...
For more information about subscribing and sending messages, see [Message channels](/en/realtime-media/rtm/build/channels/message-channel) and [Stream channels](/en/realtime-media/rtm/build/channels/stream-channel).
...
In this guide you retrieve a temporary token from a [Token Builder](https://agora-token-generator-demo.vercel.app/). To understand how to create an authentication server for development purposes, see [Secure authentication with tokens](./build/authentication-workflow.md). 
...
* [Event listeners](./build/messaging/add-event-listener.md)
</PlatformStructured>
...
For more information about sending and receiving messages see [Message channels](/en/realtime-media/rtm/build/channels/message-channel) and [Stream channels](/en/realtime-media/rtm/build/channels/stream-channel).
