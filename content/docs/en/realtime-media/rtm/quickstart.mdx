...
1. [Download](/en/api-reference/sdks?platform=linux) the latest version of the SDK and unzip it.
...
1. [Download](/en/api-reference/sdks?platform=unity) the latest version of the Agora Signaling SDK, and unzip the contents to a local folder.
