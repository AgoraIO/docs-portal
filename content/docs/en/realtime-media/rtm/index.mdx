...
<Cards>
  ...
  <Card title="Download SDKs" href="/en/api-reference/sdks" description="Get the latest Signaling SDK package for your target platform." />
  <Card title="Authentication" href="build/connect-and-authenticate/authentication-workflow.md" description="Generate and use tokens for secure Signaling connections." />
...
<CardGrid>
  <FeatureCard title="Message channels">
    ...
    [Message channels](build/work-with-channels/channels/message-channel.md)
  </FeatureCard>
  <FeatureCard title="Stream channels">
    ...
    [Stream channels](build/work-with-channels/channels/stream-channel.mdx)
  </FeatureCard>
  <FeatureCard title="Topics">
    ...
    [Topics](build/work-with-channels/channels/topics.md)
  </FeatureCard>
  <FeatureCard title="Presence">
    ...
    [Presence](build/manage-presence-and-metadata/presence.md)
  </FeatureCard>
  <FeatureCard title="Storage">
    ...
    [Storage](build/manage-presence-and-metadata/storage/store-user-metadata.md)
  </FeatureCard>
  <FeatureCard title="Locks">
    ...
    [Locks](build/manage-presence-and-metadata/storage/store-channel-metadata.md)
  </FeatureCard>
</CardGrid>
