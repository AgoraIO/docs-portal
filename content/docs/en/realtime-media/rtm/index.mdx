...
For more information about subscribing and sending messages, see [Message channels](/en/realtime-media/rtm/build/message-channel) and [Stream channels](/en/realtime-media/rtm/build/stream-channel).
...
In this guide you retrieve a temporary token from a [Token Builder](https://agora-token-generator-demo.vercel.app/). To understand how to create an authentication server for development purposes, see [Secure authentication with tokens](./get-started/authentication-workflow.md). 
...
For more information about sending and receiving messages see [Message channels](/en/realtime-media/rtm/build/message-channel) and [Stream channels](/en/realtime-media/rtm/build/stream-channel).
