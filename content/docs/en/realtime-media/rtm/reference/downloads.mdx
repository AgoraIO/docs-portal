...
To manually install the Signaling SDK for Unity:

1. Extract the latest version of the Agora [Signaling SDK for Unity](/en/api-reference/sdks?product=signaling&platform=unity) to a local folder.
