...
End users can access the Agora SDRTN® using a dynamic key, see [Secure authentication with tokens](https://docs.agora.io/en/video-calling/token-authentication/authentication-workflow).
