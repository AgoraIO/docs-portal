...
To follow this procedure you must have implemented the [SDK quickstart](../../quickstart.mdx) for IoT SDK.

## Project setup

In order to create the environment necessary to implement Agora multi-streaming feature into your app, open the IoT SDK [quickstart](../../quickstart.mdx) project you created previously.
...
1. Generate two [temporary tokens](/en/introduction/account) in Agora Console.
...
To follow this procedure you must have implemented the [SDK quickstart](/en/realtime-media/iot/quickstart) for IoT SDK.

## Project setup

In order to create the environment necessary to implement Agora multi-streaming feature into your app, open the IoT SDK [quickstart](/en/realtime-media/iot/quickstart) project you created previously.
...
1. **Add the library into your project**
    ...
    In the project you implemented for the [SDK quickstart](/en/realtime-media/iot/quickstart) for
