...
1. [Generate a temporary token](../manage-agora-account#generate-a-temporary-token) in Agora Console.
...
1. Generate the following [temporary tokens](../manage-agora-account#generate-a-temporary-token) in Agora Console.
