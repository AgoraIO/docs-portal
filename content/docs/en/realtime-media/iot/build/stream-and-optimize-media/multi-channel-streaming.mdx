...
1. [Generate a temporary token](../manage-agora-account.md#generate-temporary-tokens) in Agora Console.
...
1. Generate the following [temporary tokens](../manage-agora-account.md#generate-temporary-tokens) in Agora Console.
