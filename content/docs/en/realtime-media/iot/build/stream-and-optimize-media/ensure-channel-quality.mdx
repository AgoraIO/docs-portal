...
* Implemented the [SDK quickstart](../../quickstart.mdx).

## Project setup

To create the environment necessary to implement channel quality best practices into your app, open the [SDK quickstart](../../quickstart.mdx) for IoT SDK project you created previously.
