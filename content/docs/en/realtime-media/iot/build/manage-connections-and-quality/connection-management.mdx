...
Use `g_app.conn_id` in every subsequent call that is scoped to this connection, such as `agora_rtc_join_channel`, `agora_rtc_send_audio_data`, `agora_rtc_send_video_data`, `agora_rtc_mute_local_audio`, and `agora_rtc_leave_channel`.
