...
3. [Generate a temporary token](/en/introduction/account) in Agora Console.
...
- Open the [SDK quickstart](../get-started/get-started-sdk) IoT SDK project you created previously.
