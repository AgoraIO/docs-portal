...
This means that the App ID is invalid and the rule creation has failed. Obtain the App ID in [Agora Console](https://console.agora.io/) and call the API again.
