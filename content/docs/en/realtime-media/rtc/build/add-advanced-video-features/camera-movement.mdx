...
![Portrait light and shadow mode](https://web-cdn.agora.io/doc-cms/uploads/1706695546999-camera_portrait_6s.gif)

**Portrait lock mode**

![Portrait lock mode](https://web-cdn.agora.io/doc-cms/uploads/1706695552716-camera_lock_3s.gif)
...
1. Integrate the extension from the corresponding version folder according to the RTC SDK version used in your app. For example, if your app uses version 4.2.6, integrate the extension from the `./sdk/4.2` directory.
