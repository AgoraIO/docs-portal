...
:::note
To avoid collecting facial data through callbacks and building your own collection, encoding, and transmission framework, use the Agora [MetaKit extension](/en/realtime-media/video/build/add-advanced-video-features/metakit) for facial capture.
:::
