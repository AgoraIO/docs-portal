...
:::note
To avoid collecting facial data through callbacks and building your own collection, encoding, and transmission framework, use the Agora [MetaKit extension](/en/realtime-media/marketplace/build/add-video-and-ar-effects/metakit) for facial capture.
:::
