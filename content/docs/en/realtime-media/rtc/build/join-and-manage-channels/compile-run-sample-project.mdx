...
1. On the demo page, enter your [App ID](/en/realtime-media/rtc/manage-agora-account#get-the-app-id), [token](/en/realtime-media/rtc/manage-agora-account#generate-temporary-tokens), and channel name and join the channel.
