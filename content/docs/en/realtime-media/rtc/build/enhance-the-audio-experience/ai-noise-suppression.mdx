 ...
 * <Link to = "https://api-ref.agora.io/en/video-sdk/android/4.x/API/class_irtcengine.html#api_irtcengine_setainsmode">`setAINSMode`</Link>
</PlatformStructured>
...
When AI Noise Suppression is enabled, if RTC SDK detects that the device performance is not sufficient, it:
...
* <Link to = "https://api-ref.agora.io/en/video-sdk/ios/4.x/documentation/agorartckit/agorartcenginekit/setainsmode(_:mode:)">`setAINSMode`</Link>
</PlatformStructured>
...
* <Link to = "https://api-ref.agora.io/en/video-sdk/macos/4.x/documentation/agorartckit/agorartcenginekit/setainsmode(_:mode:)">`setAINSMode`</Link>
</PlatformStructured>
...
:::note
The following implementation steps apply to the latest version of the AI Noise Suppression extension. Refer to the [extension release notes](/en/realtime-media/rtc/reference/release-notes) for details.
:::
...
* <Link to = "https://api-ref.agora.io/en/video-sdk/cpp/4.x/API/api_irtcengine_setainsmode.html">`setAINSMode`</Link>
</PlatformStructured>
...
* <Link to = "https://api-ref.agora.io/en/video-sdk/unity/4.x/API/class_irtcengine.html#api_irtcengine_setainsmode">`SetAINSMode`</Link>
</PlatformStructured>
