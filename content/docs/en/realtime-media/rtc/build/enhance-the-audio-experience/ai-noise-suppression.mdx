 ...
 * <Link to = "https://api-ref.agora.io/en/video-sdk/electron/4.x/API/api_irtcengine_setainsmode.html">`setAINSMode`</Link>
</PlatformStructured>
 ...
 * <Link to = "https://api-ref.agora.io/en/video-sdk/react-native/4.x/API/api_irtcengine_setainsmode.html">`setAINSMode`</Link>
</PlatformStructured>
...
* <Link to = "https://api-ref.agora.io/en/video-sdk/flutter/6.x/API/api_irtcengine_setainsmode.html">`setAINSMode`</Link>
</PlatformStructured>
