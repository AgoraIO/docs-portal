...
- Two local images.
- Source video track 1: Created from the video stream captured by the camera, with the background removed using the [Virtual Background extension](/en/realtime-media/rtc/build/apply-video-effects/virtual-background).
...
1. Integrate the [Virtual Background](/en/realtime-media/rtc/build/apply-video-effects/virtual-background#integrate-the-virtual-background-extension) extension. Ensure that you understand the [considerations](/en/realtime-media/rtc/build/apply-video-effects/virtual-background#considerations).
