...
:::info
For integrating the Beauty Effect extension, Agora recommends upgrading to version 4.12.0 or later of the Web SDK.
:::
...
Ensure that you have implemented the [SDK quickstart](/en/realtime-media/rtc/get-started-sdk) in your project using the Web SDK version 4.12.0 or later.
...
An Agora RTC SDK extension for adding and managing beauty effects in real-time video streams.
