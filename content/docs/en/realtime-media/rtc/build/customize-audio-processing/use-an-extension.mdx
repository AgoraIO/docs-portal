...
- <Link to= "https://api-ref.agora.io/en/video-sdk/web/4.x/interfaces/iagorartc.html#registerextensions">`AgoraRTC.registerExtensions`</Link>
</PlatformStructured>
...
4. Experience the features of your new extension.
