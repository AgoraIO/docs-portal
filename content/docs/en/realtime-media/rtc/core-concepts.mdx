...
[Agora Console](https://console.agora.io/v2) is the main dashboard where you manage your Agora projects and services. Before you can use Agora's SDKs, you must first create a project in the Agora Console. See [Agora account management](/en/realtime-media/rtc/manage-agora-account) for
  details.
...
See [Agora account management](/en/realtime-media/rtc/manage-agora-account) for details on how to manage all aspects of your Agora account.
