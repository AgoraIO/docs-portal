...
- If you use cloud proxy with [Restricted media zones](/en/realtime-media/rtc/build/manage-connection-and-quality/geofencing), add only the IP addresses dedicated to your specified region.
