...
1. Integrate the SDK
    ...
    See [Get started](/en/realtime-media/rtc/get-started-sdk) for more information about integrating the v4.x SDK into your project.
...
See [Virtual Background](/en/realtime-media/rtc/build/apply-video-effects/virtual-background) to update the code in your app.
...
This section introduces the main changes of v4.x compared to v3.7.x in the following categories. You need to update the code of your app according to your business use-case.
  ...
  :::note
  If the version before upgrading is a version before v3.7.0, please check the [v3.x release notes](/en/realtime-media/rtc/reference/release-notes) to obtain the changes between this version and v3.7.0.
  :::
...
Agora SDK v4.0.0 is a new version of the SDK that you can use to embed real-time video and audio into your app. It supports large-scale real-time interactive activities and provides better real-time interactive effects. For details, see [Benefits and features](/en/realtime-media/rtc).
...
See [Get started](/en/realtime-media/rtc/get-started-sdk) for more information about integrating the v4.0.0 SDK into your project.
...
-  Remove the callback in [Client.setClientRole](https://api-ref.agora.io/en/video-sdk/web/4.x/interfaces/iagorartcclient.html#setclientrole) and return a promise. In the Video Calling v4.x, setting the user role as `audience` does not unpublish, and when calling `publish`, the SDK does not automatically set the user role as `host`
...
This section is based on v3.7.0 and introduces the main changes of v4.0.0 compared to v3.7.0 in the following categories. You need to update the code of your app according to your business use-case.
    :::note
    If the version before upgrading is a version before v3.7.0, please check the [v3.x release notes](/en/realtime-media/rtc/reference/release-notes?platform=windows-cpp) to obtain the changes between this version and v3.7.0.
    :::
...
Agora SDK v4.x is a new version of the SDK that you can use to embed real-time video and audio into your app. It supports large-scale real-time interactive activities and provides better real-time interactive effects. For details, see [Product overview](/en/realtime-media/rtc).
...
After updating from v4.0.0 Beta to v4.0.0, the SDK package name has changed from `electron-agora-rtc-ng` to `agora-electron-sdk`, see [Integrate the SDK](/en/realtime-media/rtc/get-started-sdk?platform=Electron#set-up-your-project-5).
...
See [Get started](/en/realtime-media/rtc/get-started-sdk#set-up-your-project) for more information about integrating the `agora_rtc_engine` 6.x SDK into your project.
...
After upgrading from v4.0.0 Beta to v4.0.0, the SDK package name has changed from `react-native-agora-rtc-ng` to `react-native-agora`, see [Integrate the SDK](/en/realtime-media/rtc/get-started-sdk?platform=React%20Native#set-up-your-project-6).
...
Agora SDK v4.0.0 is a new version of the SDK that you can use to embed real-time video and audio into your app. It supports large-scale real-time interactive activities and provides better real-time interactive effects. For details, see [Product overview](/en/realtime-media/rtc).
...
Refer to the [quickstart](/en/realtime-media/rtc/get-started-sdk) to integrate the v4.0.0 SDK into your project.
...
To integrate Video SDK for Unreal Engine v4.2.1 into your project, see [SDK quickstart](/en/realtime-media/rtc/get-started-sdk).
