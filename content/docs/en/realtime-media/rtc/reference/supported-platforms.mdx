...
- *Platforms*:
    ...
    |:-----------------|:-------|:-----|
    | Android | <Slot name="video-supported-android-abis" /> | Android Studio 3.0 or later |

    <Slot for="video-supported-android-abis">

    Android 4.1 or later.  RTC SDK supports the following ABIs.
...
- *Browsers supported on iOS*:
    ...
    On iOS, all apps with built-in browsers use the system WebView. Support for RTC SDK relies only on the iOS system version.
...
- *Platforms*:
    ...
    | Target Platform | Operating system version | IDE version     |
    |:-----------------|:-------|:-----|
    | macOS | <Slot name="video-supported-macos-architectures" /> | Xcode 9.0 or later |

    <Slot for="video-supported-macos-architectures">

    macOS 10.11 or later. RTC SDK supports the following:
...
The Agora Web SDK is a real-time audio and RTC SDK built on WebRTC technology. Consequently, its compatibility depends on the browser’s support for WebRTC.
...
- *Platforms*:
    | Target Platform | Operating system version | IDE version     |
    |:-----------------|:-------|:-----|
    | Windows | <Slot name="video-supported-windows-architectures" /> | Microsoft Visual Studio 2017 or later |

    <Slot for="video-supported-windows-architectures">

    Windows 7 or later. RTC SDK supports the following:
...
- *Platforms*:
    ...
    |:----------------|:------------------|
    | Electron | <Slot name="video-supported-electron-platforms" /> |

    <Slot for="video-supported-electron-platforms">

    Electron ≥ 1.8.3, < 25 - Windows (x86, x86-64)
    - macOS
...
- *Platforms*:
    ...
    |:----------------|:-------------------------|
    | Android | <Slot name="video-supported-flutter-android" /> |
    | iOS | <Slot name="video-supported-flutter-ios" /> |
    | macOS | <Slot name="video-supported-flutter-macos" /> |
    | Windows | <Slot name="video-supported-flutter-windows" /> |

    <Slot for="video-supported-flutter-android">
    ...
    <Slot for="video-supported-flutter-ios">
    ...
    <Slot for="video-supported-flutter-macos">
    ...
    <Slot for="video-supported-flutter-windows">
...
- *Platforms*:
    | Target Platform | Supported version |
    |:-----------------|:-------|
    | Unity | <Slot name="video-supported-unity-platforms" /> |

    <Slot for="video-supported-unity-platforms">

    Unity 2017 or later. RTC SDK supports the following:
