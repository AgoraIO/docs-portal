...
- For a guided setup flow, see [Run the sample project](/en/realtime-media/rtc/build/join-and-manage-channels/compile-run-sample-project).
- For Web quickstart guidance, see [Quickstart](/en/realtime-media/rtc/get-started-sdk).
