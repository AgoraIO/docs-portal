...
|-------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------|
| Web SDK 4.x | Call [setEnabled](https://api-ref.agora.io/en/video-sdk/web/4.13.0/interfaces/ilocaltrack.html#setenabled) method | Displays the last frame on the user screen in this slice and does not continue to generate video slices. |
