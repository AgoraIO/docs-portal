...
- You can use the [web page load timeout detection function](/en/realtime-media/recording/develop/webpage-load-timeout) to prevent the recorded content from being inconsistent with the expected content caused by the web page load timeout.
