...
Download the [Agora Format Converter Script](https://download.agora.io/acrsdk/release/cloud_recording_tools.v3.8.0.69-202302061216-release-prod.tar.gz) and decompress it. Find `ffmpeg.tar.gz` and `convert.py`. Decompress `ffmpeg.tar.gz`, and make sure it is in the same directory as `convert.py.`
...
| :--------------- | :--- |
| Linux            | VLC; ffplayer |
| Windows          | Media Player; KM Player; VLC Player; Chrome (49.0.2623 or later) |
| macOS            | QuickTime Player; Movist; MPlayerX; Chrome (49.0.2623 or later); Safari (11.0.3 or later) |
| iOS              | iOS default player; KMPlayer; Safari (9.0 or later) |
| Android          | Android default player; MXPlayer; VLC; KMPlayer; Chrome (9.0.2623 or later) |
