...
This page explains how Agora calculates your monthly bill for 
...
such as [Video Calling](/en/realtime-media/rtc), 
[Interactive Whiteboard](/en/realtime-media/whiteboard), 
or [Real-time Messaging](/en/realtime-media/rtm), expect additional charges. 
...
subscribed to a channel with a high-definition (HD) [aggregate video resolution](pricing#aggregate), Agora waives the cost of the video Video SDK usage during the web page recording; only the web page recording fees apply. Real-time communication at higher aggregate resolutions does not receive this discount.
