...
This page explains how Agora calculates your monthly bill for Cloud Recording. 
...
Billing for Cloud Recording begins once you use Cloud Recording to record and save audio calls, group video calls, or interactive video streaming made via the Agora Video SDK on your cloud storage.

Agora calculates the billing of all projects under your [Agora Account](https://console.agora.io/v2) monthly. 
...
If you create one recording instance and record multiple audio and video streams at the same time in a channel, the total service minutes per stream are not additive. For example:

- If one recording instance records the video streams of both user A and user B for the same 10 minutes, billing is for 10 minutes of video.
- If one recording instance records the audio stream of user A and the video stream of user B for the same 10 minutes, billing is also for 10 minutes of video.

If you use multiple recording sessions at the same time in a channel, service minutes are additive across recording sessions.
...
| Date | Audio seconds | HD seconds | Full HD seconds | 2K seconds | 2K+ seconds | Audio minutes | HD minutes | Full HD minutes | 2K minutes | 2K+ minutes |
| :--- | ------------: | ---------: | --------------: | ---------: | ----------: | ------------: | ---------: | --------------: | ---------: | ----------: |
...
| Monthly usage | 18,000 | 3,500 | 1,680 | 0 | 520 | 300 | 59 | 28 | 0 | 9 |

The billable service minutes in this example are:

- Audio: 300 minutes
- HD video: 59 minutes
- Full HD video: 28 minutes
- 2K video: 0 minutes
- 2K+ video: 9 minutes

The usage displayed on Agora Console is for reference only and is not used as the actual billing basis.

The cost of each service is:

- Audio: `(300 / 1000) × 1.49 = 0.447`
- HD video: `(59 / 1000) × 5.99 = 0.35341`
- Full HD video: `(28 / 1000) × 13.49 = 0.37772`
- 2K video: `0`
- 2K+ video: `(9 / 1000) × 53.99 = 0.48591`

The total estimated cost is `US$1.66`, because `0.447 + 0.35341 + 0.37772 + 0.48591 = 1.66404`, which rounds to `1.66`.

- Agora rounds up monthly total fees to two decimal places.
- Agora gives each account 10,000 free minutes per month. Because the monthly total service minutes in the example do not exceed 10,000 minutes, the service would still be free of charge and the bill would show `US$0`.
