...
The default time limit for recalling a message is two minutes. You can extend this time frame to up to 7 days in [Agora Console](https://console.agora.io/). To do so, select a project that enables Agora Chat, then click **Configure** > **Features** > **Message recall**.
