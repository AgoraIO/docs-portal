...
devices per platform up to 10 in the Chat Console. In [Agora Console](https://console.agora.io/), select **RTC Services** from the sidebar, locate the **Chat** card and select **Open Chat Console**, select **Connect Chat Console**, then in the sidebar, under **SETTING**, select **Multi-Device**.
