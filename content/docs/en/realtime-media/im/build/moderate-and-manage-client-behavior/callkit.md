 ...
 * @param enableRTCToken   Whether to enable token authentication for using the  service. If you enabled token authentication in Agora Console, set this parameter as true. The default value is false. 
  */
 ...
 *               - true: Yes.
 *               - false: No. In this situation, you do not need to pass the  token.
 * @param accessToken The Agora  token.
 */
...
```java
/**
 * Occurs when  token authentication is enabled.
 * 
