...
If you use Agora Chat together with the [Agora RTC SDK](https://docs.agora.io/cn/Agora%20Platform/term_agora_rtc_sdk), Agora recommends upgrading to [AccessToken 2](/en/realtime-media/im/build/access-token-2).
