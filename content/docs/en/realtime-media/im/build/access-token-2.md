...
## Prerequisites 
- You have built a token server based on Spring Framework and a Web client using Chat according to [Authenticate Your Users with Tokens](/en/realtime-media/im/build/authentication).
