...
:::info
The reaction feature is supported by all types of [Pricing Plans](./pricing-plan-details) and is enabled by default once you have enabled Chat in [Agora Console](https://console.agora.io/v2).
:::
