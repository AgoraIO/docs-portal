...
<Cards>
  ...
  <Card title="Authentication" href="/en/realtime-media/im/build/authentication" description="Authenticate users and protect Chat access." />
  <Card title="API reference" href="/en/api-reference/im" description="Explore Chat SDK and server API references." />
