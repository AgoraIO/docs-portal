...
- Moderation is not enabled by default. To use this feature, subscribe to the **Pro** or **Enterprise** [pricing plan](./pricing-plan-details) and enable it in [Agora Console](https://console.agora.io/).
  :::info
