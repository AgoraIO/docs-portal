...
The RESTful API call frequency limit of each method varies. For details about each method, see [**Chat RESTful API Reference**](/en/realtime-media/im/reference/server-api/restful-overview).
