...
| `400` | `illegal_argument` | "`{username}` is not legal." | The specified username is invalid when registering a user. For details, see [Registering a user](/en/realtime-media/im/reference/server-api/user-system-registration#registering-a-user). | When registering a user, pass a valid user ID `username`. |
...
| Status code | Error code | Error message | Description | Fix |
| :--------- | :---------- | :-------------| :------------ | :-------|
| `401` | `unauthorized` | "Registration is not open, please contact the app admin." | The app token is missing, incorrect, expired, or in an invalid format when calling [Registering a user](/en/realtime-media/im/reference/server-api/user-system-registration#registering-a-user) or [Registering multiple users](/en/realtime-media/im/reference/server-api/user-system-registration#registering-multiple-users). | Pass a valid app token. |
...
| Status code | Error code  | Error message | Description   | Fix     |
| :---------  | :---------- | :-------------| :------------ | :-------|
| `413`            | `file exceeding maximum limit`           | "the file size exceeds the maximum limit."   | The size of the message attachment uploaded using the [message upload API](/en/realtime-media/im/reference/server-api/message-management#upload-a-file) exceeds the allowed limit. | For more information about the size limit of message attachments, see [Message Length](./limitations#message-length). |
...
| `429` | `reach_limit` | "This request has reached API limit." | The calling frequency of the Chat API exceeds the allowed limit. | You cannot exceed the call frequency limit for RESTful APIs. For details, see [RESTful API Call Frequency Limit](/en/realtime-media/im/reference/server-api/restful-overview#features). To upgrade your pricing plan, contact [support@agora.io](mailto:support@agora.io). |
