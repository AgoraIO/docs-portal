...
- An Agora project that has [enabled the Chat service](./get-started/enable#enable-chat).
- An [App key](./get-started/enable#get-chat-project-information) and [a user token generated on your app server](/en/realtime-media/im/build/secure-access-and-authentication/authentication).
