...
1. Integrate Agora Chat SDK into your project:
    ...
    1.  In Xcode, click **File** &gt; **Add Packages...**, then paste the following link in the search:
        ...
        You see the available Agora packages. In **AgoraChat_iOS**, specify the latest Chat SDK version, for example `1.0.9`. You can obtain the latest version information in the [release notes](../overview/release-notes).
