...
- An [Agora project](../reference/manage-agora-account.md#create-an-agora-project) for which you have [enabled Chat](./enable.md#enable-).
- The [App Key](./enable.md#get-chat-project-information) for the project.
- Internet access.
...
1. Integrate Agora Chat SDK into your project:
    ...
    1.  In Xcode, click **File** &gt; **Add Packages...**, then paste the following link in the search:
        ...
        You see the available Agora packages. In **AgoraChat_iOS**, specify the latest Chat SDK version, for example `1.0.9`. You can obtain the latest version information in the [release notes](../overview/release-notes.md).
...
1. Create an app instance for the first user:
    ...
    1. [Register a user](./enable.md#register-a-user) in [Agora Console](https://console.agora.io/v2) and [Generate a user token](./enable.md#generate-a-user-token).

    1. In the `MainActivity` class, update `userId`, `token`, and `appKey` with values from Agora Console.  To get your app key, see [Get Chat project information](./enable.md#get-chat-project-information).
...
1. Create an app instance for the first user:
    ...
    1. In the `ViewController` class, update `userId`, `token`, and `appKey` with values from Agora Console.  To get your app key, see [Get Chat project information](./enable.md#get-chat-project-information).
...
1. Create an app instance for the first user:
    ...
    1. In the `_MyHomePageState` class, update `appKey`, `token`, and `userId` with values from Agora Console.  To get your app key, see [Get Chat project information](./enable.md#get-chat-project-information).
...
1. In the `NewBehaviourScript` class, update `userId`, `token`, and `appKey` with values from Agora Console. To get your app key, see [Get Chat project information](./enable.md#get-chat-project-information).
...
1. [Register the recipient user](./enable.md#register-a-user) in Agora Console and [Generate a user token](./enable.md#generate-a-user-token).
...
1. Create an app instance for the first user:
    ...
    1. In the `MainWindow` class, update `userId`, `token`, and `appKey` with values from Agora Console.  To get your app key, see [Get Chat project information](./enable.md#get-chat-project-information).
...
* For more code samples, see [Samples and demos](../reference/downloads.md).
...
* [Manual install](../reference/manual-sdk-install.md) shows you how to integrate Chat SDK into your project manually.
...
* Install the [demo  app](../reference/downloads.md).
