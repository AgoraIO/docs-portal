...
- Dubbing AI Voice Changer is used with Agora Voice SDK v4.x.
    ...
    Refer to the [SDK quickstart](/en/realtime-media/voice/quickstart) to integrate Voice SDK v4.x and implement basic voice calling.
...
1. **Integrate the Dubbing AI Voice Changer extension**
    ...
    To integrate the extension in your project:
        ...
        1. Enter the [Extensions Marketplace](https://console.agora.io/legacy/extensions-marketplace) and download the **Dubbing AI Voice Changer** extension package. After unzipping, save all `.aar` files to the project folder `/app/libs`.
...
1. **Integrate the Dubbing AI Voice Changer extension**
    ...
    To integrate the extension in your project:
        ...
        1. Enter the [Extensions Marketplace](https://console.agora.io/legacy/extensions-marketplace) page and download the plug-in package for **Extensions** plug-in.
