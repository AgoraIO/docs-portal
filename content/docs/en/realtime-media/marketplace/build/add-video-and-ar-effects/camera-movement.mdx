...
To follow this procedure, you must have integrated v4.2.x or v4.3.x of the Video SDK and implemented basic real-time audio and video functions in your app. See [SDK quickstart](/en/realtime-media/rtc/get-started-sdk).
...
2. Integrate the extension from the corresponding version folder according to the Video SDK version used in your app. For example, if your app uses version 4.2.6, integrate the extension from the `./sdk/4.2` directory.
