...
To follow this procedure, you must have integrated v4.2.x or v4.3.x of the Video SDK and implemented basic real-time audio and video functions in your app. See [SDK quickstart](/en/realtime-media/video/quickstart).
