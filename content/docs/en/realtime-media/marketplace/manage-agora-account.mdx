...
<Tabs defaultValue="email" groupId="signup" persist>
<TabsList>
...
1. On the **Security** panel, click **Generate Temp Token**, enter a channel name in the pop-up box and click **Generate**. Copy the generated RTC token for use in your app projects.
...
1. Choose the Agora product your user wants to log in to. Fill in **App ID** and **App Certificate** with the details of your project in Agora Console.
...
For more information on managing other aspects of your Agora account, see [Agora console overview](/en/realtime-media/video/build/reference/console-overview).
