...
:::info
Agora charges additionally for this extension. See [Pricing](/en/realtime-media/video/overview/pricing#ai-noise-suppression-pricing).
:::
...
For API details, see [AI Noise Suppression](/en/realtime-media/video/build/ai-noise-suppression).
