...
The Screen Sharing extension enables a local user to share their screen contents with other users to improve communication efficiency. For details, see [Screen Sharing](screen-sharing.mdx).
:::warning
