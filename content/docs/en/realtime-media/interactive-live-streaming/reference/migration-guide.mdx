...
1. Integrate the SDK
    ...
    See [Quickstart](/en/realtime-media/interactive-live-streaming/quickstart) for more information about integrating the v4.x SDK into your project.
...
See [Virtual Background](/en/realtime-media/interactive-live-streaming/build/apply-effects-and-enhancements/virtual-background) to update the code in your app.
...
Agora SDK v4.0.0 is a new version of the SDK that you can use to embed real-time video and audio into your app. It supports large-scale real-time interactive activities and provides better real-time interactive effects. For details, see [Benefits and features](/en/realtime-media/interactive-live-streaming/product-overview).
...
See [Quickstart](/en/realtime-media/interactive-live-streaming/quickstart) for more information about integrating the v4.0.0 SDK into your project.
...
Agora SDK v4.x is a new version of the SDK that you can use to embed real-time video and audio into your app. It supports large-scale real-time interactive activities and provides better real-time interactive effects. For details, see [Product overview](/en/realtime-media/interactive-live-streaming/product-overview).
...
After updating from v4.0.0 Beta to v4.0.0, the SDK package name has changed from `electron-agora-rtc-ng` to `agora-electron-sdk`. See [Quickstart](/en/realtime-media/interactive-live-streaming/quickstart) to integrate the SDK.
...
See [Quickstart](/en/realtime-media/interactive-live-streaming/quickstart) for more information about integrating the `agora_rtc_engine` 6.x SDK into your project.
...
See the [quickstart](/en/realtime-media/interactive-live-streaming/quickstart) for more information about integrating the v4.0.0 SDK into your project.
...
After upgrading from v4.0.0 Beta to v4.0.0, the SDK package name has changed from `react-native-agora-rtc-ng` to `react-native-agora`. See [Quickstart](/en/realtime-media/interactive-live-streaming/quickstart) to integrate the SDK.
...
Refer to the [quickstart](/en/realtime-media/interactive-live-streaming/quickstart) to integrate the v4.0.0 SDK into your project.
...
To integrate Video SDK for Unreal Engine v4.2.1 into your project, see [Quickstart](/en/realtime-media/interactive-live-streaming/quickstart).
