...
1. Enable Cloud Proxy. In [Agora Console](https://console.agora.io), select **Project Settings** from the sidebar. Switch to the **Services** tab, locate **Cloud Proxy**, and turn on the **Active** toggle.
