...
1. Enable Cloud Proxy. In [Agora Console](https://console.agora.io), go to **Realtime Services**, select **Cloud Proxy** under **Security & Infrastructure**, and turn on the **Active** toggle.
