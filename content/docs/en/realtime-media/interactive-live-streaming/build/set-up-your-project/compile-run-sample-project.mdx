...
- Go to the [SDKs](/en/api-reference/sdks) page, download the latest version of the Agora Video SDK, and unzip it.
...
- Go to the [SDKs](/en/api-reference/sdks) page, download the latest version of Video SDK, and unzip it.
...
- Go to the [SDKs](/en/api-reference/sdks) page, download the latest version of the Video SDK, and unzip it. You see a `.unitypackage` file.
