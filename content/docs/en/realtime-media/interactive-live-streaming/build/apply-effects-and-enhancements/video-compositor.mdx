...
Note: To integrate the extension, use version 4.12.0 or later of the Web SDK.
...
1. Integrate the [Virtual Background](/en/realtime-media/interactive-live-streaming/build/apply-effects-and-enhancements/virtual-background#integrate-the-virtual-background-extension) extension. Ensure that you understand the [considerations](/en/realtime-media/interactive-live-streaming/build/apply-effects-and-enhancements/virtual-background#considerations).
