...
* Same setup as the [Video SDK quickstart prerequisites](../../index.mdx) for Interactive Live Streaming.
...
2. Open your Flutter project
  ...
  Load the [SDK quickstart](../../index.mdx) Interactive Live Streaming project you created previously.
