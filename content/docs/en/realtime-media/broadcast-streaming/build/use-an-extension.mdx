...
* Same setup as the [Video SDK quickstart prerequisites](../index.mdx) for Broadcast Streaming.
...
1. Open your Flutter project
  ...
  Load the [SDK quickstart](../index.mdx) Broadcast Streaming project you created previously.
