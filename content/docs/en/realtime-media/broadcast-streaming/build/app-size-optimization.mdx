...
### Use the Voice SDK
Video SDK supports both audio and video functions, and the package size is large. If you only need to use audio features, best practice is to integrate the [Voice SDK](../../../sdks). For details, see [Voice SDK Quickstart](https://docs-md.agora.io/en/en/voice-calling/get-started/get-started-sdk_android).
...
- [Why are dynamic libraries preferred over static libraries in the Video SDK](https://docs-md.agora.io/en/help/integration-issues/dynamic_or_static_library)
</PlatformStructured>
...
When integrating through the [Direct download](https://docs-md.agora.io/en/en/sdks) link, manually delete the extension files that you do not need to use.
