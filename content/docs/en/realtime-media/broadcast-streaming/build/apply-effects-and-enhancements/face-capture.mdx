...
:::note
To avoid collecting facial data through callbacks and building your own collection, encoding, and transmission framework, use the Agora [MetaKit extension](metakit) for facial capture.
:::
## Prerequisites
