...
:::note
Cross-channel media stream relay is included in Agora's policy of [10,000 free minutes](https://docs-md.agora.io/en/help/account-and-billing/billing_free) every month. For usage beyond the free quota, please refer to [Pricing](../reference/pricing).
:::
## Prerequisites
