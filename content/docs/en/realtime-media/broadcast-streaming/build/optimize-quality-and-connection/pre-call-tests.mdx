...
:::
## Prerequisites
Ensure that you have implemented the [SDK quickstart](../../index) project and that your app has obtained permissions to use the relevant devices.
...
:::
## Prerequisites
Ensure that you have implemented the [SDK quickstart](../../index) project and that your game has obtained permissions to use the relevant devices.
