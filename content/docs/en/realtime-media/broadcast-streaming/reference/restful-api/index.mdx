---
title: Media Broadcast REST API overview
...
:::info
Media Broadcast is currently in public beta. To enable this service, contact <a href="mailto:support@agora.io">support@agora.io</a>.
:::
...
- The App ID of your Agora project. See [Get the App ID](/en/realtime-media/broadcast-streaming/reference/console-overview).
- A Customer ID/Customer Secret pair. See [Generate a Customer ID and Customer Secret](/en/realtime-media/broadcast-streaming/reference/agora-console-rest-api).
