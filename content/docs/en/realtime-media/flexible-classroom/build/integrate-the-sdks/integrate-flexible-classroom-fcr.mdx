...
1. Modify the code according to your needs. See [FcrUIScene SDK customization guide](/en/realtime-media/flexible-classroom/build/customize-the-ui-and-plugins/customize-ui-scene-sdk) for details.
