...
1. Open the [Flexible Classroom web demo](/en/realtime-media/flexible-classroom/quickstart) and click **Create** to create a room.

    ![flexible_classroom_web_demo](https://assets-docs.agora.io/images/flexible-classroom/fc_web_demo.png)

2. Enter the classroom name, class start and end time, then select **Online Proctoring** in **Class mode** and click **Create**.

    ![create_classroom_web_demo](https://assets-docs.agora.io/images/flexible-classroom/create_classroom_web_demo.png)
...
3. Test your hardware before entering the room to ensure that you can monitor the exam.
    ...
    ![online_proctoring](https://assets-docs.agora.io/images/flexible-classroom/online_proctoring.png)
...
5. During the exam you can see monitor screens, or surveillance walls, for examinees. You can do the following:
    ...
    ![start_exam](https://assets-docs.agora.io/images/flexible-classroom/start_exam.png)

    - Broadcast video and audio to all examinees.

    ![broadcast_video_audio](https://assets-docs.agora.io/images/flexible-classroom/broadcast_video_audio.png)

    - Click the surveillance wall of an examinee to enter the monitoring details page.

    ![monitoring_details](https://assets-docs.agora.io/images/flexible-classroom/monitoring_details.png)
...
1. Open the [Flexible Classroom web demo](/en/realtime-media/flexible-classroom/quickstart) and click **Join**.

    ![join_classroom](https://assets-docs.agora.io/images/flexible-classroom/join_classroom.png)

2. Enter the room ID, select the **Student** role, and click **Join**.

    ![enter_name](https://assets-docs.agora.io/images/flexible-classroom/enter_name.png)
...
3. Test your device capabilities before entering the room.
    ...
    ![join_exam](https://assets-docs.agora.io/images/flexible-classroom/join_exam.png)
...
when they broadcast.
   ...
   ![take_exam](https://assets-docs.agora.io/images/flexible-classroom/take_exam.png)
