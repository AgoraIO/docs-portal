...
To enable Flexible Classroom, in [Agora Console](https://console.agora.io/v2) go to **Realtime Services** and select **Flexible Classroom** under **Vertical Solutions**.
...
These values are generated when you enable Chat for the project. To enable Chat, in [Agora Console](https://console.agora.io/v2) go to **Realtime Services**, select **Chat** under **Core RTC**, turn on the **Active** toggle, and select a data center location.
