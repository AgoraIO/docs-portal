...
To enable Media Pull, in [Agora Console](https://console.agora.io), select **RTC Services** from the sidebar and find **Media Pull**. Turn on the **Active** toggle to enable.
