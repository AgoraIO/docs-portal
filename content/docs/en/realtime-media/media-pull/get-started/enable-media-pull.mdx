...
To enable Media Pull, in [Agora Console](https://console.agora.io), select **Project Settings** from the sidebar, switch to the **Services** tab and find **Media Pull**. Turn on the **Active** toggle to enable.
