...
Before starting, ensure that you have implemented the [Video SDK quickstart](https://docs.agora.io/en/video-calling/get-started/get-started-sdk) in your project.
...
1. On the **My Projects** page, find the project for which you want to enable Media Pull and click **Edit**.
