...
To enable Media Pull, in [Agora Console](https://console.agora.io/v2) go to **Realtime Services**, select **Media Pull** under **Media Services**, and turn on the **Active** toggle. If you cannot enable Media Pull, [contact support](mailto:support@agora.io).
