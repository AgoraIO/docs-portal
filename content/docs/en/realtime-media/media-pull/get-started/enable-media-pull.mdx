...
Media Pull service enables you to inject external media streams into real-time Agora channels. This page explains how to use Media Pull and RTC SDK to publish external media to a channel.

## Prerequisites

Before starting, ensure that you have implemented the [RTC SDK quickstart](/en/realtime-media/rtc/get-started-sdk) in your project.
...
To enable Media Pull, in [Agora Console](https://console.agora.io), select **RTC Services** from the sidebar, then locate the **Media Pull** card and turn on its toggle.
