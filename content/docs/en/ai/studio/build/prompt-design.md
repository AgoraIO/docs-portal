---
title: Prompt design
description: Best practices and patterns for writing effective system prompts for your AI voice agent.
---
...
For campaigns, add variable values as columns in your contact list CSV. Each column name maps to a variable name in your prompts. See [Contact list format](../deploy/campaign.md#contact-list-format) for details.
...
See [Test your agent](test-agent.md) for details on using the test interface.

## Next steps

- [Customize your agent](customize-agent.md): Configure ASR, LLM, and TTS settings in the agent editor
- [Test your agent](test-agent.md): Test and troubleshoot your agent before deployment
