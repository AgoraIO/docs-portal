...
1. Select the **Test** tab in the right panel. The agent visualizer shows a **Ready to Connect** status.
1. Select **Start Call**. The agent status changes from **Joining**, to **Connecting Agent**, to **Talking**, and then to **Listening**, indicating the agent is ready to hear you.
    ![Test agent panel](/console-tmp/test-agent-panel.png)
