...
2. At the top of the page, select the **Credentials** tab.
...
5. From the **Type** dropdown, select **ASR/STT**, **LLM**, **TTS**, or **MLLM**.
6. Select the **Vendor** from the dropdown for which you want to add the credential.
7. Paste your provider's API key and complete any other required parameters.
8. Select **Create**.
