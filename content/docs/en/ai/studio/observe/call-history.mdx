...
1. In the navigation sidebar, select **Call History**.
2. Use the search bar to find calls by agent name, campaign name, or phone number.
3. Select **Customise View** to change which columns are shown, or **+ Filter** to narrow the list further.
