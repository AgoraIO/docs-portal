...
For SIP transfer setup, valid SIP destination formats, and dynamic SIP header examples, see [Transfer to SIP address and dynamic SIP headers](transfer-to-sip-address-and-dynamic-sip-headers).
