...
1. In Agent Studio, select **Campaign** from the sidebar.
    ...
    ![Create a campaign](https://assets-docs.agora.io/images/conversational-ai/studio/campaign.png)

2. Click **Create Campaign**.

    ![New campaign](https://assets-docs.agora.io/images/conversational-ai/studio/campaign-new.png)
...
4. Upload your contact list in the **Contacts List** panel. Click **Select File** or drag and drop a CSV file into the upload area. See [Contact list format](#contact-list-format) for requirements.
...
6. Configure call settings:
    ...
    ![Call Settings](https://assets-docs.agora.io/images/conversational-ai/studio/campaign-new-2.png)
   ...
   - **Transfer Call to Human**: Transfers the call to a human agent when needed or requested by the caller. When enabled, configure the following:
      ...
      - **Transfer Destination**: Enter the destination phone number or SIP address.
   ...
   - **Transcripts & Recording**
     ...
     ![Transcripts and Call Analysis](https://assets-docs.agora.io/images/conversational-ai/studio/campaign-new-3.png)
