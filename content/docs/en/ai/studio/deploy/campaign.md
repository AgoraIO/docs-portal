...
- An [imported phone number](import.md) to use as caller ID. If you are using Twilio, see [Set up SIP trunk](sip-trunk.md) first.
- A [deployed agent](deploy-agent.md) configured for your use case
...
- [Analytics](../observe/analytics.md): View performance metrics for your campaigns
- [Call History](../observe/call-history.md): Review individual call transcripts and outcomes
