...
2. [Configure device network](../device-setup/configure-device-network)
3. [Build and flash firmware](../firmware-integration/build-and-flash-firmware)
...
- [Configure device network](../device-setup/configure-device-network)
- [Build and flash firmware](../firmware-integration/build-and-flash-firmware)
