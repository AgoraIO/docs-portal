...
Conversational AI Engine is enabled by default for new projects, so no console setup is required. If you're using an older project, verify that Conversational AI Engine is enabled on the **Realtime Services** page in [Agora Console](https://console.agora.io/).
