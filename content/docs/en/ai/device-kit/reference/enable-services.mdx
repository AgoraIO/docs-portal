...
Conversational AI Engine is enabled by default for new projects, so no console setup is required. If you're using an older project, verify that Conversational AI Engine is enabled on the **Realtime Services** page in [Agora Console](https://console.agora.io/v2).

You can then call the Convo AI Device Kit RESTful API.
...
<include cwd>content/includes/en/shared/console/restful-credentials.mdx</include>
