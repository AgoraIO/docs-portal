...
Conversational AI Engine is enabled by default for new projects, so no console setup is required. If you're using an older project, verify that Conversational AI Engine is enabled under the **Services** tab on the **Project Settings** page in [Agora Console](https://console.agora.io/).
