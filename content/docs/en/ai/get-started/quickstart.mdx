...
:::info
Conversational AI Engine is enabled by default for new projects. If you're using an older project and the agent fails to start, verify that Conversational AI Engine is enabled under the **Services** tab on the **Project Settings** page in [Agora Console](https://console.agora.io/).
:::
