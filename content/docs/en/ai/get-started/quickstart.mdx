...
- [Optimize conversation latency](../build/harden-and-optimize/optimize-latency): Tune ASR, LLM, TTS, and deployment choices.
- [Optimize audio](../build/harden-and-optimize/audio-setup): Apply recommended client audio settings.
