...
- **Latency optimization best practices**
  ...
  Adds a guide to [Optimize conversation latency](build/harden-and-optimize/optimize-latency).

- **Cloud Recording best practices**

  Adds a guide to [Record conversations with Cloud Recording](build/harden-and-optimize/record-agent-conversation).
...
- **Geofencing**
  ...
  Use `geofence` configuration when you [Start a conversational AI agent](/en/api-reference/api-ref/conversational-ai/join) to limit which Agora servers the Conversational AI Engine can access based on geographic regions. See [Restrict agent zones](build/harden-and-optimize/regional-restrictions) for details.
...
- **Multi-platform toolkit**
  ...
  - [**Optimize audio settings**](build/harden-and-optimize/audio-setup)
