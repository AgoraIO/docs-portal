...
Agora's Conversational AI Engine empowers you to build cutting-edge, voice-enabled applications by merging Agora's robust realtime audio streaming with the conversational intelligence of leading LLMs.

Use this product space when you want a software-first path for web, mobile, desktop, or backend-driven voice agents.
...
- **Multi-platform support**: Deliver the same product capability across iOS, Android, Web, and dedicated hardware paths.

## Typical use cases

- **Voice assistants and copilots**: Give users a natural spoken interface for task execution, search, and coordination.
- **Customer support and service agents**: Handle inbound or outbound service flows with realtime voice interaction.
