...
To use an OpenAI LLM with an Agora managed key, specify one of the following presets in the [`preset`](/en/api-reference/api-ref/conversational-ai/join#preset) field when starting an agent:
...
The following examples show a starting `llm` parameter configuration you can use when you [Start a conversational AI agent](/en/api-reference/api-ref/conversational-ai/join). 
