...
To use an OpenAI LLM with an Agora managed key, specify one of the following presets in the [`preset`](../../../api-reference/conversational-ai/rest-api/agent/join#preset) field when starting an agent:
...
The following examples show a starting `llm` parameter configuration you can use when you [Start a conversational AI agent](../../../api-reference/conversational-ai/rest-api/agent/join). 
...
For complete `llm` configuration options, see [LLM parameters](../../../api-reference/conversational-ai/rest-api/agent/join#properties-llm). For OpenAI-specific options and model capabilities, see the [OpenAI API documentation](https://platform.openai.com/docs/api-reference/chat).
