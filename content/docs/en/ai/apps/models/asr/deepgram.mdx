...
To use Deepgram ASR with an Agora managed key, specify one of the following presets in the [`preset`](/en/api-reference/api-ref/conversational-ai/join#preset) field when starting an agent:
