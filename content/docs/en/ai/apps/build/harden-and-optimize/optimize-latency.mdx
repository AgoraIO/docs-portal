...
The following example shows latency data from three conversation turns in an actual conversation. This data comes from the [`111 agent metrics`](/en/ai/apps/reference/event-types#111-agent-metrics) event in Agora's [message notification service](/en/ai/apps/build/handle-runtime-events/webhooks):
...
For detailed integration steps and API reference, see [Receive webhook notifications](/en/ai/apps/build/handle-runtime-events/webhooks).
...
For detailed event field descriptions, see [Notification event 111 agent metrics](/en/ai/apps/reference/event-types#111-agent-metrics).
...
For detailed MLLM integration guides, see [MLLM overview](/en/ai/apps/models/mllm). */}
...
* [Receive webhook notifications](/en/ai/apps/build/handle-runtime-events/webhooks)
...
{/* * [MLLM overview](/en/ai/apps/models/mllm) */}
