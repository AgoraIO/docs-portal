...
| --- | --- | --- |
| Receive history automatically when the session ends | Webhook event | [`103 agent history`](/en/ai/apps/reference/event-types#103-agent-history) |
...
[`103 agent history`](/en/ai/apps/reference/event-types#103-agent-history) is the best fit when you want the platform to push session history to your server after the agent stops.
...
The number of stored history items in [`103 agent history`](/en/ai/apps/reference/event-types#103-agent-history) depends on `llm.max_history` when you start the agent. The default is `32`.
...
- [Notification event types](/en/ai/apps/reference/event-types#103-agent-history)
