...
[Voice AI quickstart](../../get-started/quickstart) guide. 
...
In the meantime, use the [Voice AI quickstart](../../get-started/quickstart)
...
> **Coming soon**
> The Go backend walkthrough is not yet available. It will mirror the Python path: a standalone backend on port 8000, a Next.js web client on port 3000, and the same three HTTP endpoints. In the meantime, see the [Voice AI quickstart](../../get-started/quickstart) guide to get started with Go.
...
> [Voice AI quickstart](../../get-started/quickstart) guide in the meantime.
