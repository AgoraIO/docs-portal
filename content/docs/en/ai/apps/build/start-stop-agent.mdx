...
- The following information from Agora Console:
    ...
    - [Customer ID and Customer secret](../../../api-reference/conversational-ai/rest-api/authentication#generate-customer-id-and-customer-secret): Used for HTTP authentication when calling the RESTful APIs.
...
Call the `join` endpoint to create an agent instance that joins an Agora channel. Pass in the `channel` name and `token` for agent authentication. To generate your base64-encoded credentials, see [RESTful authentication](../../../api-reference/conversational-ai/rest-api/authentication).
...
For complete information on all request parameters, see [Start a conversational AI agent](../../../api-reference/conversational-ai/rest-api/agent/join).
...
Store the `agent_id` for use in subsequent API calls to [query](../../../api-reference/conversational-ai/rest-api/agent/query), [update](../../../api-reference/conversational-ai/rest-api/agent/update), and [stop](../../../api-reference/conversational-ai/rest-api/agent/leave) the AI agent.
