...
- [Use presets](../build/custom-model-integration/presets): Start with Agora-managed ASR, LLM, and TTS providers.
- [Optimize conversation latency](/en/ai/apps/build/harden-and-optimize/optimize-latency): Tune ASR, LLM, TTS, and deployment choices.
- [Optimize audio](/en/ai/apps/build/harden-and-optimize/audio-setup): Apply recommended client audio settings.
- [REST API reference](/en/api-reference/api-ref/conversational-ai): Review exact request and response shapes.
- Explore the SDK API references for [Typescript](../../api-reference/conversational-ai/server-sdk/typescript), [Python](../../api-reference/conversational-ai/server-sdk/python), and [Go](../../api-reference/conversational-ai/server-sdk/go).
