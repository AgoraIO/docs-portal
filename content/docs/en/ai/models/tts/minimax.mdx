...
To use MiniMax TTS with an Agora managed key, specify one of the following presets in the [`preset`](../../../api-reference/conversational-ai/rest-api/agent/join#preset) field when starting an agent:
