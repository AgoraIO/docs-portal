...
- **Managed mode**
  ...
  To use OpenAI TTS with an Agora-managed key, specify the following preset in the [`preset`](/en/api-reference/conversational-ai/rest-api/agent/join#preset) field when starting an agent:
