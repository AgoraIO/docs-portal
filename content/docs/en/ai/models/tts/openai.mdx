...
- **Managed mode**
  ...
  To use OpenAI TTS with an Agora-managed key, specify the following preset in the [`preset`](/en/api-reference/api-ref/conversational-ai/join#preset) field when starting an agent:
