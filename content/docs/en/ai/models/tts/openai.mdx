...
<ParameterList title="params">
  ...
  The full endpoint URL for the OpenAI speech API, for example `https://api.openai.com/v1/audio/speech`. See [How to use data residency](https://platform.openai.com/docs/guides/your-data#how-to-use-data-residency).
  </Parameter>
  ...
  Identifier of the model to be used. For managed mode, use `tts-1`.
  </Parameter>
