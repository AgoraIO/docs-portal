...
For complete `llm` configuration options, see [LLM parameters](/en/api-reference/api-ref/conversational-ai/join#request-body-properties-llm). For Claude-specific options and model capabilities, see the [Claude API documentation](https://docs.anthropic.com/en/api/messages).
