...
For complete `llm` configuration options, see [LLM parameters](../../../api-reference/conversational-ai/rest-api/agent/join#properties-llm). For Claude-specific options and model capabilities, see the [Claude API documentation](https://docs.anthropic.com/en/api/messages).
