...
Use `models/gemini-3.8-live-extended-thinking` when the conversation benefits from additional reasoning. Set `thinking_level` to `low`, `medium`, or `high`. To use `models/gemini-3.8-live`, omit `thinking_level`.
