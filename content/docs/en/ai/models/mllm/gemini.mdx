...
:::info[Important]
`walkie-talkie` and `clever-chatter` are early access preview models. When using either model, send your [Start a conversational AI agent](/en/api-reference/api-ref/conversational-ai/join) request to the following preview endpoint instead of the standard endpoint, and include the required header:
