...
Use `models/gemini-3.8-live-extended-thinking` when the conversation benefits from additional reasoning. Set `thinking_level` to `low`, `medium`, or `high`. Omit `thinking_level` when using `models/gemini-3.8-live`.
...
<ParameterList title="mllm" required={true}>
  ...
  <Parameter name="params" type="object" required={true}>
    ...
    <Parameter name="model" type="string" required={true} possibleValues="models/gemini-3.8-live, models/gemini-3.8-live-extended-thinking">
    ...
    <Parameter name="thinking_level" type="string" required={false} possibleValues="low, medium, high">
      The reasoning budget for `models/gemini-3.8-live-extended-thinking`. Do not set this parameter with `models/gemini-3.8-live`.
    </Parameter>
