...
:::info[SDK version]
This example requires Agora Agent Python SDK v2.8.0 or later, which automatically routes GPT-Live sessions to the preview endpoint and includes the `agora-feature: live-models` header.
:::
...
:::info[SDK version]
This example requires Agora Agent TypeScript SDK v2.8.0 or later, which automatically routes GPT-Live sessions to the preview endpoint and includes the `agora-feature: live-models` header.
:::
...
:::info[SDK version]
This example requires Agora Agent Go SDK v2.8.0 or later, which automatically routes GPT-Live sessions to the preview endpoint and includes the `agora-feature: live-models` header.
:::
