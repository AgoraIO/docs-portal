...
- Integrate Video SDK v4.5.1 or later and follow the [Quickstart](../../../realtime-media/rtc/get-started-sdk) guide to implement basic real-time audio and video features.
