...
- Enable the SIG service for your project in the Agora Console and follow the [SIG Quickstart](/en/realtime-media/rtm/quickstart) to implement real-time messaging.
...
2. Create a configuration object for the RTC engine and SIG client instances, then use it to initialize the component instance.
