...
| `content.generated_config.fallback_strategy` | String | Fallback strategy for when a generated phrase isn't available in time. Currently only `static` is supported. |
