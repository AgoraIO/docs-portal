...
To enable Signaling integration, set `advanced_features.enable_rtm` to `true` in the [POST request](../../api-reference/conversational-ai/rest-api/agent/join) when creating a conversational AI agent. Refer to the following sample request:
