...
| The response was slow or degraded before failure | [`111 agent metrics`](/en/ai/reference/event-types#111-agent-metrics) | [`Query conversation turn information`](/en/api-reference/conversational-ai/rest-api/agent/turns) |
| A specific turn failed | `turn_id` from `onAgentError` or `110` | [`Query conversation turn information`](/en/api-reference/conversational-ai/rest-api/agent/turns) |
...
- Query [`turns`](/en/api-reference/conversational-ai/rest-api/agent/turns) when you need turn-level timing and completion data
...
5. If the problem happened on a specific turn, query [`turns`](/en/api-reference/conversational-ai/rest-api/agent/turns).
...
For performance-focused analysis, also see [Optimize conversation latency](/en/ai/best-practices/optimize-latency).
...
4. If needed, query [`turns`](/en/api-reference/conversational-ai/rest-api/agent/turns) for per-turn timing and completion data.
