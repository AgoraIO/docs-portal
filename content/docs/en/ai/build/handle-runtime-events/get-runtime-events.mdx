...
For the full client setup and platform examples, see [Listen to agent runtime events on client apps](event-notifications).
...
- [Notification event types](/en/ai/reference/event-types): what the webhook event numbers mean
