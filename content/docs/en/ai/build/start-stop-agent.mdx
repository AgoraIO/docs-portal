...
- [REST API authentication credentials](/en/api-reference/api-ref/conversational-ai/authentication#generate-customer-id-and-customer-secret) for Curl requests.
- Third-party ASR, LLM, and TTS credentials for the provider configuration you plan to use.
