...
description: Explicitly control when a user's speech starts and ends by sending manual SoS and EoS requests over RTM.
---
...
<Tabs>
<TabsList>
  <TabsTrigger value="sos-result">user.manual_sos.result</TabsTrigger>
  <TabsTrigger value="eos-result">user.manual_eos.result</TabsTrigger>
  <TabsTrigger value="assistant-eos-result">assistant.manual_eos.result</TabsTrigger>
</TabsList>

<TabsContent value="sos-result">
...
<TabsContent value="assistant-eos-result">
...
- [Get agent state](/en/ai/build/harden-and-optimize/get-agent-state)
