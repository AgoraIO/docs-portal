...
| The response was slow or degraded before failure | [`111 agent metrics`](../reference/event-types#111-agent-metrics) | [`Query conversation turn information`](../../api-reference/conversational-ai/rest-api/agent/turns) |
