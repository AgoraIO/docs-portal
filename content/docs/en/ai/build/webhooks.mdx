...
Use this page when you need durable backend records for monitoring, alerting, or analytics. If you need live UI state inside the app, use [Listen to agent runtime events on software clients](event-notifications.md).
...
For payload details, see [Notification event types](../reference/event-types.md).
