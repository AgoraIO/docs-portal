...
| `instructions` | String | Instructions for voice style, emotion, or other playback directives. |
...
| `tts.params.instructions` | String | No | - | Instructions for voice style, emotion, or other playback directives. |
