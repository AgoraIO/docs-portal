...
description: Use managed mode to simplify provider setup for ASR, LLM, and TTS without supplying your own API keys.
---
...
- An Agora [account and project](/en/introduction/account). Conversational AI Engine is enabled by default for new projects.
...
| Vendor | Models |
|--------|--------|
| [ARES](/en/ai/models/asr/ares) | Built-in ASR engine |
| [Deepgram](/en/ai/models/asr/deepgram) | `nova-2`, `nova-3` |

### LLM

| Vendor | Models |
|--------|--------|
| [OpenAI](/en/ai/models/llm/openai) | `gpt-4o-mini`, `gpt-4.1-mini`, `gpt-5-nano`, `gpt-5-mini` |

### TTS

| Vendor | Models |
|--------|--------|
| [MiniMax](/en/ai/models/tts/minimax) | `speech-2.6-turbo`, `speech-2.8-turbo` |
| [OpenAI](/en/ai/models/tts/openai) | `tts-1` |
