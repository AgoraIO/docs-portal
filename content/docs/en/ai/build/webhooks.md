...
description: Receive notification of agent events in real time.
---
...
For payload details, see [Notification event types](event-types.md).
...
- [Notification event types](event-types.md)
- [Start a conversational AI agent](../../api-reference/conversational-ai/rest-api/agent/join.md)
- [Retrieve agent history](../../api-reference/conversational-ai/rest-api/agent/history.md)
