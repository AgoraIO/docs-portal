...
description: Configure Cloud Recording to record AI agent conversations.
---
This guide explains how to configure Agora [Cloud Recording](../../realtime-media/recording/index.md) to work with conversational AI agents and avoid audio scene conflicts.
...
After starting the agent, start Cloud Recording by calling the [Start Cloud Recording API](../../realtime-media/recording/index.md#start).
