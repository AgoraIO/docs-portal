...
To customize interruption behavior, configure the `turn_detection` parameters when calling [Start a conversational AI agent](../../api-reference/conversational-ai/rest-api/agent/join.md).

To enable AIVAD-based interruption, set [`turn_detection.config.end_of_speech.mode`](../../api-reference/conversational-ai/rest-api/agent/join.md#properties-turn-detection-config-end-of-speech-mode) to `"semantic"`.
...
Use the [Interrupt agent](../../api-reference/conversational-ai/rest-api/agent/interrupt.md) API to manually initiate an interruption request.
...
- Integrate VSDK v4.5.1 or later and follow the [Quickstart](../../introduction/realtime-audio-video.md) guide to implement basic real-time audio and video features.
- Enable the SIG service for your project in the Agora Console and follow the [SIG Quickstart](../../realtime-media/rtm/index.md) to implement real-time messaging.
...
Call [Start a conversational AI agent](../../api-reference/conversational-ai/rest-api/agent/join.md) using the following parameter settings:
...
- [`interrupt`](../../api-reference/conversational-ai/client-toolkit/android.md#interrupt)
...
- [`interrupt`](../../api-reference/conversational-ai/client-toolkit/ios.md#interrupt)
...
- [`interrupt`](../../api-reference/conversational-ai/client-toolkit/web.md#interrupt)
