...
- [Enabled Agora conversational AI](../reference/enable-conversational-ai.md#enable-conversational-ai) for your project.
- The following information from Agora Console:
    - [App ID](../reference/enable-conversational-ai.md#get-the-app-id): The string identifier for your project used to call the Conversational AI Engine RESTful API.
    - [Customer ID and Customer secret](../../api-reference/conversational-ai/rest-api/authentication.md#generate-customer-id-and-customer-secret): Used for HTTP authentication when calling the RESTful APIs.
    - A [temporary token](../reference/enable-conversational-ai.md#generate-temporary-tokens): The token is used by the agent for authentication when joining an Agora channel. 
- Obtained API keys for:
  ...
  > **Tip**
> If you don't yet have API keys from a third-party LLM or TTS provider, [Use presets](presets.md) to start your first agent without ASR, LLM, and TTS credentials.

- Implemented the [Voice Calling](../../introduction/realtime-audio-video.md) or [Video Calling](../../introduction/realtime-audio-video.md) quickstart.
...
Call the `join` endpoint to create an agent instance that joins an Agora channel. Pass in the `channel` name and `token` for agent authentication. To generate your base64-encoded credentials, see [RESTful authentication](../../api-reference/conversational-ai/rest-api/authentication.md).
...
For complete information on all request parameters, see [Start a conversational AI agent](../../api-reference/conversational-ai/rest-api/agent/join.md).
...
Store the `agent_id` for use in subsequent API calls to [query](../../api-reference/conversational-ai/rest-api/agent/query.md), [update](../../api-reference/conversational-ai/rest-api/agent/update.md), and [stop](../../api-reference/conversational-ai/rest-api/agent/leave.md) the AI agent.
...
- [Stop a conversational AI agent](../../api-reference/conversational-ai/rest-api/agent/leave.md)
- [Update agent configuration](../../api-reference/conversational-ai/rest-api/agent/update.md)
- [Query agent status](../../api-reference/conversational-ai/rest-api/agent/query.md)
- [Retrieve a list of agents](../../api-reference/conversational-ai/rest-api/agent/list.md)
