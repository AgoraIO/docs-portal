...
- [Start and stop an agent](../build/start-stop-agent.md): Create and end a voice agent session with the REST API.
- [Use presets](../build/presets.md): Start with Agora-managed ASR, LLM, and TTS providers.
- [Optimize conversation latency](../best-practices/optimize-latency.md): Tune ASR, LLM, TTS, and deployment choices.
- [Optimize audio](../best-practices/audio-setup.md): Apply recommended client audio settings.
...
- [Use filler words](../build/filler-words.md): Reduce perceived latency by filling silence during LLM processing.

## Reference

- [REST API reference](/en/api-reference/conversational-ai/rest-api)
- [Typescript Server SDK](../../api-reference/conversational-ai/server-sdk/typescript.md)
- [Python Server SDK](../../api-reference/conversational-ai/server-sdk/python.md)
- [Go Server SDK](../../api-reference/conversational-ai/server-sdk/go.md)

## Full-control path

- [Architecture](../build/architecture.md): Understand how the backend, client, RTC, RTM, and agent session fit together.
