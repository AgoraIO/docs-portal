...
description: Optimize end-to-end conversation latency by tuning LLM, ASR, and TTS components, geographic deployment, and RTC settings.
---
...
The following example shows latency data from three conversation turns in an actual conversation. This data comes from the [`111 agent metrics`](../build/event-types.md#111-agent-metrics) event in Agora's [message notification service](../build/webhooks.md):
...
For detailed integration steps and API reference, see [Receive webhook notifications](../build/webhooks.md).
...
For detailed event field descriptions, see [Notification event 111 agent metrics](../build/event-types.md#111-agent-metrics).
...
For detailed regional access restriction configuration, see [Restrict agent zones](regional-restrictions.md). -->
...
For detailed audio setting optimization, see [Optimize audio](audio-setup.md).
...
For detailed MLLM integration guides, see [MLLM overview](../models/mllm/index.md). -->
...
* [Optimize audio](audio-setup.md)
* [Notification event types](../build/event-types.md)
* [Conversational AI Performance Lab](https://www.agora.io/en/conversational-ai-performance-lab)

<!-- * [MLLM overview](../models/mllm/index.md) -->
