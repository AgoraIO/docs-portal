...
description: Monitor agent state changes in real time using RTM Message events.
---
...
- Completed the basic agent integration. See [Voice Agent quickstart](/en/ai/get-started/quickstart).
- Integrated the RTM SDK and implemented message listener logic. See [RTM quickstart](/en/realtime-media/rtm/quickstart).
