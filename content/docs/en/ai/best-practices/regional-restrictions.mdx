...
To configure region access restrictions, set `properties.geofence` when you [Start a conversational AI agent](../../api-reference/conversational-ai/rest-api/agent/join).
...
<ParameterList title="properties.geofence">
  <Parameter
    ...
    type="string"
    required
    possibleValues="GLOBAL, NORTH_AMERICA, EUROPE, ASIA, INDIA, JAPAN"
  >
  ...
  <Parameter
    ...
    type="string"
    required={false}
    possibleValues="NORTH_AMERICA, EUROPE, ASIA, INDIA, JAPAN"
  >
...
Use the following request body when you [Start a conversational AI agent](../../api-reference/conversational-ai/rest-api/agent/join):
