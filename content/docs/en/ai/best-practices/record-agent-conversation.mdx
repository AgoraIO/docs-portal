...
After the agent is running, call the [Start Cloud Recording API](/en/api-reference/cloud-recording/restful#start) to begin recording.
...
- [Start and stop an agent](start-stop-agent.mdx)
