...
- SDK
    ...
    - `onAudioRouteChanged`
- Toolkit
    - [`loadAudioSettings`](../../api-reference/conversational-ai/client-toolkit/android#loadaudiosettings)
...
- Toolkit
    - [`loadAudioSettings`](../../api-reference/conversational-ai/client-toolkit/ios#loadaudiosettings12)
