...
- Integrated Video SDK v4.5.1 or later and followed the [Quickstart](/en/realtime-media/rtc/get-started-sdk) guide to implement basic real-time audio and video features.
