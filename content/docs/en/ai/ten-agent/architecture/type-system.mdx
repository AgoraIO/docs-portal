---
title: 'Type system'
description: "TEN framework type system reference: basic and composite data types, type conversion rules, schema validation, and language mappings for C++, Go, and Python."
---
