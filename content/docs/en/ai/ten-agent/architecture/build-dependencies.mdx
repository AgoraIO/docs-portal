---
title: "TEN Framework build dependencies"
description: "Review the build tools, runtime libraries, and patched third-party dependencies used by the TEN Framework."
---
...
| [libwebsockets](https://github.com/TEN-framework/ten-framework/tree/main/third_party/libwebsockets) | 4.3.2, with [patch](#libwebsockets-patch) | [MIT](https://github.com/warmcat/libwebsockets/blob/main/LICENSE) | Network communication |
| [curl](https://github.com/TEN-framework/ten-framework/tree/main/third_party/curl/) | 8.1.2, with [patch](#curl-patch) | [MIT-like](https://curl.se/docs/copyright.html) | HTTP requests and API communication |
| [clingo](https://github.com/TEN-framework/ten-framework/tree/main/third_party/clingo/) | 5.8.0, with [patch](#clingo-cmake-patch) | [MIT](https://github.com/potassco/clingo/blob/master/LICENSE.md). | Logical constraint solving |
...
| [libbacktrace*](https://github.com/TEN-framework/ten-framework/tree/main/core/src/ten_utils/backtrace) | 1.0 | [BSD](https://github.com/ianlancetaylor/libbacktrace/blob/master/LICENSE) | Debug information and crash reporting |
| [uthash*](https://github.com/TEN-framework/ten-framework/tree/main/core/include/ten_utils/container) | 2.3.0 | [BSD revised](https://github.com/troydhanson/uthash/blob/master/LICENSE) | Efficient in-memory data structures |
| [uuid4*](https://github.com/TEN-framework/ten-framework/tree/main/core/src/ten_utils/lib/sys/general/uuid.c) | - | [MIT](https://github.com/rxi/uuid4/blob/master/LICENSE) | Unique identifier generation |
| [zf_log*](https://github.com/TEN-framework/ten-framework/tree/main/core/src/ten_utils/log) | - | [MIT](https://github.com/wonder-mice/zf_log/blob/master/LICENSE) | Framework-wide logging |
