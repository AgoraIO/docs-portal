---
title: "TEN metadata system"
description: "Use manifest and property metadata to describe TEN packages, configure runtime behavior, and validate app configuration."
---
