---
title: 'Schema system'
description: "TEN framework schema system: define and validate data structures for extensions, messages, and properties with type safety and consistency."
---
...
- **Review the [Type system](./type-system)** documentation for detailed information about supported data types and conversion rules
