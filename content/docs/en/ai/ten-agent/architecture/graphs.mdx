---
title: "TEN graphs"
description: "Define TEN application data flow with graphs, nodes, connections, message routing, and graph lifecycle settings."
---
...
![Two Types of Graph](https://assets-docs.agora.io/images/ten-framework/two_types_of_graph.png)
