...
Use this guide when you are starting a new Python ASR extension from the default template. For the complete extension lifecycle, see [Development workflow](./development-workflow). For metadata and schema concepts, see [Schema system](../architecture/schema-system).

## Prerequisites

- Understand the development and testing process of TEN extensions. See [Development workflow](./development-workflow).
...
:::info
For details about TEN Framework metadata and schemas, see [Schema system](../architecture/schema-system).
:::
