...
![Extension lifecycle stage transitions](/images/ten-framework/stage-transition-graph.png)
...
3. Extension A receives the response and calls `on_init_done()`
    ...
    ![Extension initialization coordination sequence](/images/ten-framework/extension-sequence.png)
