...
### All except Flutter, Android, React Native, iOS, Web

**Currently, there is no Chat UI Kit for Web.**
...
![](/images/im/ui-kit-quickstart.png)
...
- An Agora project that has [enabled the Chat service](../get-started/enable#enable-the-agora-chat-service).
- An [App key](./enable.md#get-the-information-of-the-agora-chat-project) and [a user token generated on your app server](../develop/authentication).
...
2. Integrate the Chat SDK into your project with Maven Central. 
	...
	1. In `/Gradle Scripts/build.gradle(Module: .app)`, add the following lines to integrate the Chat UI Samples into your Android project:
...
1. To add the text strings used by the UI, open `app/res/values/strings.xml ` and  replace the content with the following:
    ...
    ```xml
        ...
        Enter content
        Show log area...
        An account has been signed in, please sign out first and then sign in
...
You can see the app launch in your browser. Before you can send a message, refer to [Add a contact](../client-api/user-attributes.md#manage-contacts) or [Join a chat group](../client-api/chat-group/manage-chat-groups.md#join-and-leave-a-chat-group) to add a contact or join a chat group.
...
For demonstration purposes, Chat provides an app server that enables you to quickly retrieve a token using the App Key given in this guide. In a production context, the best practice is for you to deploy your own token server, use your own [App Key](./enable.md#get-the-information-of-the-agora-chat-project) to generate a token, and retrieve the token on the client side to log in to Agora. To see how to implement a server that generates and serves tokens on request, see [Authenticate your users with tokens](../develop/authentication).
