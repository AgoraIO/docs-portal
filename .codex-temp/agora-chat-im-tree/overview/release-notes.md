...
- Included the `libaosl.so` library in the SDK. If you have integrated both Agora Chat SDK 1.3.2 and Signaling SDK 2.2.0 and above or Video SDK 4.3.0 and above, a compilation error may occur. For details, see [Integration issues](../get-started/get-started-sdk.md#integration-issues).
