...
- An [Agora project](../reference/manage-agora-account#create-and-manage-projects) with the [App Certificate](../reference/manage-agora-account#manage-app-certificates) and [Agora Chat](../get-started/enable.md) enabled.
