...
- Your project integrates a version of the Chat SDK later than v1.0.3 and has implemented the basic [real-time chat functionalities](../../get-started/get-started-sdk.md).
