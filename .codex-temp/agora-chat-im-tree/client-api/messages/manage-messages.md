...
- You have integrated the Chat SDK, initialized the SDK and implemented the functionality of registering accounts and login. For details, see [Chat SDK quickstart](../../get-started/get-started-sdk.md).
...
- [Retrieve conversations and messages from the server](../messages/retrieve-messages)
- [Message receipts](../messages/message-receipts)
